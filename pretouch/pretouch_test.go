...
func TestPretouchTwitterStruct(t *testing.T) {
	...
	require.Nil(t, decoder.Pretouch(reflect.TypeOf(*m), option.WithCompileMaxInlineDepth(10), option.WithCompileRecursiveDepth(10)))
	e := time.Now()
	...
	require.Nil(t, encoder.Pretouch(reflect.TypeOf(m), option.WithCompileMaxInlineDepth(10), option.WithCompileRecursiveDepth(10)))
	e = time.Now()
