 ...
 */
 ...
 func (self *_Assembler) save_state() {
     ...
     self.Emit("MOVQ", _SP_x, jit.Sib(_R8, _AX, 1, 0))   // MOVQ SP.x, 0(ST)(AX)
     self.Emit("MOVQ", _SP_f, jit.Sib(_R8, _AX, 1, 8))   // MOVQ SP.f, 8(ST)(AX)
     self.Emit("MOVQ", _SP_p, jit.Sib(_R8, _AX, 1, 16))  // MOVQ SP.p, 16(ST)(AX)
     self.Emit("MOVQ", _SP_q, jit.Sib(_R8, _AX, 1, 24))  // MOVQ SP.q, 24(ST)(AX)
 }
 ...
 func (self *_Assembler) drop_state(decr int64) {
     ...
     self.Emit("MOVQ" , jit.Sib(_CX, _AX, 1, 0), _SP_x)      // MOVQ  8(ST)(AX), SP.x
     self.Emit("MOVQ" , jit.Sib(_CX, _AX, 1, 8), _SP_f)     // MOVQ  16(ST)(AX), SP.f
     self.Emit("MOVQ" , jit.Sib(_CX, _AX, 1, 16), _SP_p)     // MOVQ  24(ST)(AX), SP.p
     self.Emit("MOVQ" , jit.Sib(_CX, _AX, 1, 24), _SP_q)     // MOVQ  32(ST)(AX), SP.q
     self.Emit("PXOR" , _X0, _X0)                            // PXOR  X0, X0
     self.Emit("MOVOU", _X0, jit.Sib(_CX, _AX, 1, 0))        // MOVOU X0, 8(ST)(AX)
     self.Emit("MOVOU", _X0, jit.Sib(_CX, _AX, 1, 16))       // MOVOU X0, 24(ST)(AX)
 }
 ...
 func (self *_Assembler) _asm_OP_load(_ *_Instr) {
     self.Emit("MOVQ", jit.Ptr(_ST, 0), _AX)                 // MOVQ (ST), AX
     self.Emit("MOVQ", jit.Ptr(_ST, 8), _CX)                 // MOVQ 8(ST), CX
     self.Emit("MOVQ", jit.Sib(_CX, _AX, 1, -32), _SP_x)     // MOVQ -24(ST)(AX), SP.x
     self.Emit("MOVQ", jit.Sib(_CX, _AX, 1, -16), _SP_p)      // MOVQ -8(ST)(AX), SP.p
     self.Emit("MOVQ", jit.Sib(_CX, _AX, 1, -8), _SP_q)       // MOVQ (ST)(AX), SP.q
 }
