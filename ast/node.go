...
func (self *Node) Bool() bool {
	...
	case types.V_FALSE:
		return false
	default:
		panic("value cannot be represented as a boolean")
	}
}
...
func (self *Node) Int64() int64 {
	...
	switch self.t {
	case _V_NUMBER:
		return numberToInt64(self)
	case types.V_TRUE:
		return 1
	case types.V_FALSE:
		return 0
	default:
		panic("value cannot be represented as an integer")
	}
}
...
func (self *Node) Number() json.Number {
	...
	default:
		panic("value cannot be represented as a json.Number")
	}
}
...
func (self *Node) String() string {
	...
	case types.V_STRING:
		return addr2str(self.p, self.v)
	default:
		panic("value cannot be represented as a simple string")
	}
}
