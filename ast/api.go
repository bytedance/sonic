...
// marshalValue marshals v to JSON bytes using sonic encoder
func marshalValue(v interface{}) ([]byte, error) {
	return encoder.Encode(v, encoder.NoEncoderNewline)
}

// unmarshalValue unmarshals JSON bytes to v using sonic decoder
