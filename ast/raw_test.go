...
func TestRawNode_SetByPath(t *testing.T) {
    tests := []struct{
        ...
        {"empty object 2",`{}`,false,[]interface{}{"a",1},NewValueJSON(`2`),false,ErrIndexOutOfRange{true, 1}.Error(),`{}`},
        ...
        {"not exist array",`[1]`,false,[]interface{}{1},NewValueJSON(`2`),false,ErrIndexOutOfRange{false, 0}.Error(),`[1]`},
        {"empty array",`[]`,true,[]interface{}{1},NewValueJSON(`2`),false,"",`[2]`},
        {"empty array",`[]`,false,[]interface{}{1},NewValueJSON(`2`),false,ErrIndexOutOfRange{false, 0}.Error(),`[]`},
