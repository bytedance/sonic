...
func TestTypeCast(t *testing.T) {
    ...
    var cases = []tcase{
        ...
        {"Number", newRawNode("true", types.V_TRUE), json.Number(""), ErrUnsupportType},
        {"String", Node{}, "", ErrNotExist},
        {"String", newRawNode(`""`, types.V_STRING), ``, nil},
        {"String", newRawNode(`0.0`, _V_NUMBER), "", ErrUnsupportType},
        {"String", newRawNode(`null`, types.V_NULL), "", ErrUnsupportType},
        {"String", newRawNode(`true`, types.V_TRUE), "", ErrUnsupportType},
