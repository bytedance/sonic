...
func TestTypeCast(t *testing.T) {
	...
	var cases = []tcase{
		...
		{"Number", NewAny(int64(-42)), json.Number("-42"), nil},
		{"Number", NewAny(uint64(^uint64(0))), json.Number("18446744073709551615"), nil},
		{"Number", NewAny(float32(1.1)), json.Number("1.1"), nil},
		{"Number", NewAny(float64(-1.25)), json.Number("-1.25"), nil},
		...
		{"String", NewAny(int64(-1 << 63)), "-9223372036854775808", nil},
		{"String", NewAny(uint64(^uint64(0))), "18446744073709551615", nil},
		{"String", NewAny(float32(1.1)), "1.1", nil},
