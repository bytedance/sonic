...
void DumpElf(const std::string &OutputPath, llvm::StringRef ElfPath, MCContextBundle &Bundle,
    const std::string &Package, const std::string &BaseName, uint64_t &DumpTextSize, const std::string &Mode);
...
void DumpTmpl(const std::string &TmplFile, const std::string &Package, const std::string &OutputPath,
