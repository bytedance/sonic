...
_u64toa:
	...
	LONG $0x00a2870f; WORD $0x0000  // ja           LBB0_8, $162(%rip)
	...
	LONG $0x0016820f; WORD $0x0000  // jb           LBB0_3, $22(%rip)
	LONG $0xac0d8d48; WORD $0x0004; BYTE $0x00  // leaq         $1196(%rip), %rcx  /* _Digits+0(%rip) */
	WORD $0x0c8a; BYTE $0x0a  // movb         (%rdx,%rcx), %cl
	WORD $0x0f88  // movb         %cl, (%rdi)
	LONG $0x000001b9; BYTE $0x00  // movl         $1, %ecx
	LONG $0x00000be9; BYTE $0x00  // jmp          LBB0_4, $11(%rip)
LBB0_3:
	WORD $0xc931  // xorl         %ecx, %ecx
	WORD $0xfe83; BYTE $0x64  // cmpl         $100, %esi
	LONG $0x0045820f; WORD $0x0000  // jb           LBB0_5, $69(%rip)
LBB0_4:
	WORD $0xb70f; BYTE $0xd2  // movzwl       %dx, %edx
	LONG $0x01ca8348  // orq          $1, %rdx
	LONG $0x84358d48; WORD $0x0004; BYTE $0x00  // leaq         $1156(%rip), %rsi  /* _Digits+0(%rip) */
	WORD $0x148a; BYTE $0x32  // movb         (%rdx,%rsi), %dl
	WORD $0xce89  // movl         %ecx, %esi
	WORD $0xc1ff  // incl         %ecx
	WORD $0x1488; BYTE $0x37  // movb         %dl, (%rdi,%rsi)
LBB0_6:
	LONG $0x73158d48; WORD $0x0004; BYTE $0x00  // leaq         $1139(%rip), %rdx  /* _Digits+0(%rip) */
...
LBB0_7:
	...
	LONG $0x5b158d48; WORD $0x0004; BYTE $0x00  // leaq         $1115(%rip), %rdx  /* _Digits+0(%rip) */
...
LBB0_5:
	...
	LONG $0xffc8830f; WORD $0xffff  // jae          LBB0_6, $-56(%rip)
	LONG $0xffffd4e9; BYTE $0xff  // jmp          LBB0_7, $-44(%rip)
LBB0_8:
	LONG $0xfffe8148; WORD $0xf5e0; BYTE $0x05  // cmpq         $99999999, %rsi
	LONG $0x011e870f; WORD $0x0000  // ja           LBB0_16, $286(%rip)
	...
	LONG $0x0017820f; WORD $0x0000  // jb           LBB0_11, $23(%rip)
	LONG $0xb9058d48; WORD $0x0003; BYTE $0x00  // leaq         $953(%rip), %rax  /* _Digits+0(%rip) */
	LONG $0x02048a41  // movb         (%r10,%rax), %al
	WORD $0x0788  // movb         %al, (%rdi)
	LONG $0x000001b9; BYTE $0x00  // movl         $1, %ecx
	LONG $0x00000ee9; BYTE $0x00  // jmp          LBB0_12, $14(%rip)
LBB0_11:
	WORD $0xc931  // xorl         %ecx, %ecx
	LONG $0x4240fe81; WORD $0x000f  // cmpl         $1000000, %esi
	LONG $0x0076820f; WORD $0x0000  // jb           LBB0_13, $118(%rip)
LBB0_12:
	WORD $0x8944; BYTE $0xd0  // movl         %r10d, %eax
	LONG $0x01c88348  // orq          $1, %rax
	LONG $0x8d358d48; WORD $0x0003; BYTE $0x00  // leaq         $909(%rip), %rsi  /* _Digits+0(%rip) */
	WORD $0x048a; BYTE $0x30  // movb         (%rax,%rsi), %al
	WORD $0xce89  // movl         %ecx, %esi
	WORD $0xc1ff  // incl         %ecx
	WORD $0x0488; BYTE $0x37  // movb         %al, (%rdi,%rsi)
LBB0_14:
	LONG $0x7c058d48; WORD $0x0003; BYTE $0x00  // leaq         $892(%rip), %rax  /* _Digits+0(%rip) */
...
LBB0_15:
	...
	LONG $0x01c88348  // orq          $1, %rax
	LONG $0x62358d48; WORD $0x0003; BYTE $0x00  // leaq         $866(%rip), %rsi  /* _Digits+0(%rip) */
	WORD $0x048a; BYTE $0x30  // movb         (%rax,%rsi), %al
	WORD $0xca89  // movl         %ecx, %edx
...
LBB0_13:
	...
	LONG $0xff94830f; WORD $0xffff  // jae          LBB0_14, $-108(%rip)
	LONG $0xffffa1e9; BYTE $0xff  // jmp          LBB0_15, $-95(%rip)
LBB0_16:
	QUAD $0x86f26fc0ffffb848; WORD $0x0023  // movabsq      $9999999999999999, %rax
	WORD $0x3948; BYTE $0xc6  // cmpq         %rax, %rsi
	LONG $0x0115870f; WORD $0x0000  // ja           LBB0_18, $277(%rip)
	...
	QUAD $0xfffffd970d6f0ff3  // movdqu       $-617(%rip), %xmm1  /* LCPI0_0+0(%rip) */
	...
	QUAD $0xfffffd69156f0ff3  // movdqu       $-663(%rip), %xmm2  /* LCPI0_1+0(%rip) */
	LONG $0xc2e40f66  // pmulhuw      %xmm2, %xmm0
	QUAD $0xfffffd6d256f0ff3  // movdqu       $-659(%rip), %xmm4  /* LCPI0_2+0(%rip) */
	LONG $0xc4e40f66  // pmulhuw      %xmm4, %xmm0
	QUAD $0xfffffd712d6f0ff3  // movdqu       $-655(%rip), %xmm5  /* LCPI0_3+0(%rip) */
	...
	QUAD $0xfffffd270d6f0ff3  // movdqu       $-729(%rip), %xmm1  /* LCPI0_4+0(%rip) */
	...
	LONG $0xc8158d48; WORD $0x0002; BYTE $0x00  // leaq         $712(%rip), %rdx  /* _VecShiftShuffles+0(%rip) */
...
LBB0_18:
	...
	LONG $0x000f870f; WORD $0x0000  // ja           LBB0_20, $15(%rip)
	WORD $0xc280; BYTE $0x30  // addb         $48, %dl
	WORD $0x1788  // movb         %dl, (%rdi)
	LONG $0x000001b9; BYTE $0x00  // movl         $1, %ecx
	LONG $0x0000bae9; BYTE $0x00  // jmp          LBB0_25, $186(%rip)
LBB0_20:
	WORD $0xfa83; BYTE $0x63  // cmpl         $99, %edx
	LONG $0x001f870f; WORD $0x0000  // ja           LBB0_22, $31(%rip)
	WORD $0xd089  // movl         %edx, %eax
	LONG $0x9b0d8d48; WORD $0x0001; BYTE $0x00  // leaq         $411(%rip), %rcx  /* _Digits+0(%rip) */
	...
	LONG $0x000092e9; BYTE $0x00  // jmp          LBB0_25, $146(%rip)
LBB0_22:
	WORD $0xd089  // movl         %edx, %eax
	WORD $0xe8c1; BYTE $0x02  // shrl         $2, %eax
	LONG $0x147bc069; WORD $0x0000  // imull        $5243, %eax, %eax
	...
	LONG $0x003c870f; WORD $0x0000  // ja           LBB0_24, $60(%rip)
	...
	WORD $0xb70f; BYTE $0xc0  // movzwl       %ax, %eax
	LONG $0x460d8d48; WORD $0x0001; BYTE $0x00  // leaq         $326(%rip), %rcx  /* _Digits+0(%rip) */
	WORD $0x148a; BYTE $0x41  // movb         (%rcx,%rax,2), %dl
	LONG $0x0141448a  // movb         $1(%rcx,%rax,2), %al
	WORD $0x5788; BYTE $0x01  // movb         %dl, $1(%rdi)
	WORD $0x4788; BYTE $0x02  // movb         %al, $2(%rdi)
	LONG $0x000003b9; BYTE $0x00  // movl         $3, %ecx
	LONG $0x00003ce9; BYTE $0x00  // jmp          LBB0_25, $60(%rip)
LBB0_24:
	WORD $0xc86b; BYTE $0x64  // imull        $100, %eax, %ecx
	WORD $0xca29  // subl         %ecx, %edx
	WORD $0xb70f; BYTE $0xc0  // movzwl       %ax, %eax
	LONG $0x20058d4c; WORD $0x0001; BYTE $0x00  // leaq         $288(%rip), %r8  /* _Digits+0(%rip) */
...
LBB0_25:
	...
	LONG $0x1aeac148  // shrq         $26, %rdx
	LONG $0xc26e0f66  // movd         %edx, %xmm0
	QUAD $0xfffffb930d6f0ff3  // movdqu       $-1133(%rip), %xmm1  /* LCPI0_0+0(%rip) */
	...
	LONG $0xc0700f66; BYTE $0x50  // pshufd       $80, %xmm0, %xmm0
	QUAD $0xfffffb65256f0ff3  // movdqu       $-1179(%rip), %xmm4  /* LCPI0_1+0(%rip) */
	LONG $0xc4e40f66  // pmulhuw      %xmm4, %xmm0
	QUAD $0xfffffb692d6f0ff3  // movdqu       $-1175(%rip), %xmm5  /* LCPI0_2+0(%rip) */
	LONG $0xc5e40f66  // pmulhuw      %xmm5, %xmm0
	QUAD $0xfffffb6d1d6f0ff3  // movdqu       $-1171(%rip), %xmm3  /* LCPI0_3+0(%rip) */
	LONG $0xf06f0f66  // movdqa       %xmm0, %xmm6
	...
	LONG $0xc1670f66  // packuswb     %xmm1, %xmm0
	QUAD $0xfffffb1b05fc0f66  // paddb        $-1253(%rip), %xmm0  /* LCPI0_4+0(%rip) */
	WORD $0xc889  // movl         %ecx, %eax
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__u64toa_entry+112(SB)  // _u64toa
	MOVQ AX, ret+16(FP)
	RET
