...
_validate_one:
	...
	LONG $0x6e0f4966; BYTE $0xc3  // movq         %r11, %xmm0
...
LBB0_1:
	...
	LONG $0x24338f0f; WORD $0x0000  // jg           LBB0_439, $9267(%rip)
...
LJTI0_1:
	...
	LONG $0xfffffd4d  // .long L0_1_set_426
	LONG $0xfffffd4d  // .long L0_1_set_426
	LONG $0xffffd8ca  // .long L0_1_set_1
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__validate_one_entry+174(SB)  // _validate_one
	MOVQ AX, ret+24(FP)
	RET
