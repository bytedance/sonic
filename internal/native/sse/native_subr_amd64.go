...
var (
    _subr__f32toa             = __native_entry__() + 52448
    _subr__f64toa             = __native_entry__() + 448
    _subr__get_by_path        = __native_entry__() + 44960
    _subr__html_escape        = __native_entry__() + 10768
    _subr__i64toa             = __native_entry__() + 5120
    _subr__lspace             = __native_entry__() + 80
    _subr__quote              = __native_entry__() + 6560
    _subr__skip_array         = __native_entry__() + 24560
    _subr__skip_number        = __native_entry__() + 34448
    _subr__skip_object        = __native_entry__() + 26944
    _subr__skip_one           = __native_entry__() + 35808
    _subr__skip_one_fast      = __native_entry__() + 40672
    _subr__u64toa             = __native_entry__() + 5248
    _subr__unquote            = __native_entry__() + 8400
    _subr__validate_one       = __native_entry__() + 38192
    _subr__validate_utf8      = __native_entry__() + 51216
    _subr__validate_utf8_fast = __native_entry__() + 51888
    _subr__value              = __native_entry__() + 12064
    _subr__vnumber            = __native_entry__() + 16432
    _subr__vsigned            = __native_entry__() + 23760
    _subr__vstring            = __native_entry__() + 13984
