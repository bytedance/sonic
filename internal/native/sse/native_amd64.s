...
LBB1_8:
	...
	WORD $0xd348; BYTE $0xe3                   // shlq         %cl, %rbx
	LONG $0x121d8d4c; WORD $0x009f; BYTE $0x00 // leaq         $40722(%rip), %r11  /* _pow10_ceil_sig.g(%rip) */
...
LBB1_31:
	...
	LONG $0x0069ede8; BYTE $0x00   // callq        _format_significand, $27117(%rip)
...
LBB1_38:
	...
	LONG $0x160d8d48; WORD $0x009b; BYTE $0x00 // leaq         $39702(%rip), %rcx  /* _Digits(%rip) */
...
LBB1_52:
	...
	LONG $0xc30d8d48; WORD $0x0099; BYTE $0x00 // leaq         $39363(%rip), %rcx  /* _Digits(%rip) */
...
LBB1_97:
	WORD $0x894c; BYTE $0xfe     // movq         %r15, %rsi
	LONG $0x006467e8; BYTE $0x00 // callq        _format_significand, $25703(%rip)
...
LBB2_2:
	...
	LONG $0x400d8d48; WORD $0x0092; BYTE $0x00 // leaq         $37440(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_5:
	LONG $0x1759b941; WORD $0xd1b7             // movl         $3518437209, %r9d
	LONG $0xf9158d4c; WORD $0x0091; BYTE $0x00 // leaq         $37369(%rip), %r10  /* _Digits(%rip) */
...
LBB2_7:
	...
	LONG $0x81158d48; WORD $0x0091; BYTE $0x00 // leaq         $37249(%rip), %rdx  /* _Digits(%rip) */
...
LBB2_9:
	...
	LONG $0x600d8d48; WORD $0x0091; BYTE $0x00 // leaq         $37216(%rip), %rcx  /* _Digits(%rip) */
	LONG $0x4104b70f                           // movzwl       (%rcx,%rax,2), %eax
...
_u64toa:
	...
	LONG $0x7c0d8d48; WORD $0x0090; BYTE $0x00 // leaq         $36988(%rip), %rcx  /* _Digits(%rip) */
...
LBB4_4:
	...
	LONG $0x54358d48; WORD $0x0090; BYTE $0x00 // leaq         $36948(%rip), %rsi  /* _Digits(%rip) */
...
LBB4_6:
	LONG $0x42158d48; WORD $0x0090; BYTE $0x00 // leaq         $36930(%rip), %rdx  /* _Digits(%rip) */
...
LBB4_7:
	...
	LONG $0x29158d48; WORD $0x0090; BYTE $0x00 // leaq         $36905(%rip), %rdx  /* _Digits(%rip) */
...
LBB4_8:
	...
	LONG $0x86058d48; WORD $0x008f; BYTE $0x00 // leaq         $36742(%rip), %rax  /* _Digits(%rip) */
...
LBB4_12:
	...
	LONG $0x01c88348                           // orq          $1, %rax
	LONG $0x5a358d48; WORD $0x008f; BYTE $0x00 // leaq         $36698(%rip), %rsi  /* _Digits(%rip) */
...
LBB4_14:
	LONG $0x48058d48; WORD $0x008f; BYTE $0x00 // leaq         $36680(%rip), %rax  /* _Digits(%rip) */
...
LBB4_15:
	...
	LONG $0x01c88348                           // orq          $1, %rax
	LONG $0x2d358d48; WORD $0x008f; BYTE $0x00 // leaq         $36653(%rip), %rsi  /* _Digits(%rip) */
	WORD $0x048a; BYTE $0x30                   // movb         (%rax,%rsi), %al
	WORD $0xca89                               // movl         %ecx, %edx
	WORD $0x0488; BYTE $0x17                   // movb         %al, (%rdi,%rdx)
...
LBB4_16:
	...
	LONG $0x26158d48; WORD $0x00b5; BYTE $0x00 // leaq         $46374(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	WORD $0xd089                               // movl         %edx, %eax
	LONG $0x690d8d48; WORD $0x008d; BYTE $0x00 // leaq         $36201(%rip), %rcx  /* _Digits(%rip) */
	LONG $0x4104b70f                           // movzwl       (%rcx,%rax,2), %eax
...
LBB4_22:
	...
	WORD $0xc829                               // subl         %ecx, %eax
	WORD $0xb70f; BYTE $0xc0                   // movzwl       %ax, %eax
	LONG $0x190d8d48; WORD $0x008d; BYTE $0x00 // leaq         $36121(%rip), %rcx  /* _Digits(%rip) */
	LONG $0x4104b70f                           // movzwl       (%rcx,%rax,2), %eax
...
LBB4_24:
	...
	WORD $0xca29                               // subl         %ecx, %edx
	WORD $0xb70f; BYTE $0xc0                   // movzwl       %ax, %eax
	LONG $0xf80d8d48; WORD $0x008c; BYTE $0x00 // leaq         $36088(%rip), %rcx  /* _Digits(%rip) */
	LONG $0x4104b70f                           // movzwl       (%rcx,%rax,2), %eax
	WORD $0x8966; BYTE $0x07                   // movw         %ax, (%rdi)
	WORD $0xb70f; BYTE $0xc2                   // movzwl       %dx, %eax
...
_quote:
	...
	WORD $0x8948; BYTE $0xf0                   // movq         %rsi, %rax
	LONG $0x880d8d48; WORD $0x00b3; BYTE $0x00 // leaq         $45960(%rip), %rcx  /* __SingleQuoteTab(%rip) */
	LONG $0x81258d4c; WORD $0x00c3; BYTE $0x00 // leaq         $50049(%rip), %r12  /* __DoubleQuoteTab(%rip) */
...
LBB5_17:
	...
	LONG $0xdc358d48; WORD $0x00b1; BYTE $0x00 // leaq         $45532(%rip), %rsi  /* __SingleQuoteTab(%rip) */
...
LBB5_56:
	LONG $0x590d8d4c; WORD $0x00cf; BYTE $0x00 // leaq         $53081(%rip), %r9  /* __EscTab(%rip) */
...
LBB6_17:
	...
	LONG $0x84158d4c; WORD $0x00cc; BYTE $0x00 // leaq         $52356(%rip), %r10  /* __UnquoteTab(%rip) */
...
_html_escape:
	...
	LONG $0xfa1d8d4c; WORD $0x00c1; BYTE $0x00 // leaq         $49658(%rip), %r11  /* __HtmlQuoteTab(%rip) */
...
LBB11_2:
	...
	LONG $0x001417e8; BYTE $0x00   // callq        _vnumber, $5143(%rip)
	LONG $0xd07d8b4c               // movq         $-48(%rbp), %r15
...
LBB11_7:
	...
	LONG $0x0025e3e8; BYTE $0x00               // callq        _do_skip_number, $9699(%rip)
	WORD $0x8548; BYTE $0xc0                   // testq        %rax, %rax
...
LBB15_61:
	...
	LONG $0x120d8d48; WORD $0x00c5; BYTE $0x00 // leaq         $50450(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB15_67:
	...
	WORD $0xdef7                               // negl         %esi
	LONG $0xec058d48; WORD $0x00c4; BYTE $0x00 // leaq         $50412(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB15_71:
	...
	WORD $0xc089                               // movl         %eax, %eax
	LONG $0xb20d8d48; WORD $0x00c4; BYTE $0x00 // leaq         $50354(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x04590ff2; BYTE $0xc1               // mulsd        (%rcx,%rax,8), %xmm0
	LONG $0x45110ff2; BYTE $0xc0               // movsd        %xmm0, $-64(%rbp)
...
LBB15_74:
	...
	LONG $0xffde7be8; BYTE $0xff   // callq        _atof_eisel_lemire64, $-8581(%rip)
	WORD $0xc084                   // testb        %al, %al
	...
	WORD $0x894c; BYTE $0xe7       // movq         %r12, %rdi
	WORD $0x558b; BYTE $0xd4       // movl         $-44(%rbp), %edx
	LONG $0xffde52e8; BYTE $0xff   // callq        _atof_eisel_lemire64, $-8622(%rip)
	WORD $0xc084                   // testb        %al, %al
...
LBB15_80:
	...
	LONG $0xffe35ae8; BYTE $0xff // callq        _atof_native, $-7334(%rip)
	LONG $0x45110ff2; BYTE $0xc0 // movsd        %xmm0, $-64(%rbp)
	LONG $0x7e0f4866; BYTE $0xc0 // movq         %xmm0, %rax
...
_skip_string:
	...
	WORD $0x8948; BYTE $0xde       // movq         %rbx, %rsi
	LONG $0xffe3c0e8; BYTE $0xff   // callq        _advance_string, $-7232(%rip)
	WORD $0x8548; BYTE $0xc0       // testq        %rax, %rax
...
_validate_one:
	...
	WORD $0x8948; BYTE $0xc7                                 // movq         %rax, %rdi
	BYTE $0x5d                                               // popq         %rbp
	LONG $0xfff1cee9; BYTE $0xff                             // jmp          _fsm_exec, $-3634(%rip)
	QUAD $0x0000000000000000; LONG $0x00000000; WORD $0x0000 // .p2align 4, 0x00
...
_LB_2adbe035: // _pow10_ceil_sig.g
	QUAD $0xff77b1fcbebcdc4f // .quad -38366372719436721
...
_LB_45153a78: // _pow10_ceil_sig_f32.g
...
_skip_one:
	...
	MOVQ m+16(FP), DX
	MOVQ flags+24(FP), CX
	CALL ·__native_entry__+21200(SB) // _skip_one
	MOVQ AX, ret+32(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18944(SB), AX // _vnumber
	JMP  AX
...
_vstring:
	...
	MOVQ v+16(FP), DX
	MOVQ flags+24(FP), CX
	LEAQ ·__native_entry__+15904(SB), AX // _vstring
	JMP  AX
