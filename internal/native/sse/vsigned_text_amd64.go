...
var _text_vsigned = []byte{
	...
	0x41, 0x8a, 0x0c, 0x00, //0x0000002d movb         (%r8,%rax), %cl
	0x41, 0xb9, 0x01, 0x00, 0x00, 0x00, //0x00000031 movl         $1, %r9d
	...
	0x41, 0x8a, 0x0c, 0x00, //0x0000004d movb         (%r8,%rax), %cl
	0x49, 0xc7, 0xc1, 0xff, 0xff, 0xff, 0xff, //0x00000051 movq         $-1, %r9
	//0x00000058 LBB0_5
	...
	0x41, 0x8a, 0x0c, 0x38, //0x00000095 movb         (%r8,%rdi), %cl
	...
	0x31, 0xff, //0x000000c7 xorl         %edi, %edi
