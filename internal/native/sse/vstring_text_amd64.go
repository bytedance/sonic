...
var _text_vstring = []byte{
	...
	0x66, 0x0f, 0xd7, 0xfe, //0x000000ec pmovmskb     %xmm6, %edi
	0x66, 0x0f, 0x6f, 0xf5, //0x000000f0 movdqa       %xmm5, %xmm6
	0x66, 0x0f, 0x74, 0xf0, //0x000000f4 pcmpeqb      %xmm0, %xmm6
	0x66, 0x0f, 0xd7, 0xc6, //0x000000f8 pmovmskb     %xmm6, %eax
	...
	0x66, 0x0f, 0xd7, 0xcc, //0x00000111 pmovmskb     %xmm4, %ecx
	0x66, 0x0f, 0x74, 0xe9, //0x00000115 pcmpeqb      %xmm1, %xmm5
	0x66, 0x44, 0x0f, 0xd7, 0xf5, //0x00000119 pmovmskb     %xmm5, %r14d
	0x48, 0xc1, 0xe0, 0x30, //0x0000011e shlq         $48, %rax
	0x48, 0xc1, 0xe7, 0x20, //0x00000122 shlq         $32, %rdi
	0x48, 0x09, 0xc7, //0x00000126 orq          %rax, %rdi
	0x48, 0xc1, 0xe6, 0x10, //0x00000129 shlq         $16, %rsi
	0x48, 0x09, 0xfe, //0x0000012d orq          %rdi, %rsi
	0x49, 0x09, 0xf1, //0x00000130 orq          %rsi, %r9
	0x49, 0xc1, 0xe6, 0x30, //0x00000133 shlq         $48, %r14
	0x48, 0xc1, 0xe1, 0x20, //0x00000137 shlq         $32, %rcx
	0x4c, 0x09, 0xf1, //0x0000013b orq          %r14, %rcx
	0x48, 0xc1, 0xe2, 0x10, //0x0000013e shlq         $16, %rdx
	0x48, 0x09, 0xca, //0x00000142 orq          %rcx, %rdx
	...
	0x0f, 0x85, 0xf8, 0x04, 0x00, 0x00, //0x00000379 jne          LBB0_84
	...
	0xe9, 0xa6, 0x04, 0x00, 0x00, //0x00000423 jmp          LBB0_92
	//0x00000428 LBB0_27
	...
	0x0f, 0x82, 0x90, 0x04, 0x00, 0x00, //0x00000438 jb           LBB0_92
	//0x0000043e LBB0_28
	...
	0x0f, 0x88, 0x87, 0x04, 0x00, 0x00, //0x00000448 js           LBB0_93
	...
	0xe9, 0x68, 0x04, 0x00, 0x00, //0x00000472 jmp          LBB0_95
	//0x00000477 LBB0_32
	...
	0xe9, 0xbd, 0x03, 0x00, 0x00, //0x000004ff jmp          LBB0_91
	//0x00000504 LBB0_37
	...
	0x0f, 0x84, 0xf0, 0x01, 0x00, 0x00, //0x000005b2 je           LBB0_67
	//0x000005b8 LBB0_41
	0x48, 0x0f, 0xbc, 0xd1, //0x000005b8 bsfq         %rcx, %rdx
	0xe9, 0xec, 0x01, 0x00, 0x00, //0x000005bc jmp          LBB0_68
	//0x000005c1 LBB0_42
	0x49, 0xc7, 0xc3, 0xff, 0xff, 0xff, 0xff, //0x000005c1 movq         $-1, %r11
	0xe9, 0xb5, 0x02, 0x00, 0x00, //0x000005c8 jmp          LBB0_86
	//0x000005cd LBB0_43
	...
	0xe9, 0xca, 0x01, 0x00, 0x00, //0x0000060d jmp          LBB0_73
	//0x00000612 LBB0_46
	...
	0x0f, 0x85, 0x73, 0x02, 0x00, 0x00, //0x00000675 jne          LBB0_96
	...
	//0x0000069b LBB0_54
	0x41, 0x0f, 0xb6, 0x0c, 0x00, //0x0000069b movzbl       (%r8,%rax), %ecx
	0x80, 0xf9, 0x22, //0x000006a0 cmpb         $34, %cl
	0x0f, 0x84, 0x69, 0x00, 0x00, 0x00, //0x000006a3 je           LBB0_59
	0x80, 0xf9, 0x5c, //0x000006a9 cmpb         $92, %cl
	...
	0x0f, 0x84, 0xad, 0x01, 0x00, 0x00, //0x000006cb je           LBB0_85
	...
	0xe9, 0x6c, 0x01, 0x00, 0x00, //0x0000070d jmp          LBB0_85
	//0x00000712 LBB0_59
	...
	0x80, 0xf9, 0x22, //0x0000072b cmpb         $34, %cl
	0x0f, 0x85, 0x4a, 0x01, 0x00, 0x00, //0x0000072e jne          LBB0_85
	0x4d, 0x01, 0xe8, //0x00000734 addq         %r13, %r8
	0xe9, 0xdd, 0xff, 0xff, 0xff, //0x00000737 jmp          LBB0_60
	//0x0000073c LBB0_63
	0x48, 0x89, 0xf3, //0x0000073c movq         %rsi, %rbx
	...
	0x48, 0x2b, 0x55, 0xa8, //0x0000074d subq         $-88(%rbp), %rdx
	0x49, 0x0f, 0xbc, 0xf1, //0x00000751 bsfq         %r9, %rsi
	0x48, 0x01, 0xd6, //0x00000755 addq         %rdx, %rsi
	0x48, 0x89, 0x75, 0xd0, //0x00000758 movq         %rsi, $-48(%rbp)
	0xe9, 0x03, 0x00, 0x00, 0x00, //0x0000075c jmp          LBB0_66
	//0x00000761 LBB0_65
	0x48, 0x89, 0xf3, //0x00000761 movq         %rsi, %rbx
	//0x00000764 LBB0_66
	0x48, 0x89, 0xde, //0x00000764 movq         %rbx, %rsi
	0x89, 0xf2, //0x00000767 movl         %esi, %edx
	0xf7, 0xd2, //0x00000769 notl         %edx
	0x44, 0x21, 0xca, //0x0000076b andl         %r9d, %edx
	0x44, 0x8d, 0x04, 0x53, //0x0000076e leal         (%rbx,%rdx,2), %r8d
	0x8d, 0x1c, 0x12, //0x00000772 leal         (%rdx,%rdx), %ebx
	0xf7, 0xd3, //0x00000775 notl         %ebx
	0x44, 0x21, 0xcb, //0x00000777 andl         %r9d, %ebx
	0x81, 0xe3, 0xaa, 0xaa, 0xaa, 0xaa, //0x0000077a andl         $-1431655766, %ebx
	0x31, 0xf6, //0x00000780 xorl         %esi, %esi
	0x01, 0xd3, //0x00000782 addl         %edx, %ebx
	0x40, 0x0f, 0x92, 0xc6, //0x00000784 setb         %sil
	0x01, 0xdb, //0x00000788 addl         %ebx, %ebx
	0x81, 0xf3, 0x55, 0x55, 0x55, 0x55, //0x0000078a xorl         $1431655765, %ebx
	0x44, 0x21, 0xc3, //0x00000790 andl         %r8d, %ebx
	0xf7, 0xd3, //0x00000793 notl         %ebx
	0x21, 0xd9, //0x00000795 andl         %ebx, %ecx
	0x48, 0xc1, 0xe7, 0x10, //0x00000797 shlq         $16, %rdi
	0x48, 0x85, 0xc9, //0x0000079b testq        %rcx, %rcx
	0x48, 0x8b, 0x5d, 0xb0, //0x0000079e movq         $-80(%rbp), %rbx
	0x0f, 0x85, 0x10, 0xfe, 0xff, 0xff, //0x000007a2 jne          LBB0_41
	//0x000007a8 LBB0_67
	0xba, 0x40, 0x00, 0x00, 0x00, //0x000007a8 movl         $64, %edx
	//0x000007ad LBB0_68
	0x4c, 0x09, 0xf7, //0x000007ad orq          %r14, %rdi
	0x48, 0x85, 0xc9, //0x000007b0 testq        %rcx, %rcx
	0x0f, 0x84, 0x12, 0x00, 0x00, 0x00, //0x000007b3 je           LBB0_71
	0x48, 0x85, 0xff, //0x000007b9 testq        %rdi, %rdi
	0x0f, 0x84, 0xcd, 0x00, 0x00, 0x00, //0x000007bc je           LBB0_87
	0x48, 0x0f, 0xbc, 0xcf, //0x000007c2 bsfq         %rdi, %rcx
	0xe9, 0xc9, 0x00, 0x00, 0x00, //0x000007c6 jmp          LBB0_88
	//0x000007cb LBB0_71
	0x48, 0x85, 0xff, //0x000007cb testq        %rdi, %rdi
	0x0f, 0x85, 0xa3, 0x00, 0x00, 0x00, //0x000007ce jne          LBB0_84
	0x48, 0x83, 0xc0, 0x20, //0x000007d4 addq         $32, %rax
	0x49, 0x83, 0xc2, 0xe0, //0x000007d8 addq         $-32, %r10
	//0x000007dc LBB0_73
	0x48, 0x85, 0xf6, //0x000007dc testq        %rsi, %rsi
	0x0f, 0x85, 0x49, 0x01, 0x00, 0x00, //0x000007df jne          LBB0_98
	0x48, 0x8b, 0x4d, 0xd0, //0x000007e5 movq         $-48(%rbp), %rcx
	0x49, 0xc7, 0xc3, 0xff, 0xff, 0xff, 0xff, //0x000007e9 movq         $-1, %r11
	0x4d, 0x85, 0xd2, //0x000007f0 testq        %r10, %r10
	0x0f, 0x84, 0x85, 0x00, 0x00, 0x00, //0x000007f3 je           LBB0_85
	//0x000007f9 LBB0_75
	0x4c, 0x89, 0xd7, //0x000007f9 movq         %r10, %rdi
	//0x000007fc LBB0_76
	0x0f, 0xb6, 0x10, //0x000007fc movzbl       (%rax), %edx
	0x80, 0xfa, 0x22, //0x000007ff cmpb         $34, %dl
	0x0f, 0x84, 0xae, 0x00, 0x00, 0x00, //0x00000802 je           LBB0_90
	0x80, 0xfa, 0x5c, //0x00000808 cmpb         $92, %dl
	0x0f, 0x84, 0x26, 0x00, 0x00, 0x00, //0x0000080b je           LBB0_80
	0x80, 0xfa, 0x20, //0x00000811 cmpb         $32, %dl
	0x0f, 0x82, 0x5d, 0x00, 0x00, 0x00, //0x00000814 jb           LBB0_84
	0x48, 0xc7, 0xc2, 0xff, 0xff, 0xff, 0xff, //0x0000081a movq         $-1, %rdx
	0xbe, 0x01, 0x00, 0x00, 0x00, //0x00000821 movl         $1, %esi
	0x48, 0x01, 0xf0, //0x00000826 addq         %rsi, %rax
	0x48, 0x01, 0xd7, //0x00000829 addq         %rdx, %rdi
	0x0f, 0x85, 0xca, 0xff, 0xff, 0xff, //0x0000082c jne          LBB0_76
	0xe9, 0x47, 0x00, 0x00, 0x00, //0x00000832 jmp          LBB0_85
	//0x00000837 LBB0_80
	0x48, 0x83, 0xff, 0x01, //0x00000837 cmpq         $1, %rdi
	0x0f, 0x84, 0x3d, 0x00, 0x00, 0x00, //0x0000083b je           LBB0_85
	0x48, 0xc7, 0xc2, 0xfe, 0xff, 0xff, 0xff, //0x00000841 movq         $-2, %rdx
	0xbe, 0x02, 0x00, 0x00, 0x00, //0x00000848 movl         $2, %esi
	0x48, 0x83, 0xf9, 0xff, //0x0000084d cmpq         $-1, %rcx
	0x0f, 0x85, 0x0b, 0x00, 0x00, 0x00, //0x00000851 jne          LBB0_83
	0x48, 0x89, 0xc1, //0x00000857 movq         %rax, %rcx
	0x48, 0x2b, 0x4d, 0xa8, //0x0000085a subq         $-88(%rbp), %rcx
	0x48, 0x89, 0x4d, 0xd0, //0x0000085e movq         %rcx, $-48(%rbp)
	//0x00000862 LBB0_83
	0x48, 0x8b, 0x5d, 0xb0, //0x00000862 movq         $-80(%rbp), %rbx
	0x48, 0x01, 0xf0, //0x00000866 addq         %rsi, %rax
	0x48, 0x01, 0xd7, //0x00000869 addq         %rdx, %rdi
	0x0f, 0x85, 0x8a, 0xff, 0xff, 0xff, //0x0000086c jne          LBB0_76
	0xe9, 0x07, 0x00, 0x00, 0x00, //0x00000872 jmp          LBB0_85
	//0x00000877 LBB0_84
	0x49, 0xc7, 0xc3, 0xfe, 0xff, 0xff, 0xff, //0x00000877 movq         $-2, %r11
	//0x0000087e LBB0_85
	0x48, 0x8b, 0x5d, 0xb8, //0x0000087e movq         $-72(%rbp), %rbx
	//0x00000882 LBB0_86
	0x48, 0x8b, 0x75, 0xc0, //0x00000882 movq         $-64(%rbp), %rsi
	0x48, 0x8b, 0x7d, 0xc8, //0x00000886 movq         $-56(%rbp), %rdi
	0xe9, 0x4a, 0x00, 0x00, 0x00, //0x0000088a jmp          LBB0_94
	//0x0000088f LBB0_87
	0xb9, 0x40, 0x00, 0x00, 0x00, //0x0000088f movl         $64, %ecx
	//0x00000894 LBB0_88
	0x48, 0x8b, 0x75, 0xc0, //0x00000894 movq         $-64(%rbp), %rsi
	0x48, 0x8b, 0x7d, 0xc8, //0x00000898 movq         $-56(%rbp), %rdi
	0x48, 0x39, 0xd1, //0x0000089c cmpq         %rdx, %rcx
	0x0f, 0x82, 0x29, 0x00, 0x00, 0x00, //0x0000089f jb           LBB0_92
	0x48, 0x2b, 0x45, 0xa8, //0x000008a5 subq         $-88(%rbp), %rax
	0x4c, 0x8d, 0x1c, 0x10, //0x000008a9 leaq         (%rax,%rdx), %r11
	0x49, 0x83, 0xc3, 0x01, //0x000008ad addq         $1, %r11
	0xe9, 0x8f, 0xfb, 0xff, 0xff, //0x000008b1 jmp          LBB0_30
	//0x000008b6 LBB0_90
	0x48, 0x2b, 0x45, 0xa8, //0x000008b6 subq         $-88(%rbp), %rax
	0x48, 0x83, 0xc0, 0x01, //0x000008ba addq         $1, %rax
	0x49, 0x89, 0xc3, //0x000008be movq         %rax, %r11
	//0x000008c1 LBB0_91
	0x48, 0x8b, 0x75, 0xc0, //0x000008c1 movq         $-64(%rbp), %rsi
	0x48, 0x8b, 0x7d, 0xc8, //0x000008c5 movq         $-56(%rbp), %rdi
	0xe9, 0x77, 0xfb, 0xff, 0xff, //0x000008c9 jmp          LBB0_30
	//0x000008ce LBB0_92
	0x49, 0xc7, 0xc3, 0xfe, 0xff, 0xff, 0xff, //0x000008ce movq         $-2, %r11
	//0x000008d5 LBB0_93
	0x48, 0x8b, 0x5d, 0xb8, //0x000008d5 movq         $-72(%rbp), %rbx
	//0x000008d9 LBB0_94
	0x48, 0x89, 0x1f, //0x000008d9 movq         %rbx, (%rdi)
	0x4c, 0x89, 0x1e, //0x000008dc movq         %r11, (%rsi)
	//0x000008df LBB0_95
	0x48, 0x83, 0xc4, 0x38, //0x000008df addq         $56, %rsp
	...
	//0x000008ee LBB0_96
	0x4d, 0x85, 0xed, //0x000008ee testq        %r13, %r13
	0x0f, 0x84, 0x88, 0x00, 0x00, 0x00, //0x000008f1 je           LBB0_101
	0x4c, 0x89, 0xe7, //0x000008f7 movq         %r12, %rdi
	0x48, 0xf7, 0xd7, //0x000008fa notq         %rdi
	0x49, 0x8d, 0x04, 0x38, //0x000008fd leaq         (%r8,%rdi), %rax
	0x48, 0x8b, 0x4d, 0xd0, //0x00000901 movq         $-48(%rbp), %rcx
	0x48, 0x83, 0xf9, 0xff, //0x00000905 cmpq         $-1, %rcx
	0x48, 0x89, 0xcb, //0x00000909 movq         %rcx, %rbx
	0x48, 0x0f, 0x44, 0xc8, //0x0000090c cmoveq       %rax, %rcx
	0x48, 0x0f, 0x44, 0xd8, //0x00000910 cmoveq       %rax, %rbx
	0x49, 0x83, 0xc0, 0x01, //0x00000914 addq         $1, %r8
	0x49, 0x83, 0xc5, 0xff, //0x00000918 addq         $-1, %r13
	0x48, 0x89, 0x4d, 0xd0, //0x0000091c movq         %rcx, $-48(%rbp)
	0x4d, 0x85, 0xed, //0x00000920 testq        %r13, %r13
	0x0f, 0x85, 0x65, 0xfd, 0xff, 0xff, //0x00000923 jne          LBB0_52
	0xe9, 0xeb, 0xfd, 0xff, 0xff, //0x00000929 jmp          LBB0_60
	//0x0000092e LBB0_98
	0x4d, 0x85, 0xd2, //0x0000092e testq        %r10, %r10
	0x0f, 0x84, 0x48, 0x00, 0x00, 0x00, //0x00000931 je           LBB0_101
	0x4c, 0x89, 0xd7, //0x00000937 movq         %r10, %rdi
	0x48, 0x8b, 0x4d, 0xa8, //0x0000093a movq         $-88(%rbp), %rcx
	0x48, 0xf7, 0xd1, //0x0000093e notq         %rcx
	0x48, 0x01, 0xc1, //0x00000941 addq         %rax, %rcx
	0x48, 0x8b, 0x75, 0xd0, //0x00000944 movq         $-48(%rbp), %rsi
	0x48, 0x83, 0xfe, 0xff, //0x00000948 cmpq         $-1, %rsi
	0x48, 0x89, 0xf2, //0x0000094c movq         %rsi, %rdx
	0x48, 0x0f, 0x44, 0xd1, //0x0000094f cmoveq       %rcx, %rdx
	0x48, 0x0f, 0x45, 0xce, //0x00000953 cmovneq      %rsi, %rcx
	0x48, 0x83, 0xc0, 0x01, //0x00000957 addq         $1, %rax
	0x48, 0x83, 0xc7, 0xff, //0x0000095b addq         $-1, %rdi
	0x48, 0x89, 0x55, 0xd0, //0x0000095f movq         %rdx, $-48(%rbp)
	0x49, 0x89, 0xfa, //0x00000963 movq         %rdi, %r10
	0x48, 0x8b, 0x5d, 0xb0, //0x00000966 movq         $-80(%rbp), %rbx
	0x49, 0xc7, 0xc3, 0xff, 0xff, 0xff, 0xff, //0x0000096a movq         $-1, %r11
	0x4d, 0x85, 0xd2, //0x00000971 testq        %r10, %r10
	0x0f, 0x85, 0x7f, 0xfe, 0xff, 0xff, //0x00000974 jne          LBB0_75
	0xe9, 0xff, 0xfe, 0xff, 0xff, //0x0000097a jmp          LBB0_85
	//0x0000097f LBB0_101
	0x49, 0xc7, 0xc3, 0xff, 0xff, 0xff, 0xff, //0x0000097f movq         $-1, %r11
	0xe9, 0xf3, 0xfe, 0xff, 0xff, //0x00000986 jmp          LBB0_85
	0x00, //0x0000098b .p2align 2, 0x00
