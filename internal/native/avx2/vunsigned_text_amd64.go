...
var _text_vunsigned = []byte{
	...
	0x0f, 0x87, 0xb8, 0x00, 0x00, 0x00, //0x0000008a ja           LBB0_9
	...
	0x0f, 0x83, 0xa1, 0x00, 0x00, 0x00, //0x000000a1 jae          LBB0_9
	//0x000000a7 LBB0_10
	...
	0x0f, 0x83, 0x73, 0x00, 0x00, 0x00, //0x000000c3 jae          LBB0_21
	...
	//0x0000011e LBB0_17
	0x80, 0xfb, 0x2e, //0x0000011e cmpb         $46, %bl
	0x0f, 0x84, 0x19, 0xff, 0xff, 0xff, //0x00000121 je           LBB0_3
	0x80, 0xfb, 0x45, //0x00000127 cmpb         $69, %bl
	0x0f, 0x84, 0x10, 0xff, 0xff, 0xff, //0x0000012a je           LBB0_3
	0x80, 0xfb, 0x65, //0x00000130 cmpb         $101, %bl
	0x0f, 0x84, 0x07, 0xff, 0xff, 0xff, //0x00000133 je           LBB0_3
	0x49, 0x89, 0xca, //0x00000139 movq         %rcx, %r10
	//0x0000013c LBB0_21
	0x4c, 0x89, 0x16, //0x0000013c movq         %r10, (%rsi)
	0x49, 0x89, 0x40, 0x10, //0x0000013f movq         %rax, $16(%r8)
	0x5b, //0x00000143 popq         %rbx
	0x41, 0x5e, //0x00000144 popq         %r14
	0x5d, //0x00000146 popq         %rbp
	0xc3, //0x00000147 retq         
	//0x00000148 LBB0_9
	0x48, 0x83, 0xc1, 0x01, //0x00000148 addq         $1, %rcx
	0x48, 0x89, 0x0e, //0x0000014c movq         %rcx, (%rsi)
	0x5b, //0x0000014f popq         %rbx
	0x41, 0x5e, //0x00000150 popq         %r14
