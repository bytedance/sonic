...
var (
    ...
    __get_by_path func(s unsafe.Pointer, p unsafe.Pointer, path unsafe.Pointer, m unsafe.Pointer, flags uint64) (ret int)
...
//go:nosplit
func get_by_path(s *string, p *int, path *[]interface{}, m *types.StateMachine, flags uint64) (ret int) {
    return __get_by_path(rt.NoEscape(unsafe.Pointer(s)), rt.NoEscape(unsafe.Pointer(p)), rt.NoEscape(unsafe.Pointer(path)), rt.NoEscape(unsafe.Pointer(m)), flags)
}
