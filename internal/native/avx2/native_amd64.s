...
LBB2_8:
	...
	LEAL    -1077(DX), CX
	MOVL    $-1076, R10
	LONG    $0xd1450f44                           // cmovnel      %ecx, %r10d
	MOVQ    DI, -64(BP)
	LEAQ    0(DI*4), R15
	TESTQ   AX, AX
	SETNE   AX
	...
	TESTL   R10, R10
	JS      LBB2_23
	LONG    $0x41e26945; WORD $0x0134; BYTE $0x00 // imull        $78913, %r10d, %r12d
	SHRL    $18, R12
	CMPL    R10, $4
	ADCL    $-1, R12
	LONG    $0x4ff46941; WORD $0x1293; BYTE $0x00 // imull        $1217359, %r12d, %esi
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0x7b0d8d48; WORD $0x008b; BYTE $0x00 // leaq         $35707(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R15, R13
	ORQ     $2, R13
	MOVQ    0(AX)(CX*1), R11
	MOVQ    8(AX)(CX*1), R14
	...
	ADDL    SI, CX
	ADDB    $61, CX
	LONG    $0xdfad0f48                           // shrdq        %cl, %rbx, %rdi
	SHRQ    CX, BX
	NOTQ    R8
	ADDQ    R15, R8
	MOVQ    R11, AX
	...
	SHRQ    CX, R14
	TESTB   $64, CX
	LONG    $0xdf440f48                           // cmoveq       %rdi, %rbx
...
LBB2_23:
	LONG    $0x05ea6945; WORD $0xf4d1; BYTE $0xff // imull        $-732923, %r10d, %r13d
	SHRL    $20, R13
	XORL    AX, AX
	CMPL    R10, $-1
	SETNE   AX
	...
	MOVL    R10, AX
	NEGL    AX
	LONG    $0xb1f26941; WORD $0xed6c; BYTE $0xff // imull        $-1217359, %r10d, %esi
	SHRL    $19, SI
	MOVLQSX AX, DI
	SHLQ    $4, DI
	LONG    $0xa00d8d4c; WORD $0x009f; BYTE $0x00 // leaq         $40864(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R15, BX
	ORQ     $2, BX
	MOVQ    0(DI)(R9*1), R11
	MOVQ    R11, AX
...
LBB2_70:
	...
	MOVQ R15, SI
	MOVL BX, DX
	LONG $0x0054f1e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL BX, $2
...
LBB2_77:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R12
	LONG    $0xa6058d48; WORD $0x00ae; BYTE $0x00 // leaq         $44710(%rip), %rax  /* _Digits(%rip) */
...
LBB2_81:
	...
	MOVQ  R13, SI
	MOVL  BX, DX
	LONG  $0x005463e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R15, R15
	JS    LBB2_83
	JE    LBB2_124
	MOVL  BX, BX
...
LBB2_78:
	...
	JL      LBB2_80
	MOVLQSX R12, AX
	LONG    $0xf10d8d48; WORD $0x00ad; BYTE $0x00 // leaq         $44529(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_86:
	...
	MOVQ R13, SI
	MOVL BX, DX
	LONG $0x005326e8; BYTE $0x00 // callq        _print_mantissa
	MOVL $2, AX
	JMP  LBB2_111
...
LBB2_116:
	ANDQ $-4, DI
	XORL CX, CX
	QUAD $0xfffff6bf056ffec5 // vmovdqu      $-2369(%rip), %ymm0  /* LCPI2_0(%rip) */

LBB2_117:
	MOVQ CX, SI
	ORQ  BX, SI
	LONG $0x7f7ec1c4; WORD $0x3544; BYTE $0x00 // vmovdqu      %ymm0, (%r13,%rsi)
	LONG $0x7f7ec1c4; WORD $0x3544; BYTE $0x20 // vmovdqu      %ymm0, $32(%r13,%rsi)
	LONG $0x7f7ec1c4; WORD $0x3544; BYTE $0x40 // vmovdqu      %ymm0, $64(%r13,%rsi)
	LONG $0x7f7ec1c4; WORD $0x3544; BYTE $0x60 // vmovdqu      %ymm0, $96(%r13,%rsi)
	MOVQ SI, AX
	ORQ  $128, AX
	LONG $0x7f7ec1c4; WORD $0x0544; BYTE $0x00 // vmovdqu      %ymm0, (%r13,%rax)
	LONG $0x7f7ec1c4; WORD $0x0544; BYTE $0x20 // vmovdqu      %ymm0, $32(%r13,%rax)
	LONG $0x7f7ec1c4; WORD $0x0544; BYTE $0x40 // vmovdqu      %ymm0, $64(%r13,%rax)
	LONG $0x7f7ec1c4; WORD $0x0544; BYTE $0x60 // vmovdqu      %ymm0, $96(%r13,%rax)
	MOVQ SI, AX
	ORQ  $256, AX
	LONG $0x7f7ec1c4; WORD $0x0544; BYTE $0x00 // vmovdqu      %ymm0, (%r13,%rax)
	LONG $0x7f7ec1c4; WORD $0x0544; BYTE $0x20 // vmovdqu      %ymm0, $32(%r13,%rax)
...
LBB2_118:
	TESTQ DX, DX
	JE    LBB2_121
	QUAD  $0xfffff612056ffec5 // vmovdqu      $-2542(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_95:
	ANDQ $-4, DX
	XORL SI, SI
	QUAD $0xfffff556056ffec5 // vmovdqu      $-2730(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_97:
	TESTQ AX, AX
	JE    LBB2_100
	QUAD  $0xfffff4a4056ffec5 // vmovdqu      $-2908(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_90:
	...
	ANDQ $-16, DX
	LEAQ 2(DX), AX
	QUAD $0xfffff479056ffac5 // vmovdqu      $-2951(%rip), %xmm0  /* LCPI2_1(%rip) */

LBB2_91:
	LONG $0x7f7ac1c4; WORD $0x0d44; BYTE $0x02 // vmovdqu      %xmm0, $2(%r13,%rcx)
	ADDQ $16, CX
	CMPQ DX, CX
	JNE  LBB2_91
	CMPQ R8, DX
...
LBB2_104:
	...
	MOVL BX, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x005063e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_i64toa:
	...
	CMPL    SI, $1000
	JB      LBB3_4
	LONG    $0xdd058d48; WORD $0x00a9; BYTE $0x00 // leaq         $43485(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(DX)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, AX
	JMP     LBB3_5
...
LBB3_5:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0xbc358d48; WORD $0x00a9; BYTE $0x00 // leaq         $43452(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    AX, SI
	ADDL    $1, AX
	MOVB    DX, 0(DI)(SI*1)
...
LBB3_7:
	LONG $0xaa158d48; WORD $0x00a9; BYTE $0x00 // leaq         $43434(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(CX)(DX*1), DX
	MOVL AX, SI
	ADDL $1, AX
	MOVB DX, 0(DI)(SI*1)
...
LBB3_8:
	MOVWLZX CX, CX
	ORQ     $1, CX
	LONG    $0x91158d48; WORD $0x00a9; BYTE $0x00 // leaq         $43409(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(CX)(DX*1), CX
	MOVL    AX, DX
	ADDL    $1, AX
	MOVB    CX, 0(DI)(DX*1)
...
LBB3_12:
	...
	ADDQ $1, DI
	NEGQ SI
	LONG $0x00002fe8; BYTE $0x00 // callq        _u64toa
	ADDL $1, AX
	BYTE $0x5d                   // popq         %rbp
	RET
...
LBB3_10:
	...
	JA   LBB3_11
	BYTE $0x5d                 // popq         %rbp
	JMP  _u64toa_large_sse2

LBB3_11:
	BYTE $0x5d               // popq         %rbp
	JMP  _u64toa_xlarge_sse2
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0xfd058d48; WORD $0x00a8; BYTE $0x00 // leaq         $43261(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(DX)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, AX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0xdc358d48; WORD $0x00a8; BYTE $0x00 // leaq         $43228(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    AX, SI
	ADDL    $1, AX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0xca158d48; WORD $0x00a8; BYTE $0x00 // leaq         $43210(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(CX)(DX*1), DX
	MOVL AX, SI
	ADDL $1, AX
	MOVB DX, 0(DI)(SI*1)
...
_u32toa_medium:
	...
	IMULQ   DX, CX
	SHRQ    $45, CX
	LONG    $0x10c16944; WORD $0x0027; BYTE $0x00 // imull        $10000, %ecx, %r8d
	MOVL    SI, AX
	SUBL    R8, AX
	IMUL3Q  $1125899907, DX, R10
	SHRQ    $49, R10
	ANDL    $-2, R10
	IMUL3Q  $1374389535, CX, DX
	SHRQ    $37, DX
	...
	CMPL    SI, $10000000
	JB      LBB5_2
	LONG    $0x08058d48; WORD $0x00a8; BYTE $0x00 // leaq         $43016(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, AX
	JMP     LBB5_3
...
LBB5_3:
	MOVL R10, DX
	ORQ  $1, DX
	LONG $0xe3358d48; WORD $0x00a7; BYTE $0x00 // leaq         $42979(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(DX)(SI*1), DX
	MOVL AX, SI
	ADDL $1, AX
	MOVB DX, 0(DI)(SI*1)
...
LBB5_5:
	LONG $0xd1158d48; WORD $0x00a7; BYTE $0x00 // leaq         $42961(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(CX)(DX*1), DX
	MOVL AX, SI
	ADDL $1, AX
	MOVB DX, 0(DI)(SI*1)
...
LBB5_6:
	MOVL    CX, CX
	ORQ     $1, CX
	LONG    $0xb9158d48; WORD $0x00a7; BYTE $0x00 // leaq         $42937(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(CX)(DX*1), CX
	MOVL    AX, SI
	MOVB    CX, 0(DI)(SI*1)
	MOVB    0(R8)(DX*1), CX
...
_u64toa_large_sse2:
	...
	QUAD $0xffffff940d6ffac5                   // vmovdqu      $-108(%rip), %xmm1  /* LCPI6_0(%rip) */
	...
	QUAD $0xffff8c255979e2c4; BYTE $0xff       // vpbroadcastq $-116(%rip), %xmm4  /* LCPI6_2(%rip) */
	LONG $0xc2e4f9c5                           // vpmulhuw     %xmm2, %xmm0, %xmm0
	LONG $0xc4e4f9c5                           // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xffffff542d6ffac5                   // vmovdqu      $-172(%rip), %xmm5  /* LCPI6_3(%rip) */
	...
	SUBL CX, AX
	SHLQ $4, CX
	LONG $0x00158d48; WORD $0x00a7; BYTE $0x00 // leaq         $42752(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB7_2:
	...
	JA      LBB7_4
	MOVL    DX, AX
	LONG    $0xa10d8d48; WORD $0x00a5; BYTE $0x00 // leaq         $42401(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVL    $2, CX
	JMP     LBB7_7
...
LBB7_4:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x580d8d48; WORD $0x00a5; BYTE $0x00 // leaq         $42328(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 1(DI)
	MOVL    $3, CX
	JMP     LBB7_7
...
LBB7_6:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x3a0d8d48; WORD $0x00a5; BYTE $0x00 // leaq         $42298(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVWLZX DX, AX
	MOVB    0(CX)(AX*2), DX
...
LBB7_7:
	...
	SHRQ $26, DX
	LONG $0xc26ef9c5                     // vmovd        %edx, %xmm0
	QUAD $0xfffffecc0d6ffac5             // vmovdqu      $-308(%rip), %xmm1  /* LCPI7_0(%rip) */
	LONG $0xd1f4f9c5                     // vpmuludq     %xmm1, %xmm0, %xmm2
	LONG $0xd273e9c5; BYTE $0x2d         // vpsrlq       $45, %xmm2, %xmm2
	MOVL $10000, AX
	LONG $0x6ef9e1c4; BYTE $0xd8         // vmovq        %rax, %xmm3
	...
	LONG $0xf073f9c5; BYTE $0x02         // vpsllq       $2, %xmm0, %xmm0
	LONG $0xc070fbc5; BYTE $0x50         // vpshuflw     $80, %xmm0, %xmm0
	QUAD $0xfffeca155979e2c4; BYTE $0xff // vpbroadcastq $-310(%rip), %xmm2  /* LCPI7_1(%rip) */
	LONG $0xc070f9c5; BYTE $0x50         // vpshufd      $80, %xmm0, %xmm0
	LONG $0xc2e4f9c5                     // vpmulhuw     %xmm2, %xmm0, %xmm0
	QUAD $0xfffec0255979e2c4; BYTE $0xff // vpbroadcastq $-320(%rip), %xmm4  /* LCPI7_2(%rip) */
	LONG $0xc4e4f9c5                     // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffe8c2d6ffac5             // vmovdqu      $-372(%rip), %xmm5  /* LCPI7_3(%rip) */
	LONG $0xf5d5f9c5                     // vpmullw      %xmm5, %xmm0, %xmm6
	LONG $0xf673c9c5; BYTE $0x10         // vpsllq       $16, %xmm6, %xmm6
	LONG $0xc6f9f9c5                     // vpsubw       %xmm6, %xmm0, %xmm0
	LONG $0xe100c269; WORD $0x05f5       // imull        $100000000, %edx, %eax
	...
	LONG $0xcaf9f1c5                     // vpsubw       %xmm2, %xmm1, %xmm1
	LONG $0xc167f9c5                     // vpackuswb    %xmm1, %xmm0, %xmm0
	QUAD $0xfffffe3e05fcf9c5             // vpaddb       $-450(%rip), %xmm0, %xmm0  /* LCPI7_4(%rip) */
	MOVL CX, AX
...
_quote:
	...
	MOVQ  DI, R15
	TESTB $1, R8
	LONG  $0xe5058d48; WORD $0x00a4; BYTE $0x00 // leaq         $42213(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0xde158d4c; WORD $0x00b4; BYTE $0x00 // leaq         $46302(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	...
	MOVQ  CX, -64(BP)
	MOVQ  0(CX), R11
	QUAD  $0xffffff28056f7ec5                   // vmovdqu      $-216(%rip), %ymm8  /* LCPI8_0(%rip) */
	QUAD  $0xffffff40256ffec5                   // vmovdqu      $-192(%rip), %ymm4  /* LCPI8_1(%rip) */
	QUAD  $0xffffff582d6ffec5                   // vmovdqu      $-168(%rip), %ymm5  /* LCPI8_2(%rip) */
...
LBB8_5:
	...
	LONG  $0xc874bdc5               // vpcmpeqb     %ymm0, %ymm8, %ymm1
...
LBB8_36:
	...
	MOVQ  AX, CX
	SUBQ  R12, CX
	QUAD  $0xfffffdcc056f7ec5 // vmovdqu      $-564(%rip), %ymm8  /* LCPI8_0(%rip) */
	QUAD  $0xfffffde4256ffec5 // vmovdqu      $-540(%rip), %ymm4  /* LCPI8_1(%rip) */
	QUAD  $0xfffffdfc2d6ffec5 // vmovdqu      $-516(%rip), %ymm5  /* LCPI8_2(%rip) */
	QUAD  $0xfffffe14356ffac5 // vmovdqu      $-492(%rip), %xmm6  /* LCPI8_3(%rip) */
	QUAD  $0xfffffe1c3d6ffac5 // vmovdqu      $-484(%rip), %xmm7  /* LCPI8_4(%rip) */
	QUAD  $0xfffffe241d6ffac5 // vmovdqu      $-476(%rip), %xmm3  /* LCPI8_5(%rip) */
...
LBB8_40:
	...
	LONG  $0xd3daf9c5               // vpminub      %xmm3, %xmm0, %xmm2
	LONG  $0xc274f9c5               // vpcmpeqb     %xmm2, %xmm0, %xmm0
...
LBB8_37:
	MOVQ  BX, R14
	MOVQ  R9, R15
	QUAD  $0xfffffc9e056f7ec5 // vmovdqu      $-866(%rip), %ymm8  /* LCPI8_0(%rip) */
	QUAD  $0xfffffcb6256ffec5 // vmovdqu      $-842(%rip), %ymm4  /* LCPI8_1(%rip) */
	QUAD  $0xfffffcce2d6ffec5 // vmovdqu      $-818(%rip), %ymm5  /* LCPI8_2(%rip) */
	QUAD  $0xfffffce6356ffac5 // vmovdqu      $-794(%rip), %xmm6  /* LCPI8_3(%rip) */
	QUAD  $0xfffffcee3d6ffac5 // vmovdqu      $-786(%rip), %xmm7  /* LCPI8_4(%rip) */
	QUAD  $0xfffffcf61d6ffac5 // vmovdqu      $-778(%rip), %xmm3  /* LCPI8_5(%rip) */
	TESTB DX, DX
	JNE   LBB8_50
...
LBB8_48:
	MOVBLZX 0(R12)(R10*1), BX
	MOVQ    BX, DI
	SHLQ    $4, DI
	LONG    $0xdc158d48; WORD $0x00a1; BYTE $0x00 // leaq         $41436(%rip), %rdx  /* __SingleQuoteTab(%rip) */
	CMPQ    0(DI)(DX*1), $0
	JNE     LBB8_49
	LEAQ    0(R15)(CX*1), R9
	MOVB    BX, 0(R13)(R10*1)
...
_unquote:
	...
	MOVQ  R8, R10
	ANDL  $1, R10
	LONG  $0xcc058d4c; WORD $0x00bd; BYTE $0x00 // leaq         $48588(%rip), %r8  /* __UnquoteTab(%rip) */
	QUAD  $0xffffff950d6ffec5                   // vmovdqu      $-107(%rip), %ymm1  /* LCPI9_0(%rip) */
	QUAD  $0xffffffad156ffac5                   // vmovdqu      $-83(%rip), %xmm2  /* LCPI9_1(%rip) */
	MOVQ  DI, R15
	MOVQ  SI, R13
	MOVQ  DX, R14
	JMP   LBB9_3
...
LBB9_91:
	...
	LEAQ    2(R15), DI
	WORD    $0xf8c5; BYTE $0x77                   // vzeroupper
	LONG    $0x0007a9e8; BYTE $0x00               // callq        _unhex16_is
	TESTB   AX, AX
	JE      LBB9_100
	MOVL    2(R15), AX
	BSWAPL  AX
	...
	MOVQ    -80(BP), DX
	MOVQ    -64(BP), SI
	LONG    $0xdb058d4c; WORD $0x00bc; BYTE $0x00 // leaq         $48347(%rip), %r8  /* __UnquoteTab(%rip) */
	QUAD    $0xfffffea40d6ffec5                   // vmovdqu      $-348(%rip), %ymm1  /* LCPI9_0(%rip) */
	QUAD    $0xfffffebc156ffac5                   // vmovdqu      $-324(%rip), %xmm2  /* LCPI9_1(%rip) */
	JA      LBB9_110
	MOVW    $-16401, 0(R14)
	MOVB    $-67, 2(R14)
	ADDQ    $3, R14
...
LBB9_86:
	...
	MOVQ  -72(BP), R10
	MOVQ  -64(BP), SI
	LONG  $0xfd058d4c; WORD $0x00bb; BYTE $0x00 // leaq         $48125(%rip), %r8  /* __UnquoteTab(%rip) */
	QUAD  $0xfffffdc60d6ffec5                   // vmovdqu      $-570(%rip), %ymm1  /* LCPI9_0(%rip) */
	QUAD  $0xfffffdde156ffac5                   // vmovdqu      $-546(%rip), %xmm2  /* LCPI9_1(%rip) */
	TESTQ R13, R13
	JNE   LBB9_3
	JMP   LBB9_115
...
LBB9_11:
	...
	MOVQ R15, R11
	SUBQ R9, R11
	QUAD $0xfffffd1d0d6ffec5 // vmovdqu      $-739(%rip), %ymm1  /* LCPI9_0(%rip) */
	QUAD $0xfffffd35156ffac5 // vmovdqu      $-715(%rip), %xmm2  /* LCPI9_1(%rip) */
...
LBB9_12:
	MOVQ BX, R12
	QUAD $0xfffffcda0d6ffec5 // vmovdqu      $-806(%rip), %ymm1  /* LCPI9_0(%rip) */
	QUAD $0xfffffcf2156ffac5 // vmovdqu      $-782(%rip), %xmm2  /* LCPI9_1(%rip) */
...
LBB9_78:
	...
	LEAQ    2(BX), DI
	WORD    $0xf8c5; BYTE $0x77     // vzeroupper
	LONG    $0x0002c4e8; BYTE $0x00 // callq        _unhex16_is
	TESTB   AX, AX
	JE      LBB9_82
	MOVL    2(BX), AX
	BSWAPL  AX
...
_html_escape:
	...
	MOVQ  -64(BP), AX
	MOVQ  0(AX), R9
	QUAD  $0xffffff051d6ffec5                   // vmovdqu      $-251(%rip), %ymm3  /* LCPI11_0(%rip) */
	QUAD  $0xffffff1d256ffec5                   // vmovdqu      $-227(%rip), %ymm4  /* LCPI11_1(%rip) */
	QUAD  $0xffffff352d6ffec5                   // vmovdqu      $-203(%rip), %ymm5  /* LCPI11_2(%rip) */
	QUAD  $0xffffff4d356ffec5                   // vmovdqu      $-179(%rip), %ymm6  /* LCPI11_3(%rip) */
	LONG  $0x0b358d4c; WORD $0x00b5; BYTE $0x00 // leaq         $46347(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	MOVQ  -48(BP), R11
	MOVQ  -56(BP), R15
...
LBB11_38:
	...
	JL    LBB11_39
	CMPQ  AX, $16
	QUAD  $0xfffffe3b3d6ffac5 // vmovdqu      $-453(%rip), %xmm7  /* LCPI11_4(%rip) */
	QUAD  $0xfffffe43056f7ac5 // vmovdqu      $-445(%rip), %xmm8  /* LCPI11_5(%rip) */
	QUAD  $0xfffffe4b0d6f7ac5 // vmovdqu      $-437(%rip), %xmm9  /* LCPI11_6(%rip) */
	QUAD  $0xfffffe53156f7ac5 // vmovdqu      $-429(%rip), %xmm10  /* LCPI11_7(%rip) */
	JL    LBB11_41
	MOVQ  R11, DI
	SUBQ  R12, DI
	QUAD  $0xfffffd8f1d6ffec5 // vmovdqu      $-625(%rip), %ymm3  /* LCPI11_0(%rip) */
	QUAD  $0xfffffda7256ffec5 // vmovdqu      $-601(%rip), %ymm4  /* LCPI11_1(%rip) */
	QUAD  $0xfffffdbf2d6ffec5 // vmovdqu      $-577(%rip), %ymm5  /* LCPI11_2(%rip) */
	QUAD  $0xfffffdd7356ffec5 // vmovdqu      $-553(%rip), %ymm6  /* LCPI11_3(%rip) */
...
LBB11_39:
	MOVQ AX, R13
	MOVQ R10, R14
	QUAD $0xfffffc751d6ffec5 // vmovdqu      $-907(%rip), %ymm3  /* LCPI11_0(%rip) */
	QUAD $0xfffffc8d256ffec5 // vmovdqu      $-883(%rip), %ymm4  /* LCPI11_1(%rip) */
	QUAD $0xfffffca52d6ffec5 // vmovdqu      $-859(%rip), %ymm5  /* LCPI11_2(%rip) */
	QUAD $0xfffffcbd356ffec5 // vmovdqu      $-835(%rip), %ymm6  /* LCPI11_3(%rip) */
	QUAD $0xfffffcd53d6ffac5 // vmovdqu      $-811(%rip), %xmm7  /* LCPI11_4(%rip) */
	QUAD $0xfffffcdd056f7ac5 // vmovdqu      $-803(%rip), %xmm8  /* LCPI11_5(%rip) */
	QUAD $0xfffffce50d6f7ac5 // vmovdqu      $-795(%rip), %xmm9  /* LCPI11_6(%rip) */
	QUAD $0xfffffced156f7ac5 // vmovdqu      $-787(%rip), %xmm10  /* LCPI11_7(%rip) */
...
LBB11_58:
	...
	JGE  LBB11_59
	CMPQ R13, $8
	LONG $0x17358d4c; WORD $0x00b2; BYTE $0x00 // leaq         $45591(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	JB   LBB11_70
	MOVQ CX, 0(R8)
	LEAQ 8(R12), AX
	ADDQ $8, R8
...
LBB11_41:
	MOVQ  AX, R13
	MOVQ  R10, R14
	QUAD  $0xfffffbbf1d6ffec5 // vmovdqu      $-1089(%rip), %ymm3  /* LCPI11_0(%rip) */
	QUAD  $0xfffffbd7256ffec5 // vmovdqu      $-1065(%rip), %ymm4  /* LCPI11_1(%rip) */
	QUAD  $0xfffffbef2d6ffec5 // vmovdqu      $-1041(%rip), %ymm5  /* LCPI11_2(%rip) */
	QUAD  $0xfffffc07356ffec5 // vmovdqu      $-1017(%rip), %ymm6  /* LCPI11_3(%rip) */
	TESTB CX, CX
	JNE   LBB11_58
...
LBB11_59:
	CMPL AX, $8
	LONG $0x96358d4c; WORD $0x00b0; BYTE $0x00 // leaq         $45206(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	JB   LBB11_60
	MOVQ CX, 0(R8)
	LEAQ 8(R12), R10
	ADDQ $8, R8
...
LBB11_82:
	LONG $0xc0358d4c; WORD $0x00af; BYTE $0x00 // leaq         $44992(%rip), %r14  /* __HtmlQuoteTab(%rip) */
...
LBB12_5:
	...
	LEAL  348(SI), CX
	SHLQ  $4, CX
	LONG  $0x41258d4c; WORD $0x0036; BYTE $0x00 // leaq         $13889(%rip), %r12  /* _POW10_M128_TAB(%rip) */
	MOVQ  DI, AX
	MULQ  8(CX)(R12*1)
	MOVQ  AX, R15
	MOVQ  DX, R11
...
LBB13_6:
	...
	JLE   LBB13_17
	XORL  R12, R12
	LONG  $0x1e358d4c; WORD $0x0060; BYTE $0x00 // leaq         $24606(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB13_11
...
LBB13_9:
	NEGL SI
	MOVQ R15, DI
	LONG $0x00330be8; BYTE $0x00 // callq        _right_shift
...
LBB13_15:
	...
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x0032d2e8; BYTE $0x00 // callq        _right_shift
	LEAL 60(R14), SI
	CMPL R14, $-120
	JB   LBB13_15
	MOVQ R13, R14
...
LBB13_17:
	LONG $0xa8358d4c; WORD $0x005f; BYTE $0x00 // leaq         $24488(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB13_19
...
LBB13_25:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x0030fde8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB13_30:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x00323ce8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JB   LBB13_30
	ADDL $60, R12
...
LBB13_37:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x0031e7e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB13_38:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x003030e8; BYTE $0x00 // callq        _left_shift
...
LBB13_47:
	...
	JB   LBB13_58
	MOVL DX, R8
	QUAD $0xfffffd79056ffac5               // vmovdqu      $-647(%rip), %xmm0  /* LCPI13_0(%rip) */
	LONG $0x22f9c3c4; WORD $0x00c4         // vpinsrq      $0, %r12, %xmm0, %xmm0
	ANDL $-16, R8
	QUAD $0xfffd6505027de3c4; WORD $0xf0ff // vpblendd     $240, $-667(%rip), %ymm0, %ymm0  /* LCPI13_0(%rip) */
	LEAL -16(R8), CX
	MOVL CX, DI
	SHRL $4, DI
	ADDL $1, DI
	...
	CMPL CX, $48
	JAE  LBB13_51
	QUAD $0xfffd6615597de2c4; BYTE $0xff   // vpbroadcastq $-666(%rip), %ymm2  /* LCPI13_1(%rip) */
...
LBB13_51:
	ANDL $-4, DI
	QUAD $0xfffd5015597de2c4; BYTE $0xff // vpbroadcastq $-688(%rip), %ymm2  /* LCPI13_1(%rip) */
	QUAD $0xfffd4f25597de2c4; BYTE $0xff // vpbroadcastq $-689(%rip), %ymm4  /* LCPI13_2(%rip) */
	LONG $0xda6ffdc5                     // vmovdqa      %ymm2, %ymm3
	LONG $0xca6ffdc5                     // vmovdqa      %ymm2, %ymm1
...
LBB13_53:
	TESTL SI, SI
	JE    LBB13_56
	QUAD  $0xfffce525597de2c4; BYTE $0xff // vpbroadcastq $-795(%rip), %ymm4  /* LCPI13_3(%rip) */
...
LBB14_40:
	LEAQ -32(BP), DI
	LEAQ -40(BP), SI
	LONG $0xfff94ce8; BYTE $0xff // callq        _decimal_to_f64
...
_value:
	...
	LEAQ    -80(BP), DI
	LEAQ    -48(BP), SI
	LONG    $0x0005dce8; BYTE $0x00               // callq        _advance_ns
	MOVBLSX AX, AX
	CMPL    AX, $125
	JA      LBB15_11
	LONG    $0x110d8d48; WORD $0x0003; BYTE $0x00 // leaq         $785(%rip), %rcx  /* LJTI15_0(%rip) */
...
LBB15_2:
	...
	LEAQ  -48(BP), SI
	MOVQ  -56(BP), DX
	LONG  $0x000b88e8; BYTE $0x00 // callq        _vnumber
	MOVQ  -48(BP), BX
	JMP   LBB15_51
...
LBB15_7:
	MOVQ  BX, DI
	MOVQ  R12, SI
	LONG  $0x002248e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB15_47
	ADDQ  AX, BX
	SUBQ  R15, BX
...
LBB15_12:
	...
	LEAQ  -64(BP), DX
	MOVQ  R15, SI
	LONG  $0x00080ae8; BYTE $0x00 // callq        _advance_string
	MOVQ  AX, BX
	TESTQ AX, AX
	JS    LBB15_32
	MOVQ  BX, -48(BP)
...
LJTI15_0:
	LONG $0xfffffd89 // .long L15_0_set_10
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	...
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffdad // .long L15_0_set_12
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	...
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffe00 // .long L15_0_set_14
	LONG $0xfffffcf8 // .long L15_0_set_2
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffcf8 // .long L15_0_set_2
	LONG $0xfffffcf8 // .long L15_0_set_2
	...
	LONG $0xfffffcf8 // .long L15_0_set_2
	LONG $0xfffffcf8 // .long L15_0_set_2
	LONG $0xfffffe19 // .long L15_0_set_15
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	...
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffe32 // .long L15_0_set_16
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffe42 // .long L15_0_set_17
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	...
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffe5b // .long L15_0_set_18
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	...
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffe8b // .long L15_0_set_21
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffebc // .long L15_0_set_26
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xfffffefd // .long L15_0_set_29
	LONG $0xfffffd99 // .long L15_0_set_11
	LONG $0xffffff0d // .long L15_0_set_30
...
LBB16_28:
	...
	MOVQ R9, AX
	SUBQ BX, AX
	QUAD $0xfffffe26056ffec5 // vmovdqu      $-474(%rip), %ymm0  /* LCPI16_0(%rip) */
	QUAD $0xfffffe3e0d6ffec5 // vmovdqu      $-450(%rip), %ymm1  /* LCPI16_1(%rip) */
	QUAD $0xfffffe56156ffec5 // vmovdqu      $-426(%rip), %ymm2  /* LCPI16_2(%rip) */
	QUAD $0xfffffe6e1d6ffec5 // vmovdqu      $-402(%rip), %ymm3  /* LCPI16_3(%rip) */
...
LBB16_32:
	...
	MOVQ R9, R10
	SUBQ BX, R10
	QUAD $0xfffffe38056ffac5 // vmovdqu      $-456(%rip), %xmm0  /* LCPI16_4(%rip) */
	QUAD $0xfffffe400d6ffac5 // vmovdqu      $-448(%rip), %xmm1  /* LCPI16_5(%rip) */
	QUAD $0xfffffe48156ffac5 // vmovdqu      $-440(%rip), %xmm2  /* LCPI16_6(%rip) */
	QUAD $0xfffffe501d6ffac5 // vmovdqu      $-432(%rip), %xmm3  /* LCPI16_7(%rip) */
...
_advance_string:
	...
	MOVQ $-1, R8
	XORL R14, R14
	QUAD $0xffffff7a056ffec5        // vmovdqu      $-134(%rip), %ymm0  /* LCPI18_0(%rip) */
	QUAD $0xffffff920d6ffec5        // vmovdqu      $-110(%rip), %ymm1  /* LCPI18_1(%rip) */
...
LBB18_13:
	...
	QUAD  $0xfffffe880d74fdc5 // vpcmpeqb     $-376(%rip), %ymm0, %ymm1  /* LCPI18_0(%rip) */
	LONG  $0xf9d7fdc5         // vpmovmskb    %ymm1, %edi
	QUAD  $0xfffffe9c0574fdc5 // vpcmpeqb     $-356(%rip), %ymm0, %ymm0  /* LCPI18_1(%rip) */
...
LBB19_62:
	...
	QUAD  $0xfffffce70562f9c5                   // vpunpckldq   $-793(%rip), %xmm0, %xmm0  /* LCPI19_0(%rip) */
	QUAD  $0xfffffcef055cf9c5                   // vsubpd       $-785(%rip), %xmm0, %xmm0  /* LCPI19_1(%rip) */
	...
	JB    LBB19_73
	LEAL  -22(BX), AX
	LONG  $0x8c0d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $49036(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB19_70:
	...
	JB   LBB19_78
	NEGL BX
	LONG $0x47058d48; WORD $0x00bf; BYTE $0x00 // leaq         $48967(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB19_72:
	LONG  $0x6ef9c1c4; BYTE $0xc4   // vmovq        %r12, %xmm0
	IMULQ CX, R12
	QUAD  $0xfffffc200562f9c5       // vpunpckldq   $-992(%rip), %xmm0, %xmm0  /* LCPI19_0(%rip) */
	QUAD  $0xfffffc28055cf9c5       // vsubpd       $-984(%rip), %xmm0, %xmm0  /* LCPI19_1(%rip) */
	MOVQ  R12, 16(R14)
	LONG  $0x0579e3c4; WORD $0x01c8 // vpermilpd    $1, %xmm0, %xmm1
	LONG  $0xc058f3c5               // vaddsd       %xmm0, %xmm1, %xmm0
	ANDQ  CX, AX
...
LBB19_74:
	QUAD $0xfffffc05052ef9c5                   // vucomisd     $-1019(%rip), %xmm0  /* LCPI19_2(%rip) */
	JA   LBB19_78
	QUAD $0xfffffc030d10fbc5                   // vmovsd       $-1021(%rip), %xmm1  /* LCPI19_3(%rip) */
	LONG $0xc82ef9c5                           // vucomisd     %xmm0, %xmm1
	JA   LBB19_78
	MOVL AX, AX
	LONG $0xdb0d8d48; WORD $0x00be; BYTE $0x00 // leaq         $48859(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
...
LBB19_78:
	...
	MOVQ  BX, -80(BP)
	MOVL  DX, BX
	LONG  $0xffe778e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB19_83
	MOVQ  -80(BP), SI
	CMPL  -60(BP), $0
	...
	LEAQ  -72(BP), CX
	MOVQ  R12, DI
	LONG  $0xffe758e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB19_83
...
LBB19_83:
	...
	MOVQ -88(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffedbfe8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc8 // vmovsd       %xmm0, $-56(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB19_87
...
LBB19_96:
	...
	LEAL    0(BX)(BX*4), DI
	LEAL    -48(SI)(DI*2), SI
	WORD    $0x4d0f; BYTE $0xf3 // cmovgel      %ebx, %esi
	MOVQ    SI, BX
	CMPQ    R9, AX
	JE      LBB19_98
...
LBB23_4:
	...
	MOVQ    -56(BP), BX
	MOVQ    BX, SI
	LONG    $0xfff1e0e8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R12), DX
	LEAQ    -1(DX), CX
	CMPQ    R14, $-1
	JNE     LBB23_6
...
LBB23_6:
	...
	CMPL    SI, $5
	JA      LBB23_11
	LONG    $0x7c3d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1148(%rip), %rdi  /* LJTI23_0(%rip) */
...
LBB23_17:
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff445e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB23_57
	MOVQ  R13, 0(BX)
...
LBB23_27:
	MOVQ    $-1, R13
	LONG    $0x710d8d48; WORD $0x0003; BYTE $0x00 // leaq         $881(%rip), %rcx  /* LJTI23_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB23_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000d58e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB23_59
	MOVQ  0(BX), CX
	ADDQ  CX, AX
...
LBB23_36:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff2ebe8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB23_57
	MOVQ  R13, 0(BX)
...
LBB23_43:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000c3ee8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB23_65
	ADDQ  AX, 0(BX)
	TESTQ R13, R13
...
LJTI23_0:
	LONG $0xfffffb8d // .long L23_0_set_8
	LONG $0xfffffbc7 // .long L23_0_set_12
	LONG $0xfffffbf0 // .long L23_0_set_15
	LONG $0xfffffc2f // .long L23_0_set_19
	LONG $0xfffffc44 // .long L23_0_set_21
	LONG $0xfffffc5c // .long L23_0_set_23

	// .set L23_1_set_67, LBB23_67-LJTI23_1
	// .set L23_1_set_66, LBB23_66-LJTI23_1
...
LJTI23_1:
	LONG $0xffffff1d // .long L23_1_set_67
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	...
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xfffffd91 // .long L23_1_set_41
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	...
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xfffffdb6 // .long L23_1_set_43
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xfffffc98 // .long L23_1_set_28
	LONG $0xfffffc98 // .long L23_1_set_28
	LONG $0xfffffc98 // .long L23_1_set_28
	LONG $0xfffffc98 // .long L23_1_set_28
	LONG $0xfffffc98 // .long L23_1_set_28
	...
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xfffffded // .long L23_1_set_45
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	...
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xfffffe12 // .long L23_1_set_47
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	...
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xfffffe55 // .long L23_1_set_50
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xfffffe87 // .long L23_1_set_52
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xffffff16 // .long L23_1_set_66
	LONG $0xfffffeb9 // .long L23_1_set_54
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffede6e8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB26_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	CMPQ R13, $64
	JB   LBB27_2
	QUAD $0xffffff59056ffec5 // vmovdqu      $-167(%rip), %ymm0  /* LCPI27_0(%rip) */
	QUAD $0xffffff710d6ffec5 // vmovdqu      $-143(%rip), %ymm1  /* LCPI27_1(%rip) */
	QUAD $0xffffff89156ffec5 // vmovdqu      $-119(%rip), %ymm2  /* LCPI27_2(%rip) */
	MOVQ R15, DX
...
LBB27_52:
	...
	ADDQ  R12, SI
	WORD  $0xf8c5; BYTE $0x77     // vzeroupper
	LONG  $0x00026ae8; BYTE $0x00 // callq        _utf8_validate
	TESTQ AX, AX
	JS    LBB27_56
	ADDQ  0(R14), AX
...
LBB27_21:
	...
	QUAD  $0xfffffda80d74fdc5 // vpcmpeqb     $-600(%rip), %ymm0, %ymm1  /* LCPI27_0(%rip) */
	LONG  $0xd9d7fdc5         // vpmovmskb    %ymm1, %ebx
	QUAD  $0xfffffdbc0d74fdc5 // vpcmpeqb     $-580(%rip), %ymm0, %ymm1  /* LCPI27_1(%rip) */
	QUAD  $0xfffffdd415dafdc5 // vpminub      $-556(%rip), %ymm0, %ymm2  /* LCPI27_2(%rip) */
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB28_33
	LONG  $0xbf058d4c; WORD $0x00af; BYTE $0x00 // leaq         $44991(%rip), %r8  /* _first(%rip) */
	LONG  $0xb80d8d4c; WORD $0x00b0; BYTE $0x00 // leaq         $45240(%rip), %r9  /* _ranges(%rip) */
	LONG  $0x70158d4c; WORD $0x0001; BYTE $0x00 // leaq         $368(%rip), %r10  /* LJTI28_0(%rip) */
	MOVQ  DI, R11
...
// .set L28_0_set_31, LBB28_31-LJTI28_0
// .set L28_0_set_28, LBB28_28-LJTI28_0
// .set L28_0_set_27, LBB28_27-LJTI28_0
// .set L28_0_set_26, LBB28_26-LJTI28_0
LJTI28_0:
	LONG $0xffffff9a // .long L28_0_set_32
	LONG $0xfffffff0 // .long L28_0_set_31
	LONG $0xffffff7d // .long L28_0_set_28
	LONG $0xffffff76 // .long L28_0_set_27
	LONG $0xffffff6f // .long L28_0_set_26
...
LBB30_6:
	...
	JB   LBB30_7
	XORL AX, AX
	QUAD $0xfffffe47056ffec5 // vmovdqu      $-441(%rip), %ymm0  /* LCPI30_0(%rip) */
	QUAD $0xfffffe5f0d6ffec5 // vmovdqu      $-417(%rip), %ymm1  /* LCPI30_1(%rip) */
	QUAD $0xfffffe77156ffec5 // vmovdqu      $-393(%rip), %ymm2  /* LCPI30_2(%rip) */
	QUAD $0xfffffe8f1d6ffec5 // vmovdqu      $-369(%rip), %ymm3  /* LCPI30_3(%rip) */
	QUAD $0xfffffea7256ffec5 // vmovdqu      $-345(%rip), %ymm4  /* LCPI30_4(%rip) */
	QUAD $0xfffffebf2d6ffec5 // vmovdqu      $-321(%rip), %ymm5  /* LCPI30_5(%rip) */
	QUAD $0xfffffed7356ffec5 // vmovdqu      $-297(%rip), %ymm6  /* LCPI30_6(%rip) */
	MOVQ $-1, R8
	MOVQ $-1, R10
...
LBB30_29:
	...
	SUBQ DI, R11
	XORL AX, AX
	QUAD $0xfffffdce056f7ac5 // vmovdqu      $-562(%rip), %xmm8  /* LCPI30_7(%rip) */
	QUAD $0xfffffdd60d6f7ac5 // vmovdqu      $-554(%rip), %xmm9  /* LCPI30_8(%rip) */
	QUAD $0xfffffdde156f7ac5 // vmovdqu      $-546(%rip), %xmm10  /* LCPI30_9(%rip) */
	QUAD $0xfffffde61d6f7ac5 // vmovdqu      $-538(%rip), %xmm11  /* LCPI30_10(%rip) */
	QUAD $0xfffffdee256ffac5 // vmovdqu      $-530(%rip), %xmm4  /* LCPI30_11(%rip) */
	QUAD $0xfffffdf62d6ffac5 // vmovdqu      $-522(%rip), %xmm5  /* LCPI30_12(%rip) */
	QUAD $0xfffffdfe356ffac5 // vmovdqu      $-514(%rip), %xmm6  /* LCPI30_13(%rip) */
...
LBB30_49:
	...
	SUBQ  DI, DX
	XORL  AX, AX
	LONG  $0x813d8d4c; WORD $0x0001; BYTE $0x00 // leaq         $385(%rip), %r15  /* LJTI30_0(%rip) */
	JMP   LBB30_51
...
// .set L30_0_set_61, LBB30_61-LJTI30_0
// .set L30_0_set_66, LBB30_66-LJTI30_0
// .set L30_0_set_57, LBB30_57-LJTI30_0
// .set L30_0_set_54, LBB30_54-LJTI30_0
LJTI30_0:
	LONG $0xfffffec3 // .long L30_0_set_61
	LONG $0xffffff0e // .long L30_0_set_66
	LONG $0xfffffec3 // .long L30_0_set_61
	LONG $0xfffffed3 // .long L30_0_set_57
	LONG $0xffffff0e // .long L30_0_set_66
	LONG $0xffffff0e // .long L30_0_set_66
	LONG $0xffffff0e // .long L30_0_set_66
	LONG $0xffffff0e // .long L30_0_set_66
	...
	LONG $0xffffff0e // .long L30_0_set_66
	LONG $0xffffff0e // .long L30_0_set_66
	LONG $0xfffffe8a // .long L30_0_set_54
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffae5e8; BYTE $0xff // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB31_1
	MOVQ  0(R14), CX
	ADDQ  AX, CX
...
LBB32_3:
	MOVQ  BX, DI
	LONG  $0xfffa75e8; BYTE $0xff // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB32_7
	ADDQ  AX, BX
...
_print_mantissa:
	...
	SUBL    DI, AX
	MOVWLZX AX, R11
	LONG    $0x6f3d8d48; WORD $0x0059; BYTE $0x00 // leaq         $22895(%rip), %rdi  /* _Digits(%rip) */
...
LBB35_2:
	...
	JB   LBB35_3
	MOVL $3518437209, R8
	LONG $0x270d8d4c; WORD $0x0059; BYTE $0x00 // leaq         $22823(%rip), %r9  /* _Digits(%rip) */
...
LBB35_7:
	...
	SUBL    DX, AX
	MOVWLZX AX, AX
	LONG    $0xc0158d48; WORD $0x0058; BYTE $0x00 // leaq         $22720(%rip), %rdx  /* _Digits(%rip) */
...
LBB35_8:
	...
	JB      LBB35_10
	MOVL    AX, AX
	LONG    $0xa30d8d48; WORD $0x0058; BYTE $0x00 // leaq         $22691(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, -2(R14)
	BYTE    $0x5b                                 // popq         %rbx
	WORD    $0x5e41                               // popq         %r14
...
_left_shift:
	...
	MOVL    SI, CX
	IMUL3Q  $104, CX, R10
	LONG    $0xc71d8d4c; WORD $0x008a; BYTE $0x00 // leaq         $35527(%rip), %r11  /* _LSHIFT_TAB(%rip) */
	MOVL    0(R10)(R11*1), R8
	MOVQ    0(DI), R9
	MOVLQSX 16(DI), SI
	TESTQ   SI, SI
...
LBB36_10:
	...
	ADDQ    $-1, R14
	XORL    DX, DX
	MOVQ    $-3689348814741910323, R10

LBB36_12:
	LEAL    -1(R11), AX
	MOVBQSX 0(R9)(AX*1), SI
	ADDQ    $-48, SI
	SHLQ    CX, SI
	ADDQ    DX, SI
	MOVQ    SI, AX
...
_f64toa:
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·__native_entry__+830(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+9819(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_i64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3906(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+5564(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20615(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+24048(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20652(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18772(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+4139(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+7361(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+24165(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+13737(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16809(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18179(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15911(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18466(SB), AX // _vunsigned
	JMP  AX
