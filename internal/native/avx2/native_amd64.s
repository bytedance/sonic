...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0x4f0d8d48; WORD $0x007b; BYTE $0x00 // leaq         $31567(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0x7a0d8d4c; WORD $0x008f; BYTE $0x00 // leaq         $36730(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R9*1), R15
	MOVQ    R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x00445ce8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, CX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(CX)(CX*4), CX
	SUBL    CX, AX
	LONG    $0x5d0d8d48; WORD $0x009e; BYTE $0x00 // leaq         $40541(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_68:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x0043b8e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_79
	LEAL  0(R13)(BX*1), AX
	CMPL  R13, R15
...
LBB2_73:
	...
	JL      LBB2_81
	WORD    $0x9848                               // cltq
	LONG    $0xb00d8d48; WORD $0x009d; BYTE $0x00 // leaq         $40368(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_104:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x004037e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0xa80d8d48; WORD $0x0099; BYTE $0x00 // leaq         $39336(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x87358d48; WORD $0x0099; BYTE $0x00 // leaq         $39303(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	INCL    CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x76158d48; WORD $0x0099; BYTE $0x00 // leaq         $39286(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	INCL CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x5e158d48; WORD $0x0099; BYTE $0x00 // leaq         $39262(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	INCL    CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0xc7058d48; WORD $0x0098; BYTE $0x00 // leaq         $39111(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x77358d48; WORD $0x0098; BYTE $0x00 // leaq         $39031(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0xea158d48; WORD $0x0097; BYTE $0x00 // leaq         $38890(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0xcd0d8d48; WORD $0x0096; BYTE $0x00 // leaq         $38605(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x7c0d8d48; WORD $0x0096; BYTE $0x00 // leaq         $38524(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x59058d4c; WORD $0x0096; BYTE $0x00 // leaq         $38489(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
_quote:
	...
	MOVQ  DI, R12
	TESTB $1, R8
	LONG  $0xf6058d48; WORD $0x0095; BYTE $0x00 // leaq         $38390(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0xef158d4c; WORD $0x00a5; BYTE $0x00 // leaq         $42479(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG  $0xd0440f4c                           // cmoveq       %rax, %r10
	MOVQ  DX, R8
	MOVQ  DI, AX
	TESTQ SI, SI
...
LBB5_27:
	TESTQ CX, CX
	MOVQ  BX, R14
	LONG  $0x950d8d4c; WORD $0x0092; BYTE $0x00 // leaq         $37525(%rip), %r9  /* __SingleQuoteTab(%rip) */
	JLE   LBB5_60
	MOVQ  SI, DX
	TESTQ SI, SI
	JLE   LBB5_61
...
_unquote:
	...
	MOVQ  R8, -64(BP)
	ANDL  $1, R8
	LONG  $0xbf0d8d4c; WORD $0x00ae; BYTE $0x00 // leaq         $44735(%rip), %r9  /* __UnquoteTab(%rip) */
...
_atof_eisel_lemire64:
	...
	MOVL DX, R15
	MOVQ DI, R13
	LONG $0x002a81e8; BYTE $0x00               // callq        _count_len_u64
	MOVL AX, R8
	MOVL AX, CX
	NEGL CX
	SHLQ CX, R13
	MOVL BX, CX
	SHLQ $4, CX
	LONG $0xc6158d4c; WORD $0x002d; BYTE $0x00 // leaq         $11718(%rip), %r10  /* _POW10_M128_TAB(%rip) */
	MOVQ R13, AX
	MULQ 8(CX)(R10*1)
	MOVQ AX, R9
	MOVQ DX, DI
...
LBB8_5:
	...
	JLE   LBB8_12
	XORL  R12, R12
	LONG  $0xa3358d4c; WORD $0x0057; BYTE $0x00 // leaq         $22435(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB8_8
...
LBB8_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002a62e8; BYTE $0x00 // callq        _right_shift
...
LBB8_12:
	LONG $0x5c358d4c; WORD $0x0057; BYTE $0x00 // leaq         $22364(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB8_14
...
LBB8_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x0029b4e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB8_25
	ADDL $60, R12
...
LBB8_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x00296ee8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB8_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x0027eae8; BYTE $0x00 // callq        _left_shift
...
_value:
	...
	LEAQ    -64(BP), DI
	LEAQ    -40(BP), SI
	LONG    $0x000531e8; BYTE $0x00               // callq        _advance_ns
	MOVBLSX AX, AX
	CMPL    AX, $125
	JA      LBB10_4
	LONG    $0x6a0d8d48; WORD $0x0002; BYTE $0x00 // leaq         $618(%rip), %rcx  /* LJTI10_0(%rip) */
...
LBB10_2:
	...
	LEAQ -40(BP), SI
	MOVQ R14, DX
	LONG $0x000ab8e8; BYTE $0x00 // callq        _vnumber
	MOVQ -40(BP), BX
	JMP  LBB10_18
...
LBB10_5:
	...
	MOVQ  BX, SI
	MOVQ  R12, DX
	LONG  $0x0007dfe8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB10_25
	MOVQ  AX, -40(BP)
	MOVQ  R12, 16(R14)
...
LJTI10_0:
	LONG $0xfffffdbc // .long L10_0_set_3
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	...
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffddf // .long L10_0_set_5
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	...
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffe34 // .long L10_0_set_7
	LONG $0xfffffd9f // .long L10_0_set_2
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffd9f // .long L10_0_set_2
	LONG $0xfffffd9f // .long L10_0_set_2
	...
	LONG $0xfffffd9f // .long L10_0_set_2
	LONG $0xfffffd9f // .long L10_0_set_2
	LONG $0xfffffe4a // .long L10_0_set_8
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	...
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffe60 // .long L10_0_set_9
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffee7 // .long L10_0_set_16
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	...
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xffffff0e // .long L10_0_set_19
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	...
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffe70 // .long L10_0_set_10
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffea4 // .long L10_0_set_12
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xffffff2e // .long L10_0_set_22
	LONG $0xfffffdcc // .long L10_0_set_4
	LONG $0xfffffed4 // .long L10_0_set_15
...
LBB11_28:
	CMPQ DX, $32
	JB   LBB11_32
	QUAD $0xfffffe22056ffec5 // vmovdqu      $-478(%rip), %ymm0  /* LCPI11_0(%rip) */
	QUAD $0xfffffe3a0d6ffec5 // vmovdqu      $-454(%rip), %ymm1  /* LCPI11_1(%rip) */
	QUAD $0xfffffe52156ffec5 // vmovdqu      $-430(%rip), %ymm2  /* LCPI11_2(%rip) */
	QUAD $0xfffffe6a1d6ffec5 // vmovdqu      $-406(%rip), %ymm3  /* LCPI11_3(%rip) */
...
LBB11_32:
	...
	CMPQ DX, $16
	JB   LBB11_36
	QUAD $0xfffffe3e056ffac5 // vmovdqu      $-450(%rip), %xmm0  /* LCPI11_4(%rip) */
	QUAD $0xfffffe460d6ffac5 // vmovdqu      $-442(%rip), %xmm1  /* LCPI11_5(%rip) */
	QUAD $0xfffffe4e156ffac5 // vmovdqu      $-434(%rip), %xmm2  /* LCPI11_6(%rip) */
	QUAD $0xfffffe561d6ffac5 // vmovdqu      $-426(%rip), %xmm3  /* LCPI11_7(%rip) */
...
_advance_string:
	...
	CMPQ SI, $64
	JB   LBB13_12
	QUAD $0xffffff8c056ffec5       // vmovdqu      $-116(%rip), %ymm0  /* LCPI13_0(%rip) */
	QUAD $0xffffffa40d6ffec5       // vmovdqu      $-92(%rip), %ymm1  /* LCPI13_1(%rip) */
...
LBB13_12:
	...
	QUAD  $0xfffffe9c0d74fdc5 // vpcmpeqb     $-356(%rip), %ymm0, %ymm1  /* LCPI13_0(%rip) */
	LONG  $0xc1d7fdc5         // vpmovmskb    %ymm1, %eax
	QUAD  $0xfffffeb00574fdc5 // vpcmpeqb     $-336(%rip), %ymm0, %ymm0  /* LCPI13_1(%rip) */
	LONG  $0xd8d7fdc5         // vpmovmskb    %ymm0, %ebx
	TESTL BX, BX
	JNE   LBB13_14
	TESTQ R11, R11
...
LBB14_63:
	...
	QUAD  $0xfffffd0a0562f9c5                   // vpunpckldq   $-758(%rip), %xmm0, %xmm0  /* LCPI14_0(%rip) */
	QUAD  $0xfffffd12055cf9c5                   // vsubpd       $-750(%rip), %xmm0, %xmm0  /* LCPI14_1(%rip) */
	...
	JL    LBB14_72
	LEAL  -22(BX), AX
	LONG  $0x600d8d48; WORD $0x014f; BYTE $0x00 // leaq         $85856(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB14_69:
	...
	JB   LBB14_76
	NEGL BX
	LONG $0x28058d48; WORD $0x014f; BYTE $0x00 // leaq         $85800(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB14_71:
	LONG  $0x6ef9c1c4; BYTE $0xc4   // vmovq        %r12, %xmm0
	IMULQ CX, R12
	QUAD  $0xfffffc470562f9c5       // vpunpckldq   $-953(%rip), %xmm0, %xmm0  /* LCPI14_0(%rip) */
	QUAD  $0xfffffc4f055cf9c5       // vsubpd       $-945(%rip), %xmm0, %xmm0  /* LCPI14_1(%rip) */
	MOVQ  R12, 16(R13)
	LONG  $0x0579e3c4; WORD $0x01c8 // vpermilpd    $1, %xmm0, %xmm1
	LONG  $0xc058f3c5               // vaddsd       %xmm0, %xmm1, %xmm0
	ANDQ  CX, AX
...
LBB14_73:
	QUAD $0xfffffc33052ef9c5                   // vucomisd     $-973(%rip), %xmm0  /* LCPI14_2(%rip) */
	JA   LBB14_76
	QUAD $0xfffffc310d10fbc5                   // vmovsd       $-975(%rip), %xmm1  /* LCPI14_3(%rip) */
	LONG $0xc82ef9c5                           // vucomisd     %xmm0, %xmm1
	JA   LBB14_76
	MOVL AX, AX
	LONG $0xbb0d8d48; WORD $0x014e; BYTE $0x00 // leaq         $85691(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc8               // vmovsd       %xmm0, $-56(%rbp)
	JMP  LBB14_82
...
LBB14_76:
	...
	MOVL  BX, SI
	MOVL  -48(BP), DX
	LONG  $0xffe808e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB14_80
...
LBB14_80:
	...
	MOVL 8(CX), SI
	SUBL AX, SI
	LONG $0xffee5ce8; BYTE $0xff // callq        _atof_native_decimal
	JMP  LBB14_82
...
LBB18_4:
	...
	MOVQ    BX, DI
	MOVQ    R15, SI
	LONG    $0xfff2c2e8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R13), DX
	LEAQ    -1(DX), CX
	MOVL    0(R13)(DX*4), SI
	CMPQ    R14, $-1
...
LBB18_6:
	...
	CMPL    SI, $5
	JA      LBB18_11
	LONG    $0x263d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1062(%rip), %rdi  /* LJTI18_0(%rip) */
...
LBB18_17:
	MOVQ  R12, DX
	LEAQ  -56(BP), CX
	LONG  $0xfff52ce8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, BX
	TESTQ AX, AX
	JS    LBB18_53
	MOVQ  BX, 0(R15)
...
LBB18_27:
	MOVQ    $-1, BX
	LONG    $0x140d8d48; WORD $0x0003; BYTE $0x00 // leaq         $788(%rip), %rcx  /* LJTI18_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB18_28:
	...
	MOVQ  8(AX), SI
	SUBQ  BX, SI
	LONG  $0x0006ffe8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JS    LBB18_55
	MOVQ  0(R15), CX
	LEAQ  -1(AX)(CX*1), AX
...
LBB18_34:
	...
	MOVQ    R12, DX
	LEAQ    -56(BP), CX
	LONG    $0xfff3ebe8; BYTE $0xff // callq        _advance_string
	MOVQ    AX, BX
	TESTQ   AX, AX
	JS      LBB18_53
	MOVQ    BX, 0(R15)
...
LBB18_40:
	...
	MOVQ  8(AX), SI
	SUBQ  BX, SI
	LONG  $0x000613e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JS    LBB18_60
	ADDQ  AX, 0(R15)
	TESTQ BX, BX
...
LJTI18_0:
	LONG $0xfffffbe3 // .long L18_0_set_8
	LONG $0xfffffc1d // .long L18_0_set_12
	LONG $0xfffffc46 // .long L18_0_set_15
	LONG $0xfffffc8a // .long L18_0_set_19
	LONG $0xfffffca0 // .long L18_0_set_21
	LONG $0xfffffcb8 // .long L18_0_set_23
...
LJTI18_1:
	LONG $0xffffff28 // .long L18_1_set_62
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	...
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xfffffde6 // .long L18_1_set_40
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xfffffcf5 // .long L18_1_set_28
	LONG $0xfffffcf5 // .long L18_1_set_28
	LONG $0xfffffcf5 // .long L18_1_set_28
	LONG $0xfffffcf5 // .long L18_1_set_28
	LONG $0xfffffcf5 // .long L18_1_set_28
	...
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xfffffe19 // .long L18_1_set_42
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	...
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xfffffe3e // .long L18_1_set_44
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	...
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xfffffe7d // .long L18_1_set_47
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xfffffeab // .long L18_1_set_49
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xffffff21 // .long L18_1_set_61
	LONG $0xfffffed5 // .long L18_1_set_51
...
_skip_string:
	...
	LEAQ  -32(BP), CX
	MOVQ  BX, DX
	LONG  $0xffef25e8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB21_2
	DECQ  BX
	MOVQ  AX, CX
...
LBB23_5:
	...
	CMPQ SI, $32
	JB   LBB23_73
	QUAD $0xfffffe4b056ffec5 // vmovdqu      $-437(%rip), %ymm0  /* LCPI23_0(%rip) */
	QUAD $0xfffffe630d6ffec5 // vmovdqu      $-413(%rip), %ymm1  /* LCPI23_1(%rip) */
	QUAD $0xfffffe7b156ffec5 // vmovdqu      $-389(%rip), %ymm2  /* LCPI23_2(%rip) */
	QUAD $0xfffffe931d6ffec5 // vmovdqu      $-365(%rip), %ymm3  /* LCPI23_3(%rip) */
	QUAD $0xfffffeab256ffec5 // vmovdqu      $-341(%rip), %ymm4  /* LCPI23_4(%rip) */
	QUAD $0xfffffec32d6ffec5 // vmovdqu      $-317(%rip), %ymm5  /* LCPI23_5(%rip) */
	QUAD $0xfffffedb356ffec5 // vmovdqu      $-293(%rip), %ymm6  /* LCPI23_6(%rip) */
	MOVQ $-1, R8
	MOVQ $-1, R9
	MOVQ DI, R14
...
LBB23_24:
	QUAD $0xfffffdd5056f7ac5 // vmovdqu      $-555(%rip), %xmm8  /* LCPI23_7(%rip) */
	QUAD $0xfffffddd0d6f7ac5 // vmovdqu      $-547(%rip), %xmm9  /* LCPI23_8(%rip) */
	QUAD $0xfffffde5156f7ac5 // vmovdqu      $-539(%rip), %xmm10  /* LCPI23_9(%rip) */
	QUAD $0xfffffded1d6f7ac5 // vmovdqu      $-531(%rip), %xmm11  /* LCPI23_10(%rip) */
	QUAD $0xfffffdf5256ffac5 // vmovdqu      $-523(%rip), %xmm4  /* LCPI23_11(%rip) */
	QUAD $0xfffffdfd2d6ffac5 // vmovdqu      $-515(%rip), %xmm5  /* LCPI23_12(%rip) */
	QUAD $0xfffffe05356ffac5 // vmovdqu      $-507(%rip), %xmm6  /* LCPI23_13(%rip) */
	MOVL $4294967295, R11
...
LBB23_41:
	LONG $0x13158d48; WORD $0x0001; BYTE $0x00 // leaq         $275(%rip), %rdx  /* LJTI23_0(%rip) */
...
// .set L23_0_set_42, LBB23_42-LJTI23_0
// .set L23_0_set_46, LBB23_46-LJTI23_0
LJTI23_0:
	LONG $0xffffff09 // .long L23_0_set_44
	LONG $0xffffff68 // .long L23_0_set_54
	LONG $0xffffff09 // .long L23_0_set_44
	LONG $0xffffff39 // .long L23_0_set_48
	LONG $0xffffff68 // .long L23_0_set_54
	LONG $0xfffffeed // .long L23_0_set_42
	LONG $0xfffffeed // .long L23_0_set_42
	LONG $0xfffffeed // .long L23_0_set_42
	LONG $0xfffffeed // .long L23_0_set_42
	LONG $0xfffffeed // .long L23_0_set_42
	...
	LONG $0xffffff68 // .long L23_0_set_54
	LONG $0xffffff68 // .long L23_0_set_54
	LONG $0xffffff21 // .long L23_0_set_46
	LONG $0xffffff68 // .long L23_0_set_54
	LONG $0xffffff68 // .long L23_0_set_54
	LONG $0xffffff68 // .long L23_0_set_54
	LONG $0xffffff68 // .long L23_0_set_54
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffae8e8; BYTE $0xff // callq        _skip_number
	TESTQ AX, AX
	JS    LBB24_1
	MOVQ  0(R14), CX
	LEAQ  -1(AX)(CX*1), CX
...
TEXT ·__skip_array(SB), NOSPLIT, $0 - 32
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+18263(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__skip_object(SB), NOSPLIT, $0 - 32
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+18298(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__skip_one(SB), NOSPLIT, $0 - 32
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+16517(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__value(SB), NOSPLIT, $0 - 48
	...
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+11871(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
TEXT ·__vnumber(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+14711(SB), AX // _vnumber
	JMP  AX
...
TEXT ·__vsigned(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+15967(SB), AX // _vsigned
	JMP  AX
...
TEXT ·__vstring(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+13874(SB), AX // _vstring
	JMP  AX
...
TEXT ·__vunsigned(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+16244(SB), AX // _vunsigned
	JMP  AX
