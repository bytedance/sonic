...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0x100d8d48; WORD $0x008e; BYTE $0x00 // leaq         $36368(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0x3a0d8d4c; WORD $0x00a2; BYTE $0x00 // leaq         $41530(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R9*1), R15
	MOVQ    R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x005760e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0x19058d48; WORD $0x00b1; BYTE $0x00 // leaq         $45337(%rip), %rax  /* _Digits(%rip) */
...
LBB2_69:
	...
	JL      LBB2_84
	MOVLQSX R14, AX
	LONG    $0xae0d8d48; WORD $0x00b0; BYTE $0x00 // leaq         $45230(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x00565ce8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_77
	LEAL  0(BX)(R13*1), AX
	CMPL  R13, R15
...
LBB2_88:
	...
	NEGQ SI
	XORL DI, DI
	QUAD $0xfffff68e056ffec5 // vmovdqu      $-2418(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_90:
	...
	SHLQ  $7, DX
	XORL  SI, SI
	QUAD  $0xfffff5df056ffec5 // vmovdqu      $-2593(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_98:
	...
	NEGQ DX
	XORL SI, SI
	QUAD $0xfffff560056ffec5 // vmovdqu      $-2720(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_100:
	...
	JE    LBB2_103
	NEGQ  AX
	QUAD  $0xfffff4ab056ffec5 // vmovdqu      $-2901(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0052f7e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x190d8d48; WORD $0x00ac; BYTE $0x00 // leaq         $44057(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0xf8358d48; WORD $0x00ab; BYTE $0x00 // leaq         $44024(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0xe6158d48; WORD $0x00ab; BYTE $0x00 // leaq         $44006(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0xcd158d48; WORD $0x00ab; BYTE $0x00 // leaq         $43981(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0x35058d48; WORD $0x00ab; BYTE $0x00 // leaq         $43829(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x10358d48; WORD $0x00ab; BYTE $0x00 // leaq         $43792(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0xfe058d48; WORD $0x00aa; BYTE $0x00 // leaq         $43774(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0xe3358d48; WORD $0x00aa; BYTE $0x00 // leaq         $43747(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x59158d48; WORD $0x00aa; BYTE $0x00 // leaq         $43609(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0x3c0d8d48; WORD $0x00a9; BYTE $0x00 // leaq         $43324(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0xeb0d8d48; WORD $0x00a8; BYTE $0x00 // leaq         $43243(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0xc8058d4c; WORD $0x00a8; BYTE $0x00 // leaq         $43208(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
LBB4_25:
	...
	SHRQ $26, DX
	LONG $0xc26ef9c5                     // vmovd        %edx, %xmm0
	QUAD $0xfffffbe20d6ffac5             // vmovdqu      $-1054(%rip), %xmm1  /* LCPI4_0(%rip) */
	LONG $0xd1f4f9c5                     // vpmuludq     %xmm1, %xmm0, %xmm2
	LONG $0xd273e9c5; BYTE $0x2d         // vpsrlq       $45, %xmm2, %xmm2
	MOVL $10000, AX
	LONG $0x6ef9e1c4; BYTE $0xd8         // vmovq        %rax, %xmm3
	...
	LONG $0xf073f9c5; BYTE $0x02         // vpsllq       $2, %xmm0, %xmm0
	LONG $0xc070fbc5; BYTE $0x50         // vpshuflw     $80, %xmm0, %xmm0
	QUAD $0xfffbe0155979e2c4; BYTE $0xff // vpbroadcastq $-1056(%rip), %xmm2  /* LCPI4_1(%rip) */
	LONG $0xc070f9c5; BYTE $0x50         // vpshufd      $80, %xmm0, %xmm0
	LONG $0xc2e4f9c5                     // vpmulhuw     %xmm2, %xmm0, %xmm0
	QUAD $0xfffbd6255979e2c4; BYTE $0xff // vpbroadcastq $-1066(%rip), %xmm4  /* LCPI4_2(%rip) */
	LONG $0xc4e4f9c5                     // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffba22d6ffac5             // vmovdqu      $-1118(%rip), %xmm5  /* LCPI4_3(%rip) */
	LONG $0xf5d5f9c5                     // vpmullw      %xmm5, %xmm0, %xmm6
	LONG $0xf673c9c5; BYTE $0x10         // vpsllq       $16, %xmm6, %xmm6
	LONG $0xc6f9f9c5                     // vpsubw       %xmm6, %xmm0, %xmm0
	LONG $0xe100c269; WORD $0x05f5       // imull        $100000000, %edx, %eax
	...
	LONG $0xcaf9f1c5                     // vpsubw       %xmm2, %xmm1, %xmm1
	LONG $0xc167f9c5                     // vpackuswb    %xmm1, %xmm0, %xmm0
	QUAD $0xfffffb5405fcf9c5             // vpaddb       $-1196(%rip), %xmm0, %xmm0  /* LCPI4_4(%rip) */
	MOVL CX, AX
...
LBB5_2:
	...
	LONG $0xdd258d4c; WORD $0x00a7; BYTE $0x00 // leaq         $42973(%rip), %r12  /* _printhex.tab(%rip) */
	JMP  LBB5_3
...
LBB5_28:
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x004df4e8; BYTE $0x00 // callq        _write_syscall
	XORL AX, AX
...
LBB5_10:
	MOVQ    R14, DI
	WORD    $0xf8c5; BYTE $0x77     // vzeroupper
	LONG    $0x004d9ee8; BYTE $0x00 // callq        _write_syscall
	MOVBLSX 1(BX), CX
	ADDQ    $2, BX
	CMPL    CX, $114
	JG      LBB5_15
...
LBB5_51:
	LEAQ 288(SP), DI
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x004b75e8; BYTE $0x00 // callq        _write_syscall
...
_quote:
	...
	SUBQ  $32, SP
	TESTB $1, R8
	LONG  $0xa5058d48; WORD $0x00a4; BYTE $0x00 // leaq         $42149(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0x9e158d4c; WORD $0x00b4; BYTE $0x00 // leaq         $46238(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG  $0xd0440f4c                           // cmoveq       %rax, %r10
	MOVQ  DX, R8
	MOVQ  DI, AX
	TESTQ SI, SI
	...
	MOVQ  CX, -64(BP)
	MOVQ  0(CX), R11
	QUAD  $0xffffff2b0d6f7ec5                   // vmovdqu      $-213(%rip), %ymm9  /* LCPI6_0(%rip) */
	QUAD  $0xffffff43156f7ec5                   // vmovdqu      $-189(%rip), %ymm10  /* LCPI6_1(%rip) */
	QUAD  $0xffffff5b1d6f7ec5                   // vmovdqu      $-165(%rip), %ymm11  /* LCPI6_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0               // vpcmpeqd     %ymm8, %ymm8, %ymm8
	MOVQ  $12884901889, R14
	MOVQ  DI, -72(BP)
	MOVQ  DI, CX
	MOVQ  DX, -56(BP)
	MOVQ  DX, R8
...
LBB6_5:
	LONG  $0x6f7ea1c4; WORD $0x2804 // vmovdqu      (%rax,%r13), %ymm0
	...
	LONG  $0x7f7e81c4; WORD $0x2804 // vmovdqu      %ymm0, (%r8,%r13)
...
LBB6_36:
	...
	MOVQ  AX, CX
	SUBQ  R12, CX
	QUAD  $0xfffffdb40d6f7ec5     // vmovdqu      $-588(%rip), %ymm9  /* LCPI6_0(%rip) */
	QUAD  $0xfffffdcc156f7ec5     // vmovdqu      $-564(%rip), %ymm10  /* LCPI6_1(%rip) */
	QUAD  $0xfffffde41d6f7ec5     // vmovdqu      $-540(%rip), %ymm11  /* LCPI6_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD  $0xfffffdf73d6ffac5     // vmovdqu      $-521(%rip), %xmm7  /* LCPI6_3(%rip) */
	QUAD  $0xfffffdff256ffac5     // vmovdqu      $-513(%rip), %xmm4  /* LCPI6_4(%rip) */
	QUAD  $0xfffffe072d6ffac5     // vmovdqu      $-505(%rip), %xmm5  /* LCPI6_5(%rip) */
...
LBB6_37:
	MOVQ  BX, R14
	MOVQ  R15, R9
	QUAD  $0xfffffc700d6f7ec5     // vmovdqu      $-912(%rip), %ymm9  /* LCPI6_0(%rip) */
	QUAD  $0xfffffc88156f7ec5     // vmovdqu      $-888(%rip), %ymm10  /* LCPI6_1(%rip) */
	QUAD  $0xfffffca01d6f7ec5     // vmovdqu      $-864(%rip), %ymm11  /* LCPI6_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD  $0xfffffcb33d6ffac5     // vmovdqu      $-845(%rip), %xmm7  /* LCPI6_3(%rip) */
	QUAD  $0xfffffcbb256ffac5     // vmovdqu      $-837(%rip), %xmm4  /* LCPI6_4(%rip) */
	QUAD  $0xfffffcc32d6ffac5     // vmovdqu      $-829(%rip), %xmm5  /* LCPI6_5(%rip) */
	LONG  $0xf676c9c5             // vpcmpeqd     %xmm6, %xmm6, %xmm6
	TESTB DX, DX
	JNE   LBB6_51
...
LBB6_48:
	MOVBLZX 0(R12)(DX*1), DI
	MOVQ    DI, BX
	SHLQ    $4, BX
	LONG    $0x67358d48; WORD $0x00a1; BYTE $0x00 // leaq         $41319(%rip), %rsi  /* __SingleQuoteTab(%rip) */
	CMPQ    0(BX)(SI*1), $0
	JNE     LBB6_49
	LEAQ    0(R9)(CX*1), R15
	MOVB    DI, 0(R13)(DX*1)
...
LBB7_2:
	...
	MOVL    DX, R11
	NOTL    R11
	LEAL    -808464432(DX), AX
	ANDL    $-2139062144, R11
	TESTL   AX, R11
	JNE     LBB7_102
	LEAL    421075225(DX), AX
	ORL     DX, AX
	TESTL   $-2139062144, AX
	JNE     LBB7_102
	MOVL    DX, CX
...
LBB7_21:
	LONG  $0x6f7ec1c4; WORD $0x0104 // vmovdqu      (%r9,%rax), %ymm0
...
LBB7_24:
	...
	MOVQ R9, R13
	SUBQ R14, R13
	QUAD $0xfffffdc00d6ffec5 // vmovdqu      $-576(%rip), %ymm1  /* LCPI7_0(%rip) */
	QUAD $0xfffffdd8156ffac5 // vmovdqu      $-552(%rip), %xmm2  /* LCPI7_1(%rip) */
...
LBB7_28:
	MOVQ R15, R11
	QUAD $0xfffffd7c0d6ffec5 // vmovdqu      $-644(%rip), %ymm1  /* LCPI7_0(%rip) */
	QUAD $0xfffffd94156ffac5 // vmovdqu      $-620(%rip), %xmm2  /* LCPI7_1(%rip) */
...
LBB7_38:
	ADDQ    R14, R8
	MOVBLZX -1(R9), AX
	LONG    $0xb00d8d48; WORD $0x00ba; BYTE $0x00 // leaq         $47792(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB    0(AX)(CX*1), CX
	CMPB    CX, $-1
	JE      LBB7_41
	TESTB   CX, CX
...
LBB7_41:
	...
	MOVL    R11, CX
	NOTL    CX
	LEAL    -808464432(R11), AX
	ANDL    $-2139062144, CX
	TESTL   AX, CX
	JNE     LBB7_89
	LEAL    421075225(R11), AX
	ORL     R11, AX
	TESTL   $-2139062144, AX
	JNE     LBB7_89
	MOVL    R11, BX
...
_html_escape:
	...
	LONG  $0x7f1d8d4c; WORD $0x00b4; BYTE $0x00 // leaq         $46207(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ  $12884901889, R14
	MOVQ  -64(BP), R15
	MOVQ  -48(BP), R8
...
LBB8_5:
	LONG  $0x6f7e81c4; WORD $0x2f04 // vmovdqu      (%r15,%r13), %ymm0
...
LBB8_36:
	...
	JL    LBB8_37
	CMPQ  R10, $16
	QUAD  $0xfffffe353d6ffac5 // vmovdqu      $-459(%rip), %xmm7  /* LCPI8_4(%rip) */
	QUAD  $0xfffffe3d056f7ac5 // vmovdqu      $-451(%rip), %xmm8  /* LCPI8_5(%rip) */
	QUAD  $0xfffffe450d6f7ac5 // vmovdqu      $-443(%rip), %xmm9  /* LCPI8_6(%rip) */
	QUAD  $0xfffffe4d156f7ac5 // vmovdqu      $-435(%rip), %xmm10  /* LCPI8_7(%rip) */
	JL    LBB8_39
	MOVQ  R15, CX
	SUBQ  AX, CX
	QUAD  $0xfffffd891d6ffec5 // vmovdqu      $-631(%rip), %ymm3  /* LCPI8_0(%rip) */
	QUAD  $0xfffffda1256ffec5 // vmovdqu      $-607(%rip), %ymm4  /* LCPI8_1(%rip) */
	QUAD  $0xfffffdb92d6ffec5 // vmovdqu      $-583(%rip), %ymm5  /* LCPI8_2(%rip) */
	QUAD  $0xfffffdd1356ffec5 // vmovdqu      $-559(%rip), %ymm6  /* LCPI8_3(%rip) */
...
LBB8_37:
	MOVQ BX, R12
	MOVQ R10, R14
	QUAD $0xfffffc6a1d6ffec5 // vmovdqu      $-918(%rip), %ymm3  /* LCPI8_0(%rip) */
	QUAD $0xfffffc82256ffec5 // vmovdqu      $-894(%rip), %ymm4  /* LCPI8_1(%rip) */
	QUAD $0xfffffc9a2d6ffec5 // vmovdqu      $-870(%rip), %ymm5  /* LCPI8_2(%rip) */
	QUAD $0xfffffcb2356ffec5 // vmovdqu      $-846(%rip), %ymm6  /* LCPI8_3(%rip) */
	QUAD $0xfffffcca3d6ffac5 // vmovdqu      $-822(%rip), %xmm7  /* LCPI8_4(%rip) */
	QUAD $0xfffffcd2056f7ac5 // vmovdqu      $-814(%rip), %xmm8  /* LCPI8_5(%rip) */
	QUAD $0xfffffcda0d6f7ac5 // vmovdqu      $-806(%rip), %xmm9  /* LCPI8_6(%rip) */
	QUAD $0xfffffce2156f7ac5 // vmovdqu      $-798(%rip), %xmm10  /* LCPI8_7(%rip) */
...
LBB8_56:
	...
	JGE  LBB8_57
	CMPQ R12, $8
	LONG $0x801d8d4c; WORD $0x00b1; BYTE $0x00 // leaq         $45440(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ $12884901889, R14
	JB   LBB8_68
	MOVQ CX, 0(R13)
	LEAQ 8(AX), CX
...
LBB8_39:
	MOVQ  BX, R12
	MOVQ  R10, R14
	QUAD  $0xfffffba91d6ffec5 // vmovdqu      $-1111(%rip), %ymm3  /* LCPI8_0(%rip) */
	QUAD  $0xfffffbc1256ffec5 // vmovdqu      $-1087(%rip), %ymm4  /* LCPI8_1(%rip) */
	QUAD  $0xfffffbd92d6ffec5 // vmovdqu      $-1063(%rip), %ymm5  /* LCPI8_2(%rip) */
	QUAD  $0xfffffbf1356ffec5 // vmovdqu      $-1039(%rip), %ymm6  /* LCPI8_3(%rip) */
	TESTB R11, R11
	JNE   LBB8_56
...
LBB8_49:
	MOVBLZX 0(AX)(BX*1), DX
	CMPQ    DX, $62
	JA      LBB8_50
	MOVQ    $5764607797912141824, DI
	BTQ     DX, DI
	JB      LBB8_78
...
LBB8_57:
	CMPL BX, $8
	LONG $0xea1d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $45034(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ $12884901889, R14
	JB   LBB8_58
	MOVQ CX, 0(R13)
	LEAQ 8(AX), R10
...
LBB8_81:
	LONG $0x011d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $44801(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ $12884901889, R14
...
LBB9_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x6a3d8d4c; WORD $0x0035; BYTE $0x00 // leaq         $13674(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB10_5:
	...
	JLE   LBB10_12
	XORL  R12, R12
	LONG  $0x5e358d4c; WORD $0x005f; BYTE $0x00 // leaq         $24414(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB10_8
...
LBB10_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x00324be8; BYTE $0x00 // callq        _right_shift
...
LBB10_12:
	LONG $0x20358d4c; WORD $0x005f; BYTE $0x00 // leaq         $24352(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB10_14
...
LBB10_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x00307ee8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB10_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x0031ade8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB10_25
	ADDL $60, R12
...
LBB10_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x003166e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB10_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002fbce8; BYTE $0x00 // callq        _left_shift
...
LBB10_41:
	...
	JB   LBB10_52
	MOVL DX, R8
	QUAD $0xfffffdc0056ffac5               // vmovdqu      $-576(%rip), %xmm0  /* LCPI10_0(%rip) */
	LONG $0x22f9c3c4; WORD $0x00c4         // vpinsrq      $0, %r12, %xmm0, %xmm0
	ANDL $-16, R8
	QUAD $0xfffdac05027de3c4; WORD $0xf0ff // vpblendd     $240, $-596(%rip), %ymm0, %ymm0  /* LCPI10_0(%rip) */
	LEAL -16(R8), CX
	MOVL CX, DI
	SHRL $4, DI
	ADDL $1, DI
	...
	CMPL CX, $48
	JAE  LBB10_45
	QUAD $0xfffdad15597de2c4; BYTE $0xff   // vpbroadcastq $-595(%rip), %ymm2  /* LCPI10_1(%rip) */
...
LBB10_45:
	ANDL $-4, DI
	NEGL DI
	QUAD $0xfffd9515597de2c4; BYTE $0xff // vpbroadcastq $-619(%rip), %ymm2  /* LCPI10_1(%rip) */
	QUAD $0xfffd9425597de2c4; BYTE $0xff // vpbroadcastq $-620(%rip), %ymm4  /* LCPI10_2(%rip) */
	LONG $0xda6ffdc5                     // vmovdqa      %ymm2, %ymm3
	LONG $0xca6ffdc5                     // vmovdqa      %ymm2, %ymm1
...
LBB10_47:
	...
	JE    LBB10_50
	NEGL  SI
	QUAD  $0xfffd2825597de2c4; BYTE $0xff // vpbroadcastq $-728(%rip), %ymm4  /* LCPI10_3(%rip) */
...
LBB11_40:
	LEAQ -32(BP), DI
	LEAQ -40(BP), SI
	LONG $0xfff980e8; BYTE $0xff // callq        _decimal_to_f64
...
_value:
	...
	LEAQ    -64(BP), DI
	LEAQ    -40(BP), SI
	LONG    $0x000536e8; BYTE $0x00               // callq        _advance_ns
	MOVBLSX AX, AX
	CMPL    AX, $125
	JA      LBB12_4
	LONG    $0x6f0d8d48; WORD $0x0002; BYTE $0x00 // leaq         $623(%rip), %rcx  /* LJTI12_0(%rip) */
...
LBB12_2:
	...
	LEAQ -40(BP), SI
	MOVQ R14, DX
	LONG $0x000b03e8; BYTE $0x00 // callq        _vnumber
	MOVQ -40(BP), BX
	JMP  LBB12_18
...
LBB12_5:
	...
	LEAQ  -48(BP), DX
	MOVQ  R15, SI
	LONG  $0x0007dee8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB12_25
	MOVQ  AX, -40(BP)
	MOVQ  R15, 16(R14)
...
LJTI12_0:
	LONG $0xfffffdb8 // .long L12_0_set_3
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	...
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffddc // .long L12_0_set_5
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	...
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffe2f // .long L12_0_set_7
	LONG $0xfffffd9a // .long L12_0_set_2
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffd9a // .long L12_0_set_2
	LONG $0xfffffd9a // .long L12_0_set_2
	...
	LONG $0xfffffd9a // .long L12_0_set_2
	LONG $0xfffffd9a // .long L12_0_set_2
	LONG $0xfffffe45 // .long L12_0_set_8
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	...
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffe5b // .long L12_0_set_9
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffee2 // .long L12_0_set_16
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	...
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xffffff09 // .long L12_0_set_19
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	...
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffe6b // .long L12_0_set_10
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffe9f // .long L12_0_set_12
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xffffff29 // .long L12_0_set_22
	LONG $0xfffffdc8 // .long L12_0_set_4
	LONG $0xfffffecf // .long L12_0_set_15
...
_advance_string:
	...
	MOVQ $-1, R8
	XORL R14, R14
	QUAD $0xffffff7a056ffec5        // vmovdqu      $-134(%rip), %ymm0  /* LCPI15_0(%rip) */
	QUAD $0xffffff920d6ffec5        // vmovdqu      $-110(%rip), %ymm1  /* LCPI15_1(%rip) */
...
LBB15_3:
	...
	LONG $0xe174edc5                           // vpcmpeqb     %ymm1, %ymm2, %ymm4
	LONG $0xc4d7fdc5                           // vpmovmskb    %ymm4, %eax
	LONG $0xd974e5c5                           // vpcmpeqb     %ymm1, %ymm3, %ymm3
...
LBB15_13:
	...
	QUAD  $0xfffffe820d74fdc5 // vpcmpeqb     $-382(%rip), %ymm0, %ymm1  /* LCPI15_0(%rip) */
	LONG  $0xf9d7fdc5         // vpmovmskb    %ymm1, %edi
	QUAD  $0xfffffe960574fdc5 // vpcmpeqb     $-362(%rip), %ymm0, %ymm0  /* LCPI15_1(%rip) */
...
LBB16_61:
	...
	QUAD  $0xfffffcae0562f9c5                   // vpunpckldq   $-850(%rip), %xmm0, %xmm0  /* LCPI16_0(%rip) */
	QUAD  $0xfffffcb6055cf9c5                   // vsubpd       $-842(%rip), %xmm0, %xmm0  /* LCPI16_1(%rip) */
	...
	JL    LBB16_72
	LEAL  -22(SI), AX
	LONG  $0x630d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $48995(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB16_69:
	...
	JB   LBB16_76
	NEGL SI
	LONG $0x1a058d48; WORD $0x00bf; BYTE $0x00 // leaq         $48922(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB16_71:
	LONG  $0x6ef9c1c4; BYTE $0xc4   // vmovq        %r12, %xmm0
	IMULQ CX, R12
	QUAD  $0xfffffbda0562f9c5       // vpunpckldq   $-1062(%rip), %xmm0, %xmm0  /* LCPI16_0(%rip) */
	QUAD  $0xfffffbe2055cf9c5       // vsubpd       $-1054(%rip), %xmm0, %xmm0  /* LCPI16_1(%rip) */
	MOVQ  R12, 16(R14)
	LONG  $0x0579e3c4; WORD $0x01c8 // vpermilpd    $1, %xmm0, %xmm1
	LONG  $0xc058f3c5               // vaddsd       %xmm0, %xmm1, %xmm0
	ANDQ  CX, AX
...
LBB16_73:
	QUAD $0xfffffbbf052ef9c5                   // vucomisd     $-1089(%rip), %xmm0  /* LCPI16_2(%rip) */
	JA   LBB16_76
	QUAD $0xfffffbbd0d10fbc5                   // vmovsd       $-1091(%rip), %xmm1  /* LCPI16_3(%rip) */
	LONG $0xc82ef9c5                           // vucomisd     %xmm0, %xmm1
	JA   LBB16_76
	MOVL AX, AX
	LONG $0xa60d8d48; WORD $0x00be; BYTE $0x00 // leaq         $48806(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB16_80
...
LBB16_76:
	...
	MOVL  R10, BX
	MOVQ  SI, -88(BP)
	LONG  $0xffe829e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
	MOVQ  -88(BP), SI
	CMPL  -44(BP), $0
	...
	LEAQ  -80(BP), CX
	MOVQ  R12, DI
	LONG  $0xffe809e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
...
LBB16_81:
	...
	MOVQ -104(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffee1ee8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB16_84
...
LBB16_86:
	LONG $0x117bc1c4; WORD $0x0846 // vmovsd       %xmm0, $8(%r14)
	MOVQ R13, 0(BX)
	JMP  LBB16_8
...
LBB20_4:
	...
	MOVQ    -56(BP), BX
	MOVQ    BX, SI
	LONG    $0xfff1bde8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R12), DX
	LEAQ    -1(DX), CX
	CMPQ    R14, $-1
	JNE     LBB20_6
...
LBB20_6:
	...
	CMPL    SI, $5
	JA      LBB20_11
	LONG    $0x7c3d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1148(%rip), %rdi  /* LJTI20_0(%rip) */
...
LBB20_17:
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff425e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_57
	MOVQ  R13, 0(BX)
...
LBB20_27:
	MOVQ    $-1, R13
	LONG    $0x710d8d48; WORD $0x0003; BYTE $0x00 // leaq         $881(%rip), %rcx  /* LJTI20_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB20_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000d91e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JS    LBB20_59
	MOVQ  0(BX), CX
	ADDQ  CX, AX
...
LBB20_34:
	...
	MOVQ  R13, DI
	MOVQ  BX, SI
	LONG  $0x0005a4e8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB20_38
	JMP   LBB20_63
...
LBB20_36:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff2cbe8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_57
	MOVQ  R13, 0(BX)
...
LBB20_41:
	...
	MOVQ  -48(BP), DI
	MOVQ  -56(BP), SI
	LONG  $0x000534e8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB20_40
	JMP   LBB20_63
...
LBB20_43:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000c77e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JS    LBB20_65
	ADDQ  AX, 0(BX)
	TESTQ R13, R13
...
// .set L20_0_set_19, LBB20_19-LJTI20_0
// .set L20_0_set_21, LBB20_21-LJTI20_0
// .set L20_0_set_23, LBB20_23-LJTI20_0
LJTI20_0:
	LONG $0xfffffb8d // .long L20_0_set_8
	LONG $0xfffffbc7 // .long L20_0_set_12
	LONG $0xfffffbf0 // .long L20_0_set_15
	LONG $0xfffffc2f // .long L20_0_set_19
	LONG $0xfffffc44 // .long L20_0_set_21
	LONG $0xfffffc5c // .long L20_0_set_23

	// .set L20_1_set_67, LBB20_67-LJTI20_1
	// .set L20_1_set_66, LBB20_66-LJTI20_1
	// .set L20_1_set_41, LBB20_41-LJTI20_1
	// .set L20_1_set_43, LBB20_43-LJTI20_1
	// .set L20_1_set_28, LBB20_28-LJTI20_1
	// .set L20_1_set_45, LBB20_45-LJTI20_1
	// .set L20_1_set_47, LBB20_47-LJTI20_1
	// .set L20_1_set_50, LBB20_50-LJTI20_1
	// .set L20_1_set_52, LBB20_52-LJTI20_1
	// .set L20_1_set_54, LBB20_54-LJTI20_1
LJTI20_1:
	LONG $0xffffff1d // .long L20_1_set_67
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	...
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xfffffd91 // .long L20_1_set_41
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	...
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xfffffdb6 // .long L20_1_set_43
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xfffffc98 // .long L20_1_set_28
	LONG $0xfffffc98 // .long L20_1_set_28
	LONG $0xfffffc98 // .long L20_1_set_28
	LONG $0xfffffc98 // .long L20_1_set_28
	LONG $0xfffffc98 // .long L20_1_set_28
	...
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xfffffded // .long L20_1_set_45
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	...
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xfffffe12 // .long L20_1_set_47
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	...
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xfffffe55 // .long L20_1_set_50
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xfffffe87 // .long L20_1_set_52
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xffffff16 // .long L20_1_set_66
	LONG $0xfffffeb9 // .long L20_1_set_54
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffedc6e8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB23_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	CMPQ R13, $64
	JB   LBB24_2
	QUAD $0xffffff56056ffec5 // vmovdqu      $-170(%rip), %ymm0  /* LCPI24_0(%rip) */
	QUAD $0xffffff6e0d6ffec5 // vmovdqu      $-146(%rip), %ymm1  /* LCPI24_1(%rip) */
	QUAD $0xffffff86156ffec5 // vmovdqu      $-122(%rip), %ymm2  /* LCPI24_2(%rip) */
	LONG $0xdb76e5c5         // vpcmpeqd     %ymm3, %ymm3, %ymm3
	MOVQ R15, DX

LBB24_4:
	LONG  $0x6f7ec1c4; WORD $0x1424             // vmovdqu      (%r12,%rdx), %ymm4
	LONG  $0x6f7ec1c4; WORD $0x146c; BYTE $0x20 // vmovdqu      $32(%r12,%rdx), %ymm5
...
LBB24_7:
	...
	LONG $0xf5d7fdc5 // vpmovmskb    %ymm5, %esi
	SHLQ $32, SI
	LONG $0xe874ddc5 // vpcmpeqb     %ymm0, %ymm4, %ymm5
...
LBB24_19:
	...
	QUAD  $0xfffffd940d74fdc5 // vpcmpeqb     $-620(%rip), %ymm0, %ymm1  /* LCPI24_0(%rip) */
	LONG  $0xd9d7fdc5         // vpmovmskb    %ymm1, %ebx
	QUAD  $0xfffffda80d74fdc5 // vpcmpeqb     $-600(%rip), %ymm0, %ymm1  /* LCPI24_1(%rip) */
	LONG  $0xc9d7fdc5         // vpmovmskb    %ymm1, %ecx
	QUAD  $0xfffffdbc0d6ffec5 // vmovdqu      $-580(%rip), %ymm1  /* LCPI24_2(%rip) */
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB25_34
	LONG  $0xa10d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $44961(%rip), %r9  /* _first(%rip) */
	LONG  $0x9a058d4c; WORD $0x00b0; BYTE $0x00 // leaq         $45210(%rip), %r8  /* _ranges(%rip) */
	LONG  $0x91158d4c; WORD $0x0001; BYTE $0x00 // leaq         $401(%rip), %r10  /* LJTI25_0(%rip) */
	MOVQ  DI, R14
...
LBB25_6:
	LONG  $0x6f7ec1c4; WORD $0x1e04 // vmovdqu      (%r14,%rbx), %ymm0
	LONG  $0xc8d7fdc5               // vpmovmskb    %ymm0, %ecx
	TESTL CX, CX
	JNE   LBB25_7
	ADDQ  $32, BX
...
LBB25_8:
	...
	SUBQ    R15, SI
	JLE     LBB25_34
	LEAQ    0(R14)(R15*1), R11
	MOVBLZX 0(R14)(R15*1), R14
...
// .set L25_0_set_29, LBB25_29-LJTI25_0
// .set L25_0_set_27, LBB25_27-LJTI25_0
// .set L25_0_set_25, LBB25_25-LJTI25_0
LJTI25_0:
	LONG $0xffffff92 // .long L25_0_set_33
	LONG $0xfffffff0 // .long L25_0_set_32
	LONG $0xffffff75 // .long L25_0_set_29
	LONG $0xffffff64 // .long L25_0_set_27
	LONG $0xffffff4f // .long L25_0_set_25
...
_skip_negative:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0x000173e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JS    LBB26_1
	ADDQ  AX, 0(R14)
	ADDQ  $-1, BX
...
LBB27_6:
	...
	JB   LBB27_7
	XORL AX, AX
	QUAD $0xfffffe45056ffec5 // vmovdqu      $-443(%rip), %ymm0  /* LCPI27_0(%rip) */
	QUAD $0xfffffe5d0d6ffec5 // vmovdqu      $-419(%rip), %ymm1  /* LCPI27_1(%rip) */
	QUAD $0xfffffe75156ffec5 // vmovdqu      $-395(%rip), %ymm2  /* LCPI27_2(%rip) */
	QUAD $0xfffffe8d1d6ffec5 // vmovdqu      $-371(%rip), %ymm3  /* LCPI27_3(%rip) */
	QUAD $0xfffffea5256ffec5 // vmovdqu      $-347(%rip), %ymm4  /* LCPI27_4(%rip) */
	QUAD $0xfffffebd2d6ffec5 // vmovdqu      $-323(%rip), %ymm5  /* LCPI27_5(%rip) */
	QUAD $0xfffffed5356ffec5 // vmovdqu      $-299(%rip), %ymm6  /* LCPI27_6(%rip) */
	MOVQ $-1, R8
	MOVQ $-1, R9
...
LBB27_29:
	...
	SUBQ DI, R11
	XORL AX, AX
	QUAD $0xfffffdcc056f7ac5 // vmovdqu      $-564(%rip), %xmm8  /* LCPI27_7(%rip) */
	QUAD $0xfffffdd40d6f7ac5 // vmovdqu      $-556(%rip), %xmm9  /* LCPI27_8(%rip) */
	QUAD $0xfffffddc156f7ac5 // vmovdqu      $-548(%rip), %xmm10  /* LCPI27_9(%rip) */
	QUAD $0xfffffde41d6f7ac5 // vmovdqu      $-540(%rip), %xmm11  /* LCPI27_10(%rip) */
	QUAD $0xfffffdec256ffac5 // vmovdqu      $-532(%rip), %xmm4  /* LCPI27_11(%rip) */
	QUAD $0xfffffdf42d6ffac5 // vmovdqu      $-524(%rip), %xmm5  /* LCPI27_12(%rip) */
	QUAD $0xfffffdfc356ffac5 // vmovdqu      $-516(%rip), %xmm6  /* LCPI27_13(%rip) */
	MOVL $4294967295, R14

LBB27_30:
	LONG $0x6f7ac1c4; WORD $0x073c // vmovdqu      (%r15,%rax), %xmm7
...
LBB27_49:
	...
	SUBQ  DI, BX
	XORL  AX, AX
	LONG  $0x9a358d4c; WORD $0x0001; BYTE $0x00 // leaq         $410(%rip), %r14  /* LJTI27_0(%rip) */
	JMP   LBB27_51
...
LBB27_79:
	...
	TESTQ AX, AX
	NOTQ  R8
	LONG  $0xc7480f4d // cmovsq       %r15, %r8
	CMPQ  R9, CX
	LONG  $0xc7450f4d // cmovneq      %r15, %r8
	MOVQ  R8, AX
	JMP   LBB27_80
...
// .set L27_0_set_65, LBB27_65-LJTI27_0
// .set L27_0_set_57, LBB27_57-LJTI27_0
// .set L27_0_set_54, LBB27_54-LJTI27_0
LJTI27_0:
	LONG $0xfffffeaa // .long L27_0_set_61
	LONG $0xffffff07 // .long L27_0_set_65
	LONG $0xfffffeaa // .long L27_0_set_61
	LONG $0xfffffeba // .long L27_0_set_57
	LONG $0xffffff07 // .long L27_0_set_65
	LONG $0xffffff07 // .long L27_0_set_65
	LONG $0xffffff07 // .long L27_0_set_65
	LONG $0xffffff07 // .long L27_0_set_65
	...
	LONG $0xffffff07 // .long L27_0_set_65
	LONG $0xffffff07 // .long L27_0_set_65
	LONG $0xfffffe71 // .long L27_0_set_54
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffac7e8; BYTE $0xff // callq        _skip_number
	TESTQ AX, AX
	JS    LBB28_1
	MOVQ  0(R14), CX
	ADDQ  AX, CX
...
_print_mantissa:
	...
	SUBL    DI, AX
	MOVWLZX AX, R11
	LONG    $0x713d8d48; WORD $0x0059; BYTE $0x00 // leaq         $22897(%rip), %rdi  /* _Digits(%rip) */
...
LBB31_2:
	...
	JB   LBB31_3
	MOVL $3518437209, R8
	LONG $0x290d8d4c; WORD $0x0059; BYTE $0x00 // leaq         $22825(%rip), %r9  /* _Digits(%rip) */
...
LBB31_7:
	...
	SUBL    DX, AX
	MOVWLZX AX, AX
	LONG    $0xc2158d48; WORD $0x0058; BYTE $0x00 // leaq         $22722(%rip), %rdx  /* _Digits(%rip) */
...
LBB31_8:
	...
	JB      LBB31_10
	MOVL    AX, AX
	LONG    $0xa50d8d48; WORD $0x0058; BYTE $0x00 // leaq         $22693(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, -2(R14)
	BYTE    $0x5b                                 // popq         %rbx
	WORD    $0x5e41                               // popq         %r14
...
_left_shift:
	...
	MOVL    SI, CX
	IMUL3Q  $104, CX, R11
	LONG    $0xc3158d48; WORD $0x008a; BYTE $0x00 // leaq         $35523(%rip), %rdx  /* _LSHIFT_TAB(%rip) */
	MOVL    0(R11)(DX*1), R8
	MOVQ    0(DI), R10
	MOVLQSX 16(DI), R9
	TESTQ   R9, R9
...
_f64toa:
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·__native_entry__+825(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+10636(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_i64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3908(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+6308(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21298(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21335(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+19455(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+4003(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+8141(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+24818(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+14553(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+17469(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18899(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16562(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+19179(SB), AX // _vunsigned
	JMP  AX
