...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0x5e0d8d48; WORD $0x008e; BYTE $0x00 // leaq         $36446(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0x880d8d4c; WORD $0x00a2; BYTE $0x00 // leaq         $41608(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R9*1), R15
	MOVQ    R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x0057b9e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0x67058d48; WORD $0x00b1; BYTE $0x00 // leaq         $45415(%rip), %rax  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x0056b5e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_77
	LEAL  0(BX)(R13*1), AX
	CMPL  R13, R15
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x005350e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x670d8d48; WORD $0x00ac; BYTE $0x00 // leaq         $44135(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x46358d48; WORD $0x00ac; BYTE $0x00 // leaq         $44102(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x34158d48; WORD $0x00ac; BYTE $0x00 // leaq         $44084(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x1b158d48; WORD $0x00ac; BYTE $0x00 // leaq         $44059(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0x83058d48; WORD $0x00ab; BYTE $0x00 // leaq         $43907(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x5e358d48; WORD $0x00ab; BYTE $0x00 // leaq         $43870(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0x4c058d48; WORD $0x00ab; BYTE $0x00 // leaq         $43852(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x31358d48; WORD $0x00ab; BYTE $0x00 // leaq         $43825(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0xa7158d48; WORD $0x00aa; BYTE $0x00 // leaq         $43687(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0x8a0d8d48; WORD $0x00a9; BYTE $0x00 // leaq         $43402(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x390d8d48; WORD $0x00a9; BYTE $0x00 // leaq         $43321(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x16058d4c; WORD $0x00a9; BYTE $0x00 // leaq         $43286(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
_quote:
	...
	MOVQ  0(CX), R10
	TESTB $1, R8
	LONG  $0xb0058d48; WORD $0x00a8; BYTE $0x00 // leaq         $43184(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0xa9058d4c; WORD $0x00b8; BYTE $0x00 // leaq         $47273(%rip), %r8  /* __DoubleQuoteTab(%rip) */
...
LBB5_13:
	LONG  $0x6f7ec1c4; WORD $0x3104 // vmovdqu      (%r9,%rsi), %ymm0
	...
	LONG  $0x7f7ec1c4; WORD $0x3404 // vmovdqu      %ymm0, (%r12,%rsi)
...
LBB5_69:
	...
	JL    LBB5_70
	CMPQ  R15, $16
	QUAD  $0xfffffe103d6ffac5     // vmovdqu      $-496(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD  $0xfffffe180d6f7ac5     // vmovdqu      $-488(%rip), %xmm9  /* LCPI5_4(%rip) */
	QUAD  $0xfffffe20156f7ac5     // vmovdqu      $-480(%rip), %xmm10  /* LCPI5_5(%rip) */
	LONG  $0x762141c4; BYTE $0xdb // vpcmpeqd     %xmm11, %xmm11, %xmm11
	JL    LBB5_72
	MOVQ  R9, CX
	SUBQ  R13, CX
	QUAD  $0xfffffd87256ffec5     // vmovdqu      $-633(%rip), %ymm4  /* LCPI5_0(%rip) */
	QUAD  $0xfffffd9f2d6ffec5     // vmovdqu      $-609(%rip), %ymm5  /* LCPI5_1(%rip) */
	QUAD  $0xfffffdb7356ffec5     // vmovdqu      $-585(%rip), %ymm6  /* LCPI5_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
...
LBB5_70:
	MOVQ BX, R14
	MOVQ R15, R11
	QUAD $0xfffffc50256ffec5     // vmovdqu      $-944(%rip), %ymm4  /* LCPI5_0(%rip) */
	QUAD $0xfffffc682d6ffec5     // vmovdqu      $-920(%rip), %ymm5  /* LCPI5_1(%rip) */
	QUAD $0xfffffc80356ffec5     // vmovdqu      $-896(%rip), %ymm6  /* LCPI5_2(%rip) */
	LONG $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD $0xfffffc933d6ffac5     // vmovdqu      $-877(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD $0xfffffc9b0d6f7ac5     // vmovdqu      $-869(%rip), %xmm9  /* LCPI5_4(%rip) */
	QUAD $0xfffffca3156f7ac5     // vmovdqu      $-861(%rip), %xmm10  /* LCPI5_5(%rip) */
	LONG $0x762141c4; BYTE $0xdb // vpcmpeqd     %xmm11, %xmm11, %xmm11
...
LBB5_72:
	MOVQ  BX, R14
	MOVQ  R15, R11
	QUAD  $0xfffffb9f256ffec5     // vmovdqu      $-1121(%rip), %ymm4  /* LCPI5_0(%rip) */
	QUAD  $0xfffffbb72d6ffec5     // vmovdqu      $-1097(%rip), %ymm5  /* LCPI5_1(%rip) */
	QUAD  $0xfffffbcf356ffec5     // vmovdqu      $-1073(%rip), %ymm6  /* LCPI5_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	TESTB DX, DX
	JNE   LBB5_85
...
LBB5_79:
	TESTQ R14, R14
	LONG  $0xdd3d8d4c; WORD $0x00a4; BYTE $0x00 // leaq         $42205(%rip), %r15  /* __SingleQuoteTab(%rip) */
	JLE   LBB5_109
	TESTQ R11, R11
	JLE   LBB5_109
	XORL  CX, CX
...
LBB5_1:
	LONG $0xed0d8d4c; WORD $0x00c1; BYTE $0x00 // leaq         $49645(%rip), %r9  /* __EscTab(%rip) */
	QUAD $0xfffff880156f7ec5                   // vmovdqu      $-1920(%rip), %ymm10  /* LCPI5_0(%rip) */
	QUAD $0xfffff8980d6f7ec5                   // vmovdqu      $-1896(%rip), %ymm9  /* LCPI5_1(%rip) */
	QUAD $0xfffff8b01d6f7ec5                   // vmovdqu      $-1872(%rip), %ymm11  /* LCPI5_2(%rip) */
	LONG $0x763d41c4; BYTE $0xc0               // vpcmpeqd     %ymm8, %ymm8, %ymm8
	MOVQ DX, BX
	MOVQ R14, R10
...
LBB5_5:
	...
	WORD  $0xf8c5; BYTE $0x77     // vzeroupper
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD  $0xfffff83a1d6f7ec5     // vmovdqu      $-1990(%rip), %ymm11  /* LCPI5_2(%rip) */
	QUAD  $0xfffff8120d6f7ec5     // vmovdqu      $-2030(%rip), %ymm9  /* LCPI5_1(%rip) */
	QUAD  $0xfffff7ea156f7ec5     // vmovdqu      $-2070(%rip), %ymm10  /* LCPI5_0(%rip) */
	ADDQ  AX, DI
	SUBQ  AX, R10
	ADDQ  AX, BX
	CMPQ  CX, $48
	QUAD  $0xfffff8353d6ffac5     // vmovdqu      $-1995(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD  $0xfffff83d2d6ffac5     // vmovdqu      $-1987(%rip), %xmm5  /* LCPI5_4(%rip) */
	QUAD  $0xfffff845256ffac5     // vmovdqu      $-1979(%rip), %xmm4  /* LCPI5_5(%rip) */
...
LBB5_15:
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD $0xfffff6da1d6f7ec5     // vmovdqu      $-2342(%rip), %ymm11  /* LCPI5_2(%rip) */
	QUAD $0xfffff6b20d6f7ec5     // vmovdqu      $-2382(%rip), %ymm9  /* LCPI5_1(%rip) */
	QUAD $0xfffff68a156f7ec5     // vmovdqu      $-2422(%rip), %ymm10  /* LCPI5_0(%rip) */
	QUAD $0xfffff6e23d6ffac5     // vmovdqu      $-2334(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD $0xfffff6ea2d6ffac5     // vmovdqu      $-2326(%rip), %xmm5  /* LCPI5_4(%rip) */
	QUAD $0xfffff6f2256ffac5     // vmovdqu      $-2318(%rip), %xmm4  /* LCPI5_5(%rip) */
	LONG $0xf676c9c5             // vpcmpeqd     %xmm6, %xmm6, %xmm6
...
LBB6_38:
	ADDQ    R14, R8
	MOVBLZX -1(R9), AX
	LONG    $0x7c0d8d48; WORD $0x00bc; BYTE $0x00 // leaq         $48252(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB    0(AX)(CX*1), CX
	CMPB    CX, $-1
	JE      LBB6_41
	TESTB   CX, CX
...
_html_escape:
	...
	LONG  $0x4b3d8d4c; WORD $0x00b6; BYTE $0x00 // leaq         $46667(%rip), %r15  /* __HtmlQuoteTab(%rip) */
	MOVQ  -48(BP), R11
	MOVQ  -56(BP), R8
...
LBB7_38:
	...
	JL    LBB7_39
	CMPQ  R10, $16
	QUAD  $0xfffffe343d6ffac5 // vmovdqu      $-460(%rip), %xmm7  /* LCPI7_4(%rip) */
	QUAD  $0xfffffe3c056f7ac5 // vmovdqu      $-452(%rip), %xmm8  /* LCPI7_5(%rip) */
	QUAD  $0xfffffe440d6f7ac5 // vmovdqu      $-444(%rip), %xmm9  /* LCPI7_6(%rip) */
	QUAD  $0xfffffe4c156f7ac5 // vmovdqu      $-436(%rip), %xmm10  /* LCPI7_7(%rip) */
	JL    LBB7_41
	MOVQ  R11, DI
	SUBQ  R12, DI
	QUAD  $0xfffffd881d6ffec5 // vmovdqu      $-632(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD  $0xfffffda0256ffec5 // vmovdqu      $-608(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD  $0xfffffdb82d6ffec5 // vmovdqu      $-584(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD  $0xfffffdd0356ffec5 // vmovdqu      $-560(%rip), %ymm6  /* LCPI7_3(%rip) */
...
LBB7_39:
	MOVQ AX, R13
	MOVQ R10, R14
	QUAD $0xfffffc511d6ffec5 // vmovdqu      $-943(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD $0xfffffc69256ffec5 // vmovdqu      $-919(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD $0xfffffc812d6ffec5 // vmovdqu      $-895(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD $0xfffffc99356ffec5 // vmovdqu      $-871(%rip), %ymm6  /* LCPI7_3(%rip) */
	QUAD $0xfffffcb13d6ffac5 // vmovdqu      $-847(%rip), %xmm7  /* LCPI7_4(%rip) */
	QUAD $0xfffffcb9056f7ac5 // vmovdqu      $-839(%rip), %xmm8  /* LCPI7_5(%rip) */
	QUAD $0xfffffcc10d6f7ac5 // vmovdqu      $-831(%rip), %xmm9  /* LCPI7_6(%rip) */
	QUAD $0xfffffcc9156f7ac5 // vmovdqu      $-823(%rip), %xmm10  /* LCPI7_7(%rip) */
...
LBB7_41:
	MOVQ  AX, R13
	MOVQ  R10, R14
	QUAD  $0xfffffba21d6ffec5 // vmovdqu      $-1118(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD  $0xfffffbba256ffec5 // vmovdqu      $-1094(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD  $0xfffffbd22d6ffec5 // vmovdqu      $-1070(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD  $0xfffffbea356ffec5 // vmovdqu      $-1046(%rip), %ymm6  /* LCPI7_3(%rip) */
	TESTB CX, CX
	JNE   LBB7_58
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x4f3d8d4c; WORD $0x0036; BYTE $0x00 // leaq         $13903(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0x43358d4c; WORD $0x0060; BYTE $0x00 // leaq         $24643(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x003330e8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0x05358d4c; WORD $0x0060; BYTE $0x00 // leaq         $24581(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x003163e8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x003292e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x0030a1e8; BYTE $0x00 // callq        _left_shift
...
LBB9_41:
	...
	JB   LBB9_52
	MOVL DX, R8
	QUAD $0xfffffdc0056ffac5               // vmovdqu      $-576(%rip), %xmm0  /* LCPI9_0(%rip) */
	LONG $0x22f9c3c4; WORD $0x00c4         // vpinsrq      $0, %r12, %xmm0, %xmm0
	ANDL $-16, R8
	QUAD $0xfffdac05027de3c4; WORD $0xf0ff // vpblendd     $240, $-596(%rip), %ymm0, %ymm0  /* LCPI9_0(%rip) */
	LEAL -16(R8), CX
	MOVL CX, DI
	SHRL $4, DI
	ADDL $1, DI
	...
	CMPL CX, $48
	JAE  LBB9_45
	QUAD $0xfffdad15597de2c4; BYTE $0xff   // vpbroadcastq $-595(%rip), %ymm2  /* LCPI9_1(%rip) */
...
LBB9_45:
	ANDL $-4, DI
	NEGL DI
	QUAD $0xfffd9515597de2c4; BYTE $0xff // vpbroadcastq $-619(%rip), %ymm2  /* LCPI9_1(%rip) */
	QUAD $0xfffd9425597de2c4; BYTE $0xff // vpbroadcastq $-620(%rip), %ymm4  /* LCPI9_2(%rip) */
	LONG $0xda6ffdc5                     // vmovdqa      %ymm2, %ymm3
	LONG $0xca6ffdc5                     // vmovdqa      %ymm2, %ymm1
...
LBB9_47:
	...
	JE    LBB9_50
	NEGL  SI
	QUAD  $0xfffd2825597de2c4; BYTE $0xff // vpbroadcastq $-728(%rip), %ymm4  /* LCPI9_3(%rip) */
...
_value:
	...
	LEAQ    -80(BP), DI
	LEAQ    -48(BP), SI
	LONG    $0x0005e4e8; BYTE $0x00               // callq        _advance_ns
	MOVBLSX AX, AX
	CMPL    AX, $125
	JA      LBB11_11
	LONG    $0x190d8d48; WORD $0x0003; BYTE $0x00 // leaq         $793(%rip), %rcx  /* LJTI11_0(%rip) */
...
LBB11_2:
	...
	LEAQ  -48(BP), SI
	MOVQ  -56(BP), DX
	LONG  $0x000b9be8; BYTE $0x00 // callq        _vnumber
	MOVQ  -48(BP), BX
	JMP   LBB11_50
...
LBB11_7:
	MOVQ  R12, DI
	MOVQ  BX, SI
	LONG  $0x0020ade8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB11_46
	ADDQ  AX, R12
	MOVQ  R12, BX
...
LBB11_12:
	...
	LEAQ  -64(BP), DX
	MOVQ  R15, SI
	LONG  $0x00080be8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB11_31
	MOVQ  AX, -48(BP)
	MOVQ  R15, 16(R14)
...
LJTI11_0:
	LONG $0xfffffd8b // .long L11_0_set_10
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	...
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffdaf // .long L11_0_set_12
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	...
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffe02 // .long L11_0_set_14
	LONG $0xfffffcf0 // .long L11_0_set_2
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffcf0 // .long L11_0_set_2
	LONG $0xfffffcf0 // .long L11_0_set_2
	...
	LONG $0xfffffcf0 // .long L11_0_set_2
	LONG $0xfffffcf0 // .long L11_0_set_2
	LONG $0xfffffe16 // .long L11_0_set_15
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	...
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffe2a // .long L11_0_set_16
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffe3a // .long L11_0_set_17
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	...
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffe4e // .long L11_0_set_18
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	...
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffe7d // .long L11_0_set_21
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffead // .long L11_0_set_23
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffecd // .long L11_0_set_26
	LONG $0xfffffd9b // .long L11_0_set_11
	LONG $0xfffffedd // .long L11_0_set_27
...
_advance_string:
	...
	MOVQ $-1, R8
	XORL R14, R14
	QUAD $0xffffff7a056ffec5        // vmovdqu      $-134(%rip), %ymm0  /* LCPI14_0(%rip) */
	QUAD $0xffffff920d6ffec5        // vmovdqu      $-110(%rip), %ymm1  /* LCPI14_1(%rip) */
...
LBB14_13:
	...
	QUAD  $0xfffffe820d74fdc5 // vpcmpeqb     $-382(%rip), %ymm0, %ymm1  /* LCPI14_0(%rip) */
	LONG  $0xf9d7fdc5         // vpmovmskb    %ymm1, %edi
	QUAD  $0xfffffe960574fdc5 // vpcmpeqb     $-362(%rip), %ymm0, %ymm0  /* LCPI14_1(%rip) */
	LONG  $0xc0d7fdc5         // vpmovmskb    %ymm0, %eax
	TESTL AX, AX
	JNE   LBB14_19
	TESTQ R14, R14
...
LBB15_61:
	...
	QUAD  $0xfffffcae0562f9c5                   // vpunpckldq   $-850(%rip), %xmm0, %xmm0  /* LCPI15_0(%rip) */
	QUAD  $0xfffffcb6055cf9c5                   // vsubpd       $-842(%rip), %xmm0, %xmm0  /* LCPI15_1(%rip) */
	...
	JL    LBB15_72
	LEAL  -22(SI), AX
	LONG  $0x930d8d48; WORD $0x00c0; BYTE $0x00 // leaq         $49299(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB15_69:
	...
	JB   LBB15_76
	NEGL SI
	LONG $0x4a058d48; WORD $0x00c0; BYTE $0x00 // leaq         $49226(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB15_71:
	LONG  $0x6ef9c1c4; BYTE $0xc4   // vmovq        %r12, %xmm0
	IMULQ CX, R12
	QUAD  $0xfffffbda0562f9c5       // vpunpckldq   $-1062(%rip), %xmm0, %xmm0  /* LCPI15_0(%rip) */
	QUAD  $0xfffffbe2055cf9c5       // vsubpd       $-1054(%rip), %xmm0, %xmm0  /* LCPI15_1(%rip) */
	MOVQ  R12, 16(R14)
	LONG  $0x0579e3c4; WORD $0x01c8 // vpermilpd    $1, %xmm0, %xmm1
	LONG  $0xc058f3c5               // vaddsd       %xmm0, %xmm1, %xmm0
	ANDQ  CX, AX
...
LBB15_73:
	QUAD $0xfffffbbf052ef9c5                   // vucomisd     $-1089(%rip), %xmm0  /* LCPI15_2(%rip) */
	JA   LBB15_76
	QUAD $0xfffffbbd0d10fbc5                   // vmovsd       $-1091(%rip), %xmm1  /* LCPI15_3(%rip) */
	LONG $0xc82ef9c5                           // vucomisd     %xmm0, %xmm1
	JA   LBB15_76
	MOVL AX, AX
	LONG $0xd60d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $49110(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB15_80
...
LBB15_76:
	...
	MOVL  R10, BX
	MOVQ  SI, -88(BP)
	LONG  $0xffe779e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_81
	MOVQ  -88(BP), SI
	CMPL  -44(BP), $0
	...
	LEAQ  -80(BP), CX
	MOVQ  R12, DI
	LONG  $0xffe759e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_81
...
LBB15_81:
	...
	MOVQ -104(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffed6ee8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB15_84
...
LBB19_6:
	...
	CMPL    SI, $5
	JA      LBB19_11
	LONG    $0x7c3d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1148(%rip), %rdi  /* LJTI19_0(%rip) */
...
LBB19_27:
	MOVQ    $-1, R13
	LONG    $0x710d8d48; WORD $0x0003; BYTE $0x00 // leaq         $881(%rip), %rcx  /* LJTI19_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB19_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000b95e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB19_59
	MOVQ  0(BX), CX
	ADDQ  CX, AX
...
LBB19_43:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000a7be8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB19_65
	ADDQ  AX, 0(BX)
	TESTQ R13, R13
...
// .set L19_0_set_19, LBB19_19-LJTI19_0
// .set L19_0_set_21, LBB19_21-LJTI19_0
// .set L19_0_set_23, LBB19_23-LJTI19_0
LJTI19_0:
	LONG $0xfffffb8d // .long L19_0_set_8
	LONG $0xfffffbc7 // .long L19_0_set_12
	LONG $0xfffffbf0 // .long L19_0_set_15
	LONG $0xfffffc2f // .long L19_0_set_19
	LONG $0xfffffc44 // .long L19_0_set_21
	LONG $0xfffffc5c // .long L19_0_set_23
...
LJTI19_1:
	LONG $0xffffff1d // .long L19_1_set_67
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	...
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xfffffd91 // .long L19_1_set_41
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	...
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xfffffdb6 // .long L19_1_set_43
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xfffffc98 // .long L19_1_set_28
	LONG $0xfffffc98 // .long L19_1_set_28
	LONG $0xfffffc98 // .long L19_1_set_28
	LONG $0xfffffc98 // .long L19_1_set_28
	LONG $0xfffffc98 // .long L19_1_set_28
	...
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xfffffded // .long L19_1_set_45
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	...
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xfffffe12 // .long L19_1_set_47
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	...
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xfffffe55 // .long L19_1_set_50
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xfffffe87 // .long L19_1_set_52
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xffffff16 // .long L19_1_set_66
	LONG $0xfffffeb9 // .long L19_1_set_54
...
_validate_string:
	...
	MOVQ $-1, R10
	XORL R15, R15
	QUAD $0xffffff5d056ffec5        // vmovdqu      $-163(%rip), %ymm0  /* LCPI23_0(%rip) */
	QUAD $0xffffff750d6ffec5        // vmovdqu      $-139(%rip), %ymm1  /* LCPI23_1(%rip) */
	QUAD $0xffffff8d156ffec5        // vmovdqu      $-115(%rip), %ymm2  /* LCPI23_2(%rip) */
	LONG $0xdb76e5c5                // vpcmpeqd     %ymm3, %ymm3, %ymm3
	MOVQ $-6148914691236517206, R11
	MOVQ $6148914691236517205, R14
	MOVQ R9, DI

LBB23_4:
	LONG  $0x6f7ec1c4; WORD $0x3c24             // vmovdqu      (%r12,%rdi), %ymm4
	LONG  $0x6f7ec1c4; WORD $0x3c6c; BYTE $0x20 // vmovdqu      $32(%r12,%rdi), %ymm5
	LONG  $0xf074d5c5                           // vpcmpeqb     %ymm0, %ymm5, %ymm6
	LONG  $0xded7fdc5                           // vpmovmskb    %ymm6, %ebx
	LONG  $0xf174ddc5                           // vpcmpeqb     %ymm1, %ymm4, %ymm6
	LONG  $0xd6d7fdc5                           // vpmovmskb    %ymm6, %edx
...
LBB23_20:
	LONG  $0x076ffec5         // vmovdqu      (%rdi), %ymm0
	QUAD  $0xfffffdc40d74fdc5 // vpcmpeqb     $-572(%rip), %ymm0, %ymm1  /* LCPI23_0(%rip) */
	LONG  $0xd9d7fdc5         // vpmovmskb    %ymm1, %ebx
	QUAD  $0xfffffdd80d74fdc5 // vpcmpeqb     $-552(%rip), %ymm0, %ymm1  /* LCPI23_1(%rip) */
	LONG  $0xc9d7fdc5         // vpmovmskb    %ymm1, %ecx
	QUAD  $0xfffffdec0d6ffec5 // vmovdqu      $-532(%rip), %ymm1  /* LCPI23_2(%rip) */
	LONG  $0xc864f5c5         // vpcmpgtb     %ymm0, %ymm1, %ymm1
	LONG  $0xd276edc5         // vpcmpeqd     %ymm2, %ymm2, %ymm2
	LONG  $0xc264fdc5         // vpcmpgtb     %ymm2, %ymm0, %ymm0
	LONG  $0xc0dbf5c5         // vpand        %ymm0, %ymm1, %ymm0
	LONG  $0xd8d77dc5         // vpmovmskb    %ymm0, %r11d
	TESTL CX, CX
	JNE   LBB23_21
	TESTQ R15, R15
	JNE   LBB23_23
...
LBB25_6:
	...
	JB   LBB25_7
	XORL AX, AX
	QUAD $0xfffffe45056ffec5 // vmovdqu      $-443(%rip), %ymm0  /* LCPI25_0(%rip) */
	QUAD $0xfffffe5d0d6ffec5 // vmovdqu      $-419(%rip), %ymm1  /* LCPI25_1(%rip) */
	QUAD $0xfffffe75156ffec5 // vmovdqu      $-395(%rip), %ymm2  /* LCPI25_2(%rip) */
	QUAD $0xfffffe8d1d6ffec5 // vmovdqu      $-371(%rip), %ymm3  /* LCPI25_3(%rip) */
	QUAD $0xfffffea5256ffec5 // vmovdqu      $-347(%rip), %ymm4  /* LCPI25_4(%rip) */
	QUAD $0xfffffebd2d6ffec5 // vmovdqu      $-323(%rip), %ymm5  /* LCPI25_5(%rip) */
	QUAD $0xfffffed5356ffec5 // vmovdqu      $-299(%rip), %ymm6  /* LCPI25_6(%rip) */
	MOVQ $-1, R8
	MOVQ $-1, R9
...
LBB25_29:
	...
	SUBQ DI, R11
	XORL AX, AX
	QUAD $0xfffffdcc056f7ac5 // vmovdqu      $-564(%rip), %xmm8  /* LCPI25_7(%rip) */
	QUAD $0xfffffdd40d6f7ac5 // vmovdqu      $-556(%rip), %xmm9  /* LCPI25_8(%rip) */
	QUAD $0xfffffddc156f7ac5 // vmovdqu      $-548(%rip), %xmm10  /* LCPI25_9(%rip) */
	QUAD $0xfffffde41d6f7ac5 // vmovdqu      $-540(%rip), %xmm11  /* LCPI25_10(%rip) */
	QUAD $0xfffffdec256ffac5 // vmovdqu      $-532(%rip), %xmm4  /* LCPI25_11(%rip) */
	QUAD $0xfffffdf42d6ffac5 // vmovdqu      $-524(%rip), %xmm5  /* LCPI25_12(%rip) */
	QUAD $0xfffffdfc356ffac5 // vmovdqu      $-516(%rip), %xmm6  /* LCPI25_13(%rip) */
	MOVL $4294967295, R14
...
LBB25_49:
	...
	SUBQ  DI, BX
	XORL  AX, AX
	LONG  $0x9a358d4c; WORD $0x0001; BYTE $0x00 // leaq         $410(%rip), %r14  /* LJTI25_0(%rip) */
	JMP   LBB25_51
...
// .set L25_0_set_65, LBB25_65-LJTI25_0
// .set L25_0_set_57, LBB25_57-LJTI25_0
// .set L25_0_set_54, LBB25_54-LJTI25_0
LJTI25_0:
	LONG $0xfffffeaa // .long L25_0_set_61
	LONG $0xffffff07 // .long L25_0_set_65
	LONG $0xfffffeaa // .long L25_0_set_61
	LONG $0xfffffeba // .long L25_0_set_57
	LONG $0xffffff07 // .long L25_0_set_65
	LONG $0xffffff07 // .long L25_0_set_65
	LONG $0xffffff07 // .long L25_0_set_65
	LONG $0xffffff07 // .long L25_0_set_65
	...
	LONG $0xffffff07 // .long L25_0_set_65
	LONG $0xffffff07 // .long L25_0_set_65
	LONG $0xfffffe71 // .long L25_0_set_54
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffac7e8; BYTE $0xff // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB26_1
	MOVQ  0(R14), CX
	ADDQ  AX, CX
...
LBB27_3:
	MOVQ  BX, DI
	LONG  $0xfffa57e8; BYTE $0xff // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB27_7
	ADDQ  AX, BX
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB30_34
	LONG  $0x950d8d4c; WORD $0x00a8; BYTE $0x00 // leaq         $43157(%rip), %r9  /* _first(%rip) */
	LONG  $0x8e058d4c; WORD $0x00a9; BYTE $0x00 // leaq         $43406(%rip), %r8  /* _ranges(%rip) */
	LONG  $0x91158d4c; WORD $0x0001; BYTE $0x00 // leaq         $401(%rip), %r10  /* LJTI30_0(%rip) */
	MOVQ  DI, R14
...
// .set L30_0_set_33, LBB30_33-LJTI30_0
// .set L30_0_set_32, LBB30_32-LJTI30_0
// .set L30_0_set_29, LBB30_29-LJTI30_0
// .set L30_0_set_27, LBB30_27-LJTI30_0
// .set L30_0_set_25, LBB30_25-LJTI30_0
LJTI30_0:
	LONG $0xffffff92 // .long L30_0_set_33
	LONG $0xfffffff0 // .long L30_0_set_32
	LONG $0xffffff75 // .long L30_0_set_29
	LONG $0xffffff64 // .long L30_0_set_27
	LONG $0xffffff4f // .long L30_0_set_25
...
_print_mantissa:
	...
	SUBL    DI, AX
	MOVWLZX AX, R11
	LONG    $0x663d8d48; WORD $0x0059; BYTE $0x00 // leaq         $22886(%rip), %rdi  /* _Digits(%rip) */
...
LBB31_2:
	...
	JB   LBB31_3
	MOVL $3518437209, R8
	LONG $0x1e0d8d4c; WORD $0x0059; BYTE $0x00 // leaq         $22814(%rip), %r9  /* _Digits(%rip) */
...
LBB31_7:
	...
	SUBL    DX, AX
	MOVWLZX AX, AX
	LONG    $0xb7158d48; WORD $0x0058; BYTE $0x00 // leaq         $22711(%rip), %rdx  /* _Digits(%rip) */
...
LBB31_8:
	...
	JB      LBB31_10
	MOVL    AX, AX
	LONG    $0x9a0d8d48; WORD $0x0058; BYTE $0x00 // leaq         $22682(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, -2(R14)
	BYTE    $0x5b                                 // popq         %rbx
	WORD    $0x5e41                               // popq         %r14
...
_left_shift:
	...
	MOVL    SI, CX
	IMUL3Q  $104, CX, R11
	LONG    $0xbe158d48; WORD $0x008b; BYTE $0x00 // leaq         $35774(%rip), %rdx  /* _LSHIFT_TAB(%rip) */
	MOVL    0(R11)(DX*1), R8
	MOVQ    0(DI), R10
	MOVLQSX 16(DI), R9
	TESTQ   R9, R9
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+10493(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21311(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+24323(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21348(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+19468(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+7998(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+24440(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+14390(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+17482(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18912(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16575(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+19192(SB), AX // _vunsigned
	JMP  AX
