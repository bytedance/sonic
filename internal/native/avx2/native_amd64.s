...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0x830d8d48; WORD $0x008a; BYTE $0x00 // leaq         $35459(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0xad0d8d4c; WORD $0x009e; BYTE $0x00 // leaq         $40621(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R9*1), R15
	MOVQ    R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x0053eae8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0x8c058d48; WORD $0x00ad; BYTE $0x00 // leaq         $44428(%rip), %rax  /* _Digits(%rip) */
...
LBB2_69:
	...
	JL      LBB2_84
	MOVLQSX R14, AX
	LONG    $0x210d8d48; WORD $0x00ad; BYTE $0x00 // leaq         $44321(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x0052e6e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_77
	LEAL  0(BX)(R13*1), AX
	CMPL  R13, R15
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x004f81e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x8c0d8d48; WORD $0x00a8; BYTE $0x00 // leaq         $43148(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x6b358d48; WORD $0x00a8; BYTE $0x00 // leaq         $43115(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x59158d48; WORD $0x00a8; BYTE $0x00 // leaq         $43097(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x40158d48; WORD $0x00a8; BYTE $0x00 // leaq         $43072(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x83358d48; WORD $0x00a7; BYTE $0x00 // leaq         $42883(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0x71058d48; WORD $0x00a7; BYTE $0x00 // leaq         $42865(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x56358d48; WORD $0x00a7; BYTE $0x00 // leaq         $42838(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0xcc158d48; WORD $0x00a6; BYTE $0x00 // leaq         $42700(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0xaf0d8d48; WORD $0x00a5; BYTE $0x00 // leaq         $42415(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x5e0d8d48; WORD $0x00a5; BYTE $0x00 // leaq         $42334(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x3b058d4c; WORD $0x00a5; BYTE $0x00 // leaq         $42299(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
_quote:
	...
	SUBQ  $32, SP
	TESTB $1, R8
	LONG  $0xde058d48; WORD $0x00a4; BYTE $0x00 // leaq         $42206(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0xd7158d4c; WORD $0x00b4; BYTE $0x00 // leaq         $46295(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG  $0xd0440f4c                           // cmoveq       %rax, %r10
	MOVQ  DX, R8
	MOVQ  DI, AX
	TESTQ SI, SI
...
LBB5_48:
	...
	MOVQ    DI, BX
	SHLQ    $4, BX
	LONG    $0xa0358d48; WORD $0x00a1; BYTE $0x00 // leaq         $41376(%rip), %rsi  /* __SingleQuoteTab(%rip) */
	CMPQ    0(BX)(SI*1), $0
	JNE     LBB5_49
	LEAQ    0(R9)(CX*1), R15
	MOVB    DI, 0(R13)(DX*1)
...
LBB6_38:
	ADDQ    R14, R8
	MOVBLZX -1(R9), AX
	LONG    $0xe90d8d48; WORD $0x00ba; BYTE $0x00 // leaq         $47849(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB    0(AX)(CX*1), CX
	CMPB    CX, $-1
	JE      LBB6_41
	TESTB   CX, CX
...
_html_escape:
	...
	LONG  $0xb83d8d4c; WORD $0x00b4; BYTE $0x00 // leaq         $46264(%rip), %r15  /* __HtmlQuoteTab(%rip) */
	MOVQ  -48(BP), R11
	MOVQ  -56(BP), R8
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0xc83d8d4c; WORD $0x0035; BYTE $0x00 // leaq         $13768(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0xbc358d4c; WORD $0x005f; BYTE $0x00 // leaq         $24508(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x0032a9e8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0x7e358d4c; WORD $0x005f; BYTE $0x00 // leaq         $24446(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x0030dce8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x00320be8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x0031c4e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x00301ae8; BYTE $0x00 // callq        _left_shift
...
_value:
	...
	CMPL    AX, $125
	JA      LBB11_4
	LONG    $0x6f0d8d48; WORD $0x0002; BYTE $0x00 // leaq         $623(%rip), %rcx  /* LJTI11_0(%rip) */
...
LJTI11_0:
	LONG $0xfffffdb8 // .long L11_0_set_3
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	...
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffddc // .long L11_0_set_5
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	...
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffe2f // .long L11_0_set_7
	LONG $0xfffffd9a // .long L11_0_set_2
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffd9a // .long L11_0_set_2
	LONG $0xfffffd9a // .long L11_0_set_2
	...
	LONG $0xfffffd9a // .long L11_0_set_2
	LONG $0xfffffd9a // .long L11_0_set_2
	LONG $0xfffffe45 // .long L11_0_set_8
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	...
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffe5b // .long L11_0_set_9
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffee2 // .long L11_0_set_16
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	...
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xffffff09 // .long L11_0_set_19
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	...
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffe6b // .long L11_0_set_10
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffe9f // .long L11_0_set_12
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xffffff29 // .long L11_0_set_22
	LONG $0xfffffdc8 // .long L11_0_set_4
	LONG $0xfffffecf // .long L11_0_set_15
...
LBB15_61:
	...
	JL    LBB15_72
	LEAL  -22(SI), AX
	LONG  $0xb00d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $49072(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB15_69:
	...
	JB   LBB15_76
	NEGL SI
	LONG $0x67058d48; WORD $0x00bf; BYTE $0x00 // leaq         $48999(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB15_73:
	...
	JA   LBB15_76
	MOVL AX, AX
	LONG $0xf30d8d48; WORD $0x00be; BYTE $0x00 // leaq         $48883(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB15_80
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB24_34
	LONG  $0xee0d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $45038(%rip), %r9  /* _first(%rip) */
	LONG  $0xe7058d4c; WORD $0x00b0; BYTE $0x00 // leaq         $45287(%rip), %r8  /* _ranges(%rip) */
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+9653(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20295(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+23815(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20332(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18452(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+23932(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+13550(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16466(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+17896(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15559(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18176(SB), AX // _vunsigned
	JMP  AX
