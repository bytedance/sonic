...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0x880d8d48; WORD $0x008e; BYTE $0x00 // leaq         $36488(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0xb20d8d4c; WORD $0x00a2; BYTE $0x00 // leaq         $41650(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R9*1), R15
	MOVQ    R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x0057efe8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0x91058d48; WORD $0x00b1; BYTE $0x00 // leaq         $45457(%rip), %rax  /* _Digits(%rip) */
...
LBB2_69:
	...
	JL      LBB2_84
	MOVLQSX R14, AX
	LONG    $0x260d8d48; WORD $0x00b1; BYTE $0x00 // leaq         $45350(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x0056ebe8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_77
	LEAL  0(BX)(R13*1), AX
	CMPL  R13, R15
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x005386e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x910d8d48; WORD $0x00ac; BYTE $0x00 // leaq         $44177(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x70358d48; WORD $0x00ac; BYTE $0x00 // leaq         $44144(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x45158d48; WORD $0x00ac; BYTE $0x00 // leaq         $44101(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0xad058d48; WORD $0x00ab; BYTE $0x00 // leaq         $43949(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x88358d48; WORD $0x00ab; BYTE $0x00 // leaq         $43912(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0x76058d48; WORD $0x00ab; BYTE $0x00 // leaq         $43894(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x5b358d48; WORD $0x00ab; BYTE $0x00 // leaq         $43867(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0xd1158d48; WORD $0x00aa; BYTE $0x00 // leaq         $43729(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0xb40d8d48; WORD $0x00a9; BYTE $0x00 // leaq         $43444(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x630d8d48; WORD $0x00a9; BYTE $0x00 // leaq         $43363(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x40058d4c; WORD $0x00a9; BYTE $0x00 // leaq         $43328(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
_quote:
	...
	SUBQ  $32, SP
	TESTB $1, R8
	LONG  $0xe3058d48; WORD $0x00a8; BYTE $0x00 // leaq         $43235(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0xdc158d4c; WORD $0x00b8; BYTE $0x00 // leaq         $47324(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG  $0xd0440f4c                           // cmoveq       %rax, %r10
	MOVQ  DX, R8
	MOVQ  DI, AX
	TESTQ SI, SI
	...
	MOVQ  CX, -64(BP)
	MOVQ  0(CX), R11
	QUAD  $0xffffff2b0d6f7ec5                   // vmovdqu      $-213(%rip), %ymm9  /* LCPI5_0(%rip) */
	QUAD  $0xffffff43156f7ec5                   // vmovdqu      $-189(%rip), %ymm10  /* LCPI5_1(%rip) */
	QUAD  $0xffffff5b1d6f7ec5                   // vmovdqu      $-165(%rip), %ymm11  /* LCPI5_2(%rip) */
...
LBB5_36:
	...
	MOVQ  AX, CX
	SUBQ  R12, CX
	QUAD  $0xfffffdb40d6f7ec5     // vmovdqu      $-588(%rip), %ymm9  /* LCPI5_0(%rip) */
	QUAD  $0xfffffdcc156f7ec5     // vmovdqu      $-564(%rip), %ymm10  /* LCPI5_1(%rip) */
	QUAD  $0xfffffde41d6f7ec5     // vmovdqu      $-540(%rip), %ymm11  /* LCPI5_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD  $0xfffffdf73d6ffac5     // vmovdqu      $-521(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD  $0xfffffdff256ffac5     // vmovdqu      $-513(%rip), %xmm4  /* LCPI5_4(%rip) */
	QUAD  $0xfffffe072d6ffac5     // vmovdqu      $-505(%rip), %xmm5  /* LCPI5_5(%rip) */
...
LBB5_37:
	MOVQ  BX, R14
	MOVQ  R15, R9
	QUAD  $0xfffffc700d6f7ec5     // vmovdqu      $-912(%rip), %ymm9  /* LCPI5_0(%rip) */
	QUAD  $0xfffffc88156f7ec5     // vmovdqu      $-888(%rip), %ymm10  /* LCPI5_1(%rip) */
	QUAD  $0xfffffca01d6f7ec5     // vmovdqu      $-864(%rip), %ymm11  /* LCPI5_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD  $0xfffffcb33d6ffac5     // vmovdqu      $-845(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD  $0xfffffcbb256ffac5     // vmovdqu      $-837(%rip), %xmm4  /* LCPI5_4(%rip) */
	QUAD  $0xfffffcc32d6ffac5     // vmovdqu      $-829(%rip), %xmm5  /* LCPI5_5(%rip) */
	LONG  $0xf676c9c5             // vpcmpeqd     %xmm6, %xmm6, %xmm6
	TESTB DX, DX
	JNE   LBB5_51
...
LBB5_48:
	...
	MOVQ    DI, BX
	SHLQ    $4, BX
	LONG    $0xa5358d48; WORD $0x00a5; BYTE $0x00 // leaq         $42405(%rip), %rsi  /* __SingleQuoteTab(%rip) */
	CMPQ    0(BX)(SI*1), $0
	JNE     LBB5_49
	LEAQ    0(R9)(CX*1), R15
	MOVB    DI, 0(R13)(DX*1)
...
LBB6_24:
	...
	MOVQ R9, R13
	SUBQ R14, R13
	QUAD $0xfffffdc00d6ffec5 // vmovdqu      $-576(%rip), %ymm1  /* LCPI6_0(%rip) */
	QUAD $0xfffffdd8156ffac5 // vmovdqu      $-552(%rip), %xmm2  /* LCPI6_1(%rip) */
...
LBB6_28:
	MOVQ R15, R11
	QUAD $0xfffffd7c0d6ffec5 // vmovdqu      $-644(%rip), %ymm1  /* LCPI6_0(%rip) */
	QUAD $0xfffffd94156ffac5 // vmovdqu      $-620(%rip), %xmm2  /* LCPI6_1(%rip) */
...
LBB6_38:
	ADDQ    R14, R8
	MOVBLZX -1(R9), AX
	LONG    $0xee0d8d48; WORD $0x00be; BYTE $0x00 // leaq         $48878(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB    0(AX)(CX*1), CX
	CMPB    CX, $-1
	JE      LBB6_41
	TESTB   CX, CX
...
LBB7_2:
	MOVBLZX 1(DI), AX
	LONG    $0xb60d8d48; WORD $0x00b8; BYTE $0x00 // leaq         $47286(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB    0(AX)(CX*1), CX
	CMPB    CX, $-1
	JE      LBB7_5
	MOVL    $2, AX
...
LBB7_5:
	...
	MOVL  AX, CX
	NOTL  CX
	LEAL  -808464432(AX), SI
	ANDL  $-2139062144, CX
	TESTL SI, CX
	JNE   LBB7_11
	LEAL  421075225(AX), SI
	ORL   AX, SI
	TESTL $-2139062144, SI
	JNE   LBB7_11
	ANDL  $2139062143, AX
...
_html_escape:
	...
	LONG  $0x773d8d4c; WORD $0x00b7; BYTE $0x00 // leaq         $46967(%rip), %r15  /* __HtmlQuoteTab(%rip) */
	MOVQ  -48(BP), R11
	MOVQ  -56(BP), R8
...
LBB8_7:
	...
	LONG  $0x7f7ec1c4; WORD $0x1804 // vmovdqu      %ymm0, (%r8,%rbx)
...
LBB8_38:
	...
	JL    LBB8_39
	CMPQ  R10, $16
	QUAD  $0xfffffe343d6ffac5 // vmovdqu      $-460(%rip), %xmm7  /* LCPI8_4(%rip) */
	QUAD  $0xfffffe3c056f7ac5 // vmovdqu      $-452(%rip), %xmm8  /* LCPI8_5(%rip) */
	QUAD  $0xfffffe440d6f7ac5 // vmovdqu      $-444(%rip), %xmm9  /* LCPI8_6(%rip) */
	QUAD  $0xfffffe4c156f7ac5 // vmovdqu      $-436(%rip), %xmm10  /* LCPI8_7(%rip) */
	JL    LBB8_41
	MOVQ  R11, DI
	SUBQ  R12, DI
	QUAD  $0xfffffd881d6ffec5 // vmovdqu      $-632(%rip), %ymm3  /* LCPI8_0(%rip) */
	QUAD  $0xfffffda0256ffec5 // vmovdqu      $-608(%rip), %ymm4  /* LCPI8_1(%rip) */
	QUAD  $0xfffffdb82d6ffec5 // vmovdqu      $-584(%rip), %ymm5  /* LCPI8_2(%rip) */
	QUAD  $0xfffffdd0356ffec5 // vmovdqu      $-560(%rip), %ymm6  /* LCPI8_3(%rip) */
...
LBB8_39:
	MOVQ AX, R13
	MOVQ R10, R14
	QUAD $0xfffffc511d6ffec5 // vmovdqu      $-943(%rip), %ymm3  /* LCPI8_0(%rip) */
	QUAD $0xfffffc69256ffec5 // vmovdqu      $-919(%rip), %ymm4  /* LCPI8_1(%rip) */
	QUAD $0xfffffc812d6ffec5 // vmovdqu      $-895(%rip), %ymm5  /* LCPI8_2(%rip) */
	QUAD $0xfffffc99356ffec5 // vmovdqu      $-871(%rip), %ymm6  /* LCPI8_3(%rip) */
	QUAD $0xfffffcb13d6ffac5 // vmovdqu      $-847(%rip), %xmm7  /* LCPI8_4(%rip) */
	QUAD $0xfffffcb9056f7ac5 // vmovdqu      $-839(%rip), %xmm8  /* LCPI8_5(%rip) */
	QUAD $0xfffffcc10d6f7ac5 // vmovdqu      $-831(%rip), %xmm9  /* LCPI8_6(%rip) */
	QUAD $0xfffffcc9156f7ac5 // vmovdqu      $-823(%rip), %xmm10  /* LCPI8_7(%rip) */
...
LBB8_41:
	MOVQ  AX, R13
	MOVQ  R10, R14
	QUAD  $0xfffffba21d6ffec5 // vmovdqu      $-1118(%rip), %ymm3  /* LCPI8_0(%rip) */
	QUAD  $0xfffffbba256ffec5 // vmovdqu      $-1094(%rip), %ymm4  /* LCPI8_1(%rip) */
	QUAD  $0xfffffbd22d6ffec5 // vmovdqu      $-1070(%rip), %ymm5  /* LCPI8_2(%rip) */
	QUAD  $0xfffffbea356ffec5 // vmovdqu      $-1046(%rip), %ymm6  /* LCPI8_3(%rip) */
	TESTB CX, CX
	JNE   LBB8_58
...
LBB9_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x873d8d4c; WORD $0x0038; BYTE $0x00 // leaq         $14471(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB10_5:
	...
	JLE   LBB10_12
	XORL  R12, R12
	LONG  $0x7b358d4c; WORD $0x0062; BYTE $0x00 // leaq         $25211(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB10_8
...
LBB10_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x003568e8; BYTE $0x00 // callq        _right_shift
...
LBB10_12:
	LONG $0x3d358d4c; WORD $0x0062; BYTE $0x00 // leaq         $25149(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB10_14
...
LBB10_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x00339be8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB10_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x0034cae8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB10_25
	ADDL $60, R12
...
LBB10_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x003483e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB10_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x0032d9e8; BYTE $0x00 // callq        _left_shift
...
LBB12_2:
	...
	LEAQ -40(BP), SI
	MOVQ R14, DX
	LONG $0x000b09e8; BYTE $0x00 // callq        _vnumber
	MOVQ -40(BP), BX
	JMP  LBB12_18
...
LBB16_61:
	...
	JL    LBB16_72
	LEAL  -22(SI), AX
	LONG  $0x690d8d48; WORD $0x00c2; BYTE $0x00 // leaq         $49769(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB16_69:
	...
	JB   LBB16_76
	NEGL SI
	LONG $0x20058d48; WORD $0x00c2; BYTE $0x00 // leaq         $49696(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB16_73:
	...
	JA   LBB16_76
	MOVL AX, AX
	LONG $0xac0d8d48; WORD $0x00c1; BYTE $0x00 // leaq         $49580(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB16_80
...
LBB16_76:
	...
	MOVL  R10, BX
	MOVQ  SI, -88(BP)
	LONG  $0xffe823e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
	MOVQ  -88(BP), SI
	CMPL  -44(BP), $0
	...
	LEAQ  -80(BP), CX
	MOVQ  R12, DI
	LONG  $0xffe803e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
...
LBB16_81:
	...
	MOVQ -104(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffee18e8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB16_84
...
LBB20_2:
	MOVQ  R13, DI
	MOVQ  BX, SI
	LONG  $0x0007a9e8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JS    LBB20_36
...
LBB20_5:
	...
	MOVQ    -56(BP), BX
	MOVQ    BX, SI
	LONG    $0xfff1bbe8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R12), DX
	LEAQ    -1(DX), CX
	CMPQ    R14, $-1
	JNE     LBB20_7
...
LBB20_7:
	...
	CMPL    SI, $5
	JA      LBB20_12
	LONG    $0x623d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1122(%rip), %rdi  /* LJTI20_0(%rip) */
...
LBB20_18:
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff420e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_65
	MOVQ  R13, 0(BX)
...
LBB20_25:
	MOVQ    $-1, R13
	LONG    $0x8d0d8d48; WORD $0x0003; BYTE $0x00 // leaq         $909(%rip), %rcx  /* LJTI20_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB20_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x0010f3e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JS    LBB20_64
	MOVQ  0(BX), CX
	ADDQ  CX, AX
...
LBB20_34:
	...
	MOVQ  R13, DI
	MOVQ  BX, SI
	LONG  $0x0005bce8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB20_39
	JMP   LBB20_36
...
LBB20_37:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff2fbe8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_65
	MOVQ  R13, 0(BX)
...
LBB20_41:
	...
	MOVQ  -48(BP), DI
	MOVQ  -56(BP), SI
	LONG  $0x00054ce8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB20_3
	JMP   LBB20_36
...
LBB20_43:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000fd5e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JLE   LBB20_66
	ADDQ  AX, 0(BX)
	TESTQ R13, R13
...
LJTI20_0:
	LONG $0xfffffba7 // .long L20_0_set_9
	LONG $0xfffffbd6 // .long L20_0_set_13
	LONG $0xfffffc03 // .long L20_0_set_15
	LONG $0xfffffc4c // .long L20_0_set_21
	LONG $0xfffffc61 // .long L20_0_set_23
	LONG $0xfffffcd9 // .long L20_0_set_26

	// .set L20_1_set_68, LBB20_68-LJTI20_1
	...
	// .set L20_1_set_60, LBB20_60-LJTI20_1
LJTI20_1:
	LONG $0xffffff09 // .long L20_1_set_68
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	...
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xfffffd79 // .long L20_1_set_41
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	...
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xfffffd9e // .long L20_1_set_43
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xfffffc7c // .long L20_1_set_28
	LONG $0xfffffc7c // .long L20_1_set_28
	LONG $0xfffffc7c // .long L20_1_set_28
	LONG $0xfffffc7c // .long L20_1_set_28
	LONG $0xfffffc7c // .long L20_1_set_28
	...
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xfffffdd5 // .long L20_1_set_46
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	...
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xfffffdfa // .long L20_1_set_48
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	...
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xfffffe3d // .long L20_1_set_51
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xfffffe6b // .long L20_1_set_56
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xffffff02 // .long L20_1_set_67
	LONG $0xfffffead // .long L20_1_set_60
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffeddee8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB23_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	MOVQ $-1, CX
	XORL R15, R15
	QUAD $0xffffff37156ffec5       // vmovdqu      $-201(%rip), %ymm2  /* LCPI24_0(%rip) */
	QUAD $0xffffff4f1d6ffec5       // vmovdqu      $-177(%rip), %ymm3  /* LCPI24_1(%rip) */
	QUAD $0xffffff67256ffec5       // vmovdqu      $-153(%rip), %ymm4  /* LCPI24_2(%rip) */
...
LBB24_5:
	LONG $0xc274cdc5 // vpcmpeqb     %ymm2, %ymm6, %ymm0
	LONG $0xc8d7fdc5 // vpmovmskb    %ymm0, %ecx
	ORQ  CX, R12
	MOVQ AX, CX
	ORQ  R15, CX
...
LBB24_6:
	LONG  $0xc164ddc5 // vpcmpgtb     %ymm1, %ymm4, %ymm0
	LONG  $0xcd64f5c5 // vpcmpgtb     %ymm5, %ymm1, %ymm1
	LONG  $0xc1dbfdc5 // vpand        %ymm1, %ymm0, %ymm0
	LONG  $0xc8d7fdc5 // vpmovmskb    %ymm0, %ecx
	SHLQ  $32, CX
	LONG  $0xc664ddc5 // vpcmpgtb     %ymm6, %ymm4, %ymm0
	LONG  $0xcd64cdc5 // vpcmpgtb     %ymm5, %ymm6, %ymm1
	LONG  $0xc1dbfdc5 // vpand        %ymm1, %ymm0, %ymm0
	LONG  $0xc0d7fdc5 // vpmovmskb    %ymm0, %eax
	ORQ   CX, AX
	TESTQ R12, R12
...
LBB24_14:
	...
	MOVQ  R11, 24(SP)
	MOVQ  SI, 8(SP)
	LONG  $0x747ffdc5; WORD $0x4024 // vmovdqa      %ymm6, $64(%rsp)
	LONG  $0x4c7ffdc5; WORD $0x6024 // vmovdqa      %ymm1, $96(%rsp)
...
LBB24_16:
	...
	SUBQ  AX, SI
	WORD  $0xf8c5; BYTE $0x77       // vzeroupper
	LONG  $0xffd1a8e8; BYTE $0xff   // callq        _valid_escaped
	TESTL AX, AX
	JS    LBB24_20
	MOVQ  56(SP), CX
	ADDL  AX, CX
	...
	CMPL  CX, $63
	MOVL  $0, AX
	LONG  $0xf04f0f4c               // cmovgq       %rax, %r14
	TESTQ R14, R14
	MOVQ  40(SP), R8
	MOVQ  24(SP), R11
	MOVQ  8(SP), SI
	QUAD  $0xfffffd7d156ffec5       // vmovdqu      $-643(%rip), %ymm2  /* LCPI24_0(%rip) */
	QUAD  $0xfffffd951d6ffec5       // vmovdqu      $-619(%rip), %ymm3  /* LCPI24_1(%rip) */
	QUAD  $0xfffffdad256ffec5       // vmovdqu      $-595(%rip), %ymm4  /* LCPI24_2(%rip) */
	LONG  $0xed76d5c5               // vpcmpeqd     %ymm5, %ymm5, %ymm5
	MOVQ  $-6148914691236517206, R9
	MOVQ  $6148914691236517205, R10
	LEAQ  16(SP), DX
	LONG  $0x746ffdc5; WORD $0x4024 // vmovdqa      $64(%rsp), %ymm6
...
LBB24_20:
	...
	MOVQ 24(SP), R11
	MOVQ 8(SP), SI
	QUAD $0xfffffcf5156ffec5       // vmovdqu      $-779(%rip), %ymm2  /* LCPI24_0(%rip) */
	QUAD $0xfffffd0d1d6ffec5       // vmovdqu      $-755(%rip), %ymm3  /* LCPI24_1(%rip) */
	QUAD $0xfffffd25256ffec5       // vmovdqu      $-731(%rip), %ymm4  /* LCPI24_2(%rip) */
	LONG $0xed76d5c5               // vpcmpeqd     %ymm5, %ymm5, %ymm5
	MOVQ $-6148914691236517206, R9
	MOVQ $6148914691236517205, R10
	LEAQ 16(SP), DX
...
LBB24_25:
	...
	ADDQ  0(R8), DI
	WORD  $0xf8c5; BYTE $0x77     // vzeroupper
	LONG  $0x000408e8; BYTE $0x00 // callq        _utf8_validate
	TESTQ AX, AX
	JS    LBB24_28
	ADDQ  0(R14), AX
	MOVQ  $-2, CX
...
LBB24_33:
	CMPQ  R13, $32
	JB    LBB24_46
	LONG  $0x136ffec5         // vmovdqu      (%rbx), %ymm2
	QUAD  $0xfffffbfb0574edc5 // vpcmpeqb     $-1029(%rip), %ymm2, %ymm0  /* LCPI24_0(%rip) */
	LONG  $0xe0d77dc5         // vpmovmskb    %ymm0, %r12d
	QUAD  $0xfffffc0f0574edc5 // vpcmpeqb     $-1009(%rip), %ymm2, %ymm0  /* LCPI24_1(%rip) */
	LONG  $0xc0d7fdc5         // vpmovmskb    %ymm0, %eax
	TESTL AX, AX
	JNE   LBB24_59
	TESTQ R15, R15
...
LBB24_37:
	QUAD  $0xfffffc0f056ffec5 // vmovdqu      $-1009(%rip), %ymm0  /* LCPI24_2(%rip) */
	LONG  $0xc264fdc5         // vpcmpgtb     %ymm2, %ymm0, %ymm0
	LONG  $0xc976f5c5         // vpcmpeqd     %ymm1, %ymm1, %ymm1
	LONG  $0xc964edc5         // vpcmpgtb     %ymm1, %ymm2, %ymm1
	LONG  $0xc1dbfdc5         // vpand        %ymm1, %ymm0, %ymm0
	LONG  $0xc0d7fdc5         // vpmovmskb    %ymm0, %eax
	TESTQ R12, R12
	JE    LBB24_44
...
LBB24_55:
	...
	MOVQ  R12, DX
	WORD  $0xf8c5; BYTE $0x77     // vzeroupper
	LONG  $0xffceeee8; BYTE $0xff // callq        _valid_escaped
	TESTQ AX, AX
	JS    LBB24_83
	ADDQ  AX, BX
	SUBQ  AX, R13
...
LBB24_64:
	...
	LEAQ  16(SP), DX
	WORD  $0xf8c5; BYTE $0x77     // vzeroupper
	LONG  $0xffcdede8; BYTE $0xff // callq        _valid_escaped
	TESTL AX, AX
	JS    LBB24_79
	MOVQ  56(SP), CX
	ADDL  AX, CX
...
LBB24_67:
	...
	MOVQ 24(SP), R11
	MOVQ 8(SP), SI
	LONG $0x546ffdc5; WORD $0x4024 // vmovdqa      $64(%rsp), %ymm2
	JMP  LBB24_37
...
LBB24_68:
	...
	MOVQ  R14, DI
	WORD  $0xf8c5; BYTE $0x77     // vzeroupper
	LONG  $0xffcd77e8; BYTE $0xff // callq        _valid_escaped
	TESTQ AX, AX
	JS    LBB24_82
	ADDQ  AX, BX
	ADDQ  $-1, BX
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB25_34
	LONG  $0x7f0d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $44927(%rip), %r9  /* _first(%rip) */
	LONG  $0x78058d4c; WORD $0x00b0; BYTE $0x00 // leaq         $45176(%rip), %r8  /* _ranges(%rip) */
...
LBB27_49:
	...
	SUBQ  DI, BX
	XORL  AX, AX
	LONG  $0xa0358d4c; WORD $0x0001; BYTE $0x00 // leaq         $416(%rip), %r14  /* LJTI27_0(%rip) */
	JMP   LBB27_51
...
LJTI27_0:
	LONG $0xfffffea4 // .long L27_0_set_61
	LONG $0xffffff01 // .long L27_0_set_65
	LONG $0xfffffea4 // .long L27_0_set_61
	LONG $0xfffffeb4 // .long L27_0_set_57
	LONG $0xffffff01 // .long L27_0_set_65
	LONG $0xffffff01 // .long L27_0_set_65
	LONG $0xffffff01 // .long L27_0_set_65
	LONG $0xffffff01 // .long L27_0_set_65
	...
	LONG $0xffffff01 // .long L27_0_set_65
	LONG $0xffffff01 // .long L27_0_set_65
	LONG $0xfffffe6b // .long L27_0_set_54
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffac1e8; BYTE $0xff // callq        _skip_number
	TESTQ AX, AX
	JS    LBB28_1
	MOVQ  0(R14), CX
	ADDQ  AX, CX
...
_print_mantissa:
	...
	SUBL    DI, AX
	MOVWLZX AX, R11
	LONG    $0x5a3d8d48; WORD $0x0059; BYTE $0x00 // leaq         $22874(%rip), %rdi  /* _Digits(%rip) */
...
LBB31_2:
	...
	JB   LBB31_3
	MOVL $3518437209, R8
	LONG $0x120d8d4c; WORD $0x0059; BYTE $0x00 // leaq         $22802(%rip), %r9  /* _Digits(%rip) */
...
LBB31_7:
	...
	SUBL    DX, AX
	MOVWLZX AX, AX
	LONG    $0xab158d48; WORD $0x0058; BYTE $0x00 // leaq         $22699(%rip), %rdx  /* _Digits(%rip) */
...
LBB31_8:
	...
	JB      LBB31_10
	MOVL    AX, AX
	LONG    $0x8e0d8d48; WORD $0x0058; BYTE $0x00 // leaq         $22670(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, -2(R14)
	BYTE    $0x5b                                 // popq         %rbx
	WORD    $0x5e41                               // popq         %r14
...
_left_shift:
	...
	MOVL    SI, CX
	IMUL3Q  $104, CX, R11
	LONG    $0xb2158d48; WORD $0x008a; BYTE $0x00 // leaq         $35506(%rip), %rdx  /* _LSHIFT_TAB(%rip) */
	MOVL    0(R11)(DX*1), R8
	MOVQ    0(DI), R10
	MOVLQSX 16(DI), R9
	TESTQ   R9, R9
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+9979(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+5325(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20597(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20634(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18784(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+7158(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+24961(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+13876(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16798(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18228(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15885(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18508(SB), AX // _vunsigned
	JMP  AX
