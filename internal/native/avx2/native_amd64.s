...
LBB2_8:
	...
	MOVQ    R13, AX
	SHLQ    $4, AX
	LONG    $0x470d8d48; WORD $0x008e; BYTE $0x00 // leaq         $36423(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R10, R12
	ORQ     $2, R12
	MOVQ    0(AX)(CX*1), R11
	MOVQ    8(AX)(CX*1), R14
...
LBB2_22:
	...
	MOVLQSX AX, DI
	SHLQ    $4, DI
	LONG    $0x7a1d8d4c; WORD $0x00a2; BYTE $0x00 // leaq         $41594(%rip), %r11  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R10, CX
	ORQ     $2, CX
	MOVQ    0(DI)(R11*1), R9
	MOVQ    R9, AX
...
LBB2_67:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x0057cde8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R12), AX
	MOVB AX, 0(R12)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_74:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0x8a058d48; WORD $0x00b1; BYTE $0x00 // leaq         $45450(%rip), %rax  /* _Digits(%rip) */
...
LBB2_80:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x0056cce8; BYTE $0x00 // callq        _print_mantissa
	TESTL R12, R12
	JE    LBB2_81
	LEAL  0(R12)(BX*1), AX
	CMPL  R12, R15
...
LBB2_85:
	...
	MOVQ R12, SI
	MOVL R15, DX
	LONG $0x0055f0e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
	MOVL -44(BP), R9
	JMP  LBB2_105
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x0c0d8d48; WORD $0x00ae; BYTE $0x00 // leaq         $44556(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0xeb358d48; WORD $0x00ad; BYTE $0x00 // leaq         $44523(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0xd9158d48; WORD $0x00ad; BYTE $0x00 // leaq         $44505(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0xc0158d48; WORD $0x00ad; BYTE $0x00 // leaq         $44480(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0x28058d48; WORD $0x00ad; BYTE $0x00 // leaq         $44328(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x03358d48; WORD $0x00ad; BYTE $0x00 // leaq         $44291(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0xf1058d48; WORD $0x00ac; BYTE $0x00 // leaq         $44273(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0xd6358d48; WORD $0x00ac; BYTE $0x00 // leaq         $44246(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x4c158d48; WORD $0x00ac; BYTE $0x00 // leaq         $44108(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA      LBB4_22
	MOVL    DX, AX
	LONG    $0x2f0d8d48; WORD $0x00ab; BYTE $0x00 // leaq         $43823(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVL    $2, CX
	JMP     LBB4_25
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0xe60d8d48; WORD $0x00aa; BYTE $0x00 // leaq         $43750(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 1(DI)
	MOVL    $3, CX
	JMP     LBB4_25
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0xc80d8d48; WORD $0x00aa; BYTE $0x00 // leaq         $43720(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVWLZX DX, AX
	MOVB    0(CX)(AX*2), DX
...
_quote:
	...
	MOVQ  0(CX), R10
	TESTB $1, R8
	LONG  $0x6d058d48; WORD $0x00aa; BYTE $0x00 // leaq         $43629(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0x66058d4c; WORD $0x00ba; BYTE $0x00 // leaq         $47718(%rip), %r8  /* __DoubleQuoteTab(%rip) */
...
LBB5_40:
	...
	MOVQ    BX, SI
	SHLQ    $4, SI
	LONG    $0x69058d48; WORD $0x00a6; BYTE $0x00 // leaq         $42601(%rip), %rax  /* __SingleQuoteTab(%rip) */
	CMPQ    0(SI)(AX*1), $0
	JNE     LBB5_61
	LEAQ    0(R15)(CX*1), AX
	MOVB    BX, 0(R12)(DX*1)
...
LBB5_93:
	LONG $0xcf0d8d4c; WORD $0x00c3; BYTE $0x00 // leaq         $50127(%rip), %r9  /* __EscTab(%rip) */
...
LBB6_43:
	ADDQ    R14, R8
	MOVBLZX -1(R11), AX
	LONG    $0xca0d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $49098(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB    0(AX)(CX*1), AX
	CMPB    AX, $-1
	JE      LBB6_46
	TESTB   AX, AX
...
_html_escape:
	...
	LONG  $0x45358d4c; WORD $0x00b5; BYTE $0x00 // leaq         $46405(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	MOVQ  -48(BP), R11
	MOVQ  -56(BP), R15
...
LBB7_58:
	...
	JGE  LBB7_59
	CMPQ R13, $8
	LONG $0x55358d4c; WORD $0x00b2; BYTE $0x00 // leaq         $45653(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	JB   LBB7_70
	MOVQ CX, 0(R8)
	LEAQ 8(R12), AX
	ADDQ $8, R8
...
LBB7_59:
	CMPL AX, $8
	LONG $0xd4358d4c; WORD $0x00b0; BYTE $0x00 // leaq         $45268(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	JB   LBB7_60
	MOVQ CX, 0(R8)
	LEAQ 8(R12), R10
	ADDQ $8, R8
...
LBB7_82:
	LONG $0xfe358d4c; WORD $0x00af; BYTE $0x00 // leaq         $45054(%rip), %r14  /* __HtmlQuoteTab(%rip) */
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x853d8d4c; WORD $0x0035; BYTE $0x00 // leaq         $13701(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0x7a358d4c; WORD $0x005f; BYTE $0x00 // leaq         $24442(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x003267e8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0x3c358d4c; WORD $0x005f; BYTE $0x00 // leaq         $24380(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x00308be8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x0031cce8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x003185e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002fcce8; BYTE $0x00 // callq        _left_shift
...
LBB11_2:
	...
	LEAQ  -48(BP), SI
	MOVQ  -56(BP), DX
	LONG  $0x000b80e8; BYTE $0x00 // callq        _vnumber
	MOVQ  -48(BP), BX
	JMP   LBB11_49
...
LBB11_12:
	...
	LEAQ  -64(BP), DX
	MOVQ  R15, SI
	LONG  $0x0007fce8; BYTE $0x00 // callq        _advance_string
	MOVQ  AX, BX
	TESTQ AX, AX
	JS    LBB11_33
	MOVQ  BX, -48(BP)
...
LBB14_13:
	...
	QUAD  $0xfffffe880d74fdc5 // vpcmpeqb     $-376(%rip), %ymm0, %ymm1  /* LCPI14_0(%rip) */
	LONG  $0xf9d7fdc5         // vpmovmskb    %ymm1, %edi
	QUAD  $0xfffffe9c0574fdc5 // vpcmpeqb     $-356(%rip), %ymm0, %ymm0  /* LCPI14_1(%rip) */
	LONG  $0xc0d7fdc5         // vpmovmskb    %ymm0, %eax
	TESTL AX, AX
	JNE   LBB14_19
	TESTQ R14, R14
...
LBB15_61:
	...
	JL    LBB15_70
	LEAL  -22(SI), AX
	LONG  $0x740d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $49012(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB15_67:
	...
	JB   LBB15_74
	NEGL SI
	LONG $0x55058d48; WORD $0x00bf; BYTE $0x00 // leaq         $48981(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB15_71:
	...
	JA   LBB15_74
	MOVL AX, AX
	LONG $0x260d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $48934(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB15_78
...
LBB15_74:
	...
	MOVQ  R12, DI
	MOVQ  SI, -88(BP)
	LONG  $0xffe795e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_80
	MOVQ  -88(BP), SI
	CMPL  -68(BP), $0
	...
	MOVQ  R12, DI
	MOVL  -44(BP), DX
	LONG  $0xffe774e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_80
...
LBB15_80:
	...
	MOVQ -56(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffed89e8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB15_83
...
LBB19_6:
	...
	MOVQ    -56(BP), BX
	MOVQ    BX, SI
	LONG    $0xfff226e8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R12), DX
	LEAQ    -1(DX), CX
	CMPQ    R14, $-1
	JNE     LBB19_8
...
LBB19_8:
	...
	CMPL    SI, $5
	JA      LBB19_13
	LONG    $0x353d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1077(%rip), %rdi  /* LJTI19_0(%rip) */
...
LBB19_18:
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff492e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB19_65
	MOVQ  R13, 0(BX)
...
LBB19_25:
	MOVQ    $-1, R13
	LONG    $0x6a0d8d48; WORD $0x0003; BYTE $0x00 // leaq         $874(%rip), %rcx  /* LJTI19_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB19_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000d76e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB19_66
	MOVQ  0(BX), CX
	ADDQ  CX, AX
...
LBB19_34:
	...
	MOVQ  R13, DI
	MOVQ  BX, SI
	LONG  $0x000599e8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB19_39
	JMP   LBB19_36
...
LBB19_37:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff36de8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB19_65
	MOVQ  R13, 0(BX)
...
LBB19_41:
	...
	MOVQ  -48(BP), DI
	MOVQ  -56(BP), SI
	LONG  $0x000529e8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB19_4
	JMP   LBB19_36
...
LBB19_43:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000c58e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB19_67
	ADDQ  AX, 0(BX)
	TESTQ R13, R13
...
// .set L19_0_set_26, LBB19_26-LJTI19_0
LJTI19_0:
	LONG $0xfffffbd4 // .long L19_0_set_10
	LONG $0xfffffc03 // .long L19_0_set_14
	LONG $0xfffffc30 // .long L19_0_set_16
	LONG $0xfffffc6f // .long L19_0_set_21
	LONG $0xfffffc84 // .long L19_0_set_23
	LONG $0xfffffcfc // .long L19_0_set_26
...
LJTI19_1:
	LONG $0xffffff30 // .long L19_1_set_74
	...
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xfffffd9c // .long L19_1_set_41
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	...
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xfffffdc1 // .long L19_1_set_43
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xfffffc9f // .long L19_1_set_28
	LONG $0xfffffc9f // .long L19_1_set_28
	LONG $0xfffffc9f // .long L19_1_set_28
	LONG $0xfffffc9f // .long L19_1_set_28
	LONG $0xfffffc9f // .long L19_1_set_28
	...
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xfffffdf8 // .long L19_1_set_46
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	...
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xfffffe1d // .long L19_1_set_48
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	...
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xfffffe60 // .long L19_1_set_52
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xfffffe96 // .long L19_1_set_57
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xffffff29 // .long L19_1_set_68
	LONG $0xfffffecc // .long L19_1_set_62
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffee73e8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB22_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	CMPQ R13, $64
	JB   LBB23_2
	QUAD $0xffffff5b056ffec5 // vmovdqu      $-165(%rip), %ymm0  /* LCPI23_0(%rip) */
	QUAD $0xffffff730d6ffec5 // vmovdqu      $-141(%rip), %ymm1  /* LCPI23_1(%rip) */
	QUAD $0xffffff8b156ffec5 // vmovdqu      $-117(%rip), %ymm2  /* LCPI23_2(%rip) */
	LONG $0xdb76e5c5         // vpcmpeqd     %ymm3, %ymm3, %ymm3
	MOVQ R14, R15

LBB23_4:
	LONG  $0x6f7e81c4; WORD $0x3b24             // vmovdqu      (%r11,%r15), %ymm4
	LONG  $0x6f7e81c4; WORD $0x3b6c; BYTE $0x20 // vmovdqu      $32(%r11,%r15), %ymm5
...
LBB23_52:
	...
	ADDQ  BX, SI
	WORD  $0xf8c5; BYTE $0x77     // vzeroupper
	LONG  $0x000280e8; BYTE $0x00 // callq        _utf8_validate
	TESTQ AX, AX
	JS    LBB23_56
	MOVQ  R15, SI
	ADDQ  0(R15), AX
...
LBB23_20:
	...
	QUAD  $0xfffffda50d74fdc5     // vpcmpeqb     $-603(%rip), %ymm0, %ymm1  /* LCPI23_0(%rip) */
	LONG  $0xd9d7fdc5             // vpmovmskb    %ymm1, %ebx
	QUAD  $0xfffffdb90d74fdc5     // vpcmpeqb     $-583(%rip), %ymm0, %ymm1  /* LCPI23_1(%rip) */
	LONG  $0xc9d7fdc5             // vpmovmskb    %ymm1, %ecx
	QUAD  $0xfffffdcd0d6ffec5     // vmovdqu      $-563(%rip), %ymm1  /* LCPI23_2(%rip) */
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21271(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21308(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+17612(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18917(SB), AX // _vsigned
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+19197(SB), AX // _vunsigned
	JMP  AX
