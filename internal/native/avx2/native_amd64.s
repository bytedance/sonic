...
LBB1_7:
	...
	MOVQ DI, SI
	SUBQ R10, SI
	QUAD $0xfffffec4056ffec5 // vmovdqu      $-316(%rip), %ymm0  /* LCPI1_0(%rip) */
	QUAD $0xfffffedc0d6ffec5 // vmovdqu      $-292(%rip), %ymm1  /* LCPI1_1(%rip) */
	QUAD $0xfffffef4156ffec5 // vmovdqu      $-268(%rip), %ymm2  /* LCPI1_2(%rip) */
	QUAD $0xffffff0c1d6ffec5 // vmovdqu      $-244(%rip), %ymm3  /* LCPI1_3(%rip) */
...
LBB1_13:
	...
	MOVQ DI, SI
	SUBQ R10, SI
	QUAD $0xfffffed5056ffac5 // vmovdqu      $-299(%rip), %xmm0  /* LCPI1_4(%rip) */
	QUAD $0xfffffedd0d6ffac5 // vmovdqu      $-291(%rip), %xmm1  /* LCPI1_5(%rip) */
	QUAD $0xfffffee5156ffac5 // vmovdqu      $-283(%rip), %xmm2  /* LCPI1_6(%rip) */
	QUAD $0xfffffeed1d6ffac5 // vmovdqu      $-275(%rip), %xmm3  /* LCPI1_7(%rip) */
...
LBB2_8:
	...
	MOVQ    R13, AX
	SHLQ    $4, AX
	LONG    $0xd70d8d48; WORD $0x009a; BYTE $0x00 // leaq         $39639(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R10, R12
	ORQ     $2, R12
	MOVQ    0(AX)(CX*1), R11
	MOVQ    8(AX)(CX*1), R14
...
LBB2_22:
	...
	MOVLQSX AX, DI
	SHLQ    $4, DI
	LONG    $0x0a1d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $44810(%rip), %r11  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R10, CX
	ORQ     $2, CX
	MOVQ    0(DI)(R11*1), R9
	MOVQ    R9, AX
...
LBB2_67:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x006415e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R12), AX
	MOVB AX, 0(R12)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_74:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0x1a058d48; WORD $0x00be; BYTE $0x00 // leaq         $48666(%rip), %rax  /* _Digits(%rip) */
...
LBB2_75:
	...
	JL      LBB2_77
	MOVLQSX R14, AX
	LONG    $0xb10d8d48; WORD $0x00bd; BYTE $0x00 // leaq         $48561(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_80:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x006314e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R12, R12
	JE    LBB2_81
	LEAL  0(R12)(BX*1), AX
	CMPL  R12, R15
...
LBB2_85:
	...
	MOVQ R12, SI
	MOVL R15, DX
	LONG $0x006238e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
	MOVL -44(BP), R9
	JMP  LBB2_105
...
LBB2_97:
	...
	NEGQ SI
	XORL DI, DI
	QUAD $0xfffff6c8056ffec5 // vmovdqu      $-2360(%rip), %ymm0  /* LCPI2_0(%rip) */
...
LBB2_99:
	...
	SHLQ  $7, DX
	XORL  SI, SI
	QUAD  $0xfffff619056ffec5 // vmovdqu      $-2535(%rip), %ymm0  /* LCPI2_0(%rip) */
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x9c0d8d48; WORD $0x00ba; BYTE $0x00 // leaq         $47772(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x7b358d48; WORD $0x00ba; BYTE $0x00 // leaq         $47739(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x69158d48; WORD $0x00ba; BYTE $0x00 // leaq         $47721(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x50158d48; WORD $0x00ba; BYTE $0x00 // leaq         $47696(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0xb8058d48; WORD $0x00b9; BYTE $0x00 // leaq         $47544(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x93358d48; WORD $0x00b9; BYTE $0x00 // leaq         $47507(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0x81058d48; WORD $0x00b9; BYTE $0x00 // leaq         $47489(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x66358d48; WORD $0x00b9; BYTE $0x00 // leaq         $47462(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	QUAD $0xfffffdc60d6ffac5                   // vmovdqu      $-570(%rip), %xmm1  /* LCPI4_0(%rip) */
	...
	QUAD $0xfffdbf155979e2c4; BYTE $0xff       // vpbroadcastq $-577(%rip), %xmm2  /* LCPI4_1(%rip) */
	QUAD $0xfffdbe255979e2c4; BYTE $0xff       // vpbroadcastq $-578(%rip), %xmm4  /* LCPI4_2(%rip) */
	LONG $0xc2e4f9c5                           // vpmulhuw     %xmm2, %xmm0, %xmm0
	LONG $0xc4e4f9c5                           // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffd862d6ffac5                   // vmovdqu      $-634(%rip), %xmm5  /* LCPI4_3(%rip) */
	...
	QUAD $0xfffffd400dfcf9c5                   // vpaddb       $-704(%rip), %xmm0, %xmm1  /* LCPI4_4(%rip) */
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0xdc158d48; WORD $0x00b8; BYTE $0x00 // leaq         $47324(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA      LBB4_22
	MOVL    DX, AX
	LONG    $0xbf0d8d48; WORD $0x00b7; BYTE $0x00 // leaq         $47039(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVL    $2, CX
	JMP     LBB4_25
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x760d8d48; WORD $0x00b7; BYTE $0x00 // leaq         $46966(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 1(DI)
	MOVL    $3, CX
	JMP     LBB4_25
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x580d8d48; WORD $0x00b7; BYTE $0x00 // leaq         $46936(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVWLZX DX, AX
	MOVB    0(CX)(AX*2), DX
...
LBB4_25:
	...
	SHRQ $26, DX
	LONG $0xc26ef9c5                     // vmovd        %edx, %xmm0
	QUAD $0xfffffbfa0d6ffac5             // vmovdqu      $-1030(%rip), %xmm1  /* LCPI4_0(%rip) */
	LONG $0xd1f4f9c5                     // vpmuludq     %xmm1, %xmm0, %xmm2
	LONG $0xd273e9c5; BYTE $0x2d         // vpsrlq       $45, %xmm2, %xmm2
	MOVL $10000, AX
	LONG $0x6ef9e1c4; BYTE $0xd8         // vmovq        %rax, %xmm3
	...
	LONG $0xf073f9c5; BYTE $0x02         // vpsllq       $2, %xmm0, %xmm0
	LONG $0xc070fbc5; BYTE $0x50         // vpshuflw     $80, %xmm0, %xmm0
	QUAD $0xfffbf8155979e2c4; BYTE $0xff // vpbroadcastq $-1032(%rip), %xmm2  /* LCPI4_1(%rip) */
	LONG $0xc070f9c5; BYTE $0x50         // vpshufd      $80, %xmm0, %xmm0
	LONG $0xc2e4f9c5                     // vpmulhuw     %xmm2, %xmm0, %xmm0
	QUAD $0xfffbee255979e2c4; BYTE $0xff // vpbroadcastq $-1042(%rip), %xmm4  /* LCPI4_2(%rip) */
	LONG $0xc4e4f9c5                     // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffbba2d6ffac5             // vmovdqu      $-1094(%rip), %xmm5  /* LCPI4_3(%rip) */
	LONG $0xf5d5f9c5                     // vpmullw      %xmm5, %xmm0, %xmm6
	LONG $0xf673c9c5; BYTE $0x10         // vpsllq       $16, %xmm6, %xmm6
	LONG $0xc6f9f9c5                     // vpsubw       %xmm6, %xmm0, %xmm0
	LONG $0xe100c269; WORD $0x05f5       // imull        $100000000, %edx, %eax
	...
	LONG $0xcaf9f1c5                     // vpsubw       %xmm2, %xmm1, %xmm1
	LONG $0xc167f9c5                     // vpackuswb    %xmm1, %xmm0, %xmm0
	QUAD $0xfffffb6c05fcf9c5             // vpaddb       $-1172(%rip), %xmm0, %xmm0  /* LCPI4_4(%rip) */
	MOVL CX, AX
...
_quote:
	...
	MOVQ  0(CX), R10
	TESTB $1, R8
	LONG  $0xfd058d48; WORD $0x00b6; BYTE $0x00 // leaq         $46845(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0xf6058d4c; WORD $0x00c6; BYTE $0x00 // leaq         $50934(%rip), %r8  /* __DoubleQuoteTab(%rip) */
	...
	TESTQ R14, R14
	JE    LBB5_125
	QUAD  $0xffffff18256ffec5                   // vmovdqu      $-232(%rip), %ymm4  /* LCPI5_0(%rip) */
	QUAD  $0xffffff302d6ffec5                   // vmovdqu      $-208(%rip), %ymm5  /* LCPI5_1(%rip) */
	QUAD  $0xffffff48356ffec5                   // vmovdqu      $-184(%rip), %ymm6  /* LCPI5_2(%rip) */
...
LBB5_14:
	...
	JL    LBB5_31
	CMPQ  BX, $16
	QUAD  $0xfffffe203d6ffac5     // vmovdqu      $-480(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD  $0xfffffe280d6f7ac5     // vmovdqu      $-472(%rip), %xmm9  /* LCPI5_4(%rip) */
	QUAD  $0xfffffe30156f7ac5     // vmovdqu      $-464(%rip), %xmm10  /* LCPI5_5(%rip) */
	LONG  $0x762141c4; BYTE $0xdb // vpcmpeqd     %xmm11, %xmm11, %xmm11
	JL    LBB5_36
	MOVQ  AX, CX
	SUBQ  R13, CX
	QUAD  $0xfffffd97256ffec5     // vmovdqu      $-617(%rip), %ymm4  /* LCPI5_0(%rip) */
	QUAD  $0xfffffdaf2d6ffec5     // vmovdqu      $-593(%rip), %ymm5  /* LCPI5_1(%rip) */
	QUAD  $0xfffffdc7356ffec5     // vmovdqu      $-569(%rip), %ymm6  /* LCPI5_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
...
LBB5_31:
	MOVQ  BX, R14
	MOVQ  R11, R15
	QUAD  $0xfffffbd2256ffec5     // vmovdqu      $-1070(%rip), %ymm4  /* LCPI5_0(%rip) */
	QUAD  $0xfffffbea2d6ffec5     // vmovdqu      $-1046(%rip), %ymm5  /* LCPI5_1(%rip) */
	QUAD  $0xfffffc02356ffec5     // vmovdqu      $-1022(%rip), %ymm6  /* LCPI5_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD  $0xfffffc153d6ffac5     // vmovdqu      $-1003(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD  $0xfffffc1d0d6f7ac5     // vmovdqu      $-995(%rip), %xmm9  /* LCPI5_4(%rip) */
	QUAD  $0xfffffc25156f7ac5     // vmovdqu      $-987(%rip), %xmm10  /* LCPI5_5(%rip) */
	LONG  $0x762141c4; BYTE $0xdb // vpcmpeqd     %xmm11, %xmm11, %xmm11
	TESTB DX, DX
	JE    LBB5_37
	JMP   LBB5_33
...
LBB5_36:
	MOVQ  BX, R14
	MOVQ  R11, R15
	QUAD  $0xfffffb89256ffec5     // vmovdqu      $-1143(%rip), %ymm4  /* LCPI5_0(%rip) */
	QUAD  $0xfffffba12d6ffec5     // vmovdqu      $-1119(%rip), %ymm5  /* LCPI5_1(%rip) */
	QUAD  $0xfffffbb9356ffec5     // vmovdqu      $-1095(%rip), %ymm6  /* LCPI5_2(%rip) */
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	TESTB DX, DX
	JNE   LBB5_33
...
LBB5_40:
	...
	MOVQ    BX, SI
	SHLQ    $4, SI
	LONG    $0xf9058d48; WORD $0x00b2; BYTE $0x00 // leaq         $45817(%rip), %rax  /* __SingleQuoteTab(%rip) */
	CMPQ    0(SI)(AX*1), $0
	JNE     LBB5_61
	LEAQ    0(R15)(CX*1), AX
	MOVB    BX, 0(R12)(DX*1)
...
LBB5_93:
	LONG $0x5f0d8d4c; WORD $0x00d0; BYTE $0x00 // leaq         $53343(%rip), %r9  /* __EscTab(%rip) */
	QUAD $0xfffff8a5156f7ec5                   // vmovdqu      $-1883(%rip), %ymm10  /* LCPI5_0(%rip) */
	QUAD $0xfffff8bd0d6f7ec5                   // vmovdqu      $-1859(%rip), %ymm9  /* LCPI5_1(%rip) */
	QUAD $0xfffff8d51d6f7ec5                   // vmovdqu      $-1835(%rip), %ymm11  /* LCPI5_2(%rip) */
	LONG $0x763d41c4; BYTE $0xc0               // vpcmpeqd     %ymm8, %ymm8, %ymm8
	MOVQ DX, BX
	MOVQ R14, SI
...
LBB5_97:
	...
	WORD  $0xf8c5; BYTE $0x77     // vzeroupper
	LONG  $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD  $0xfffff75f1d6f7ec5     // vmovdqu      $-2209(%rip), %ymm11  /* LCPI5_2(%rip) */
	QUAD  $0xfffff7370d6f7ec5     // vmovdqu      $-2249(%rip), %ymm9  /* LCPI5_1(%rip) */
	QUAD  $0xfffff70f156f7ec5     // vmovdqu      $-2289(%rip), %ymm10  /* LCPI5_0(%rip) */
	LEAQ  32(SI), AX
	CMPQ  AX, $48
	QUAD  $0xfffff75f3d6ffac5     // vmovdqu      $-2209(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD  $0xfffff7672d6ffac5     // vmovdqu      $-2201(%rip), %xmm5  /* LCPI5_4(%rip) */
	QUAD  $0xfffff76f256ffac5     // vmovdqu      $-2193(%rip), %xmm4  /* LCPI5_5(%rip) */
...
LBB5_110:
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x763d41c4; BYTE $0xc0 // vpcmpeqd     %ymm8, %ymm8, %ymm8
	QUAD $0xfffff7141d6f7ec5     // vmovdqu      $-2284(%rip), %ymm11  /* LCPI5_2(%rip) */
	QUAD $0xfffff6ec0d6f7ec5     // vmovdqu      $-2324(%rip), %ymm9  /* LCPI5_1(%rip) */
	QUAD $0xfffff6c4156f7ec5     // vmovdqu      $-2364(%rip), %ymm10  /* LCPI5_0(%rip) */
	QUAD $0xfffff71c3d6ffac5     // vmovdqu      $-2276(%rip), %xmm7  /* LCPI5_3(%rip) */
	QUAD $0xfffff7242d6ffac5     // vmovdqu      $-2268(%rip), %xmm5  /* LCPI5_4(%rip) */
	QUAD $0xfffff72c256ffac5     // vmovdqu      $-2260(%rip), %xmm4  /* LCPI5_5(%rip) */
	LONG $0xf676c9c5             // vpcmpeqd     %xmm6, %xmm6, %xmm6
...
_unquote:
	...
	MOVL  R8, R9
	ANDL  $1, R9
	QUAD  $0xffffff9c0d6ffec5 // vmovdqu      $-100(%rip), %ymm1  /* LCPI6_0(%rip) */
	QUAD  $0xffffffb4156ffac5 // vmovdqu      $-76(%rip), %xmm2  /* LCPI6_1(%rip) */
	MOVQ  DI, R11
	MOVQ  SI, R13
	MOVQ  DX, R8
...
LBB6_29:
	...
	MOVQ R11, R12
	SUBQ R14, R12
	QUAD $0xffffff1e0d6ffec5 // vmovdqu      $-226(%rip), %ymm1  /* LCPI6_0(%rip) */
	QUAD $0xffffff36156ffac5 // vmovdqu      $-202(%rip), %xmm2  /* LCPI6_1(%rip) */
...
LBB6_33:
	MOVQ R15, R10
	QUAD $0xfffffedb0d6ffec5 // vmovdqu      $-293(%rip), %ymm1  /* LCPI6_0(%rip) */
	QUAD $0xfffffef3156ffac5 // vmovdqu      $-269(%rip), %xmm2  /* LCPI6_1(%rip) */
...
LBB6_43:
	ADDQ    R14, R8
	MOVBLZX -1(R11), AX
	LONG    $0x5a0d8d48; WORD $0x00cc; BYTE $0x00 // leaq         $52314(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB    0(AX)(CX*1), AX
	CMPB    AX, $-1
	JE      LBB6_46
	TESTB   AX, AX
...
_html_escape:
	...
	MOVQ  -64(BP), AX
	MOVQ  0(AX), R9
	QUAD  $0xffffff051d6ffec5                   // vmovdqu      $-251(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD  $0xffffff1d256ffec5                   // vmovdqu      $-227(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD  $0xffffff352d6ffec5                   // vmovdqu      $-203(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD  $0xffffff4d356ffec5                   // vmovdqu      $-179(%rip), %ymm6  /* LCPI7_3(%rip) */
	LONG  $0xd5358d4c; WORD $0x00c1; BYTE $0x00 // leaq         $49621(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	MOVQ  -48(BP), R11
	MOVQ  -56(BP), R15
...
LBB7_38:
	...
	JL    LBB7_39
	CMPQ  AX, $16
	QUAD  $0xfffffe3f3d6ffac5 // vmovdqu      $-449(%rip), %xmm7  /* LCPI7_4(%rip) */
	QUAD  $0xfffffe47056f7ac5 // vmovdqu      $-441(%rip), %xmm8  /* LCPI7_5(%rip) */
	QUAD  $0xfffffe4f0d6f7ac5 // vmovdqu      $-433(%rip), %xmm9  /* LCPI7_6(%rip) */
	QUAD  $0xfffffe57156f7ac5 // vmovdqu      $-425(%rip), %xmm10  /* LCPI7_7(%rip) */
	JL    LBB7_41
	MOVQ  R11, DI
	SUBQ  R12, DI
	QUAD  $0xfffffd931d6ffec5 // vmovdqu      $-621(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD  $0xfffffdab256ffec5 // vmovdqu      $-597(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD  $0xfffffdc32d6ffec5 // vmovdqu      $-573(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD  $0xfffffddb356ffec5 // vmovdqu      $-549(%rip), %ymm6  /* LCPI7_3(%rip) */
...
LBB7_39:
	MOVQ AX, R13
	MOVQ R10, R14
	QUAD $0xfffffc791d6ffec5 // vmovdqu      $-903(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD $0xfffffc91256ffec5 // vmovdqu      $-879(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD $0xfffffca92d6ffec5 // vmovdqu      $-855(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD $0xfffffcc1356ffec5 // vmovdqu      $-831(%rip), %ymm6  /* LCPI7_3(%rip) */
	QUAD $0xfffffcd93d6ffac5 // vmovdqu      $-807(%rip), %xmm7  /* LCPI7_4(%rip) */
	QUAD $0xfffffce1056f7ac5 // vmovdqu      $-799(%rip), %xmm8  /* LCPI7_5(%rip) */
	QUAD $0xfffffce90d6f7ac5 // vmovdqu      $-791(%rip), %xmm9  /* LCPI7_6(%rip) */
	QUAD $0xfffffcf1156f7ac5 // vmovdqu      $-783(%rip), %xmm10  /* LCPI7_7(%rip) */
...
LBB7_58:
	...
	JGE  LBB7_59
	CMPQ R13, $8
	LONG $0xe5358d4c; WORD $0x00be; BYTE $0x00 // leaq         $48869(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	JB   LBB7_70
	MOVQ CX, 0(R8)
	LEAQ 8(R12), AX
	ADDQ $8, R8
...
LBB7_41:
	MOVQ  AX, R13
	MOVQ  R10, R14
	QUAD  $0xfffffbc31d6ffec5 // vmovdqu      $-1085(%rip), %ymm3  /* LCPI7_0(%rip) */
	QUAD  $0xfffffbdb256ffec5 // vmovdqu      $-1061(%rip), %ymm4  /* LCPI7_1(%rip) */
	QUAD  $0xfffffbf32d6ffec5 // vmovdqu      $-1037(%rip), %ymm5  /* LCPI7_2(%rip) */
	QUAD  $0xfffffc0b356ffec5 // vmovdqu      $-1013(%rip), %ymm6  /* LCPI7_3(%rip) */
	TESTB CX, CX
	JNE   LBB7_58
...
LBB7_59:
	CMPL AX, $8
	LONG $0x64358d4c; WORD $0x00bd; BYTE $0x00 // leaq         $48484(%rip), %r14  /* __HtmlQuoteTab(%rip) */
	JB   LBB7_60
	MOVQ CX, 0(R8)
	LEAQ 8(R12), R10
	ADDQ $8, R8
...
LBB7_82:
	LONG $0x8e358d4c; WORD $0x00bc; BYTE $0x00 // leaq         $48270(%rip), %r14  /* __HtmlQuoteTab(%rip) */
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0xe43d8d4c; WORD $0x0041; BYTE $0x00 // leaq         $16868(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0xd9358d4c; WORD $0x006b; BYTE $0x00 // leaq         $27609(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x003eafe8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0x9b358d4c; WORD $0x006b; BYTE $0x00 // leaq         $27547(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x003cd3e8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x003e14e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x003dcde8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x003c14e8; BYTE $0x00 // callq        _left_shift
...
LBB9_41:
	...
	JB   LBB9_52
	MOVL DX, R8
	QUAD $0xfffffdc3056ffac5               // vmovdqu      $-573(%rip), %xmm0  /* LCPI9_0(%rip) */
	LONG $0x22f9c3c4; WORD $0x00c4         // vpinsrq      $0, %r12, %xmm0, %xmm0
	ANDL $-16, R8
	QUAD $0xfffdaf05027de3c4; WORD $0xf0ff // vpblendd     $240, $-593(%rip), %ymm0, %ymm0  /* LCPI9_0(%rip) */
	LEAL -16(R8), CX
	MOVL CX, DI
	SHRL $4, DI
	ADDL $1, DI
	...
	CMPL CX, $48
	JAE  LBB9_45
	QUAD $0xfffdb015597de2c4; BYTE $0xff   // vpbroadcastq $-592(%rip), %ymm2  /* LCPI9_1(%rip) */
...
LBB9_45:
	ANDL $-4, DI
	NEGL DI
	QUAD $0xfffd9815597de2c4; BYTE $0xff // vpbroadcastq $-616(%rip), %ymm2  /* LCPI9_1(%rip) */
	QUAD $0xfffd9725597de2c4; BYTE $0xff // vpbroadcastq $-617(%rip), %ymm4  /* LCPI9_2(%rip) */
	LONG $0xda6ffdc5                     // vmovdqa      %ymm2, %ymm3
	LONG $0xca6ffdc5                     // vmovdqa      %ymm2, %ymm1
...
LBB9_47:
	...
	JE    LBB9_50
	NEGL  SI
	QUAD  $0xfffd2b25597de2c4; BYTE $0xff // vpbroadcastq $-725(%rip), %ymm4  /* LCPI9_3(%rip) */
...
LBB11_52:
	...
	LONG $0xc6258d4c; WORD $0x00da; BYTE $0x00 // leaq         $56006(%rip), %r12  /* _printhex.tab(%rip) */
	JMP  LBB11_1
...
LBB11_25:
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0038c7e8; BYTE $0x00 // callq        _write_syscall
	XORL AX, AX
...
LBB11_8:
	MOVQ    BX, DI
	WORD    $0xf8c5; BYTE $0x77     // vzeroupper
	LONG    $0x00387ce8; BYTE $0x00 // callq        _write_syscall
	MOVBLSX 1(R15), CX
	ADDQ    $2, R15
	CMPL    CX, $114
	JG      LBB11_13
...
LBB11_43:
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0036d9e8; BYTE $0x00 // callq        _write_syscall
	XORL AX, AX
	LEAQ 96(SP), BX
	JMP  LBB11_1
...
LBB11_49:
	LEAQ 96(SP), DI
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x003651e8; BYTE $0x00 // callq        _write_syscall
...
_value:
	...
	LEAQ    -80(BP), DI
	LEAQ    -48(BP), SI
	LONG    $0x0005d3e8; BYTE $0x00               // callq        _advance_ns
	MOVBLSX AX, AX
	CMPL    AX, $125
	JA      LBB12_11
	LONG    $0x080d8d48; WORD $0x0003; BYTE $0x00 // leaq         $776(%rip), %rcx  /* LJTI12_0(%rip) */
...
LBB12_2:
	...
	LEAQ  -48(BP), SI
	MOVQ  -56(BP), DX
	LONG  $0x00165ce8; BYTE $0x00 // callq        _vnumber
	MOVQ  -48(BP), BX
	JMP   LBB12_49
...
LBB12_7:
	MOVQ  BX, DI
	MOVQ  R12, SI
	LONG  $0x002a41e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB12_45
	ADDQ  AX, BX
	SUBQ  R15, BX
...
LBB12_12:
	...
	MOVQ  $-1, -64(BP)
	MOVQ  -48(BP), R15
	LONG  $0x0b3d8d48; WORD $0x0061; BYTE $0x00 // leaq         $24843(%rip), %rdi  /* L_.str.1(%rip) */
	MOVQ  BX, SI
	XORL  AX, AX
	LONG  $0xfffb20e8; BYTE $0xff               // callq        _xprintf
	LEAQ  -80(BP), DI
	LEAQ  -64(BP), DX
	MOVQ  R15, SI
	LONG  $0x001204e8; BYTE $0x00               // callq        _advance_string_old
	MOVQ  AX, BX
	TESTQ AX, AX
	JS    LBB12_33
	MOVQ  BX, -48(BP)
...
LJTI12_0:
	LONG $0xfffffd92 // .long L12_0_set_10
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	...
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffdb6 // .long L12_0_set_12
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	...
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffe1d // .long L12_0_set_14
	LONG $0xfffffd01 // .long L12_0_set_2
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffd01 // .long L12_0_set_2
	LONG $0xfffffd01 // .long L12_0_set_2
	...
	LONG $0xfffffd01 // .long L12_0_set_2
	LONG $0xfffffd01 // .long L12_0_set_2
	LONG $0xfffffe2b // .long L12_0_set_15
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	...
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffe39 // .long L12_0_set_16
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffe49 // .long L12_0_set_17
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	...
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffe57 // .long L12_0_set_18
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	...
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffe87 // .long L12_0_set_21
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffeb8 // .long L12_0_set_27
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xfffffef9 // .long L12_0_set_30
	LONG $0xfffffda2 // .long L12_0_set_11
	LONG $0xffffff09 // .long L12_0_set_31
...
LBB13_28:
	...
	MOVQ R9, AX
	SUBQ BX, AX
	QUAD $0xfffffe26056ffec5 // vmovdqu      $-474(%rip), %ymm0  /* LCPI13_0(%rip) */
	QUAD $0xfffffe3e0d6ffec5 // vmovdqu      $-450(%rip), %ymm1  /* LCPI13_1(%rip) */
	QUAD $0xfffffe56156ffec5 // vmovdqu      $-426(%rip), %ymm2  /* LCPI13_2(%rip) */
	QUAD $0xfffffe6e1d6ffec5 // vmovdqu      $-402(%rip), %ymm3  /* LCPI13_3(%rip) */
...
LBB13_32:
	...
	MOVQ R9, R10
	SUBQ BX, R10
	QUAD $0xfffffe38056ffac5 // vmovdqu      $-456(%rip), %xmm0  /* LCPI13_4(%rip) */
	QUAD $0xfffffe400d6ffac5 // vmovdqu      $-448(%rip), %xmm1  /* LCPI13_5(%rip) */
	QUAD $0xfffffe48156ffac5 // vmovdqu      $-440(%rip), %xmm2  /* LCPI13_6(%rip) */
	QUAD $0xfffffe501d6ffac5 // vmovdqu      $-432(%rip), %xmm3  /* LCPI13_7(%rip) */
...
_vstring:
	...
	TESTB $32, CX
	JNE   LBB14_1
	LONG  $0x843d8d48; WORD $0x0059; BYTE $0x00 // leaq         $22916(%rip), %rdi  /* L_.str.1(%rip) */
	MOVQ  CX, SI
	XORL  AX, AX
	LONG  $0xfff399e8; BYTE $0xff               // callq        _xprintf
	LEAQ  -40(BP), DX
	MOVQ  R15, DI
	MOVQ  R12, SI
	LONG  $0x000a7ee8; BYTE $0x00               // callq        _advance_string_old
	TESTQ AX, AX
	JS    LBB14_4
...
LBB14_1:
	LONG  $0x213d8d48; WORD $0x0059; BYTE $0x00 // leaq         $22817(%rip), %rdi  /* L_.str(%rip) */
	MOVQ  CX, SI
	XORL  AX, AX
	LONG  $0xfff350e8; BYTE $0xff               // callq        _xprintf
	MOVQ  0(R15), DI
	MOVQ  8(R15), SI
	LEAQ  -40(BP), CX
	MOVQ  R12, DX
	LONG  $0x00009ce8; BYTE $0x00               // callq        _advance_validate_string
	TESTQ AX, AX
	JNS   LBB14_5
...
LBB15_2:
	LONG $0x203d8d48; WORD $0x00d0; BYTE $0x00 // leaq         $53280(%rip), %rdi  /* L_.str.23(%rip) */
	XORL AX, AX
	LONG $0xfff247e8; BYTE $0xff               // callq        _xprintf
...
LBB15_5:
	...
	MOVQ  BX, DX
	ORQ   R15, DX
	LONG  $0x863d8d48; WORD $0x00cd; BYTE $0x00 // leaq         $52614(%rip), %rdi  /* L_.str.7(%rip) */
	MOVQ  SI, R14
	MOVQ  R13, CX
	XORL  AX, AX
	WORD  $0xf8c5; BYTE $0x77                   // vzeroupper
	LONG  $0xfff185e8; BYTE $0xff               // callq        _xprintf
	ORQ   R15, BX
	JNE   LBB15_19
	TESTQ R13, R13
	JNE   LBB15_21
...
LBB15_8:
	...
	SHLQ  $32, R14
	QUAD  $0xfffffe72056ffec5                   // vmovdqu      $-398(%rip), %ymm0  /* LCPI15_2(%rip) */
	LONG  $0x4c6ffdc5; WORD $0x4024             // vmovdqa      $64(%rsp), %ymm1
	LONG  $0xc164fdc5                           // vpcmpgtb     %ymm1, %ymm0, %ymm0
	QUAD  $0xfffffe800d64f5c5                   // vpcmpgtb     $-384(%rip), %ymm1, %ymm1  /* LCPI15_3(%rip) */
	LONG  $0xc1dbfdc5                           // vpand        %ymm1, %ymm0, %ymm0
	LONG  $0xc0d7fdc5                           // vpmovmskb    %ymm0, %eax
	ORQ   AX, R12
	LONG  $0x203d8d48; WORD $0x00cd; BYTE $0x00 // leaq         $52512(%rip), %rdi  /* L_.str.7(%rip) */
	MOVQ  R15, SI
	MOVQ  CX, 128(SP)
	XORL  AX, AX
	WORD  $0xf8c5; BYTE $0x77                   // vzeroupper
	LONG  $0xfff11ae8; BYTE $0xff               // callq        _xprintf
	MOVL  $64, BX
	MOVL  $64, R13
	TESTQ R15, R15
	JE    LBB15_10
...
LBB15_15:
	...
	MOVQ  24(SP), CX
	LEAQ  0(AX)(CX*1), SI
	LONG  $0xd23d8d48; WORD $0x00cc; BYTE $0x00 // leaq         $52434(%rip), %rdi  /* L_.str.8(%rip) */
	MOVQ  40(SP), DX
	XORL  AX, AX
	WORD  $0xf8c5; BYTE $0x77                   // vzeroupper
	LONG  $0xfff0b1e8; BYTE $0xff               // callq        _xprintf
	LONG  $0xde3d8d48; WORD $0x00cc; BYTE $0x00 // leaq         $52446(%rip), %rdi  /* L_.str.9(%rip) */
	MOVQ  R13, SI
	MOVQ  R15, R12
	MOVQ  R15, DX
	MOVQ  BX, CX
	XORL  AX, AX
	LONG  $0xfff097e8; BYTE $0xff               // callq        _xprintf
	CMPQ  56(SP), $0
	JNE   LBB15_22
	CMPQ  64(SP), $0
	JNE   LBB15_60
...
LBB15_25:
	LONG $0x123d8d48; WORD $0x00cd; BYTE $0x00 // leaq         $52498(%rip), %rdi  /* L_.str.20(%rip) */
	MOVQ BX, SI
	MOVQ R13, DX
	XORL AX, AX
	LONG $0xffefa6e8; BYTE $0xff               // callq        _xprintf
	MOVQ BX, R15
	ADDQ R12, R15
	SUBQ R12, R13
	CMPQ R13, $4
	MOVQ R13, R12
	JB   LBB15_64
	LONG $0x69358d4c; WORD $0x00cd; BYTE $0x00 // leaq         $52585(%rip), %r14  /* L_.str.24(%rip) */
	LONG $0x3a2d8d4c; WORD $0x00cd; BYTE $0x00 // leaq         $52538(%rip), %r13  /* L_.str.22(%rip) */
...
LBB15_27:
	...
	MOVL  BX, SI
	XORL  AX, AX
	LONG  $0xffef73e8; BYTE $0xff // callq        _xprintf
	MOVL  BX, AX
	ANDL  $12632304, AX
	CMPL  AX, $8421600
	JNE   LBB15_30
...
LBB15_36:
	...
	MOVQ    R13, DI
	XORL    AX, AX
	LONG    $0xffeed6e8; BYTE $0xff // callq        _xprintf
	MOVQ    BX, R15
	CMPQ    R12, $3
	JA      LBB15_27
	JMP     LBB15_68
...
LBB15_40:
	...
	QUAD  $0xfffffb850d74fdc5                   // vpcmpeqb     $-1147(%rip), %ymm0, %ymm1  /* LCPI15_0(%rip) */
	LONG  $0xe9d77dc5                           // vpmovmskb    %ymm1, %r13d
	QUAD  $0xfffffb990d74fdc5                   // vpcmpeqb     $-1127(%rip), %ymm0, %ymm1  /* LCPI15_1(%rip) */
	LONG  $0xf1d77dc5                           // vpmovmskb    %ymm1, %r14d
	QUAD  $0xfffffbad0d6ffec5                   // vmovdqu      $-1107(%rip), %ymm1  /* LCPI15_2(%rip) */
	LONG  $0xc864f5c5                           // vpcmpgtb     %ymm0, %ymm1, %ymm1
	QUAD  $0xfffffbc11564fdc5                   // vpcmpgtb     $-1087(%rip), %ymm0, %ymm2  /* LCPI15_3(%rip) */
	LONG  $0xcadbf5c5                           // vpand        %ymm2, %ymm1, %ymm1
	LONG  $0xc9d7fdc5                           // vpmovmskb    %ymm1, %ecx
	LONG  $0xc0d77dc5                           // vpmovmskb    %ymm0, %r8d
	LONG  $0xc13d8d48; WORD $0x00ca; BYTE $0x00 // leaq         $51905(%rip), %rdi  /* L_.str.10(%rip) */
	MOVQ  R13, SI
	MOVQ  R14, DX
	MOVQ  CX, 24(SP)
	MOVQ  R8, 64(SP)
	XORL  AX, AX
	WORD  $0xf8c5; BYTE $0x77                   // vzeroupper
	LONG  $0xffee55e8; BYTE $0xff               // callq        _xprintf
	TESTL R14, R14
	JNE   LBB15_53
	TESTQ R15, R15
	JNE   LBB15_55
...
LBB15_43:
	MOVQ  24(SP), CX
	LONG  $0x7d3d8d48; WORD $0x00ca; BYTE $0x00 // leaq         $51837(%rip), %rdi  /* L_.str.10(%rip) */
	MOVQ  R13, SI
	MOVQ  64(SP), R14
	MOVQ  R14, R8
	XORL  AX, AX
	LONG  $0xffee19e8; BYTE $0xff               // callq        _xprintf
	TESTQ R13, R13
	MOVQ  BX, 8(SP)
	MOVQ  R12, 40(SP)
	MOVQ  R13, 56(SP)
...
LBB15_46:
	...
	MOVQ  8(SP), R14
	SUBQ  32(SP), R14
	LONG  $0x3f3d8d48; WORD $0x00ca; BYTE $0x00 // leaq         $51775(%rip), %rdi  /* L_.str.11(%rip) */
	MOVQ  R14, SI
	MOVQ  40(SP), DX
	XORL  AX, AX
	LONG  $0xffedb0e8; BYTE $0xff               // callq        _xprintf
	LONG  $0x4b3d8d48; WORD $0x00ca; BYTE $0x00 // leaq         $51787(%rip), %rdi  /* L_.str.12(%rip) */
	MOVQ  R13, SI
	MOVQ  R15, 48(SP)
	MOVQ  R15, DX
	MOVQ  R12, CX
	XORL  AX, AX
	LONG  $0xffed94e8; BYTE $0xff               // callq        _xprintf
	CMPQ  56(SP), $0
	JE    LBB15_49
	CMPQ  R12, R13
	JB    LBB15_101
...
LBB15_56:
	MOVL    -4(R15), DX
	MOVBLZX 0(R15), CX
	LONG    $0x1d3d8d48; WORD $0x00ca; BYTE $0x00 // leaq         $51741(%rip), %rdi  /* L_.str.21(%rip) */
	XORL    SI, SI
	MOVQ    R15, R8
	XORL    AX, AX
	LONG    $0xffec9be8; BYTE $0xff               // callq        _xprintf
	SUBQ    32(SP), R15
	MOVQ    16(SP), AX
	MOVQ    R15, 0(AX)
...
LBB15_68:
	MOVQ  BX, R14
	SUBQ  32(SP), R14
	LONG  $0xaa3d8d48; WORD $0x00c8; BYTE $0x00 // leaq         $51370(%rip), %rdi  /* L_.str.13(%rip) */
	MOVQ  R14, SI
	MOVQ  R12, DX
	XORL  AX, AX
	LONG  $0xffebdde8; BYTE $0xff               // callq        _xprintf
	TESTQ R12, R12
	JE    LBB15_99
	MOVQ  BX, 8(SP)
	LONG  $0xa23d8d48; WORD $0x00c8; BYTE $0x00 // leaq         $51362(%rip), %rdi  /* L_.str.14(%rip) */
	MOVQ  32(SP), R13
...
LBB15_70:
	...
	MOVQ    R12, DX
	XORL    AX, AX
	LONG    $0xffebaae8; BYTE $0xff // callq        _xprintf
	MOVBLZX 0(R15), R12
	CMPL    R12, $34
	JE      LBB15_97
	CMPB    R12, $92
...
LBB15_81:
	SUBQ  32(SP), R13
	LONG  $0x283d8d48; WORD $0x00c8; BYTE $0x00 // leaq         $51240(%rip), %rdi  /* L_.str.17(%rip) */
	MOVQ  R13, SI
	MOVL  R12, DX
	XORL  AX, AX
	LONG  $0xffeb16e8; BYTE $0xff               // callq        _xprintf
	LONG  $0xef3d8d48; WORD $0x00c8; BYTE $0x00 // leaq         $51439(%rip), %rdi  /* L_.str.24(%rip) */
	MOVL  R12, SI
	XORL  AX, AX
	LONG  $0xffeb05e8; BYTE $0xff               // callq        _xprintf
	MOVL  R12, AX
	ANDL  $12632304, AX
	CMPL  AX, $8421600
	JNE   LBB15_84
...
LBB15_93:
	CMPQ BX, $1
	JE   LBB15_109
	LONG $0x563d8d48; WORD $0x00c7; BYTE $0x00 // leaq         $51030(%rip), %rdi  /* L_.str.16(%rip) */
	XORL AX, AX
	LONG $0xffea51e8; BYTE $0xff               // callq        _xprintf
	MOVQ 16(SP), AX
	CMPQ 0(AX), $-1
	JNE  LBB15_96
	MOVQ 8(SP), AX
...
LBB15_97:
	SUBQ R13, R15
	ADDQ $1, R15
	LONG $0x0a3d8d48; WORD $0x00c7; BYTE $0x00 // leaq         $50954(%rip), %rdi  /* L_.str.15(%rip) */
	MOVQ R15, SI
	XORL AX, AX
	LONG $0xffea0de8; BYTE $0xff               // callq        _xprintf
	MOVQ R15, AX
	JMP  LBB15_58
...
LBB15_99:
	MOVQ 16(SP), AX
	MOVQ 0(AX), CX
	LONG $0x173d8d48; WORD $0x00c7; BYTE $0x00 // leaq         $50967(%rip), %rdi  /* L_.str.18(%rip) */
	MOVQ R14, SI
	XORL DX, DX
	XORL AX, AX
	LONG $0xffe9e2e8; BYTE $0xff               // callq        _xprintf
	LONG $0x2e3d8d48; WORD $0x00c7; BYTE $0x00 // leaq         $50990(%rip), %rdi  /* L_.str.19(%rip) */
	XORL AX, AX
	LONG $0xffe9d4e8; BYTE $0xff               // callq        _xprintf
	MOVQ $-1, AX
	JMP  LBB15_58
...
LBB16_3:
	...
	QUAD  $0xffffff581d6ffec5                   // vmovdqu      $-168(%rip), %ymm3  /* LCPI16_0(%rip) */
	...
	QUAD  $0xffffff60156ffec5                   // vmovdqu      $-160(%rip), %ymm2  /* LCPI16_1(%rip) */
	...
	MOVQ  R12, DX
	ORQ   R14, DX
	LONG  $0x553d8d48; WORD $0x00c4; BYTE $0x00 // leaq         $50261(%rip), %rdi  /* L_.str.7(%rip) */
	MOVQ  R15, SI
	XORL  AX, AX
	MOVQ  CX, BX
	WORD  $0xf8c5; BYTE $0x77                   // vzeroupper
	LONG  $0xffe854e8; BYTE $0xff               // callq        _xprintf
	ORQ   R14, R12
	JNE   LBB16_8
	TESTQ BX, BX
	MOVQ  BX, SI
...
LBB16_6:
	LONG  $0x2d3d8d48; WORD $0x00c4; BYTE $0x00 // leaq         $50221(%rip), %rdi  /* L_.str.7(%rip) */
	MOVQ  R15, SI
	MOVQ  CX, R14
	XORL  AX, AX
	LONG  $0xffe82fe8; BYTE $0xff               // callq        _xprintf
	TESTQ R15, R15
	JNE   LBB16_11
	MOVQ  -72(BP), BX
	ADDQ  $-64, BX
...
LBB16_14:
	...
	QUAD  $0xfffffe160d74fdc5                   // vpcmpeqb     $-490(%rip), %ymm0, %ymm1  /* LCPI16_0(%rip) */
	LONG  $0xf9d77dc5                           // vpmovmskb    %ymm1, %r15d
	QUAD  $0xfffffe2a0574fdc5                   // vpcmpeqb     $-470(%rip), %ymm0, %ymm0  /* LCPI16_1(%rip) */
	LONG  $0xd8d7fdc5                           // vpmovmskb    %ymm0, %ebx
	LONG  $0x443d8d48; WORD $0x00c5; BYTE $0x00 // leaq         $50500(%rip), %rdi  /* L_.str.25(%rip) */
	MOVQ  R15, SI
	MOVQ  BX, DX
	XORL  AX, AX
	WORD  $0xf8c5; BYTE $0x77                   // vzeroupper
	LONG  $0xffe73be8; BYTE $0xff               // callq        _xprintf
	TESTL BX, BX
	JNE   LBB16_39
	TESTQ R12, R12
	JNE   LBB16_41
...
LBB16_17:
	LONG  $0x173d8d48; WORD $0x00c5; BYTE $0x00 // leaq         $50455(%rip), %rdi  /* L_.str.25(%rip) */
	MOVQ  R15, SI
	XORL  AX, AX
	LONG  $0xffe714e8; BYTE $0xff               // callq        _xprintf
	TESTQ R15, R15
	JE    LBB16_19
	BSFQ  R15, AX
	SUBQ  -56(BP), R13
...
LBB17_69:
	...
	IMULQ CX, R12
	QUAD  $0xfffffcd10562f9c5       // vpunpckldq   $-815(%rip), %xmm0, %xmm0  /* LCPI17_0(%rip) */
	QUAD  $0xfffffcd9055cf9c5       // vsubpd       $-807(%rip), %xmm0, %xmm0  /* LCPI17_1(%rip) */
	MOVQ  R12, 16(BX)
...
LBB17_61:
	MOVQ  $0, -80(BP)
	LONG  $0x6ef9c1c4; BYTE $0xc4               // vmovq        %r12, %xmm0
	QUAD  $0xfffffc320562f9c5                   // vpunpckldq   $-974(%rip), %xmm0, %xmm0  /* LCPI17_0(%rip) */
	QUAD  $0xfffffc3a055cf9c5                   // vsubpd       $-966(%rip), %xmm0, %xmm0  /* LCPI17_1(%rip) */
	LONG  $0x0579e3c4; WORD $0x01c8             // vpermilpd    $1, %xmm0, %xmm1
	LONG  $0xc058f3c5                           // vaddsd       %xmm0, %xmm1, %xmm0
	...
	JL    LBB17_70
	LEAL  -22(SI), AX
	LONG  $0x840d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $49028(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB17_67:
	...
	JB   LBB17_74
	NEGL SI
	LONG $0x65058d48; WORD $0x00bf; BYTE $0x00 // leaq         $48997(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB17_71:
	QUAD $0xfffffbb7052ef9c5                   // vucomisd     $-1097(%rip), %xmm0  /* LCPI17_2(%rip) */
	JA   LBB17_74
	QUAD $0xfffffbb50d10fbc5                   // vmovsd       $-1099(%rip), %xmm1  /* LCPI17_3(%rip) */
	LONG $0xc82ef9c5                           // vucomisd     %xmm0, %xmm1
	JA   LBB17_74
	MOVL AX, AX
	LONG $0x360d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $48950(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB17_78
...
LBB17_74:
	...
	MOVQ  R12, DI
	MOVQ  SI, -88(BP)
	LONG  $0xffd8e0e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB17_80
	MOVQ  -88(BP), SI
	CMPL  -68(BP), $0
	...
	MOVQ  R12, DI
	MOVL  -44(BP), DX
	LONG  $0xffd8bfe8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB17_80
...
LBB17_80:
	...
	MOVQ -56(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffded4e8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB17_83
...
LBB21_6:
	...
	MOVQ    -48(BP), BX
	MOVQ    BX, SI
	LONG    $0xffe749e8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R15), DX
	LEAQ    -1(DX), CX
	CMPQ    R12, $-1
	JNE     LBB21_8
...
LBB21_8:
	...
	CMPL    SI, $5
	JA      LBB21_13
	LONG    $0x703d8d48; WORD $0x0005; BYTE $0x00 // leaq         $1392(%rip), %rdi  /* LJTI21_0(%rip) */
...
LBB21_19:
	...
	MOVQ  BX, SI
	LEAQ  -64(BP), DX
	LONG  $0xfff3dbe8; BYTE $0xff               // callq        _advance_string_old
	LONG  $0xad3d8d48; WORD $0x00bb; BYTE $0x00 // leaq         $48045(%rip), %rdi  /* L_.str.26(%rip) */
	XORL  AX, AX
	LONG  $0xffdcd9e8; BYTE $0xff               // callq        _xprintf
	MOVQ  0(R14), DI
	MOVQ  8(R14), SI
	MOVQ  BX, DX
	LEAQ  -96(BP), CX
	LONG  $0xffea25e8; BYTE $0xff               // callq        _advance_validate_string
	MOVQ  AX, R14
	TESTQ AX, AX
	JS    LBB21_62
	MOVQ  R14, 0(R13)
...
LBB21_29:
	MOVQ    $-1, R14
	LONG    $0x8d0d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1165(%rip), %rcx  /* LJTI21_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB21_30:
	...
	MOVQ  8(AX), SI
	SUBQ  R14, SI
	LONG  $0x000aede8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB21_64
	MOVQ  0(BX), CX
	ADDQ  CX, AX
...
LBB21_36:
	...
	MOVQ  DX, -88(BP)
	LEAQ  -64(BP), CX
	LONG  $0xffe8e2e8; BYTE $0xff // callq        _advance_validate_string
	MOVQ  BX, CX
	MOVQ  AX, BX
	TESTQ AX, AX
	JS    LBB21_69
	...
	ADDQ  AX, SI
	ADDQ  0(R13), DI
	LONG  $0x0006b2e8; BYTE $0x00 // callq        _utf8_validate
	TESTQ AX, AX
	JNS   LBB21_70
	MOVQ  -48(BP), AX
	MOVQ  BX, 0(AX)
...
LBB21_40:
	...
	MOVQ  BX, SI
	LEAQ  -64(BP), DX
	LONG  $0xfff21ae8; BYTE $0xff               // callq        _advance_string_old
	LONG  $0xec3d8d48; WORD $0x00b9; BYTE $0x00 // leaq         $47596(%rip), %rdi  /* L_.str.26(%rip) */
	XORL  AX, AX
	LONG  $0xffdb18e8; BYTE $0xff               // callq        _xprintf
	MOVQ  0(R14), DI
	MOVQ  8(R14), SI
	MOVQ  BX, DX
	LEAQ  -96(BP), CX
	LONG  $0xffe864e8; BYTE $0xff               // callq        _advance_validate_string
	MOVQ  AX, R14
	TESTQ AX, AX
	JS    LBB21_62
	MOVQ  R14, 0(R13)
...
LBB21_44:
	...
	MOVQ  DX, -88(BP)
	LEAQ  -64(BP), CX
	LONG  $0xffe7fee8; BYTE $0xff // callq        _advance_validate_string
	MOVQ  AX, R14
	TESTQ AX, AX
	JS    LBB21_89
	MOVQ  0(BX), DI
	...
	ADDQ  AX, SI
	ADDQ  0(R13), DI
	LONG  $0x0005d1e8; BYTE $0x00 // callq        _utf8_validate
	TESTQ AX, AX
	JNS   LBB21_90
	MOVQ  R14, 0(BX)
	MOVQ  -88(BP), R14
...
LBB21_48:
	...
	MOVQ  8(R13), SI
	SUBQ  R14, SI
	LONG  $0x0008f4e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB21_71
	ADDQ  AX, 0(BX)
	TESTQ R14, R14
...
LBB21_69:
	CMPQ BX, $-1
	LEAQ -64(BP), AX
	LONG $0x45440f48; BYTE $0xc8 // cmoveq       $-56(%rbp), %rax
	MOVQ 0(AX), AX
	MOVQ AX, 0(CX)
	MOVQ BX, R14
	JMP  LBB21_88
...
LJTI21_0:
	LONG $0xfffffa99 // .long L21_0_set_10
	LONG $0xfffffac7 // .long L21_0_set_14
	LONG $0xfffffae1 // .long L21_0_set_17
	LONG $0xfffffb4c // .long L21_0_set_21
	LONG $0xfffffb61 // .long L21_0_set_23
	LONG $0xfffffbdc // .long L21_0_set_25

	// .set L21_1_set_88, LBB21_88-LJTI21_1
	// .set L21_1_set_87, LBB21_87-LJTI21_1
	// .set L21_1_set_44, LBB21_44-LJTI21_1
	// .set L21_1_set_48, LBB21_48-LJTI21_1
	// .set L21_1_set_30, LBB21_30-LJTI21_1
	// .set L21_1_set_50, LBB21_50-LJTI21_1
	// .set L21_1_set_52, LBB21_52-LJTI21_1
	// .set L21_1_set_55, LBB21_55-LJTI21_1
	// .set L21_1_set_57, LBB21_57-LJTI21_1
	// .set L21_1_set_59, LBB21_59-LJTI21_1
LJTI21_1:
	LONG $0xfffffee3 // .long L21_1_set_88
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	...
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffd13 // .long L21_1_set_44
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	...
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffd7b // .long L21_1_set_48
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffb7c // .long L21_1_set_30
	LONG $0xfffffb7c // .long L21_1_set_30
	LONG $0xfffffb7c // .long L21_1_set_30
	LONG $0xfffffb7c // .long L21_1_set_30
	LONG $0xfffffb7c // .long L21_1_set_30
	...
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffdaf // .long L21_1_set_50
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	...
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffdd2 // .long L21_1_set_52
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	...
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffe15 // .long L21_1_set_55
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffe4b // .long L21_1_set_57
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffedc // .long L21_1_set_87
	LONG $0xfffffe81 // .long L21_1_set_59
...
_skip_string:
	...
	LEAQ  -40(BP), DX
	MOVQ  BX, SI
	LONG  $0xffec70e8; BYTE $0xff               // callq        _advance_string_old
	LONG  $0x423d8d48; WORD $0x00b4; BYTE $0x00 // leaq         $46146(%rip), %rdi  /* L_.str.26(%rip) */
	XORL  AX, AX
	LONG  $0xffd56ee8; BYTE $0xff               // callq        _xprintf
	MOVQ  0(R15), DI
	MOVQ  8(R15), SI
	LEAQ  -32(BP), CX
	MOVQ  BX, DX
	LONG  $0xffe2bae8; BYTE $0xff               // callq        _advance_validate_string
	TESTQ AX, AX
	JS    LBB24_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	MOVQ  R15, DX
	MOVQ  R13, CX
	LONG  $0xffe26ae8; BYTE $0xff // callq        _advance_validate_string
	MOVQ  AX, R12
	TESTQ AX, AX
	JS    LBB25_1
	MOVQ  0(R14), DI
	...
	ADDQ  AX, SI
	ADDQ  0(BX), DI
	LONG  $0x000042e8; BYTE $0x00 // callq        _utf8_validate
	TESTQ AX, AX
	JS    LBB25_3
	ADDQ  0(R14), AX
	MOVQ  $-2, R12
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB26_35
	LONG  $0x77058d4c; WORD $0x00b3; BYTE $0x00 // leaq         $45943(%rip), %r8  /* _first(%rip) */
	LONG  $0x700d8d4c; WORD $0x00b4; BYTE $0x00 // leaq         $46192(%rip), %r9  /* _ranges(%rip) */
	LONG  $0x84158d4c; WORD $0x0001; BYTE $0x00 // leaq         $388(%rip), %r10  /* LJTI26_0(%rip) */
	MOVQ  DI, R11
...
// .set L26_0_set_33, LBB26_33-LJTI26_0
// .set L26_0_set_30, LBB26_30-LJTI26_0
// .set L26_0_set_28, LBB26_28-LJTI26_0
// .set L26_0_set_26, LBB26_26-LJTI26_0
LJTI26_0:
	LONG $0xffffff9a // .long L26_0_set_34
	LONG $0xfffffff0 // .long L26_0_set_33
	LONG $0xffffff7d // .long L26_0_set_30
	LONG $0xffffff70 // .long L26_0_set_28
	LONG $0xffffff5b // .long L26_0_set_26
...
LBB28_6:
	...
	JB   LBB28_7
	XORL AX, AX
	QUAD $0xfffffe47056ffec5 // vmovdqu      $-441(%rip), %ymm0  /* LCPI28_0(%rip) */
	QUAD $0xfffffe5f0d6ffec5 // vmovdqu      $-417(%rip), %ymm1  /* LCPI28_1(%rip) */
	QUAD $0xfffffe77156ffec5 // vmovdqu      $-393(%rip), %ymm2  /* LCPI28_2(%rip) */
	QUAD $0xfffffe8f1d6ffec5 // vmovdqu      $-369(%rip), %ymm3  /* LCPI28_3(%rip) */
	QUAD $0xfffffea7256ffec5 // vmovdqu      $-345(%rip), %ymm4  /* LCPI28_4(%rip) */
	QUAD $0xfffffebf2d6ffec5 // vmovdqu      $-321(%rip), %ymm5  /* LCPI28_5(%rip) */
	QUAD $0xfffffed7356ffec5 // vmovdqu      $-297(%rip), %ymm6  /* LCPI28_6(%rip) */
	MOVQ $-1, R8
	MOVQ $-1, R10
...
LBB28_29:
	...
	SUBQ DI, R11
	XORL AX, AX
	QUAD $0xfffffdce056f7ac5 // vmovdqu      $-562(%rip), %xmm8  /* LCPI28_7(%rip) */
	QUAD $0xfffffdd60d6f7ac5 // vmovdqu      $-554(%rip), %xmm9  /* LCPI28_8(%rip) */
	QUAD $0xfffffdde156f7ac5 // vmovdqu      $-546(%rip), %xmm10  /* LCPI28_9(%rip) */
	QUAD $0xfffffde61d6f7ac5 // vmovdqu      $-538(%rip), %xmm11  /* LCPI28_10(%rip) */
	QUAD $0xfffffdee256ffac5 // vmovdqu      $-530(%rip), %xmm4  /* LCPI28_11(%rip) */
	QUAD $0xfffffdf62d6ffac5 // vmovdqu      $-522(%rip), %xmm5  /* LCPI28_12(%rip) */
	QUAD $0xfffffdfe356ffac5 // vmovdqu      $-514(%rip), %xmm6  /* LCPI28_13(%rip) */
...
LBB28_49:
	...
	SUBQ  DI, DX
	XORL  AX, AX
	LONG  $0x813d8d4c; WORD $0x0001; BYTE $0x00 // leaq         $385(%rip), %r15  /* LJTI28_0(%rip) */
	JMP   LBB28_51
...
// .set L28_0_set_66, LBB28_66-LJTI28_0
// .set L28_0_set_57, LBB28_57-LJTI28_0
// .set L28_0_set_54, LBB28_54-LJTI28_0
LJTI28_0:
	LONG $0xfffffec3 // .long L28_0_set_61
	LONG $0xffffff0e // .long L28_0_set_66
	LONG $0xfffffec3 // .long L28_0_set_61
	LONG $0xfffffed3 // .long L28_0_set_57
	LONG $0xffffff0e // .long L28_0_set_66
	LONG $0xffffff0e // .long L28_0_set_66
	LONG $0xffffff0e // .long L28_0_set_66
	LONG $0xffffff0e // .long L28_0_set_66
	...
	LONG $0xffffff0e // .long L28_0_set_66
	LONG $0xffffff0e // .long L28_0_set_66
	LONG $0xfffffe8a // .long L28_0_set_54
...
_print_mantissa:
	...
	SUBL    DI, AX
	MOVWLZX AX, R11
	LONG    $0xbd3d8d48; WORD $0x0059; BYTE $0x00 // leaq         $22973(%rip), %rdi  /* _Digits(%rip) */
...
LBB33_2:
	...
	JB   LBB33_3
	MOVL $3518437209, R8
	LONG $0x750d8d4c; WORD $0x0059; BYTE $0x00 // leaq         $22901(%rip), %r9  /* _Digits(%rip) */
...
LBB33_7:
	...
	SUBL    DX, AX
	MOVWLZX AX, AX
	LONG    $0x0e158d48; WORD $0x0059; BYTE $0x00 // leaq         $22798(%rip), %rdx  /* _Digits(%rip) */
...
LBB33_8:
	...
	JB      LBB33_10
	MOVL    AX, AX
	LONG    $0xf10d8d48; WORD $0x0058; BYTE $0x00 // leaq         $22769(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, -2(R14)
	BYTE    $0x5b                                 // popq         %rbx
	WORD    $0x5e41                               // popq         %r14
...
_left_shift:
	...
	MOVL    SI, CX
	IMUL3Q  $104, CX, R14
	LONG    $0x13158d48; WORD $0x008c; BYTE $0x00 // leaq         $35859(%rip), %rdx  /* _LSHIFT_TAB(%rip) */
	MOVL    0(R14)(DX*1), R8
	MOVQ    0(DI), R11
	MOVLQSX 16(DI), R9
	MOVL    R9, R10
...
_LB_146285dc: // L_.str
	QUAD $0x3a676e6972747356; QUAD $0x6c61762073616820 // .asciz 16, 'Vstring: has val'
	QUAD $0x6425206574616469; WORD $0x000a             // .asciz 10, 'idate %d\n\x00'

_LB_d7e59bf5: // L_.str.1
	QUAD $0x3a676e6972747356; QUAD $0x6f6e207473657420                   // .asciz 16, 'Vstring: test no'
	QUAD $0x6164696c61762074; LONG $0x25206574; WORD $0x0a64; BYTE $0x00 // .asciz 15, 't validate %d\n\x00'
...
_LB_839353fa: // L_.str.26
	QUAD $0x77656e3d3d3d3d3d; QUAD $0x65636e6176646120 // .asciz 16, '=====new advance'
	QUAD $0x3d676e6972747320; QUAD $0x000a3d3d3d3d3d3d // .asciz 16, ' string=======\n\x00'
...
_f64toa:
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·__native_entry__+814(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+10717(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_i64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3449(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
_lspace:
	...
	MOVQ nb+8(FP), SI
	MOVQ off+16(FP), DX
	CALL ·__native_entry__+379(SB) // _lspace
	MOVQ AX, ret+24(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+4842(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+25356(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+27886(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+25393(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3544(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+7467(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+28003(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+15533(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+21377(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+22682(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ v+16(FP), DX
	MOVQ flags+24(FP), CX
	LEAQ ·__native_entry__+17698(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+22962(SB), AX // _vunsigned
	JMP  AX
