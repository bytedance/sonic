...
LBB2_5:
	...
	MOVQ R12, AX
	SHLQ $4, AX
	LONG $0xf00d8d48; WORD $0x0089; BYTE $0x00  // leaq         $35312(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ R8, DI
	ORQ $2, DI
	MOVQ 0(AX)(CX*1), R10
	MOVQ 8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ $4, SI
	LONG $0x1a0d8d4c; WORD $0x009e; BYTE $0x00  // leaq         $40474(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ R8, DI
	ORQ $2, DI
	MOVQ 0(SI)(R9*1), R15
	MOVQ R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x005357e8; BYTE $0x00  // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_69:
	...
	JL LBB2_84
	MOVLQSX R14, AX
	LONG $0x8e0d8d48; WORD $0x00ac; BYTE $0x00  // leaq         $44174(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ -56(BP), SI
	MOVL R15, DX
	LONG $0x005253e8; BYTE $0x00  // callq        _print_mantissa
	TESTL R13, R13
	JE LBB2_77
	LEAL 0(BX)(R13*1), AX
	CMPL R13, R15
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77  // vzeroupper   
	LONG $0x004eeee8; BYTE $0x00  // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
LBB2_111:
	MOVL -44(BP), R9
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ $1, DX
	LONG $0xd8358d48; WORD $0x00a7; BYTE $0x00  // leaq         $42968(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(DX)(SI*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
LBB4_6:
	LONG $0xc6158d48; WORD $0x00a7; BYTE $0x00  // leaq         $42950(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
LBB4_7:
	MOVWLZX AX, AX
	ORQ $1, AX
	LONG $0xad158d48; WORD $0x00a7; BYTE $0x00  // leaq         $42925(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), AX
	MOVL CX, DX
	ADDL $1, CX
	MOVB AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL SI, $10000000
	JB LBB4_11
	LONG $0x15058d48; WORD $0x00a7; BYTE $0x00  // leaq         $42773(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R10)(AX*1), AX
	MOVB AX, 0(DI)
	MOVL $1, CX
	JMP LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ $1, AX
	LONG $0xf0358d48; WORD $0x00a6; BYTE $0x00  // leaq         $42736(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
LBB4_14:
	LONG $0xde058d48; WORD $0x00a6; BYTE $0x00  // leaq         $42718(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
LBB4_15:
	MOVWLZX R9, AX
	ORQ $1, AX
	LONG $0xc3358d48; WORD $0x00a6; BYTE $0x00  // leaq         $42691(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, DX
	MOVB AX, 0(DI)(DX*1)
	MOVB 0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x39158d48; WORD $0x00a6; BYTE $0x00  // leaq         $42553(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA LBB4_22
	MOVL DX, AX
	LONG $0x1c0d8d48; WORD $0x00a5; BYTE $0x00  // leaq         $42268(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL CX, AX
	MOVWLZX AX, AX
	LONG $0xcb0d8d48; WORD $0x00a4; BYTE $0x00  // leaq         $42187(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 1(DI)
	MOVB AX, 2(DI)
...
LBB4_24:
	...
	SUBL CX, DX
	MOVWLZX AX, AX
	LONG $0xa8058d4c; WORD $0x00a4; BYTE $0x00  // leaq         $42152(%rip), %r8  /* _Digits(%rip) */
	MOVB 0(R8)(AX*2), CX
	MOVB 1(R8)(AX*2), AX
	MOVB CX, 0(DI)
	MOVB AX, 1(DI)
...
_quote:
	...
	SUBQ $32, SP
	TESTB $1, R8
	LONG $0x4b058d48; WORD $0x00a4; BYTE $0x00  // leaq         $42059(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG $0x44158d4c; WORD $0x00b4; BYTE $0x00  // leaq         $46148(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG $0xd0440f4c  // cmoveq       %rax, %r10
	MOVQ DX, R8
	MOVQ DI, AX
	TESTQ SI, SI
...
LBB5_48:
	...
	MOVQ DI, BX
	SHLQ $4, BX
	LONG $0x0d358d48; WORD $0x00a1; BYTE $0x00  // leaq         $41229(%rip), %rsi  /* __SingleQuoteTab(%rip) */
	CMPQ 0(BX)(SI*1), $0
	JNE LBB5_49
	LEAQ 0(R9)(CX*1), R15
	MOVB DI, 0(R13)(DX*1)
...
LBB6_38:
	ADDQ R14, R8
	MOVBLZX -1(R9), AX
	LONG $0x560d8d48; WORD $0x00ba; BYTE $0x00  // leaq         $47702(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB 0(AX)(CX*1), CX
	CMPB CX, $-1
	JE LBB6_41
	TESTB CX, CX
...
_html_escape:
	...
	LONG $0x253d8d4c; WORD $0x00b4; BYTE $0x00  // leaq         $46117(%rip), %r15  /* __HtmlQuoteTab(%rip) */
	MOVQ -48(BP), R11
	MOVQ -56(BP), R8
LBB7_2:
	TESTQ R9, R9
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x353d8d4c; WORD $0x0035; BYTE $0x00  // leaq         $13621(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE LBB9_12
	XORL R12, R12
	LONG $0x29358d4c; WORD $0x005f; BYTE $0x00  // leaq         $24361(%rip), %r14  /* _POW_TAB(%rip) */
	JMP LBB9_8
LBB9_10:
	MOVL AX, AX
	MOVL 0(R14)(AX*4), BX
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x003216e8; BYTE $0x00  // callq        _right_shift
LBB9_7:
	ADDL BX, R12
	MOVL 20(R15), AX
	TESTL AX, AX
...
LBB9_8:
	...
	JMP LBB9_7
LBB9_12:
	LONG $0xeb358d4c; WORD $0x005e; BYTE $0x00  // leaq         $24299(%rip), %r14  /* _POW_TAB(%rip) */
	JMP LBB9_14
LBB9_18:
	MOVL $27, BX
	CMPL 16(R15), $0
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x003049e8; BYTE $0x00  // callq        _left_shift
	MOVL 20(R15), AX
LBB9_13:
	SUBL BX, R12
LBB9_14:
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x003178e8; BYTE $0x00  // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x003131e8; BYTE $0x00  // callq        _right_shift
	MOVL $-1022, R14
LBB9_32:
	CMPL 16(R15), $0
	JE LBB9_34
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002f87e8; BYTE $0x00  // callq        _left_shift
LBB9_34:
	MOVL 20(R15), AX
	MOVQ $-1, R12
	CMPL AX, $20
...
LBB15_61:
	...
	JL LBB15_72
	LEAL -22(SI), AX
	LONG $0x1d0d8d48; WORD $0x00bf; BYTE $0x00  // leaq         $48925(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB15_69:
	...
	JB LBB15_76
	NEGL SI
	LONG $0xd4058d48; WORD $0x00be; BYTE $0x00  // leaq         $48852(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB15_73:
	...
	JA LBB15_76
	MOVL AX, AX
	LONG $0x600d8d48; WORD $0x00be; BYTE $0x00  // leaq         $48736(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1  // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0  // vmovsd       %xmm0, $-64(%rbp)
	JMP LBB15_80
LBB15_76:
...
LBB19_7:
	...
	CMPL SI, $5
	JA LBB19_12
	LONG $0x623d8d48; WORD $0x0004; BYTE $0x00  // leaq         $1122(%rip), %rdi  /* LJTI19_0(%rip) */
...
LBB19_25:
	MOVQ $-1, R13
	LONG $0x8d0d8d48; WORD $0x0003; BYTE $0x00  // leaq         $909(%rip), %rcx  /* LJTI19_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ CX, AX
	JMP AX
LBB19_28:
	...
	MOVQ 8(AX), SI
	SUBQ R13, SI
	LONG $0x000dade8; BYTE $0x00  // callq        _skip_number
	TESTQ AX, AX
	JS LBB19_64
	MOVQ 0(BX), CX
	ADDQ CX, AX
...
LBB19_43:
	...
	MOVQ 8(AX), SI
	SUBQ R13, SI
	LONG $0x000c8fe8; BYTE $0x00  // callq        _skip_number
	TESTQ AX, AX
	JS LBB19_66
	ADDQ AX, 0(BX)
	TESTQ R13, R13
...
LJTI19_0:
	LONG $0xfffffba7  // .long L19_0_set_9
	LONG $0xfffffbd6  // .long L19_0_set_13
	LONG $0xfffffc03  // .long L19_0_set_15
	LONG $0xfffffc4c  // .long L19_0_set_21
	LONG $0xfffffc61  // .long L19_0_set_23
	LONG $0xfffffcd9  // .long L19_0_set_26
...
LJTI19_1:
	LONG $0xffffff09  // .long L19_1_set_68
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	...
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xfffffd79  // .long L19_1_set_41
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	...
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xfffffd9e  // .long L19_1_set_43
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xfffffc7c  // .long L19_1_set_28
	LONG $0xfffffc7c  // .long L19_1_set_28
	LONG $0xfffffc7c  // .long L19_1_set_28
	LONG $0xfffffc7c  // .long L19_1_set_28
	LONG $0xfffffc7c  // .long L19_1_set_28
	...
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xfffffdd5  // .long L19_1_set_46
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	...
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xfffffdfa  // .long L19_1_set_48
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	...
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xfffffe3d  // .long L19_1_set_51
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xfffffe6b  // .long L19_1_set_56
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xffffff02  // .long L19_1_set_67
	LONG $0xfffffead  // .long L19_1_set_60
_skip_array:
	BYTE $0x55  // pushq        %rbp
	WORD $0x8948; BYTE $0xe5  // movq         %rsp, %rbp
	MOVQ DX, AX
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20265(SB)  // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20302(SB)  // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+23785(SB)  // _validate_one
	MOVQ AX, ret+24(FP)
	RET
