...
var _text_vstring = []byte{
	...
	0x0f, 0x85, 0x3c, 0x04, 0x00, 0x00, //0x00000280 jne          LBB0_80
	...
	0xe9, 0x6a, 0x03, 0x00, 0x00, //0x00000364 jmp          LBB0_83
	//0x00000369 LBB0_30
	...
	0x0f, 0x82, 0x69, 0x02, 0x00, 0x00, //0x000003cb jb           LBB0_70
	//0x000003d1 LBB0_36
	...
	0xc5, 0xfd, 0xd7, 0xc0, //0x000003de vpmovmskb    %ymm0, %eax
	0xc5, 0xf5, 0x74, 0x05, 0x36, 0xfc, 0xff, 0xff, //0x000003e2 vpcmpeqb     $-970(%rip), %ymm1, %ymm0  /* LCPI0_1+0(%rip) */
	0xc5, 0xfd, 0xd7, 0xc8, //0x000003ea vpmovmskb    %ymm0, %ecx
	...
	0x85, 0xc9, //0x00000402 testl        %ecx, %ecx
	...
	0xe9, 0xc6, 0x01, 0x00, 0x00, //0x0000046f jmp          LBB0_70
	//0x00000474 LBB0_44
	...
	0x0f, 0x85, 0x1a, 0x02, 0x00, 0x00, //0x000004d4 jne          LBB0_85
	...
	0x0f, 0x84, 0x99, 0x01, 0x00, 0x00, //0x0000052a je           LBB0_81
	...
	0xe9, 0x58, 0x01, 0x00, 0x00, //0x0000056c jmp          LBB0_81
	//0x00000571 LBB0_57
	...
	0x0f, 0x85, 0x36, 0x01, 0x00, 0x00, //0x0000058d jne          LBB0_81
	...
	0x48, 0x0f, 0xbc, 0xd9, //0x000005ac bsfq         %rcx, %rbx
	...
	0x21, 0xd8, //0x000005e5 andl         %ebx, %eax
	0xc5, 0xfd, 0xdb, 0xc1, //0x000005e7 vpand        %ymm1, %ymm0, %ymm0
	0x48, 0x85, 0xc0, //0x000005eb testq        %rax, %rax
	0x0f, 0x85, 0x2f, 0xfe, 0xff, 0xff, //0x000005ee jne          LBB0_39
	//0x000005f4 LBB0_64
	0xb9, 0x40, 0x00, 0x00, 0x00, //0x000005f4 movl         $64, %ecx
	//0x000005f9 LBB0_65
	0xc5, 0xfd, 0xd7, 0xd8, //0x000005f9 vpmovmskb    %ymm0, %ebx
	0x48, 0x85, 0xc0, //0x000005fd testq        %rax, %rax
	0x0f, 0x84, 0x24, 0x00, 0x00, 0x00, //0x00000600 je           LBB0_68
	0x0f, 0xbc, 0xc3, //0x00000606 bsfl         %ebx, %eax
	0xbf, 0x40, 0x00, 0x00, 0x00, //0x00000609 movl         $64, %edi
	0x0f, 0x45, 0xf8, //0x0000060e cmovnel      %eax, %edi
	0x48, 0x39, 0xf9, //0x00000611 cmpq         %rdi, %rcx
	0x0f, 0x87, 0xa8, 0x00, 0x00, 0x00, //0x00000614 ja           LBB0_80
	0x4d, 0x29, 0xd9, //0x0000061a subq         %r11, %r9
	0x4d, 0x8d, 0x34, 0x09, //0x0000061d leaq         (%r9,%rcx), %r14
	0x49, 0x83, 0xc6, 0x01, //0x00000621 addq         $1, %r14
	0xe9, 0x0d, 0xfd, 0xff, 0xff, //0x00000625 jmp          LBB0_28
	//0x0000062a LBB0_68
	0x85, 0xdb, //0x0000062a testl        %ebx, %ebx
	0x0f, 0x85, 0x90, 0x00, 0x00, 0x00, //0x0000062c jne          LBB0_80
	0x49, 0x83, 0xc1, 0x20, //0x00000632 addq         $32, %r9
	0x49, 0x83, 0xc5, 0xe0, //0x00000636 addq         $-32, %r13
	//0x0000063a LBB0_70
	0x4d, 0x85, 0xe4, //0x0000063a testq        %r12, %r12
	0x0f, 0x85, 0xf1, 0x00, 0x00, 0x00, //0x0000063d jne          LBB0_87
	0x48, 0x8b, 0x45, 0xd0, //0x00000643 movq         $-48(%rbp), %rax
	0x49, 0xc7, 0xc6, 0xff, 0xff, 0xff, 0xff, //0x00000647 movq         $-1, %r14
	0x4d, 0x85, 0xed, //0x0000064e testq        %r13, %r13
	0x0f, 0x84, 0x72, 0x00, 0x00, 0x00, //0x00000651 je           LBB0_81
	//0x00000657 LBB0_72
	0x41, 0x0f, 0xb6, 0x09, //0x00000657 movzbl       (%r9), %ecx
	0x80, 0xf9, 0x22, //0x0000065b cmpb         $34, %cl
	0x0f, 0x84, 0x81, 0x00, 0x00, 0x00, //0x0000065e je           LBB0_84
	0x80, 0xf9, 0x5c, //0x00000664 cmpb         $92, %cl
	0x0f, 0x84, 0x26, 0x00, 0x00, 0x00, //0x00000667 je           LBB0_77
	0x80, 0xf9, 0x20, //0x0000066d cmpb         $32, %cl
	0x0f, 0x82, 0x4c, 0x00, 0x00, 0x00, //0x00000670 jb           LBB0_80
	0x48, 0xc7, 0xc1, 0xff, 0xff, 0xff, 0xff, //0x00000676 movq         $-1, %rcx
	0xbb, 0x01, 0x00, 0x00, 0x00, //0x0000067d movl         $1, %ebx
	//0x00000682 LBB0_76
	0x49, 0x01, 0xd9, //0x00000682 addq         %rbx, %r9
	0x49, 0x01, 0xcd, //0x00000685 addq         %rcx, %r13
	0x0f, 0x85, 0xc9, 0xff, 0xff, 0xff, //0x00000688 jne          LBB0_72
	0xe9, 0x36, 0x00, 0x00, 0x00, //0x0000068e jmp          LBB0_81
	//0x00000693 LBB0_77
	0x49, 0x83, 0xfd, 0x01, //0x00000693 cmpq         $1, %r13
	0x0f, 0x84, 0x2c, 0x00, 0x00, 0x00, //0x00000697 je           LBB0_81
	0x48, 0xc7, 0xc1, 0xfe, 0xff, 0xff, 0xff, //0x0000069d movq         $-2, %rcx
	0xbb, 0x02, 0x00, 0x00, 0x00, //0x000006a4 movl         $2, %ebx
	0x48, 0x83, 0xf8, 0xff, //0x000006a9 cmpq         $-1, %rax
	0x0f, 0x85, 0xcf, 0xff, 0xff, 0xff, //0x000006ad jne          LBB0_76
	0x4c, 0x89, 0xc8, //0x000006b3 movq         %r9, %rax
	0x4c, 0x29, 0xd8, //0x000006b6 subq         %r11, %rax
	0x48, 0x89, 0x45, 0xd0, //0x000006b9 movq         %rax, $-48(%rbp)
	0xe9, 0xc0, 0xff, 0xff, 0xff, //0x000006bd jmp          LBB0_76
	//0x000006c2 LBB0_80
	0x49, 0xc7, 0xc6, 0xfe, 0xff, 0xff, 0xff, //0x000006c2 movq         $-2, %r14
	//0x000006c9 LBB0_81
	0x4c, 0x8b, 0x55, 0xc8, //0x000006c9 movq         $-56(%rbp), %r10
	//0x000006cd LBB0_82
	0x4c, 0x89, 0x16, //0x000006cd movq         %r10, (%rsi)
	0x4c, 0x89, 0x32, //0x000006d0 movq         %r14, (%rdx)
	//0x000006d3 LBB0_83
	0x48, 0x83, 0xc4, 0x18, //0x000006d3 addq         $24, %rsp
	0x5b, //0x000006d7 popq         %rbx
	0x41, 0x5c, //0x000006d8 popq         %r12
	0x41, 0x5d, //0x000006da popq         %r13
	0x41, 0x5e, //0x000006dc popq         %r14
	0x41, 0x5f, //0x000006de popq         %r15
	0x5d, //0x000006e0 popq         %rbp
	0xc5, 0xf8, 0x77, //0x000006e1 vzeroupper   
	0xc3, //0x000006e4 retq         
	//0x000006e5 LBB0_84
	0x4d, 0x29, 0xd9, //0x000006e5 subq         %r11, %r9
	0x49, 0x83, 0xc1, 0x01, //0x000006e8 addq         $1, %r9
	0x4d, 0x89, 0xce, //0x000006ec movq         %r9, %r14
	0xe9, 0x43, 0xfc, 0xff, 0xff, //0x000006ef jmp          LBB0_28
	//0x000006f4 LBB0_85
	0x4d, 0x85, 0xed, //0x000006f4 testq        %r13, %r13
	0x0f, 0x84, 0x7d, 0x00, 0x00, 0x00, //0x000006f7 je           LBB0_89
	0x4c, 0x89, 0xdf, //0x000006fd movq         %r11, %rdi
	0x48, 0xf7, 0xd7, //0x00000700 notq         %rdi
	0x49, 0x8d, 0x04, 0x38, //0x00000703 leaq         (%r8,%rdi), %rax
	0x48, 0x8b, 0x4d, 0xd0, //0x00000707 movq         $-48(%rbp), %rcx
	0x48, 0x83, 0xf9, 0xff, //0x0000070b cmpq         $-1, %rcx
	0x49, 0x89, 0xcf, //0x0000070f movq         %rcx, %r15
	0x48, 0x0f, 0x44, 0xc8, //0x00000712 cmoveq       %rax, %rcx
	0x4c, 0x0f, 0x44, 0xf8, //0x00000716 cmoveq       %rax, %r15
	0x49, 0x83, 0xc0, 0x01, //0x0000071a addq         $1, %r8
	0x49, 0x83, 0xc5, 0xff, //0x0000071e addq         $-1, %r13
	0x48, 0x89, 0x4d, 0xd0, //0x00000722 movq         %rcx, $-48(%rbp)
	0x4d, 0x85, 0xed, //0x00000726 testq        %r13, %r13
	0x0f, 0x85, 0xbe, 0xfd, 0xff, 0xff, //0x00000729 jne          LBB0_50
	0xe9, 0x44, 0xfe, 0xff, 0xff, //0x0000072f jmp          LBB0_58
	//0x00000734 LBB0_87
	0x4d, 0x85, 0xed, //0x00000734 testq        %r13, %r13
	0x0f, 0x84, 0x3d, 0x00, 0x00, 0x00, //0x00000737 je           LBB0_89
	0x4c, 0x89, 0xd8, //0x0000073d movq         %r11, %rax
	0x48, 0xf7, 0xd0, //0x00000740 notq         %rax
	0x4c, 0x01, 0xc8, //0x00000743 addq         %r9, %rax
	0x48, 0x8b, 0x7d, 0xd0, //0x00000746 movq         $-48(%rbp), %rdi
	0x48, 0x83, 0xff, 0xff, //0x0000074a cmpq         $-1, %rdi
	0x48, 0x89, 0xf9, //0x0000074e movq         %rdi, %rcx
	0x48, 0x0f, 0x44, 0xc8, //0x00000751 cmoveq       %rax, %rcx
	0x48, 0x0f, 0x45, 0xc7, //0x00000755 cmovneq      %rdi, %rax
	0x49, 0x83, 0xc1, 0x01, //0x00000759 addq         $1, %r9
	0x49, 0x83, 0xc5, 0xff, //0x0000075d addq         $-1, %r13
	0x48, 0x89, 0x4d, 0xd0, //0x00000761 movq         %rcx, $-48(%rbp)
	0x49, 0xc7, 0xc6, 0xff, 0xff, 0xff, 0xff, //0x00000765 movq         $-1, %r14
	0x4d, 0x85, 0xed, //0x0000076c testq        %r13, %r13
	0x0f, 0x85, 0xe2, 0xfe, 0xff, 0xff, //0x0000076f jne          LBB0_72
	0xe9, 0x4f, 0xff, 0xff, 0xff, //0x00000775 jmp          LBB0_81
	//0x0000077a LBB0_89
	0x49, 0xc7, 0xc6, 0xff, 0xff, 0xff, 0xff, //0x0000077a movq         $-1, %r14
	0xe9, 0x43, 0xff, 0xff, 0xff, //0x00000781 jmp          LBB0_81
	0x00, 0x00, //0x00000786 .p2align 2, 0x00
