...
var _text_f64toa = []byte{
	...
	0x0f, 0x84, 0x29, 0x13, 0x00, 0x00, //0x00000096 je           LBB0_5
	...
	0x48, 0x8d, 0x1d, 0x9c, 0x13, 0x00, 0x00, //0x0000012d leaq         $5020(%rip), %rbx  /* _pow10_ceil_sig.g+0(%rip) */
	...
	0xe9, 0x1c, 0x11, 0x00, 0x00, //0x00000275 jmp          LBB0_181
	//0x0000027a LBB0_42
	...
	0x0f, 0x83, 0xab, 0x0f, 0x00, 0x00, //0x000003fa jae          LBB0_62
	//0x00000400 LBB0_64
	...
	0x0f, 0x83, 0x09, 0x06, 0x00, 0x00, //0x00000437 jae          LBB0_73
	//0x0000043d LBB0_72
	...
	0x0f, 0x84, 0x9a, 0x05, 0x00, 0x00, //0x00000490 je           LBB0_68
	...
	0x48, 0x8d, 0x3d, 0x08, 0x0f, 0x00, 0x00, //0x000004f1 leaq         $3848(%rip), %rdi  /* _Digits+0(%rip) */
	...
	0xe9, 0x14, 0x05, 0x00, 0x00, //0x0000052d jmp          LBB0_73
	//0x00000532 LBB0_11
	...
	0x0f, 0x86, 0x1b, 0x04, 0x00, 0x00, //0x00000548 jbe          LBB0_20
	...
	0x69, 0xca, 0x00, 0x1f, 0x0a, 0xfa, //0x000005fa imull        $-100000000, %edx, %ecx
	0x44, 0x01, 0xc1, //0x00000600 addl         %r8d, %ecx
	0x41, 0xba, 0x59, 0x17, 0xb7, 0xd1, //0x00000603 movl         $3518437209, %r10d
	0x48, 0x89, 0xce, //0x00000609 movq         %rcx, %rsi
	0x49, 0x0f, 0xaf, 0xf2, //0x0000060c imulq        %r10, %rsi
	0x48, 0xc1, 0xee, 0x2d, //0x00000610 shrq         $45, %rsi
	0x69, 0xde, 0x10, 0x27, 0x00, 0x00, //0x00000614 imull        $10000, %esi, %ebx
	0x29, 0xd9, //0x0000061a subl         %ebx, %ecx
	0x48, 0x89, 0xf0, //0x0000061c movq         %rsi, %rax
	0x49, 0x0f, 0xaf, 0xc2, //0x0000061f imulq        %r10, %rax
	0x48, 0xc1, 0xe8, 0x2d, //0x00000623 shrq         $45, %rax
	0x69, 0xc0, 0x10, 0x27, 0x00, 0x00, //0x00000627 imull        $10000, %eax, %eax
	0x29, 0xc6, //0x0000062d subl         %eax, %esi
	0x0f, 0xb7, 0xc1, //0x0000062f movzwl       %cx, %eax
	0xc1, 0xe8, 0x02, //0x00000632 shrl         $2, %eax
	0x44, 0x69, 0xd0, 0x7b, 0x14, 0x00, 0x00, //0x00000635 imull        $5243, %eax, %r10d
	0x41, 0xc1, 0xea, 0x11, //0x0000063c shrl         $17, %r10d
	0x41, 0x6b, 0xc2, 0x64, //0x00000640 imull        $100, %r10d, %eax
	0x29, 0xc1, //0x00000644 subl         %eax, %ecx
	0x0f, 0xb7, 0xc1, //0x00000646 movzwl       %cx, %eax
	0x0f, 0xb7, 0xce, //0x00000649 movzwl       %si, %ecx
	0xc1, 0xe9, 0x02, //0x0000064c shrl         $2, %ecx
	0x69, 0xc9, 0x7b, 0x14, 0x00, 0x00, //0x0000064f imull        $5243, %ecx, %ecx
	0xc1, 0xe9, 0x11, //0x00000655 shrl         $17, %ecx
	0x6b, 0xd9, 0x64, //0x00000658 imull        $100, %ecx, %ebx
	0x29, 0xde, //0x0000065b subl         %ebx, %esi
	0x0f, 0xb7, 0xf6, //0x0000065d movzwl       %si, %esi
	0x48, 0x8d, 0x1d, 0x99, 0x0d, 0x00, 0x00, //0x00000660 leaq         $3481(%rip), %rbx  /* _Digits+0(%rip) */
	0x0f, 0xb7, 0x04, 0x43, //0x00000667 movzwl       (%rbx,%rax,2), %eax
	0x66, 0x41, 0x89, 0x41, 0xfe, //0x0000066b movw         %ax, $-2(%r9)
	0x42, 0x0f, 0xb7, 0x04, 0x53, //0x00000670 movzwl       (%rbx,%r10,2), %eax
	0x66, 0x41, 0x89, 0x41, 0xfc, //0x00000675 movw         %ax, $-4(%r9)
	0x0f, 0xb7, 0x04, 0x73, //0x0000067a movzwl       (%rbx,%rsi,2), %eax
	0x66, 0x41, 0x89, 0x41, 0xfa, //0x0000067e movw         %ax, $-6(%r9)
	0x49, 0x8d, 0x41, 0xf8, //0x00000683 leaq         $-8(%r9), %rax
	0x0f, 0xb7, 0x0c, 0x4b, //0x00000687 movzwl       (%rbx,%rcx,2), %ecx
	0x66, 0x41, 0x89, 0x49, 0xf8, //0x0000068b movw         %cx, $-8(%r9)
	0x49, 0x89, 0xd0, //0x00000690 movq         %rdx, %r8
	0x41, 0x81, 0xf8, 0x10, 0x27, 0x00, 0x00, //0x00000693 cmpl         $10000, %r8d
	0x0f, 0x82, 0x6f, 0x03, 0x00, 0x00, //0x0000069a jb           LBB0_32
	//0x000006a0 LBB0_33
	0x41, 0xba, 0x59, 0x17, 0xb7, 0xd1, //0x000006a0 movl         $3518437209, %r10d
	0x4c, 0x8d, 0x1d, 0x53, 0x0d, 0x00, 0x00, //0x000006a6 leaq         $3411(%rip), %r11  /* _Digits+0(%rip) */
	...
	0x0f, 0x82, 0xe4, 0x02, 0x00, 0x00, //0x00000736 jb           LBB0_39
	...
	0xe9, 0xd3, 0x02, 0x00, 0x00, //0x0000074d jmp          LBB0_40
	//0x00000752 LBB0_94
	0x45, 0x85, 0xc9, //0x00000752 testl        %r9d, %r9d
	0x0f, 0x8f, 0x86, 0x07, 0x00, 0x00, //0x00000755 jg           LBB0_107
	...
	0x0f, 0x89, 0x73, 0x07, 0x00, 0x00, //0x00000768 jns          LBB0_107
	...
	0x0f, 0x82, 0x40, 0x07, 0x00, 0x00, //0x0000077d jb           LBB0_105
	...
	0x0f, 0x83, 0x0d, 0x06, 0x00, 0x00, //0x000007aa jae          LBB0_99
	0x31, 0xd2, //0x000007b0 xorl         %edx, %edx
	0xe9, 0xb7, 0x06, 0x00, 0x00, //0x000007b2 jmp          LBB0_101
	//0x000007b7 LBB0_151
	...
	0x48, 0x8d, 0x1d, 0xcd, 0x0b, 0x00, 0x00, //0x0000082c leaq         $3021(%rip), %rbx  /* _Digits+0(%rip) */
	...
	0x4c, 0x8d, 0x3d, 0x8a, 0x0b, 0x00, 0x00, //0x0000086f leaq         $2954(%rip), %r15  /* _Digits+0(%rip) */
	...
	0x49, 0x8d, 0x14, 0x0e, //0x0000093f leaq         (%r14,%rcx), %rdx
	0x48, 0x83, 0xc2, 0x01, //0x00000943 addq         $1, %rdx
	0x48, 0x01, 0xc8, //0x00000947 addq         %rcx, %rax
	0x48, 0x39, 0xc2, //0x0000094a cmpq         %rax, %rdx
	0x48, 0x0f, 0x47, 0xc2, //0x0000094d cmovaq       %rdx, %rax
	0x4c, 0x01, 0xf1, //0x00000951 addq         %r14, %rcx
	0x48, 0x29, 0xc8, //0x00000954 subq         %rcx, %rax
	0x48, 0x83, 0xf8, 0x10, //0x00000957 cmpq         $16, %rax
	0x0f, 0x83, 0xa8, 0x02, 0x00, 0x00, //0x0000095b jae          LBB0_163
	//0x00000961 LBB0_178
	0x4c, 0x89, 0xd2, //0x00000961 movq         %r10, %rdx
	0xe9, 0x37, 0x04, 0x00, 0x00, //0x00000964 jmp          LBB0_179
	//0x00000969 LBB0_20
	0x41, 0xb9, 0x01, 0x00, 0x00, 0x00, //0x00000969 movl         $1, %r9d
	0x49, 0x83, 0xf8, 0x0a, //0x0000096f cmpq         $10, %r8
	0x0f, 0x82, 0x82, 0x00, 0x00, 0x00, //0x00000973 jb           LBB0_28
	0x41, 0xb9, 0x02, 0x00, 0x00, 0x00, //0x00000979 movl         $2, %r9d
	0x49, 0x83, 0xf8, 0x64, //0x0000097f cmpq         $100, %r8
	0x0f, 0x82, 0x72, 0x00, 0x00, 0x00, //0x00000983 jb           LBB0_28
	0x41, 0xb9, 0x03, 0x00, 0x00, 0x00, //0x00000989 movl         $3, %r9d
	0x49, 0x81, 0xf8, 0xe8, 0x03, 0x00, 0x00, //0x0000098f cmpq         $1000, %r8
	0x0f, 0x82, 0x5f, 0x00, 0x00, 0x00, //0x00000996 jb           LBB0_28
	0x41, 0xb9, 0x04, 0x00, 0x00, 0x00, //0x0000099c movl         $4, %r9d
	0x49, 0x81, 0xf8, 0x10, 0x27, 0x00, 0x00, //0x000009a2 cmpq         $10000, %r8
	0x0f, 0x82, 0x4c, 0x00, 0x00, 0x00, //0x000009a9 jb           LBB0_28
	0x41, 0xb9, 0x05, 0x00, 0x00, 0x00, //0x000009af movl         $5, %r9d
	0x49, 0x81, 0xf8, 0xa0, 0x86, 0x01, 0x00, //0x000009b5 cmpq         $100000, %r8
	0x0f, 0x82, 0x39, 0x00, 0x00, 0x00, //0x000009bc jb           LBB0_28
	0x41, 0xb9, 0x06, 0x00, 0x00, 0x00, //0x000009c2 movl         $6, %r9d
	0x49, 0x81, 0xf8, 0x40, 0x42, 0x0f, 0x00, //0x000009c8 cmpq         $1000000, %r8
	0x0f, 0x82, 0x26, 0x00, 0x00, 0x00, //0x000009cf jb           LBB0_28
	0x41, 0xb9, 0x07, 0x00, 0x00, 0x00, //0x000009d5 movl         $7, %r9d
	0x49, 0x81, 0xf8, 0x80, 0x96, 0x98, 0x00, //0x000009db cmpq         $10000000, %r8
	0x0f, 0x82, 0x13, 0x00, 0x00, 0x00, //0x000009e2 jb           LBB0_28
	0x41, 0xb9, 0x08, 0x00, 0x00, 0x00, //0x000009e8 movl         $8, %r9d
	0x49, 0x81, 0xf8, 0xff, 0xe0, 0xf5, 0x05, //0x000009ee cmpq         $99999999, %r8
	0x0f, 0x87, 0xd8, 0x09, 0x00, 0x00, //0x000009f5 ja           LBB0_29
	//0x000009fb LBB0_28
	0x4c, 0x03, 0x4d, 0xc8, //0x000009fb addq         $-56(%rbp), %r9
	//0x000009ff LBB0_30
	0x4c, 0x89, 0xc8, //0x000009ff movq         %r9, %rax
	0x41, 0x81, 0xf8, 0x10, 0x27, 0x00, 0x00, //0x00000a02 cmpl         $10000, %r8d
	0x0f, 0x83, 0x91, 0xfc, 0xff, 0xff, //0x00000a09 jae          LBB0_33
	//0x00000a0f LBB0_32
	0x44, 0x89, 0xc2, //0x00000a0f movl         %r8d, %edx
	0x83, 0xfa, 0x64, //0x00000a12 cmpl         $100, %edx
	0x0f, 0x83, 0xe8, 0xfc, 0xff, 0xff, //0x00000a15 jae          LBB0_36
	0xe9, 0x0f, 0xfd, 0xff, 0xff, //0x00000a1b jmp          LBB0_37
	//0x00000a20 LBB0_39
	0x80, 0xc2, 0x30, //0x00000a20 addb         $48, %dl
	0x88, 0x11, //0x00000a23 movb         %dl, (%rcx)
	//0x00000a25 LBB0_40
	0x41, 0x29, 0xf9, //0x00000a25 subl         %edi, %r9d
	0x45, 0x89, 0xc8, //0x00000a28 movl         %r9d, %r8d
	0xe9, 0x66, 0x09, 0x00, 0x00, //0x00000a2b jmp          LBB0_181
	//0x00000a30 LBB0_68
	0x41, 0xba, 0x08, 0x00, 0x00, 0x00, //0x00000a30 movl         $8, %r10d
	0x48, 0x83, 0xc6, 0xf8, //0x00000a36 addq         $-8, %rsi
	0x81, 0xfa, 0x10, 0x27, 0x00, 0x00, //0x00000a3a cmpl         $10000, %edx
	0x0f, 0x82, 0xf7, 0xf9, 0xff, 0xff, //0x00000a40 jb           LBB0_72
	//0x00000a46 LBB0_73
	0x41, 0xbb, 0x59, 0x17, 0xb7, 0xd1, //0x00000a46 movl         $3518437209, %r11d
	0x4c, 0x8d, 0x3d, 0xad, 0x09, 0x00, 0x00, //0x00000a4c leaq         $2477(%rip), %r15  /* _Digits+0(%rip) */
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00000a53 .p2align 4, 0x90
	//0x00000a60 LBB0_74
	...
	//0x00000c09 LBB0_163
	0x48, 0x3d, 0x80, 0x00, 0x00, 0x00, //0x00000c09 cmpq         $128, %rax
	0x0f, 0x83, 0x07, 0x00, 0x00, 0x00, //0x00000c0f jae          LBB0_168
	0x31, 0xc9, //0x00000c15 xorl         %ecx, %ecx
	0xe9, 0x49, 0x01, 0x00, 0x00, //0x00000c17 jmp          LBB0_165
	//0x00000c1c LBB0_168
	0x48, 0x89, 0xc1, //0x00000c1c movq         %rax, %rcx
	0x48, 0x83, 0xe1, 0x80, //0x00000c1f andq         $-128, %rcx
	0x48, 0x8d, 0x79, 0x80, //0x00000c23 leaq         $-128(%rcx), %rdi
	0x48, 0x89, 0xfe, //0x00000c27 movq         %rdi, %rsi
	0x48, 0xc1, 0xee, 0x07, //0x00000c2a shrq         $7, %rsi
	0x48, 0x83, 0xc6, 0x01, //0x00000c2e addq         $1, %rsi
	0x89, 0xf2, //0x00000c32 movl         %esi, %edx
	0x83, 0xe2, 0x03, //0x00000c34 andl         $3, %edx
	0x48, 0x81, 0xff, 0x80, 0x01, 0x00, 0x00, //0x00000c37 cmpq         $384, %rdi
	0x0f, 0x83, 0x07, 0x00, 0x00, 0x00, //0x00000c3e jae          LBB0_170
	0x31, 0xdb, //0x00000c44 xorl         %ebx, %ebx
	0xe9, 0xb6, 0x00, 0x00, 0x00, //0x00000c46 jmp          LBB0_172
	//0x00000c4b LBB0_170
	0x4b, 0x8d, 0x3c, 0x2e, //0x00000c4b leaq         (%r14,%r13), %rdi
	0x4c, 0x01, 0xe7, //0x00000c4f addq         %r12, %rdi
	0x48, 0x81, 0xc7, 0xe0, 0x01, 0x00, 0x00, //0x00000c52 addq         $480, %rdi
	0x48, 0x83, 0xe6, 0xfc, //0x00000c59 andq         $-4, %rsi
	0x48, 0xf7, 0xde, //0x00000c5d negq         %rsi
	0x31, 0xdb, //0x00000c60 xorl         %ebx, %ebx
	0xc5, 0xfe, 0x6f, 0x05, 0x96, 0xf3, 0xff, 0xff, //0x00000c62 vmovdqu      $-3178(%rip), %ymm0  /* LCPI0_0+0(%rip) */
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00000c6a .p2align 4, 0x90
	//0x00000c70 LBB0_171
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0x20, 0xfe, 0xff, 0xff, //0x00000c70 vmovdqu      %ymm0, $-480(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0x40, 0xfe, 0xff, 0xff, //0x00000c79 vmovdqu      %ymm0, $-448(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0x60, 0xfe, 0xff, 0xff, //0x00000c82 vmovdqu      %ymm0, $-416(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0x80, 0xfe, 0xff, 0xff, //0x00000c8b vmovdqu      %ymm0, $-384(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0xa0, 0xfe, 0xff, 0xff, //0x00000c94 vmovdqu      %ymm0, $-352(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0xc0, 0xfe, 0xff, 0xff, //0x00000c9d vmovdqu      %ymm0, $-320(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0xe0, 0xfe, 0xff, 0xff, //0x00000ca6 vmovdqu      %ymm0, $-288(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0x00, 0xff, 0xff, 0xff, //0x00000caf vmovdqu      %ymm0, $-256(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0x20, 0xff, 0xff, 0xff, //0x00000cb8 vmovdqu      %ymm0, $-224(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0x40, 0xff, 0xff, 0xff, //0x00000cc1 vmovdqu      %ymm0, $-192(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x84, 0x1f, 0x60, 0xff, 0xff, 0xff, //0x00000cca vmovdqu      %ymm0, $-160(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x44, 0x1f, 0x80, //0x00000cd3 vmovdqu      %ymm0, $-128(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x44, 0x1f, 0xa0, //0x00000cd9 vmovdqu      %ymm0, $-96(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x44, 0x1f, 0xc0, //0x00000cdf vmovdqu      %ymm0, $-64(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x44, 0x1f, 0xe0, //0x00000ce5 vmovdqu      %ymm0, $-32(%rdi,%rbx)
	0xc5, 0xfe, 0x7f, 0x04, 0x1f, //0x00000ceb vmovdqu      %ymm0, (%rdi,%rbx)
	0x48, 0x81, 0xc3, 0x00, 0x02, 0x00, 0x00, //0x00000cf0 addq         $512, %rbx
	0x48, 0x83, 0xc6, 0x04, //0x00000cf7 addq         $4, %rsi
	...
	0x4c, 0x01, 0xeb, //0x00000d0a addq         %r13, %rbx
	0x4c, 0x01, 0xf3, //0x00000d0d addq         %r14, %rbx
	0x49, 0x8d, 0x34, 0x1c, //0x00000d10 leaq         (%r12,%rbx), %rsi
	0x48, 0x83, 0xc6, 0x60, //0x00000d14 addq         $96, %rsi
	0x48, 0xc1, 0xe2, 0x07, //0x00000d18 shlq         $7, %rdx
	0x31, 0xff, //0x00000d1c xorl         %edi, %edi
	0xc5, 0xfe, 0x6f, 0x05, 0xda, 0xf2, 0xff, 0xff, //0x00000d1e vmovdqu      $-3366(%rip), %ymm0  /* LCPI0_0+0(%rip) */
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00000d26 .p2align 4, 0x90
	//0x00000d30 LBB0_174
	...
	//0x00000d54 LBB0_175
	0x48, 0x39, 0xc8, //0x00000d54 cmpq         %rcx, %rax
	0x0f, 0x84, 0x36, 0x06, 0x00, 0x00, //0x00000d57 je           LBB0_180
	0xa8, 0x70, //0x00000d5d testb        $112, %al
	0x0f, 0x84, 0x50, 0x00, 0x00, 0x00, //0x00000d5f je           LBB0_177
	//0x00000d65 LBB0_165
	0x48, 0x89, 0xc6, //0x00000d65 movq         %rax, %rsi
	0x48, 0x83, 0xe6, 0xf0, //0x00000d68 andq         $-16, %rsi
	0x49, 0x8d, 0x14, 0x32, //0x00000d6c leaq         (%r10,%rsi), %rdx
	0xc5, 0xfa, 0x6f, 0x05, 0xa8, 0xf2, 0xff, 0xff, //0x00000d70 vmovdqu      $-3416(%rip), %xmm0  /* LCPI0_1+0(%rip) */
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00000d78 .p2align 4, 0x90
	//0x00000d80 LBB0_166
	0xc4, 0xc1, 0x7a, 0x7f, 0x04, 0x0a, //0x00000d80 vmovdqu      %xmm0, (%r10,%rcx)
	0x48, 0x83, 0xc1, 0x10, //0x00000d86 addq         $16, %rcx
	0x48, 0x39, 0xce, //0x00000d8a cmpq         %rcx, %rsi
	0x0f, 0x85, 0xed, 0xff, 0xff, 0xff, //0x00000d8d jne          LBB0_166
	0x48, 0x39, 0xf0, //0x00000d93 cmpq         %rsi, %rax
	0x0f, 0x84, 0xf7, 0x05, 0x00, 0x00, //0x00000d96 je           LBB0_180
	0x90, 0x90, 0x90, 0x90, //0x00000d9c .p2align 4, 0x90
	//0x00000da0 LBB0_179
	0xc6, 0x02, 0x30, //0x00000da0 movb         $48, (%rdx)
	0x48, 0x83, 0xc2, 0x01, //0x00000da3 addq         $1, %rdx
	0x4c, 0x39, 0xc2, //0x00000da7 cmpq         %r8, %rdx
	0x0f, 0x82, 0xf0, 0xff, 0xff, 0xff, //0x00000daa jb           LBB0_179
	0xe9, 0xde, 0x05, 0x00, 0x00, //0x00000db0 jmp          LBB0_180
	//0x00000db5 LBB0_177
	0x49, 0x01, 0xca, //0x00000db5 addq         %rcx, %r10
	0xe9, 0xa4, 0xfb, 0xff, 0xff, //0x00000db8 jmp          LBB0_178
	//0x00000dbd LBB0_99
	0x48, 0x8b, 0x55, 0xd0, //0x00000dbd movq         $-48(%rbp), %rdx
	0x4a, 0x8d, 0x34, 0x2a, //0x00000dc1 leaq         (%rdx,%r13), %rsi
	0x48, 0x81, 0xc6, 0xe2, 0x01, 0x00, 0x00, //0x00000dc5 addq         $482, %rsi
	0x48, 0x83, 0xe3, 0xfc, //0x00000dcc andq         $-4, %rbx
	0x48, 0xf7, 0xdb, //0x00000dd0 negq         %rbx
	0x31, 0xd2, //0x00000dd3 xorl         %edx, %edx
	0xc5, 0xfe, 0x6f, 0x05, 0x23, 0xf2, 0xff, 0xff, //0x00000dd5 vmovdqu      $-3549(%rip), %ymm0  /* LCPI0_0+0(%rip) */
	//0x00000ddd LBB0_100
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0x20, 0xfe, 0xff, 0xff, //0x00000ddd vmovdqu      %ymm0, $-480(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0x40, 0xfe, 0xff, 0xff, //0x00000de6 vmovdqu      %ymm0, $-448(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0x60, 0xfe, 0xff, 0xff, //0x00000def vmovdqu      %ymm0, $-416(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0x80, 0xfe, 0xff, 0xff, //0x00000df8 vmovdqu      %ymm0, $-384(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0xa0, 0xfe, 0xff, 0xff, //0x00000e01 vmovdqu      %ymm0, $-352(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0xc0, 0xfe, 0xff, 0xff, //0x00000e0a vmovdqu      %ymm0, $-320(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0xe0, 0xfe, 0xff, 0xff, //0x00000e13 vmovdqu      %ymm0, $-288(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0x00, 0xff, 0xff, 0xff, //0x00000e1c vmovdqu      %ymm0, $-256(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0x20, 0xff, 0xff, 0xff, //0x00000e25 vmovdqu      %ymm0, $-224(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0x40, 0xff, 0xff, 0xff, //0x00000e2e vmovdqu      %ymm0, $-192(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x84, 0x16, 0x60, 0xff, 0xff, 0xff, //0x00000e37 vmovdqu      %ymm0, $-160(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x44, 0x16, 0x80, //0x00000e40 vmovdqu      %ymm0, $-128(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x44, 0x16, 0xa0, //0x00000e46 vmovdqu      %ymm0, $-96(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x44, 0x16, 0xc0, //0x00000e4c vmovdqu      %ymm0, $-64(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x44, 0x16, 0xe0, //0x00000e52 vmovdqu      %ymm0, $-32(%rsi,%rdx)
	0xc5, 0xfe, 0x7f, 0x04, 0x16, //0x00000e58 vmovdqu      %ymm0, (%rsi,%rdx)
	0x48, 0x81, 0xc2, 0x00, 0x02, 0x00, 0x00, //0x00000e5d addq         $512, %rdx
	0x48, 0x83, 0xc3, 0x04, //0x00000e64 addq         $4, %rbx
	0x0f, 0x85, 0x6f, 0xff, 0xff, 0xff, //0x00000e68 jne          LBB0_100
	//0x00000e6e LBB0_101
	0x4d, 0x85, 0xe4, //0x00000e6e testq        %r12, %r12
	0x0f, 0x84, 0x40, 0x00, 0x00, 0x00, //0x00000e71 je           LBB0_104
	0x4c, 0x01, 0xea, //0x00000e77 addq         %r13, %rdx
	0x48, 0x8b, 0x75, 0xd0, //0x00000e7a movq         $-48(%rbp), %rsi
	0x48, 0x01, 0xf2, //0x00000e7e addq         %rsi, %rdx
	0x48, 0x83, 0xc2, 0x62, //0x00000e81 addq         $98, %rdx
	0x49, 0xc1, 0xe4, 0x07, //0x00000e85 shlq         $7, %r12
	0x31, 0xf6, //0x00000e89 xorl         %esi, %esi
	0xc5, 0xfe, 0x6f, 0x05, 0x6d, 0xf1, 0xff, 0xff, //0x00000e8b vmovdqu      $-3731(%rip), %ymm0  /* LCPI0_0+0(%rip) */
	//0x00000e93 LBB0_103
	0xc5, 0xfe, 0x7f, 0x44, 0x32, 0xa0, //0x00000e93 vmovdqu      %ymm0, $-96(%rdx,%rsi)
	0xc5, 0xfe, 0x7f, 0x44, 0x32, 0xc0, //0x00000e99 vmovdqu      %ymm0, $-64(%rdx,%rsi)
	0xc5, 0xfe, 0x7f, 0x44, 0x32, 0xe0, //0x00000e9f vmovdqu      %ymm0, $-32(%rdx,%rsi)
	0xc5, 0xfe, 0x7f, 0x04, 0x32, //0x00000ea5 vmovdqu      %ymm0, (%rdx,%rsi)
	0x48, 0x83, 0xee, 0x80, //0x00000eaa subq         $-128, %rsi
	0x49, 0x39, 0xf4, //0x00000eae cmpq         %rsi, %r12
	0x0f, 0x85, 0xdc, 0xff, 0xff, 0xff, //0x00000eb1 jne          LBB0_103
	//0x00000eb7 LBB0_104
	0x49, 0x01, 0xc0, //0x00000eb7 addq         %rax, %r8
	0x49, 0x39, 0xc7, //0x00000eba cmpq         %rax, %r15
	0x0f, 0x84, 0x1e, 0x00, 0x00, 0x00, //0x00000ebd je           LBB0_107
	//0x00000ec3 LBB0_105
	0x44, 0x01, 0xc8, //0x00000ec3 addl         %r9d, %eax
	0xf7, 0xd8, //0x00000ec6 negl         %eax
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00000ec8 .p2align 4, 0x90
	//0x00000ed0 LBB0_106
	...
	//0x00000ee1 LBB0_107
	0x4f, 0x8d, 0x3c, 0x30, //0x00000ee1 leaq         (%r8,%r14), %r15
	0x48, 0x89, 0xc8, //0x00000ee5 movq         %rcx, %rax
	0x48, 0xc1, 0xe8, 0x20, //0x00000ee8 shrq         $32, %rax
	0x0f, 0x85, 0x1f, 0x00, 0x00, 0x00, //0x00000eec jne          LBB0_109
	0x45, 0x31, 0xed, //0x00000ef2 xorl         %r13d, %r13d
	0x89, 0xca, //0x00000ef5 movl         %ecx, %edx
	0x4c, 0x89, 0xf8, //0x00000ef7 movq         %r15, %rax
	0x4c, 0x89, 0x55, 0xc0, //0x00000efa movq         %r10, $-64(%rbp)
	0x81, 0xfa, 0x10, 0x27, 0x00, 0x00, //0x00000efe cmpl         $10000, %edx
	0x0f, 0x83, 0xd0, 0x00, 0x00, 0x00, //0x00000f04 jae          LBB0_115
	//0x00000f0a LBB0_114
	0x89, 0xd1, //0x00000f0a movl         %edx, %ecx
	0xe9, 0x25, 0x01, 0x00, 0x00, //0x00000f0c jmp          LBB0_117
	//0x00000f11 LBB0_109
	0x48, 0xba, 0xfd, 0xce, 0x61, 0x84, 0x11, 0x77, 0xcc, 0xab, //0x00000f11 movabsq      $-6067343680855748867, %rdx
	0x48, 0x89, 0xc8, //0x00000f1b movq         %rcx, %rax
	0x48, 0xf7, 0xe2, //0x00000f1e mulq         %rdx
	0x48, 0xc1, 0xea, 0x1a, //0x00000f21 shrq         $26, %rdx
	0x69, 0xf2, 0x00, 0x1f, 0x0a, 0xfa, //0x00000f25 imull        $-100000000, %edx, %esi
	0x01, 0xce, //0x00000f2b addl         %ecx, %esi
	0x0f, 0x84, 0x8d, 0x00, 0x00, 0x00, //0x00000f2d je           LBB0_110
	0x89, 0xf0, //0x00000f33 movl         %esi, %eax
	0xb9, 0x59, 0x17, 0xb7, 0xd1, //0x00000f35 movl         $3518437209, %ecx
	0x48, 0x0f, 0xaf, 0xc1, //0x00000f3a imulq        %rcx, %rax
	0x48, 0xc1, 0xe8, 0x2d, //0x00000f3e shrq         $45, %rax
	0x69, 0xf8, 0x10, 0x27, 0x00, 0x00, //0x00000f42 imull        $10000, %eax, %edi
	0x29, 0xfe, //0x00000f48 subl         %edi, %esi
	0x48, 0x89, 0xc7, //0x00000f4a movq         %rax, %rdi
	0x48, 0x0f, 0xaf, 0xf9, //0x00000f4d imulq        %rcx, %rdi
	0x48, 0xc1, 0xef, 0x2d, //0x00000f51 shrq         $45, %rdi
	0x69, 0xcf, 0x10, 0x27, 0x00, 0x00, //0x00000f55 imull        $10000, %edi, %ecx
	0x29, 0xc8, //0x00000f5b subl         %ecx, %eax
	0x0f, 0xb7, 0xce, //0x00000f5d movzwl       %si, %ecx
	0xc1, 0xe9, 0x02, //0x00000f60 shrl         $2, %ecx
	0x69, 0xc9, 0x7b, 0x14, 0x00, 0x00, //0x00000f63 imull        $5243, %ecx, %ecx
	0xc1, 0xe9, 0x11, //0x00000f69 shrl         $17, %ecx
	0x6b, 0xf9, 0x64, //0x00000f6c imull        $100, %ecx, %edi
	0x29, 0xfe, //0x00000f6f subl         %edi, %esi
	0x0f, 0xb7, 0xde, //0x00000f71 movzwl       %si, %ebx
	0x0f, 0xb7, 0xf8, //0x00000f74 movzwl       %ax, %edi
	0xc1, 0xef, 0x02, //0x00000f77 shrl         $2, %edi
	0x69, 0xff, 0x7b, 0x14, 0x00, 0x00, //0x00000f7a imull        $5243, %edi, %edi
	0xc1, 0xef, 0x11, //0x00000f80 shrl         $17, %edi
	0x6b, 0xf7, 0x64, //0x00000f83 imull        $100, %edi, %esi
	0x29, 0xf0, //0x00000f86 subl         %esi, %eax
	0x44, 0x0f, 0xb7, 0xe0, //0x00000f88 movzwl       %ax, %r12d
	0x48, 0x8d, 0x35, 0x6d, 0x04, 0x00, 0x00, //0x00000f8c leaq         $1133(%rip), %rsi  /* _Digits+0(%rip) */
	0x0f, 0xb7, 0x04, 0x5e, //0x00000f93 movzwl       (%rsi,%rbx,2), %eax
	0x66, 0x41, 0x89, 0x47, 0xfe, //0x00000f97 movw         %ax, $-2(%r15)
	0x0f, 0xb7, 0x04, 0x4e, //0x00000f9c movzwl       (%rsi,%rcx,2), %eax
	0x66, 0x41, 0x89, 0x47, 0xfc, //0x00000fa0 movw         %ax, $-4(%r15)
	0x42, 0x0f, 0xb7, 0x04, 0x66, //0x00000fa5 movzwl       (%rsi,%r12,2), %eax
	0x66, 0x41, 0x89, 0x47, 0xfa, //0x00000faa movw         %ax, $-6(%r15)
	0x0f, 0xb7, 0x04, 0x7e, //0x00000faf movzwl       (%rsi,%rdi,2), %eax
	0x66, 0x41, 0x89, 0x47, 0xf8, //0x00000fb3 movw         %ax, $-8(%r15)
	0x45, 0x31, 0xed, //0x00000fb8 xorl         %r13d, %r13d
	0xe9, 0x06, 0x00, 0x00, 0x00, //0x00000fbb jmp          LBB0_112
	//0x00000fc0 LBB0_110
	0x41, 0xbd, 0x08, 0x00, 0x00, 0x00, //0x00000fc0 movl         $8, %r13d
	//0x00000fc6 LBB0_112
	0x49, 0x8d, 0x47, 0xf8, //0x00000fc6 leaq         $-8(%r15), %rax
	0x4c, 0x89, 0x55, 0xc0, //0x00000fca movq         %r10, $-64(%rbp)
	0x81, 0xfa, 0x10, 0x27, 0x00, 0x00, //0x00000fce cmpl         $10000, %edx
	0x0f, 0x82, 0x30, 0xff, 0xff, 0xff, //0x00000fd4 jb           LBB0_114
	//0x00000fda LBB0_115
	0x41, 0xbc, 0x59, 0x17, 0xb7, 0xd1, //0x00000fda movl         $3518437209, %r12d
	0x48, 0x8d, 0x3d, 0x19, 0x04, 0x00, 0x00, //0x00000fe0 leaq         $1049(%rip), %rdi  /* _Digits+0(%rip) */
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00000fe7 .p2align 4, 0x90
	//0x00000ff0 LBB0_116
	0x89, 0xd1, //0x00000ff0 movl         %edx, %ecx
	0x49, 0x0f, 0xaf, 0xcc, //0x00000ff2 imulq        %r12, %rcx
	0x48, 0xc1, 0xe9, 0x2d, //0x00000ff6 shrq         $45, %rcx
	0x69, 0xd9, 0xf0, 0xd8, 0xff, 0xff, //0x00000ffa imull        $-10000, %ecx, %ebx
	0x01, 0xd3, //0x00001000 addl         %edx, %ebx
	0x48, 0x69, 0xf3, 0x1f, 0x85, 0xeb, 0x51, //0x00001002 imulq        $1374389535, %rbx, %rsi
	0x48, 0xc1, 0xee, 0x25, //0x00001009 shrq         $37, %rsi
	0x44, 0x6b, 0xd6, 0x64, //0x0000100d imull        $100, %esi, %r10d
	0x44, 0x29, 0xd3, //0x00001011 subl         %r10d, %ebx
	0x0f, 0xb7, 0x1c, 0x5f, //0x00001014 movzwl       (%rdi,%rbx,2), %ebx
	0x66, 0x89, 0x58, 0xfe, //0x00001018 movw         %bx, $-2(%rax)
	0x0f, 0xb7, 0x34, 0x77, //0x0000101c movzwl       (%rdi,%rsi,2), %esi
	0x66, 0x89, 0x70, 0xfc, //0x00001020 movw         %si, $-4(%rax)
	0x48, 0x83, 0xc0, 0xfc, //0x00001024 addq         $-4, %rax
	0x81, 0xfa, 0xff, 0xe0, 0xf5, 0x05, //0x00001028 cmpl         $99999999, %edx
	0x89, 0xca, //0x0000102e movl         %ecx, %edx
	0x0f, 0x87, 0xba, 0xff, 0xff, 0xff, //0x00001030 ja           LBB0_116
	//0x00001036 LBB0_117
	0x83, 0xf9, 0x64, //0x00001036 cmpl         $100, %ecx
	0x0f, 0x82, 0x2c, 0x00, 0x00, 0x00, //0x00001039 jb           LBB0_119
	0x0f, 0xb7, 0xd1, //0x0000103f movzwl       %cx, %edx
	0xc1, 0xea, 0x02, //0x00001042 shrl         $2, %edx
	0x69, 0xd2, 0x7b, 0x14, 0x00, 0x00, //0x00001045 imull        $5243, %edx, %edx
	0xc1, 0xea, 0x11, //0x0000104b shrl         $17, %edx
	0x6b, 0xf2, 0x64, //0x0000104e imull        $100, %edx, %esi
	0x29, 0xf1, //0x00001051 subl         %esi, %ecx
	0x0f, 0xb7, 0xc9, //0x00001053 movzwl       %cx, %ecx
	0x48, 0x8d, 0x35, 0xa3, 0x03, 0x00, 0x00, //0x00001056 leaq         $931(%rip), %rsi  /* _Digits+0(%rip) */
	0x0f, 0xb7, 0x0c, 0x4e, //0x0000105d movzwl       (%rsi,%rcx,2), %ecx
	0x66, 0x89, 0x48, 0xfe, //0x00001061 movw         %cx, $-2(%rax)
	0x48, 0x83, 0xc0, 0xfe, //0x00001065 addq         $-2, %rax
	0x89, 0xd1, //0x00001069 movl         %edx, %ecx
	//0x0000106b LBB0_119
	0x48, 0x8b, 0x7d, 0xc0, //0x0000106b movq         $-64(%rbp), %rdi
	0x83, 0xf9, 0x0a, //0x0000106f cmpl         $10, %ecx
	0x0f, 0x82, 0x16, 0x00, 0x00, 0x00, //0x00001072 jb           LBB0_121
	0x89, 0xc9, //0x00001078 movl         %ecx, %ecx
	0x48, 0x8d, 0x15, 0x7f, 0x03, 0x00, 0x00, //0x0000107a leaq         $895(%rip), %rdx  /* _Digits+0(%rip) */
	0x0f, 0xb7, 0x0c, 0x4a, //0x00001081 movzwl       (%rdx,%rcx,2), %ecx
	0x66, 0x89, 0x48, 0xfe, //0x00001085 movw         %cx, $-2(%rax)
	0xe9, 0x06, 0x00, 0x00, 0x00, //0x00001089 jmp          LBB0_122
	//0x0000108e LBB0_121
	0x80, 0xc1, 0x30, //0x0000108e addb         $48, %cl
	0x41, 0x88, 0x08, //0x00001091 movb         %cl, (%r8)
	//0x00001094 LBB0_122
	0x4d, 0x29, 0xef, //0x00001094 subq         %r13, %r15
	0x4d, 0x29, 0xee, //0x00001097 subq         %r13, %r14
	0x49, 0x83, 0xc6, 0x01, //0x0000109a addq         $1, %r14
	0x42, 0x8d, 0x04, 0x2f, //0x0000109e leal         (%rdi,%r13), %eax
	0xb1, 0x01, //0x000010a2 movb         $1, %cl
	0x28, 0xc1, //0x000010a4 subb         %al, %cl
	0xbe, 0x01, 0x00, 0x00, 0x00, //0x000010a6 movl         $1, %esi
	0x29, 0xfe, //0x000010ab subl         %edi, %esi
	0x44, 0x29, 0xee, //0x000010ad subl         %r13d, %esi
	0x46, 0x8d, 0x24, 0x2f, //0x000010b0 leal         (%rdi,%r13), %r12d
	0x41, 0x83, 0xc4, 0xfe, //0x000010b4 addl         $-2, %r12d
	0x44, 0x01, 0xef, //0x000010b8 addl         %r13d, %edi
	0x83, 0xc7, 0xff, //0x000010bb addl         $-1, %edi
	0x31, 0xc0, //0x000010be xorl         %eax, %eax
	0x44, 0x89, 0xe2, //0x000010c0 movl         %r12d, %edx
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x000010c3 .p2align 4, 0x90
	//0x000010d0 LBB0_123
	0x80, 0xc1, 0x03, //0x000010d0 addb         $3, %cl
	0x83, 0xc2, 0x01, //0x000010d3 addl         $1, %edx
	0x41, 0x80, 0x7c, 0x07, 0xff, 0x30, //0x000010d6 cmpb         $48, $-1(%r15,%rax)
	0x48, 0x8d, 0x40, 0xff, //0x000010dc leaq         $-1(%rax), %rax
	0x0f, 0x84, 0xea, 0xff, 0xff, 0xff, //0x000010e0 je           LBB0_123
	0x4d, 0x8d, 0x14, 0x07, //0x000010e6 leaq         (%r15,%rax), %r10
	0x49, 0x83, 0xc2, 0x01, //0x000010ea addq         $1, %r10
	0x45, 0x85, 0xc9, //0x000010ee testl        %r9d, %r9d
	0x0f, 0x8e, 0xb8, 0x00, 0x00, 0x00, //0x000010f1 jle          LBB0_125
	0x45, 0x29, 0xeb, //0x000010f7 subl         %r13d, %r11d
	0x41, 0x8d, 0x1c, 0x03, //0x000010fa leal         (%r11,%rax), %ebx
	0x83, 0xc3, 0x01, //0x000010fe addl         $1, %ebx
	0x41, 0x39, 0xd9, //0x00001101 cmpl         %ebx, %r9d
	0x0f, 0x8d, 0x32, 0x00, 0x00, 0x00, //0x00001104 jge          LBB0_127
	0x83, 0xc6, 0xff, //0x0000110a addl         $-1, %esi
	0x48, 0x63, 0xd6, //0x0000110d movslq       %esi, %rdx
	0x48, 0x8d, 0x3c, 0x02, //0x00001110 leaq         (%rdx,%rax), %rdi
	0x48, 0x83, 0xc7, 0x01, //0x00001114 addq         $1, %rdi
	0x85, 0xff, //0x00001118 testl        %edi, %edi
	0x4c, 0x8b, 0x65, 0xd0, //0x0000111a movq         $-48(%rbp), %r12
	0x0f, 0x8e, 0x05, 0x01, 0x00, 0x00, //0x0000111e jle          LBB0_146
	0x41, 0x89, 0xfa, //0x00001124 movl         %edi, %r10d
	0x49, 0x8d, 0x72, 0xff, //0x00001127 leaq         $-1(%r10), %rsi
	0x48, 0x83, 0xfe, 0x03, //0x0000112b cmpq         $3, %rsi
	0x0f, 0x83, 0x86, 0x00, 0x00, 0x00, //0x0000112f jae          LBB0_147
	0x31, 0xf6, //0x00001135 xorl         %esi, %esi
	0xe9, 0xb0, 0x00, 0x00, 0x00, //0x00001137 jmp          LBB0_143
	//0x0000113c LBB0_127
	0x89, 0xf9, //0x0000113c movl         %edi, %ecx
	0x48, 0x29, 0xc1, //0x0000113e subq         %rax, %rcx
	0x85, 0xc9, //0x00001141 testl        %ecx, %ecx
	0x0f, 0x8e, 0x66, 0x00, 0x00, 0x00, //0x00001143 jle          LBB0_125
	0x45, 0x89, 0xe3, //0x00001149 movl         %r12d, %r11d
	0x4c, 0x89, 0xdf, //0x0000114c movq         %r11, %rdi
	0x48, 0x29, 0xc7, //0x0000114f subq         %rax, %rdi
	0x31, 0xf6, //0x00001152 xorl         %esi, %esi
	0x83, 0xff, 0x7f, //0x00001154 cmpl         $127, %edi
	0x4c, 0x8b, 0x65, 0xd0, //0x00001157 movq         $-48(%rbp), %r12
	0x0f, 0x82, 0x15, 0x02, 0x00, 0x00, //0x0000115b jb           LBB0_137
	0x49, 0x29, 0xc3, //0x00001161 subq         %rax, %r11
	0x41, 0x89, 0xf9, //0x00001164 movl         %edi, %r9d
	0x49, 0x83, 0xc1, 0x01, //0x00001167 addq         $1, %r9
	0x48, 0xbe, 0x80, 0xff, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, //0x0000116b movabsq      $8589934464, %rsi
	0x4c, 0x21, 0xce, //0x00001175 andq         %r9, %rsi
	0x4d, 0x01, 0xf0, //0x00001178 addq         %r14, %r8
	0x41, 0x89, 0xd2, //0x0000117b movl         %edx, %r10d
	0x49, 0x83, 0xc2, 0x01, //0x0000117e addq         $1, %r10
	0x49, 0x83, 0xe2, 0x80, //0x00001182 andq         $-128, %r10
	0x4d, 0x01, 0xc2, //0x00001186 addq         %r8, %r10
	0x49, 0x89, 0xf6, //0x00001189 movq         %rsi, %r14
	0x48, 0x8d, 0x56, 0x80, //0x0000118c leaq         $-128(%rsi), %rdx
	0x49, 0x89, 0xd0, //0x00001190 movq         %rdx, %r8
	0x49, 0xc1, 0xe8, 0x07, //0x00001193 shrq         $7, %r8
	0x49, 0x83, 0xc0, 0x01, //0x00001197 addq         $1, %r8
	0x48, 0x81, 0xfa, 0x80, 0x01, 0x00, 0x00, //0x0000119b cmpq         $384, %rdx
	0x0f, 0x83, 0x96, 0x00, 0x00, 0x00, //0x000011a2 jae          LBB0_131
	0x31, 0xf6, //0x000011a8 xorl         %esi, %esi
	0xe9, 0x50, 0x01, 0x00, 0x00, //0x000011aa jmp          LBB0_133
	//0x000011af LBB0_125
	0x4d, 0x89, 0xd0, //0x000011af movq         %r10, %r8
	0x4c, 0x8b, 0x65, 0xd0, //0x000011b2 movq         $-48(%rbp), %r12
	0xe9, 0xd8, 0x01, 0x00, 0x00, //0x000011b6 jmp          LBB0_180
	//0x000011bb LBB0_147
	0x83, 0xe7, 0xfc, //0x000011bb andl         $-4, %edi
	0x48, 0xf7, 0xdf, //0x000011be negq         %rdi
	0x31, 0xf6, //0x000011c1 xorl         %esi, %esi
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x000011c3 .p2align 4, 0x90
	//0x000011d0 LBB0_148
	0x49, 0x8d, 0x1c, 0x37, //0x000011d0 leaq         (%r15,%rsi), %rbx
	...
	0x4c, 0x89, 0xfa, //0x000011ff movq         %r15, %rdx
	...
	0x4d, 0x8d, 0x04, 0x07, //0x00001231 leaq         (%r15,%rax), %r8
	...
	0x48, 0xf7, 0xda, //0x00001259 negq         %rdx
	0x31, 0xf6, //0x0000125c xorl         %esi, %esi
	0xc5, 0xfe, 0x6f, 0x05, 0x9a, 0xed, 0xff, 0xff, //0x0000125e vmovdqu      $-4710(%rip), %ymm0  /* LCPI0_0+0(%rip) */
	//0x00001266 LBB0_132
	0x49, 0x8d, 0x3c, 0x37, //0x00001266 leaq         (%r15,%rsi), %rdi
	0xc5, 0xfe, 0x7f, 0x44, 0x38, 0x01, //0x0000126a vmovdqu      %ymm0, $1(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x44, 0x38, 0x21, //0x00001270 vmovdqu      %ymm0, $33(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x44, 0x38, 0x41, //0x00001276 vmovdqu      %ymm0, $65(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x44, 0x38, 0x61, //0x0000127c vmovdqu      %ymm0, $97(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0x81, 0x00, 0x00, 0x00, //0x00001282 vmovdqu      %ymm0, $129(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0xa1, 0x00, 0x00, 0x00, //0x0000128b vmovdqu      %ymm0, $161(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0xc1, 0x00, 0x00, 0x00, //0x00001294 vmovdqu      %ymm0, $193(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0xe1, 0x00, 0x00, 0x00, //0x0000129d vmovdqu      %ymm0, $225(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0x01, 0x01, 0x00, 0x00, //0x000012a6 vmovdqu      %ymm0, $257(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0x21, 0x01, 0x00, 0x00, //0x000012af vmovdqu      %ymm0, $289(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0x41, 0x01, 0x00, 0x00, //0x000012b8 vmovdqu      %ymm0, $321(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0x61, 0x01, 0x00, 0x00, //0x000012c1 vmovdqu      %ymm0, $353(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0x81, 0x01, 0x00, 0x00, //0x000012ca vmovdqu      %ymm0, $385(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0xa1, 0x01, 0x00, 0x00, //0x000012d3 vmovdqu      %ymm0, $417(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0xc1, 0x01, 0x00, 0x00, //0x000012dc vmovdqu      %ymm0, $449(%rax,%rdi)
	0xc5, 0xfe, 0x7f, 0x84, 0x38, 0xe1, 0x01, 0x00, 0x00, //0x000012e5 vmovdqu      %ymm0, $481(%rax,%rdi)
	0x48, 0x81, 0xc6, 0x00, 0x02, 0x00, 0x00, //0x000012ee addq         $512, %rsi
	0x48, 0x83, 0xc2, 0x04, //0x000012f5 addq         $4, %rdx
	0x0f, 0x85, 0x67, 0xff, 0xff, 0xff, //0x000012f9 jne          LBB0_132
	//0x000012ff LBB0_133
	0x49, 0x01, 0xc2, //0x000012ff addq         %rax, %r10
	0x41, 0xf6, 0xc0, 0x03, //0x00001302 testb        $3, %r8b
	0x0f, 0x84, 0x5b, 0x00, 0x00, 0x00, //0x00001306 je           LBB0_136
	0x41, 0x83, 0xc3, 0x01, //0x0000130c addl         $1, %r11d
	0x41, 0x81, 0xe3, 0x80, 0x01, 0x00, 0x00, //0x00001310 andl         $384, %r11d
	0x41, 0x83, 0xc3, 0x80, //0x00001317 addl         $-128, %r11d
	0x41, 0xc1, 0xeb, 0x07, //0x0000131b shrl         $7, %r11d
	0x41, 0x80, 0xc3, 0x01, //0x0000131f addb         $1, %r11b
	0x41, 0x0f, 0xb6, 0xd3, //0x00001323 movzbl       %r11b, %edx
	0x83, 0xe2, 0x03, //0x00001327 andl         $3, %edx
	0x48, 0xc1, 0xe2, 0x07, //0x0000132a shlq         $7, %rdx
	0x4c, 0x01, 0xfe, //0x0000132e addq         %r15, %rsi
	0x48, 0x83, 0xc6, 0x61, //0x00001331 addq         $97, %rsi
	0x31, 0xff, //0x00001335 xorl         %edi, %edi
	0xc5, 0xfe, 0x6f, 0x05, 0xc1, 0xec, 0xff, 0xff, //0x00001337 vmovdqu      $-4927(%rip), %ymm0  /* LCPI0_0+0(%rip) */
	//0x0000133f LBB0_135
	0x48, 0x8d, 0x1c, 0x3e, //0x0000133f leaq         (%rsi,%rdi), %rbx
	0xc5, 0xfe, 0x7f, 0x44, 0x18, 0xa0, //0x00001343 vmovdqu      %ymm0, $-96(%rax,%rbx)
	0xc5, 0xfe, 0x7f, 0x44, 0x18, 0xc0, //0x00001349 vmovdqu      %ymm0, $-64(%rax,%rbx)
	0xc5, 0xfe, 0x7f, 0x44, 0x18, 0xe0, //0x0000134f vmovdqu      %ymm0, $-32(%rax,%rbx)
	0xc5, 0xfe, 0x7f, 0x04, 0x18, //0x00001355 vmovdqu      %ymm0, (%rax,%rbx)
	0x48, 0x83, 0xef, 0x80, //0x0000135a subq         $-128, %rdi
	0x48, 0x39, 0xfa, //0x0000135e cmpq         %rdi, %rdx
	0x0f, 0x85, 0xd8, 0xff, 0xff, 0xff, //0x00001361 jne          LBB0_135
	//0x00001367 LBB0_136
	0x44, 0x89, 0xf6, //0x00001367 movl         %r14d, %esi
	0x4d, 0x89, 0xd0, //0x0000136a movq         %r10, %r8
	0x4d, 0x39, 0xf1, //0x0000136d cmpq         %r14, %r9
	0x0f, 0x84, 0x1d, 0x00, 0x00, 0x00, //0x00001370 je           LBB0_180
	//0x00001376 LBB0_137
	0x4d, 0x89, 0xd0, //0x00001376 movq         %r10, %r8
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00001379 .p2align 4, 0x90
	//0x00001380 LBB0_138
	0x41, 0xc6, 0x00, 0x30, //0x00001380 movb         $48, (%r8)
	0x49, 0x83, 0xc0, 0x01, //0x00001384 addq         $1, %r8
	0x83, 0xc6, 0x01, //0x00001388 addl         $1, %esi
	0x39, 0xce, //0x0000138b cmpl         %ecx, %esi
	0x0f, 0x8c, 0xed, 0xff, 0xff, 0xff, //0x0000138d jl           LBB0_138
	//0x00001393 LBB0_180
	0x45, 0x29, 0xe0, //0x00001393 subl         %r12d, %r8d
	//0x00001396 LBB0_181
	...
	0xe9, 0x79, 0xef, 0xff, 0xff, //0x000013b8 jmp          LBB0_63
	//0x000013bd LBB0_1
	...
	0xe9, 0x03, 0xed, 0xff, 0xff, //0x000013ce jmp          LBB0_6
	//0x000013d3 LBB0_29
	0x49, 0x81, 0xf8, 0x00, 0xca, 0x9a, 0x3b, //0x000013d3 cmpq         $1000000000, %r8
	0x4c, 0x8b, 0x4d, 0xc8, //0x000013da movq         $-56(%rbp), %r9
	...
	0x0f, 0x85, 0xf3, 0xf1, 0xff, 0xff, //0x000013ed jne          LBB0_19
	0xe9, 0x07, 0xf6, 0xff, 0xff, //0x000013f3 jmp          LBB0_30
