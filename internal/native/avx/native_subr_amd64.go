...
var (
    _subr__f32toa        = __native_entry__() + 29072
    _subr__f64toa        = __native_entry__() + 496
    _subr__get_by_path   = __native_entry__() + 27984
    ...
    _subr__skip_array    = __native_entry__() + 21200
    _subr__skip_number   = __native_entry__() + 24528
    _subr__skip_object   = __native_entry__() + 23104
    _subr__skip_one      = __native_entry__() + 24672
    _subr__skip_one_fast = __native_entry__() + 24880
    ...
    _subr__vsigned       = __native_entry__() + 20496
    _subr__vstring       = __native_entry__() + 16864
    _subr__vunsigned     = __native_entry__() + 20848
)
