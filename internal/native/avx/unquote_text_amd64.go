...
var _text_unquote = []byte{
	...
	0xc5, 0xfa, 0x6f, 0x05, 0xb8, 0xff, 0xff, 0xff, //0x00000040 vmovdqu      $-72(%rip), %xmm0  /* LCPI0_0+0(%rip) */
	...
	//0x00000090 LBB0_7
	0xc4, 0x81, 0x7a, 0x6f, 0x0c, 0x21, //0x00000090 vmovdqu      (%r9,%r12), %xmm1
	0xc4, 0xa1, 0x7a, 0x7f, 0x0c, 0x20, //0x00000096 vmovdqu      %xmm1, (%rax,%r12)
	0xc5, 0xf1, 0x74, 0xc8, //0x0000009c vpcmpeqb     %xmm0, %xmm1, %xmm1
	0xc5, 0xf9, 0xd7, 0xc9, //0x000000a0 vpmovmskb    %xmm1, %ecx
