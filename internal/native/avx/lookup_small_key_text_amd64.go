...
var _text_lookup_small_key = []byte{
	...
	0x0f, 0x84, 0x38, 0x03, 0x00, 0x00, //0x0000005f je           LBB0_39
	...
	0x66, 0x0f, 0x64, 0xda, //0x000001d1 pcmpgtb      %xmm2, %xmm3
	0xf3, 0x0f, 0x6f, 0x0d, 0x33, 0xfe, 0xff, 0xff, //0x000001d5 movdqu       $-461(%rip), %xmm1  /* LCPI0_1+0(%rip) */
	0x66, 0x0f, 0x6f, 0xc1, //0x000001dd movdqa       %xmm1, %xmm0
	0x66, 0x0f, 0x64, 0xc4, //0x000001e1 pcmpgtb      %xmm4, %xmm0
	0x66, 0x0f, 0xdb, 0xc3, //0x000001e5 pand         %xmm3, %xmm0
	...
	0x66, 0x0f, 0x71, 0xf0, 0x05, //0x000001f5 psllw        $5, %xmm0
	0x66, 0x0f, 0xfc, 0xc4, //0x000001fa paddb        %xmm4, %xmm0
	0x41, 0x0f, 0xb6, 0xca, //0x000001fe movzbl       %r10b, %ecx
	0x41, 0x83, 0xf8, 0x09, //0x00000202 cmpl         $9, %r8d
	0x0f, 0x83, 0xea, 0x00, 0x00, 0x00, //0x00000206 jae          LBB0_21
	0xf3, 0x0f, 0x7f, 0x45, 0xc0, //0x0000020c movdqu       %xmm0, $-64(%rbp)
	0x8a, 0x55, 0xc0, //0x00000211 movb         $-64(%rbp), %dl
	0x8a, 0x5d, 0xc1, //0x00000214 movb         $-63(%rbp), %bl
	0x44, 0x8a, 0x65, 0xc2, //0x00000217 movb         $-62(%rbp), %r12b
	0x44, 0x8a, 0x6d, 0xc3, //0x0000021b movb         $-61(%rbp), %r13b
	0x44, 0x8a, 0x55, 0xc4, //0x0000021f movb         $-60(%rbp), %r10b
	0x44, 0x8a, 0x75, 0xc5, //0x00000223 movb         $-59(%rbp), %r14b
	0x44, 0x8a, 0x7d, 0xc6, //0x00000227 movb         $-58(%rbp), %r15b
	0x8a, 0x45, 0xc7, //0x0000022b movb         $-57(%rbp), %al
	0x41, 0x83, 0xc0, 0x01, //0x0000022e addl         $1, %r8d
	0x41, 0x83, 0xf9, 0x02, //0x00000232 cmpl         $2, %r9d
	0xbf, 0x01, 0x00, 0x00, 0x00, //0x00000236 movl         $1, %edi
	0x41, 0x0f, 0x43, 0xf9, //0x0000023b cmovael      %r9d, %edi
	...
	0x0f, 0x83, 0xb8, 0x00, 0x00, 0x00, //0x000002c5 jae          LBB0_35
	...
	0xe9, 0x9b, 0x00, 0x00, 0x00, //0x000002d7 jmp          LBB0_38
	//0x000002dc LBB0_17
	0x4c, 0x01, 0xee, //0x000002dc addq         %r13, %rsi
	0x48, 0x83, 0xc6, 0xff, //0x000002df addq         $-1, %rsi
	0x0f, 0xb6, 0x06, //0x000002e3 movzbl       (%rsi), %eax
	0xe9, 0xb2, 0x00, 0x00, 0x00, //0x000002e6 jmp          LBB0_39
	//0x000002eb LBB0_4
	0x48, 0x01, 0xce, //0x000002eb addq         %rcx, %rsi
	0x0f, 0xb6, 0x06, //0x000002ee movzbl       (%rsi), %eax
	0xe9, 0xa7, 0x00, 0x00, 0x00, //0x000002f1 jmp          LBB0_39
	//0x000002f6 LBB0_21
	0xf3, 0x41, 0x0f, 0x6f, 0x67, 0x10, //0x000002f6 movdqu       $16(%r15), %xmm4
	0x66, 0x0f, 0x6f, 0xec, //0x000002fc movdqa       %xmm4, %xmm5
	0x66, 0x0f, 0x64, 0xea, //0x00000300 pcmpgtb      %xmm2, %xmm5
	0x66, 0x0f, 0x64, 0xcc, //0x00000304 pcmpgtb      %xmm4, %xmm1
	0x66, 0x0f, 0xdb, 0xcd, //0x00000308 pand         %xmm5, %xmm1
	0x66, 0x0f, 0xdb, 0xcb, //0x0000030c pand         %xmm3, %xmm1
	0x66, 0x0f, 0x71, 0xf1, 0x05, //0x00000310 psllw        $5, %xmm1
	0x66, 0x0f, 0xfc, 0xcc, //0x00000315 paddb        %xmm4, %xmm1
	0x48, 0xc7, 0xc0, 0xff, 0xff, 0xff, 0xff, //0x00000319 movq         $-1, %rax
	0x48, 0xd3, 0xe0, //0x00000320 shlq         %cl, %rax
	0x41, 0x83, 0xc0, 0x01, //0x00000323 addl         $1, %r8d
	0x41, 0x83, 0xf9, 0x02, //0x00000327 cmpl         $2, %r9d
	0xba, 0x01, 0x00, 0x00, 0x00, //0x0000032b movl         $1, %edx
	0x41, 0x0f, 0x43, 0xd1, //0x00000330 cmovael      %r9d, %edx
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00000334 .p2align 4, 0x90
	//0x00000340 LBB0_22
	0xf3, 0x41, 0x0f, 0x6f, 0x13, //0x00000340 movdqu       (%r11), %xmm2
	0xf3, 0x41, 0x0f, 0x6f, 0x5b, 0x10, //0x00000345 movdqu       $16(%r11), %xmm3
	0x66, 0x0f, 0x74, 0xd9, //0x0000034b pcmpeqb      %xmm1, %xmm3
	0x66, 0x0f, 0x74, 0xd0, //0x0000034f pcmpeqb      %xmm0, %xmm2
	0x66, 0x0f, 0xd7, 0xf2, //0x00000353 pmovmskb     %xmm2, %esi
	0x66, 0x0f, 0xd7, 0xfb, //0x00000357 pmovmskb     %xmm3, %edi
	0xc1, 0xe7, 0x10, //0x0000035b shll         $16, %edi
	0x09, 0xf7, //0x0000035e orl          %esi, %edi
	0x09, 0xc7, //0x00000360 orl          %eax, %edi
	0x83, 0xff, 0xff, //0x00000362 cmpl         $-1, %edi
	0x0f, 0x84, 0x28, 0x00, 0x00, 0x00, //0x00000365 je           LBB0_23
	0x4d, 0x01, 0xc3, //0x0000036b addq         %r8, %r11
	0x83, 0xc2, 0xff, //0x0000036e addl         $-1, %edx
	0x0f, 0x85, 0xc9, 0xff, 0xff, 0xff, //0x00000371 jne          LBB0_22
	//0x00000377 LBB0_38
	0x48, 0xc7, 0xc0, 0xff, 0xff, 0xff, 0xff, //0x00000377 movq         $-1, %rax
	0xe9, 0x1a, 0x00, 0x00, 0x00, //0x0000037e jmp          LBB0_39
	//0x00000383 LBB0_35
	0x4b, 0x8d, 0x34, 0x18, //0x00000383 leaq         (%r8,%r11), %rsi
	0x48, 0x83, 0xc6, 0xff, //0x00000387 addq         $-1, %rsi
	0x0f, 0xb6, 0x06, //0x0000038b movzbl       (%rsi), %eax
	0xe9, 0x0a, 0x00, 0x00, 0x00, //0x0000038e jmp          LBB0_39
	//0x00000393 LBB0_23
	0x49, 0x01, 0xcb, //0x00000393 addq         %rcx, %r11
	0x4c, 0x89, 0xde, //0x00000396 movq         %r11, %rsi
	0x41, 0x0f, 0xb6, 0x03, //0x00000399 movzbl       (%r11), %eax
	//0x0000039d LBB0_39
	0x48, 0x83, 0xc4, 0x28, //0x0000039d addq         $40, %rsp
	0x5b, //0x000003a1 popq         %rbx
	0x41, 0x5c, //0x000003a2 popq         %r12
	0x41, 0x5d, //0x000003a4 popq         %r13
	0x41, 0x5e, //0x000003a6 popq         %r14
	0x41, 0x5f, //0x000003a8 popq         %r15
	0x5d, //0x000003aa popq         %rbp
	0xc3, //0x000003ab retq         
}
