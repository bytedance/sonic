...
var (
    ...
    __count_elems_fast func(s unsafe.Pointer, l int, p int) int
)
...
//go:nosplit
func count_elems_fast(s *byte, n int, i int) (ret int) {
    return __count_elems_fast(rt.NoEscape(unsafe.Pointer(s)), n, i)
}
