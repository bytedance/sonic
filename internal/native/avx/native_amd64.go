...
var (
    ...
    __count_elems2 func(s unsafe.Pointer, p unsafe.Pointer) int
)
...
//go:nosplit
func count_elems(s *string, p *int) (ret int) {
    return __count_elems(rt.NoEscape(unsafe.Pointer(s)), rt.NoEscape(unsafe.Pointer(p)))
}

//go:nosplit
func count_elems2(s *string, p *int) (ret int) {
    return __count_elems2(rt.NoEscape(unsafe.Pointer(s)), rt.NoEscape(unsafe.Pointer(p)))
}
