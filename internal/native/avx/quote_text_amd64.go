...
var _text_quote = []byte{
	...
	0x4c, 0x8d, 0x25, 0x91, 0x16, 0x00, 0x00, //0x00000058 leaq         $5777(%rip), %r12  /* __DoubleQuoteTab+0(%rip) */
	...
	0x0f, 0x8d, 0xec, 0x03, 0x00, 0x00, //0x0000006e jge          LBB0_56
	0x4d, 0x89, 0xfe, //0x00000074 movq         %r15, %r14
	0x49, 0x89, 0xf9, //0x00000077 movq         %rdi, %r9
	0x48, 0x85, 0xc0, //0x0000007a testq        %rax, %rax
	0x0f, 0x84, 0xcc, 0x03, 0x00, 0x00, //0x0000007d je           LBB0_80
	0x4c, 0x89, 0x5d, 0xc8, //0x00000083 movq         %r11, $-56(%rbp)
	0xc5, 0xfa, 0x6f, 0x05, 0x71, 0xff, 0xff, 0xff, //0x00000087 vmovdqu      $-143(%rip), %xmm0  /* LCPI0_0+0(%rip) */
	0xc5, 0xfa, 0x6f, 0x0d, 0x79, 0xff, 0xff, 0xff, //0x0000008f vmovdqu      $-135(%rip), %xmm1  /* LCPI0_1+0(%rip) */
	0xc5, 0xfa, 0x6f, 0x15, 0x81, 0xff, 0xff, 0xff, //0x00000097 vmovdqu      $-127(%rip), %xmm2  /* LCPI0_2+0(%rip) */
	0xc5, 0xe1, 0x76, 0xdb, //0x0000009f vpcmpeqd     %xmm3, %xmm3, %xmm3
	...
	0x0f, 0x8c, 0x77, 0x00, 0x00, 0x00, //0x000000c7 jl           LBB0_10
	0x49, 0x83, 0xfa, 0x10, //0x000000cd cmpq         $16, %r10
	0x0f, 0x8c, 0x6d, 0x00, 0x00, 0x00, //0x000000d1 jl           LBB0_10
	0x45, 0x31, 0xff, //0x000000d7 xorl         %r15d, %r15d
	0x48, 0x89, 0xc1, //0x000000da movq         %rax, %rcx
	0x4c, 0x89, 0xd2, //0x000000dd movq         %r10, %rdx
	//0x000000e0 .p2align 4, 0x90
	//0x000000e0 LBB0_6
	0xc4, 0x81, 0x7a, 0x6f, 0x24, 0x39, //0x000000e0 vmovdqu      (%r9,%r15), %xmm4
	...
	0xc4, 0x81, 0x7a, 0x7f, 0x24, 0x3e, //0x000000f6 vmovdqu      %xmm4, (%r14,%r15)
	0xc5, 0xd9, 0x64, 0xe3, //0x000000fc vpcmpgtb     %xmm3, %xmm4, %xmm4
	0xc5, 0xd1, 0xdb, 0xe4, //0x00000100 vpand        %xmm4, %xmm5, %xmm4
	0xc5, 0xc9, 0xeb, 0xe4, //0x00000104 vpor         %xmm4, %xmm6, %xmm4
	0xc5, 0xf9, 0xd7, 0xf4, //0x00000108 vpmovmskb    %xmm4, %esi
	0x85, 0xf6, //0x0000010c testl        %esi, %esi
	0x0f, 0x85, 0x27, 0x01, 0x00, 0x00, //0x0000010e jne          LBB0_23
	0x4c, 0x8d, 0x59, 0xf0, //0x00000114 leaq         $-16(%rcx), %r11
	0x4c, 0x8d, 0x62, 0xf0, //0x00000118 leaq         $-16(%rdx), %r12
	0x49, 0x83, 0xc7, 0x10, //0x0000011c addq         $16, %r15
	0x48, 0x83, 0xf9, 0x20, //0x00000120 cmpq         $32, %rcx
	0x0f, 0x9d, 0xc3, //0x00000124 setge        %bl
	0x0f, 0x8c, 0x10, 0x00, 0x00, 0x00, //0x00000127 jl           LBB0_9
	0x4c, 0x89, 0xd9, //0x0000012d movq         %r11, %rcx
	0x48, 0x83, 0xfa, 0x1f, //0x00000130 cmpq         $31, %rdx
	0x4c, 0x89, 0xe2, //0x00000134 movq         %r12, %rdx
	0x0f, 0x8f, 0xa3, 0xff, 0xff, 0xff, //0x00000137 jg           LBB0_6
	//0x0000013d LBB0_9
	0x4f, 0x8d, 0x2c, 0x39, //0x0000013d leaq         (%r9,%r15), %r13
	0x4d, 0x01, 0xf7, //0x00000141 addq         %r14, %r15
	//0x00000144 LBB0_10
	0x84, 0xdb, //0x00000144 testb        %bl, %bl
	0x0f, 0x84, 0x67, 0x00, 0x00, 0x00, //0x00000146 je           LBB0_14
	0xc4, 0xc1, 0x7a, 0x6f, 0x65, 0x00, //0x0000014c vmovdqu      (%r13), %xmm4
	0xc5, 0xf9, 0x64, 0xec, //0x00000152 vpcmpgtb     %xmm4, %xmm0, %xmm5
	0xc5, 0xd9, 0x74, 0xf1, //0x00000156 vpcmpeqb     %xmm1, %xmm4, %xmm6
	0xc5, 0xd9, 0x74, 0xfa, //0x0000015a vpcmpeqb     %xmm2, %xmm4, %xmm7
	0xc5, 0xc1, 0xeb, 0xf6, //0x0000015e vpor         %xmm6, %xmm7, %xmm6
	0xc5, 0xd9, 0x64, 0xfb, //0x00000162 vpcmpgtb     %xmm3, %xmm4, %xmm7
	0xc5, 0xd1, 0xdb, 0xef, //0x00000166 vpand        %xmm7, %xmm5, %xmm5
	0xc5, 0xc9, 0xeb, 0xed, //0x0000016a vpor         %xmm5, %xmm6, %xmm5
	0xc5, 0xf9, 0xd7, 0xcd, //0x0000016e vpmovmskb    %xmm5, %ecx
	0x81, 0xc9, 0x00, 0x00, 0x01, 0x00, //0x00000172 orl          $65536, %ecx
	0x44, 0x0f, 0xbc, 0xd9, //0x00000178 bsfl         %ecx, %r11d
	0xc4, 0xe1, 0xf9, 0x7e, 0xe1, //0x0000017c vmovq        %xmm4, %rcx
	0x4d, 0x39, 0xdc, //0x00000181 cmpq         %r11, %r12
	0x0f, 0x8d, 0xc1, 0x00, 0x00, 0x00, //0x00000184 jge          LBB0_24
	0x49, 0x83, 0xfc, 0x08, //0x0000018a cmpq         $8, %r12
	0x0f, 0x82, 0xf6, 0x00, 0x00, 0x00, //0x0000018e jb           LBB0_28
	0x49, 0x89, 0x0f, //0x00000194 movq         %rcx, (%r15)
	0x4d, 0x8d, 0x5d, 0x08, //0x00000197 leaq         $8(%r13), %r11
	0x49, 0x83, 0xc7, 0x08, //0x0000019b addq         $8, %r15
	0x49, 0x8d, 0x5c, 0x24, 0xf8, //0x0000019f leaq         $-8(%r12), %rbx
	0x48, 0x83, 0xfb, 0x04, //0x000001a4 cmpq         $4, %rbx
	0x0f, 0x8d, 0xec, 0x00, 0x00, 0x00, //0x000001a8 jge          LBB0_29
	0xe9, 0xf9, 0x00, 0x00, 0x00, //0x000001ae jmp          LBB0_30
	//0x000001b3 LBB0_14
	0x4d, 0x85, 0xdb, //0x000001b3 testq        %r11, %r11
	0x0f, 0x8e, 0x67, 0x00, 0x00, 0x00, //0x000001b6 jle          LBB0_21
	0x4d, 0x85, 0xe4, //0x000001bc testq        %r12, %r12
	0x0f, 0x8e, 0x5e, 0x00, 0x00, 0x00, //0x000001bf jle          LBB0_21
	0x4c, 0x89, 0x4d, 0xb8, //0x000001c5 movq         %r9, $-72(%rbp)
	0x45, 0x31, 0xc9, //0x000001c9 xorl         %r9d, %r9d
	0x31, 0xc9, //0x000001cc xorl         %ecx, %ecx
	0x90, 0x90, //0x000001ce .p2align 4, 0x90
	//0x000001d0 LBB0_17
	0x43, 0x0f, 0xb6, 0x74, 0x0d, 0x00, //0x000001d0 movzbl       (%r13,%r9), %esi
	0x48, 0x89, 0xf3, //0x000001d6 movq         %rsi, %rbx
	0x48, 0xc1, 0xe3, 0x04, //0x000001d9 shlq         $4, %rbx
	0x48, 0x8d, 0x15, 0x0c, 0x05, 0x00, 0x00, //0x000001dd leaq         $1292(%rip), %rdx  /* __SingleQuoteTab+0(%rip) */
	0x48, 0x83, 0x3c, 0x13, 0x00, //0x000001e4 cmpq         $0, (%rbx,%rdx)
	0x0f, 0x85, 0x8c, 0x00, 0x00, 0x00, //0x000001e9 jne          LBB0_27
	0x4d, 0x8d, 0x04, 0x0b, //0x000001ef leaq         (%r11,%rcx), %r8
	0x43, 0x88, 0x34, 0x0f, //0x000001f3 movb         %sil, (%r15,%r9)
	0x48, 0x8d, 0x59, 0xff, //0x000001f7 leaq         $-1(%rcx), %rbx
	0x49, 0x83, 0xf8, 0x02, //0x000001fb cmpq         $2, %r8
	0x0f, 0x8c, 0x14, 0x00, 0x00, 0x00, //0x000001ff jl           LBB0_20
	0x4c, 0x01, 0xe1, //0x00000205 addq         %r12, %rcx
	0x49, 0x83, 0xc1, 0x01, //0x00000208 addq         $1, %r9
	0x48, 0x83, 0xf9, 0x01, //0x0000020c cmpq         $1, %rcx
	0x48, 0x89, 0xd9, //0x00000210 movq         %rbx, %rcx
	0x0f, 0x8f, 0xb7, 0xff, 0xff, 0xff, //0x00000213 jg           LBB0_17
	//0x00000219 LBB0_20
	0x49, 0x29, 0xdd, //0x00000219 subq         %rbx, %r13
	0x49, 0x01, 0xdb, //0x0000021c addq         %rbx, %r11
	0x4c, 0x8b, 0x4d, 0xb8, //0x0000021f movq         $-72(%rbp), %r9
	//0x00000223 LBB0_21
	0x4d, 0x85, 0xdb, //0x00000223 testq        %r11, %r11
	0x4c, 0x8b, 0x65, 0xc0, //0x00000226 movq         $-64(%rbp), %r12
	0x0f, 0x84, 0x43, 0x00, 0x00, 0x00, //0x0000022a je           LBB0_26
	0x49, 0xf7, 0xd5, //0x00000230 notq         %r13
	0x4d, 0x01, 0xcd, //0x00000233 addq         %r9, %r13
	0xe9, 0x27, 0x01, 0x00, 0x00, //0x00000236 jmp          LBB0_41
	//0x0000023b LBB0_23
	0x66, 0x0f, 0xbc, 0xce, //0x0000023b bsfw         %si, %cx
	0x44, 0x0f, 0xb7, 0xe9, //0x0000023f movzwl       %cx, %r13d
	0x4d, 0x01, 0xfd, //0x00000243 addq         %r15, %r13
	0xe9, 0x13, 0x01, 0x00, 0x00, //0x00000246 jmp          LBB0_40
	//0x0000024b LBB0_24
	0x41, 0x83, 0xfb, 0x08, //0x0000024b cmpl         $8, %r11d
	0x0f, 0x82, 0xa3, 0x00, 0x00, 0x00, //0x0000024f jb           LBB0_34
	0x49, 0x89, 0x0f, //0x00000255 movq         %rcx, (%r15)
	0x4d, 0x8d, 0x65, 0x08, //0x00000258 leaq         $8(%r13), %r12
	0x49, 0x83, 0xc7, 0x08, //0x0000025c addq         $8, %r15
	0x49, 0x8d, 0x5b, 0xf8, //0x00000260 leaq         $-8(%r11), %rbx
	0x48, 0x83, 0xfb, 0x04, //0x00000264 cmpq         $4, %rbx
	0x0f, 0x8d, 0x9a, 0x00, 0x00, 0x00, //0x00000268 jge          LBB0_35
	0xe9, 0xa8, 0x00, 0x00, 0x00, //0x0000026e jmp          LBB0_36
	//0x00000273 LBB0_26
	0x4d, 0x29, 0xcd, //0x00000273 subq         %r9, %r13
	0xe9, 0xe7, 0x00, 0x00, 0x00, //0x00000276 jmp          LBB0_41
	//0x0000027b LBB0_27
	0x4c, 0x8b, 0x4d, 0xb8, //0x0000027b movq         $-72(%rbp), %r9
	0x4d, 0x29, 0xcd, //0x0000027f subq         %r9, %r13
	0x49, 0x29, 0xcd, //0x00000282 subq         %rcx, %r13
	0xe9, 0xd4, 0x00, 0x00, 0x00, //0x00000285 jmp          LBB0_40
	//0x0000028a LBB0_28
	0x4d, 0x89, 0xeb, //0x0000028a movq         %r13, %r11
	0x4c, 0x89, 0xe3, //0x0000028d movq         %r12, %rbx
	0x48, 0x83, 0xfb, 0x04, //0x00000290 cmpq         $4, %rbx
	0x0f, 0x8c, 0x12, 0x00, 0x00, 0x00, //0x00000294 jl           LBB0_30
	//0x0000029a LBB0_29
	0x41, 0x8b, 0x0b, //0x0000029a movl         (%r11), %ecx
	0x41, 0x89, 0x0f, //0x0000029d movl         %ecx, (%r15)
	0x49, 0x83, 0xc3, 0x04, //0x000002a0 addq         $4, %r11
	0x49, 0x83, 0xc7, 0x04, //0x000002a4 addq         $4, %r15
	0x48, 0x83, 0xc3, 0xfc, //0x000002a8 addq         $-4, %rbx
	//0x000002ac LBB0_30
	0x48, 0x83, 0xfb, 0x02, //0x000002ac cmpq         $2, %rbx
	0x0f, 0x82, 0x22, 0x00, 0x00, 0x00, //0x000002b0 jb           LBB0_31
	0x41, 0x0f, 0xb7, 0x0b, //0x000002b6 movzwl       (%r11), %ecx
	0x66, 0x41, 0x89, 0x0f, //0x000002ba movw         %cx, (%r15)
	0x49, 0x83, 0xc3, 0x02, //0x000002be addq         $2, %r11
	0x49, 0x83, 0xc7, 0x02, //0x000002c2 addq         $2, %r15
	0x48, 0x83, 0xc3, 0xfe, //0x000002c6 addq         $-2, %rbx
	0x48, 0x85, 0xdb, //0x000002ca testq        %rbx, %rbx
	0x0f, 0x85, 0x0e, 0x00, 0x00, 0x00, //0x000002cd jne          LBB0_32
	0xe9, 0x0f, 0x00, 0x00, 0x00, //0x000002d3 jmp          LBB0_33
	//0x000002d8 LBB0_31
	0x48, 0x85, 0xdb, //0x000002d8 testq        %rbx, %rbx
	0x0f, 0x84, 0x06, 0x00, 0x00, 0x00, //0x000002db je           LBB0_33
	//0x000002e1 LBB0_32
	0x41, 0x8a, 0x0b, //0x000002e1 movb         (%r11), %cl
	0x41, 0x88, 0x0f, //0x000002e4 movb         %cl, (%r15)
	//0x000002e7 LBB0_33
	0x4d, 0x01, 0xec, //0x000002e7 addq         %r13, %r12
	0x49, 0xf7, 0xd4, //0x000002ea notq         %r12
	0x4d, 0x01, 0xcc, //0x000002ed addq         %r9, %r12
	0x4d, 0x89, 0xe5, //0x000002f0 movq         %r12, %r13
	0xe9, 0x66, 0x00, 0x00, 0x00, //0x000002f3 jmp          LBB0_40
	//0x000002f8 LBB0_34
	0x4d, 0x89, 0xec, //0x000002f8 movq         %r13, %r12
	0x4c, 0x89, 0xdb, //0x000002fb movq         %r11, %rbx
	0x48, 0x83, 0xfb, 0x04, //0x000002fe cmpq         $4, %rbx
	0x0f, 0x8c, 0x13, 0x00, 0x00, 0x00, //0x00000302 jl           LBB0_36
	//0x00000308 LBB0_35
	0x41, 0x8b, 0x0c, 0x24, //0x00000308 movl         (%r12), %ecx
	0x41, 0x89, 0x0f, //0x0000030c movl         %ecx, (%r15)
	0x49, 0x83, 0xc4, 0x04, //0x0000030f addq         $4, %r12
	0x49, 0x83, 0xc7, 0x04, //0x00000313 addq         $4, %r15
	0x48, 0x83, 0xc3, 0xfc, //0x00000317 addq         $-4, %rbx
	//0x0000031b LBB0_36
	0x48, 0x83, 0xfb, 0x02, //0x0000031b cmpq         $2, %rbx
	0x0f, 0x82, 0x23, 0x00, 0x00, 0x00, //0x0000031f jb           LBB0_37
	0x41, 0x0f, 0xb7, 0x0c, 0x24, //0x00000325 movzwl       (%r12), %ecx
	0x66, 0x41, 0x89, 0x0f, //0x0000032a movw         %cx, (%r15)
	0x49, 0x83, 0xc4, 0x02, //0x0000032e addq         $2, %r12
	0x49, 0x83, 0xc7, 0x02, //0x00000332 addq         $2, %r15
	0x48, 0x83, 0xc3, 0xfe, //0x00000336 addq         $-2, %rbx
	0x48, 0x85, 0xdb, //0x0000033a testq        %rbx, %rbx
	0x0f, 0x85, 0x0e, 0x00, 0x00, 0x00, //0x0000033d jne          LBB0_38
	0xe9, 0x10, 0x00, 0x00, 0x00, //0x00000343 jmp          LBB0_39
	//0x00000348 LBB0_37
	0x48, 0x85, 0xdb, //0x00000348 testq        %rbx, %rbx
	0x0f, 0x84, 0x07, 0x00, 0x00, 0x00, //0x0000034b je           LBB0_39
	//0x00000351 LBB0_38
	0x41, 0x8a, 0x0c, 0x24, //0x00000351 movb         (%r12), %cl
	0x41, 0x88, 0x0f, //0x00000355 movb         %cl, (%r15)
	//0x00000358 LBB0_39
	0x4d, 0x29, 0xcd, //0x00000358 subq         %r9, %r13
	0x4d, 0x01, 0xdd, //0x0000035b addq         %r11, %r13
	//0x0000035e LBB0_40
	0x4c, 0x8b, 0x65, 0xc0, //0x0000035e movq         $-64(%rbp), %r12
	//0x00000362 LBB0_41
	0x49, 0xbb, 0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, //0x00000362 movabsq      $12884901889, %r11
	0x4d, 0x85, 0xed, //0x0000036c testq        %r13, %r13
	0x0f, 0x88, 0x4f, 0x03, 0x00, 0x00, //0x0000036f js           LBB0_83
	0x4d, 0x01, 0xee, //0x00000375 addq         %r13, %r14
	0x4c, 0x39, 0xe8, //0x00000378 cmpq         %r13, %rax
	0x0f, 0x84, 0xc3, 0x00, 0x00, 0x00, //0x0000037b je           LBB0_79
	0x4d, 0x29, 0xea, //0x00000381 subq         %r13, %r10
	0xe9, 0x17, 0x00, 0x00, 0x00, //0x00000384 jmp          LBB0_45
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00000389 .p2align 4, 0x90
	//0x00000390 LBB0_44
	0x49, 0x01, 0xf6, //0x00000390 addq         %rsi, %r14
	0x49, 0x83, 0xc5, 0x01, //0x00000393 addq         $1, %r13
	0x4c, 0x39, 0xe8, //0x00000397 cmpq         %r13, %rax
	0x0f, 0x84, 0xa4, 0x00, 0x00, 0x00, //0x0000039a je           LBB0_79
	//0x000003a0 LBB0_45
	0x43, 0x0f, 0xb6, 0x0c, 0x29, //0x000003a0 movzbl       (%r9,%r13), %ecx
	0x48, 0xc1, 0xe1, 0x04, //0x000003a5 shlq         $4, %rcx
	0x49, 0x8b, 0x14, 0x0c, //0x000003a9 movq         (%r12,%rcx), %rdx
	0x85, 0xd2, //0x000003ad testl        %edx, %edx
	0x0f, 0x84, 0x82, 0x00, 0x00, 0x00, //0x000003af je           LBB0_53
	0x48, 0x63, 0xf2, //0x000003b5 movslq       %edx, %rsi
	0x49, 0x29, 0xf2, //0x000003b8 subq         %rsi, %r10
	0x0f, 0x8c, 0xdd, 0x02, 0x00, 0x00, //0x000003bb jl           LBB0_81
	0x48, 0xc1, 0xe2, 0x20, //0x000003c1 shlq         $32, %rdx
	0x49, 0x8d, 0x1c, 0x0c, //0x000003c5 leaq         (%r12,%rcx), %rbx
	0x48, 0x83, 0xc3, 0x08, //0x000003c9 addq         $8, %rbx
	0x4c, 0x39, 0xda, //0x000003cd cmpq         %r11, %rdx
	0x0f, 0x8c, 0x2a, 0x00, 0x00, 0x00, //0x000003d0 jl           LBB0_49
	0x8b, 0x13, //0x000003d6 movl         (%rbx), %edx
	0x41, 0x89, 0x16, //0x000003d8 movl         %edx, (%r14)
	0x49, 0x8d, 0x1c, 0x0c, //0x000003db leaq         (%r12,%rcx), %rbx
	0x48, 0x83, 0xc3, 0x0c, //0x000003df addq         $12, %rbx
	0x4d, 0x8d, 0x46, 0x04, //0x000003e3 leaq         $4(%r14), %r8
	0x48, 0x8d, 0x4e, 0xfc, //0x000003e7 leaq         $-4(%rsi), %rcx
	0x48, 0x83, 0xf9, 0x02, //0x000003eb cmpq         $2, %rcx
	0x0f, 0x83, 0x1b, 0x00, 0x00, 0x00, //0x000003ef jae          LBB0_50
	0xe9, 0x29, 0x00, 0x00, 0x00, //0x000003f5 jmp          LBB0_51
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x000003fa .p2align 4, 0x90
	//0x00000400 LBB0_49
	0x4d, 0x89, 0xf0, //0x00000400 movq         %r14, %r8
	0x48, 0x89, 0xf1, //0x00000403 movq         %rsi, %rcx
	0x48, 0x83, 0xf9, 0x02, //0x00000406 cmpq         $2, %rcx
	0x0f, 0x82, 0x13, 0x00, 0x00, 0x00, //0x0000040a jb           LBB0_51
	//0x00000410 LBB0_50
	0x0f, 0xb7, 0x13, //0x00000410 movzwl       (%rbx), %edx
	0x66, 0x41, 0x89, 0x10, //0x00000413 movw         %dx, (%r8)
	0x48, 0x83, 0xc3, 0x02, //0x00000417 addq         $2, %rbx
	0x49, 0x83, 0xc0, 0x02, //0x0000041b addq         $2, %r8
	0x48, 0x83, 0xc1, 0xfe, //0x0000041f addq         $-2, %rcx
	//0x00000423 LBB0_51
	0x48, 0x85, 0xc9, //0x00000423 testq        %rcx, %rcx
	0x0f, 0x84, 0x64, 0xff, 0xff, 0xff, //0x00000426 je           LBB0_44
	0x0f, 0xb6, 0x0b, //0x0000042c movzbl       (%rbx), %ecx
	0x41, 0x88, 0x08, //0x0000042f movb         %cl, (%r8)
	0xe9, 0x59, 0xff, 0xff, 0xff, //0x00000432 jmp          LBB0_44
	//0x00000437 LBB0_53
	0x4b, 0x8d, 0x0c, 0x29, //0x00000437 leaq         (%r9,%r13), %rcx
	0x4c, 0x29, 0xe8, //0x0000043b subq         %r13, %rax
	0x0f, 0x85, 0x6d, 0xfc, 0xff, 0xff, //0x0000043e jne          LBB0_3
	//0x00000444 LBB0_79
	0x4d, 0x01, 0xe9, //0x00000444 addq         %r13, %r9
	0x4c, 0x8b, 0x5d, 0xc8, //0x00000447 movq         $-56(%rbp), %r11
	0x4c, 0x8b, 0x7d, 0xd0, //0x0000044b movq         $-48(%rbp), %r15
	//0x0000044f LBB0_80
	0x4d, 0x29, 0xfe, //0x0000044f subq         %r15, %r14
	0x4d, 0x89, 0x33, //0x00000452 movq         %r14, (%r11)
	0x49, 0x29, 0xf9, //0x00000455 subq         %rdi, %r9
	0x4c, 0x89, 0xc8, //0x00000458 movq         %r9, %rax
	0xe9, 0x55, 0x02, 0x00, 0x00, //0x0000045b jmp          LBB0_82
	//0x00000460 LBB0_56
	0xc5, 0xfa, 0x6f, 0x05, 0x98, 0xfb, 0xff, 0xff, //0x00000460 vmovdqu      $-1128(%rip), %xmm0  /* LCPI0_0+0(%rip) */
	0xc5, 0xfa, 0x6f, 0x0d, 0xa0, 0xfb, 0xff, 0xff, //0x00000468 vmovdqu      $-1120(%rip), %xmm1  /* LCPI0_1+0(%rip) */
	0xc5, 0xfa, 0x6f, 0x15, 0xa8, 0xfb, 0xff, 0xff, //0x00000470 vmovdqu      $-1112(%rip), %xmm2  /* LCPI0_2+0(%rip) */
	0xc5, 0xe1, 0x76, 0xdb, //0x00000478 vpcmpeqd     %xmm3, %xmm3, %xmm3
	0x4c, 0x8d, 0x0d, 0x6d, 0x22, 0x00, 0x00, //0x0000047c leaq         $8813(%rip), %r9  /* __EscTab+0(%rip) */
	0x4c, 0x89, 0xfe, //0x00000483 movq         %r15, %rsi
	0x48, 0x89, 0xc3, //0x00000486 movq         %rax, %rbx
	//0x00000489 LBB0_57
	0x48, 0x83, 0xfb, 0x10, //0x00000489 cmpq         $16, %rbx
	0x0f, 0x8c, 0x5d, 0x00, 0x00, 0x00, //0x0000048d jl           LBB0_62
	0x49, 0x89, 0xda, //0x00000493 movq         %rbx, %r10
	0x49, 0xf7, 0xda, //0x00000496 negq         %r10
	0x48, 0x83, 0xc3, 0x10, //0x00000499 addq         $16, %rbx
	0x90, 0x90, 0x90, //0x0000049d .p2align 4, 0x90
	//0x000004a0 LBB0_59
	0xc5, 0xfa, 0x6f, 0x27, //0x000004a0 vmovdqu      (%rdi), %xmm4
	0xc5, 0xf9, 0x64, 0xec, //0x000004a4 vpcmpgtb     %xmm4, %xmm0, %xmm5
	0xc5, 0xd9, 0x74, 0xf1, //0x000004a8 vpcmpeqb     %xmm1, %xmm4, %xmm6
	0xc5, 0xd9, 0x74, 0xfa, //0x000004ac vpcmpeqb     %xmm2, %xmm4, %xmm7
	0xc5, 0xc1, 0xeb, 0xf6, //0x000004b0 vpor         %xmm6, %xmm7, %xmm6
	0xc5, 0xfa, 0x7f, 0x26, //0x000004b4 vmovdqu      %xmm4, (%rsi)
	0xc5, 0xd9, 0x64, 0xe3, //0x000004b8 vpcmpgtb     %xmm3, %xmm4, %xmm4
	0xc5, 0xd1, 0xdb, 0xe4, //0x000004bc vpand        %xmm4, %xmm5, %xmm4
	0xc5, 0xc9, 0xeb, 0xe4, //0x000004c0 vpor         %xmm4, %xmm6, %xmm4
	0xc5, 0xf9, 0xd7, 0xcc, //0x000004c4 vpmovmskb    %xmm4, %ecx
	0x85, 0xc9, //0x000004c8 testl        %ecx, %ecx
	0x0f, 0x85, 0x2e, 0x01, 0x00, 0x00, //0x000004ca jne          LBB0_72
	0x48, 0x83, 0xc7, 0x10, //0x000004d0 addq         $16, %rdi
	0x48, 0x83, 0xc6, 0x10, //0x000004d4 addq         $16, %rsi
	0x49, 0x83, 0xc2, 0x10, //0x000004d8 addq         $16, %r10
	0x48, 0x83, 0xc3, 0xf0, //0x000004dc addq         $-16, %rbx
	0x48, 0x83, 0xfb, 0x20, //0x000004e0 cmpq         $32, %rbx
	0x0f, 0x8d, 0xb6, 0xff, 0xff, 0xff, //0x000004e4 jge          LBB0_59
	0x49, 0xf7, 0xda, //0x000004ea negq         %r10
	0x4c, 0x89, 0xd3, //0x000004ed movq         %r10, %rbx
	//0x000004f0 LBB0_62
	0x48, 0x83, 0xfb, 0x08, //0x000004f0 cmpq         $8, %rbx
	0x0f, 0x8c, 0x75, 0x00, 0x00, 0x00, //0x000004f4 jl           LBB0_66
	0x0f, 0xb6, 0x0f, //0x000004fa movzbl       (%rdi), %ecx
	0x0f, 0xb6, 0x57, 0x01, //0x000004fd movzbl       $1(%rdi), %edx
	0x42, 0x8a, 0x14, 0x0a, //0x00000501 movb         (%rdx,%r9), %dl
	0x00, 0xd2, //0x00000505 addb         %dl, %dl
	0x42, 0x0a, 0x14, 0x09, //0x00000507 orb          (%rcx,%r9), %dl
	0x0f, 0xb6, 0x4f, 0x02, //0x0000050b movzbl       $2(%rdi), %ecx
	0x42, 0x8a, 0x0c, 0x09, //0x0000050f movb         (%rcx,%r9), %cl
	0xc0, 0xe1, 0x02, //0x00000513 shlb         $2, %cl
	0x08, 0xd1, //0x00000516 orb          %dl, %cl
	0x0f, 0xb6, 0x57, 0x03, //0x00000518 movzbl       $3(%rdi), %edx
	0x42, 0x8a, 0x14, 0x0a, //0x0000051c movb         (%rdx,%r9), %dl
	0xc0, 0xe2, 0x03, //0x00000520 shlb         $3, %dl
	0x08, 0xca, //0x00000523 orb          %cl, %dl
	0x48, 0x8b, 0x0f, //0x00000525 movq         (%rdi), %rcx
	0x48, 0x89, 0x0e, //0x00000528 movq         %rcx, (%rsi)
	0x0f, 0x85, 0x2e, 0x01, 0x00, 0x00, //0x0000052b jne          LBB0_76
	0x0f, 0xb6, 0x4f, 0x04, //0x00000531 movzbl       $4(%rdi), %ecx
	0x0f, 0xb6, 0x57, 0x05, //0x00000535 movzbl       $5(%rdi), %edx
	0x42, 0x8a, 0x14, 0x0a, //0x00000539 movb         (%rdx,%r9), %dl
	0x00, 0xd2, //0x0000053d addb         %dl, %dl
	0x42, 0x0a, 0x14, 0x09, //0x0000053f orb          (%rcx,%r9), %dl
	0x0f, 0xb6, 0x4f, 0x06, //0x00000543 movzbl       $6(%rdi), %ecx
	0x42, 0x8a, 0x0c, 0x09, //0x00000547 movb         (%rcx,%r9), %cl
	0xc0, 0xe1, 0x02, //0x0000054b shlb         $2, %cl
	0x08, 0xd1, //0x0000054e orb          %dl, %cl
	0x0f, 0xb6, 0x57, 0x07, //0x00000550 movzbl       $7(%rdi), %edx
	0x42, 0x8a, 0x14, 0x0a, //0x00000554 movb         (%rdx,%r9), %dl
	0xc0, 0xe2, 0x03, //0x00000558 shlb         $3, %dl
	0x08, 0xca, //0x0000055b orb          %cl, %dl
	0x0f, 0x85, 0x10, 0x01, 0x00, 0x00, //0x0000055d jne          LBB0_77
	0x48, 0x83, 0xc6, 0x08, //0x00000563 addq         $8, %rsi
	0x48, 0x83, 0xc7, 0x08, //0x00000567 addq         $8, %rdi
	0x48, 0x83, 0xc3, 0xf8, //0x0000056b addq         $-8, %rbx
	//0x0000056f LBB0_66
	0x48, 0x83, 0xfb, 0x04, //0x0000056f cmpq         $4, %rbx
	0x0f, 0x8c, 0x41, 0x00, 0x00, 0x00, //0x00000573 jl           LBB0_69
	0x0f, 0xb6, 0x0f, //0x00000579 movzbl       (%rdi), %ecx
	0x0f, 0xb6, 0x57, 0x01, //0x0000057c movzbl       $1(%rdi), %edx
	0x42, 0x8a, 0x14, 0x0a, //0x00000580 movb         (%rdx,%r9), %dl
	0x00, 0xd2, //0x00000584 addb         %dl, %dl
	0x42, 0x0a, 0x14, 0x09, //0x00000586 orb          (%rcx,%r9), %dl
	0x0f, 0xb6, 0x4f, 0x02, //0x0000058a movzbl       $2(%rdi), %ecx
	0x42, 0x8a, 0x0c, 0x09, //0x0000058e movb         (%rcx,%r9), %cl
	0xc0, 0xe1, 0x02, //0x00000592 shlb         $2, %cl
	0x08, 0xd1, //0x00000595 orb          %dl, %cl
	0x0f, 0xb6, 0x57, 0x03, //0x00000597 movzbl       $3(%rdi), %edx
	0x42, 0x8a, 0x14, 0x0a, //0x0000059b movb         (%rdx,%r9), %dl
	0xc0, 0xe2, 0x03, //0x0000059f shlb         $3, %dl
	0x08, 0xca, //0x000005a2 orb          %cl, %dl
	0x8b, 0x0f, //0x000005a4 movl         (%rdi), %ecx
	0x89, 0x0e, //0x000005a6 movl         %ecx, (%rsi)
	0x0f, 0x85, 0xb1, 0x00, 0x00, 0x00, //0x000005a8 jne          LBB0_76
	0x48, 0x83, 0xc6, 0x04, //0x000005ae addq         $4, %rsi
	0x48, 0x83, 0xc7, 0x04, //0x000005b2 addq         $4, %rdi
	0x48, 0x83, 0xc3, 0xfc, //0x000005b6 addq         $-4, %rbx
	//0x000005ba LBB0_69
	0x48, 0x85, 0xdb, //0x000005ba testq        %rbx, %rbx
	0x0f, 0x8e, 0xd0, 0x00, 0x00, 0x00, //0x000005bd jle          LBB0_78
	...
	0x0f, 0x85, 0x36, 0x00, 0x00, 0x00, //0x000005d8 jne          LBB0_73
	0x48, 0x83, 0xc7, 0x01, //0x000005de addq         $1, %rdi
	0x88, 0x0e, //0x000005e2 movb         %cl, (%rsi)
	0x48, 0x83, 0xc6, 0x01, //0x000005e4 addq         $1, %rsi
	0x48, 0x8d, 0x4b, 0xff, //0x000005e8 leaq         $-1(%rbx), %rcx
	0x48, 0x83, 0xfb, 0x01, //0x000005ec cmpq         $1, %rbx
	0x48, 0x89, 0xcb, //0x000005f0 movq         %rcx, %rbx
	0x0f, 0x8f, 0xd7, 0xff, 0xff, 0xff, //0x000005f3 jg           LBB0_70
	0xe9, 0x95, 0x00, 0x00, 0x00, //0x000005f9 jmp          LBB0_78
	//0x000005fe LBB0_72
	0x66, 0x0f, 0xbc, 0xc9, //0x000005fe bsfw         %cx, %cx
	0x0f, 0xb7, 0xc9, //0x00000602 movzwl       %cx, %ecx
	0x48, 0x01, 0xcf, //0x00000605 addq         %rcx, %rdi
	0x49, 0x01, 0xca, //0x00000608 addq         %rcx, %r10
	0x49, 0xf7, 0xda, //0x0000060b negq         %r10
	0x48, 0x01, 0xce, //0x0000060e addq         %rcx, %rsi
	0x4c, 0x89, 0xd3, //0x00000611 movq         %r10, %rbx
	//0x00000614 LBB0_73
	0x8a, 0x0f, //0x00000614 movb         (%rdi), %cl
	0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, //0x00000616 .p2align 4, 0x90
	//0x00000620 LBB0_74
	0x48, 0x89, 0xf2, //0x00000620 movq         %rsi, %rdx
	0x0f, 0xb6, 0xc9, //0x00000623 movzbl       %cl, %ecx
	0x48, 0xc1, 0xe1, 0x04, //0x00000626 shlq         $4, %rcx
	0x49, 0x63, 0x34, 0x0c, //0x0000062a movslq       (%r12,%rcx), %rsi
	0x49, 0x8b, 0x4c, 0x0c, 0x08, //0x0000062e movq         $8(%r12,%rcx), %rcx
	0x48, 0x89, 0x0a, //0x00000633 movq         %rcx, (%rdx)
	0x48, 0x01, 0xd6, //0x00000636 addq         %rdx, %rsi
	0x48, 0x83, 0xfb, 0x02, //0x00000639 cmpq         $2, %rbx
	0x0f, 0x8c, 0x50, 0x00, 0x00, 0x00, //0x0000063d jl           LBB0_78
	0x0f, 0xb6, 0x4f, 0x01, //0x00000643 movzbl       $1(%rdi), %ecx
	0x48, 0x83, 0xc7, 0x01, //0x00000647 addq         $1, %rdi
	0x48, 0x83, 0xc3, 0xff, //0x0000064b addq         $-1, %rbx
	0x42, 0x80, 0x3c, 0x09, 0x00, //0x0000064f cmpb         $0, (%rcx,%r9)
	0x0f, 0x85, 0xc6, 0xff, 0xff, 0xff, //0x00000654 jne          LBB0_74
	0xe9, 0x2a, 0xfe, 0xff, 0xff, //0x0000065a jmp          LBB0_57
	//0x0000065f LBB0_76
	0x0f, 0xb6, 0xca, //0x0000065f movzbl       %dl, %ecx
	0x0f, 0xbc, 0xc9, //0x00000662 bsfl         %ecx, %ecx
	0x48, 0x01, 0xcf, //0x00000665 addq         %rcx, %rdi
	0x48, 0x29, 0xcb, //0x00000668 subq         %rcx, %rbx
	0x48, 0x01, 0xce, //0x0000066b addq         %rcx, %rsi
	0xe9, 0xa1, 0xff, 0xff, 0xff, //0x0000066e jmp          LBB0_73
	//0x00000673 LBB0_77
	0x0f, 0xb6, 0xca, //0x00000673 movzbl       %dl, %ecx
	0x0f, 0xbc, 0xc9, //0x00000676 bsfl         %ecx, %ecx
	0x48, 0x8d, 0x51, 0x04, //0x00000679 leaq         $4(%rcx), %rdx
	0x48, 0x01, 0xcf, //0x0000067d addq         %rcx, %rdi
	0x48, 0x83, 0xc7, 0x04, //0x00000680 addq         $4, %rdi
	0x48, 0x29, 0xd3, //0x00000684 subq         %rdx, %rbx
	0x48, 0x01, 0xce, //0x00000687 addq         %rcx, %rsi
	0x48, 0x83, 0xc6, 0x04, //0x0000068a addq         $4, %rsi
	0xe9, 0x81, 0xff, 0xff, 0xff, //0x0000068e jmp          LBB0_73
	//0x00000693 LBB0_78
	0x4c, 0x29, 0xfe, //0x00000693 subq         %r15, %rsi
	0x49, 0x89, 0x33, //0x00000696 movq         %rsi, (%r11)
	0xe9, 0x17, 0x00, 0x00, 0x00, //0x00000699 jmp          LBB0_82
	//0x0000069e LBB0_81
	0x4c, 0x2b, 0x75, 0xd0, //0x0000069e subq         $-48(%rbp), %r14
	0x48, 0x8b, 0x45, 0xc8, //0x000006a2 movq         $-56(%rbp), %rax
	0x4c, 0x89, 0x30, //0x000006a6 movq         %r14, (%rax)
	0x4c, 0x29, 0xcf, //0x000006a9 subq         %r9, %rdi
	0x49, 0xf7, 0xd5, //0x000006ac notq         %r13
	0x49, 0x01, 0xfd, //0x000006af addq         %rdi, %r13
	0x4c, 0x89, 0xe8, //0x000006b2 movq         %r13, %rax
	//0x000006b5 LBB0_82
	0x48, 0x83, 0xc4, 0x20, //0x000006b5 addq         $32, %rsp
	0x5b, //0x000006b9 popq         %rbx
	0x41, 0x5c, //0x000006ba popq         %r12
	0x41, 0x5d, //0x000006bc popq         %r13
	0x41, 0x5e, //0x000006be popq         %r14
	0x41, 0x5f, //0x000006c0 popq         %r15
	0x5d, //0x000006c2 popq         %rbp
	0xc3, //0x000006c3 retq         
	//0x000006c4 LBB0_83
	0x48, 0x8b, 0x4d, 0xd0, //0x000006c4 movq         $-48(%rbp), %rcx
	0x4c, 0x01, 0xe9, //0x000006c8 addq         %r13, %rcx
	0x48, 0xf7, 0xd1, //0x000006cb notq         %rcx
	0x4c, 0x01, 0xf1, //0x000006ce addq         %r14, %rcx
	0x48, 0x8b, 0x45, 0xc8, //0x000006d1 movq         $-56(%rbp), %rax
	0x48, 0x89, 0x08, //0x000006d5 movq         %rcx, (%rax)
	0x4c, 0x29, 0xcf, //0x000006d8 subq         %r9, %rdi
	0x4c, 0x01, 0xef, //0x000006db addq         %r13, %rdi
	0x48, 0x89, 0xf8, //0x000006de movq         %rdi, %rax
	0xe9, 0xcf, 0xff, 0xff, 0xff, //0x000006e1 jmp          LBB0_82
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //0x000006e6 .p2align 4, 0x00
