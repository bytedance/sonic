...
_LB_da11c741: // _pow10_ceil_sig.g
	QUAD $0xff77b1fcbebcdc4f // .quad -38366372719436721
...
_LB_7ad26adc: // _pow10_ceil_sig_f32.g
...
_f32toa:
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·__native_entry__+24816(SB) // _f32toa
	MOVQ  AX, ret+16(FP)
	RET
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+10704(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_i64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+4400(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+5776(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ m+16(FP), DX
	MOVQ flags+24(FP), CX
	CALL ·__native_entry__+23088(SB) // _skip_array
	MOVQ AX, ret+32(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+24560(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ m+16(FP), DX
	MOVQ flags+24(FP), CX
	CALL ·__native_entry__+23136(SB) // _skip_object
	MOVQ AX, ret+32(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+4512(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+7520(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+24704(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	MOVQ v+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+13952(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18960(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+20512(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ v+16(FP), DX
	MOVQ flags+24(FP), CX
	LEAQ ·__native_entry__+16032(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+20864(SB), AX // _vunsigned
	JMP  AX
