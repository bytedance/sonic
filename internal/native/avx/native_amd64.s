...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0xfd0d8d48; WORD $0x0073; BYTE $0x00 // leaq         $29693(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0x280d8d4c; WORD $0x0088; BYTE $0x00 // leaq         $34856(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R9*1), R15
	MOVQ    R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x003d0ae8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, CX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(CX)(CX*4), CX
	SUBL    CX, AX
	LONG    $0x0b0d8d48; WORD $0x0097; BYTE $0x00 // leaq         $38667(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_68:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x003c66e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_79
	LEAL  0(R13)(BX*1), AX
	CMPL  R13, R15
...
LBB2_73:
	...
	JL      LBB2_81
	WORD    $0x9848                               // cltq
	LONG    $0x5e0d8d48; WORD $0x0096; BYTE $0x00 // leaq         $38494(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_104:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0038e5e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x560d8d48; WORD $0x0092; BYTE $0x00 // leaq         $37462(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x35358d48; WORD $0x0092; BYTE $0x00 // leaq         $37429(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	INCL    CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x24158d48; WORD $0x0092; BYTE $0x00 // leaq         $37412(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	INCL CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x0c158d48; WORD $0x0092; BYTE $0x00 // leaq         $37388(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	INCL    CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0x75058d48; WORD $0x0091; BYTE $0x00 // leaq         $37237(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x50358d48; WORD $0x0091; BYTE $0x00 // leaq         $37200(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	INCL CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0x3f058d48; WORD $0x0091; BYTE $0x00 // leaq         $37183(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	INCL CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x25358d48; WORD $0x0091; BYTE $0x00 // leaq         $37157(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x9a158d48; WORD $0x0090; BYTE $0x00 // leaq         $37018(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0x7d0d8d48; WORD $0x008f; BYTE $0x00 // leaq         $36733(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x2c0d8d48; WORD $0x008f; BYTE $0x00 // leaq         $36652(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x09058d4c; WORD $0x008f; BYTE $0x00 // leaq         $36617(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
_quote:
	...
	MOVQ  DX, CX
	TESTB $1, R8
	LONG  $0x08058d48; WORD $0x008f; BYTE $0x00 // leaq         $36616(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0x01158d48; WORD $0x009f; BYTE $0x00 // leaq         $40705(%rip), %rdx  /* __DoubleQuoteTab(%rip) */
...
LBB5_14:
	...
	MOVQ  -48(BP), CX
	MOVQ  -56(BP), DI
	LONG  $0x8d2d8d4c; WORD $0x008d; BYTE $0x00 // leaq         $36237(%rip), %r13  /* __SingleQuoteTab(%rip) */
	JLE   LBB5_29
...
_unquote:
	...
	MOVQ  R8, -72(BP)
	ANDL  $1, R8
	LONG  $0xfa3d8d48; WORD $0x00aa; BYTE $0x00 // leaq         $43770(%rip), %rdi  /* __UnquoteTab(%rip) */
...
LBB6_25:
	...
	MOVL    R9, R12
	NOTL    R12
	LEAL    -808464432(R9), CX
	ANDL    $-2139062144, R12
	TESTL   CX, R12
	JNE     LBB6_106
	LEAL    421075225(R9), CX
	ORL     R9, CX
	TESTL   $-2139062144, CX
	JNE     LBB6_106
	MOVL    R9, R10
...
LBB6_41:
	...
	MOVL    R9, CX
	NOTL    CX
	LEAL    -808464432(R9), BX
	ANDL    $-2139062144, CX
	TESTL   BX, CX
	JNE     LBB6_107
	LEAL    421075225(R9), BX
	ORL     R9, BX
	TESTL   $-2139062144, BX
	JNE     LBB6_107
	MOVL    R9, BX
...
_atof_eisel_lemire64:
	...
	MOVL DX, R15
	MOVQ DI, R13
	LONG $0x002765e8; BYTE $0x00               // callq        _count_len_u64
	MOVL AX, R8
	MOVL AX, CX
	NEGL CX
	SHLQ CX, R13
	MOVL BX, CX
	SHLQ $4, CX
	LONG $0xaa158d4c; WORD $0x002a; BYTE $0x00 // leaq         $10922(%rip), %r10  /* _POW10_M128_TAB(%rip) */
	MOVQ R13, AX
	MULQ 8(CX)(R10*1)
	MOVQ AX, R9
	MOVQ DX, DI
...
LBB8_5:
	...
	JLE   LBB8_12
	XORL  R12, R12
	LONG  $0xbf358d4c; WORD $0x0054; BYTE $0x00 // leaq         $21695(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB8_8
...
LBB8_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x00277ee8; BYTE $0x00 // callq        _right_shift
...
LBB8_12:
	LONG $0x78358d4c; WORD $0x0054; BYTE $0x00 // leaq         $21624(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB8_14
...
LBB8_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x0025d1e8; BYTE $0x00 // callq        _left_shift
	MOVL 804(R15), AX
...
LBB8_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x0026d0e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB8_25
	ADDL $60, R12
...
LBB8_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x00268ae8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB8_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002506e8; BYTE $0x00 // callq        _left_shift
...
LBB10_26:
	CMPQ DX, $16
	JB   LBB10_30
	QUAD $0xfffffe9b056ffac5 // vmovdqu      $-357(%rip), %xmm0  /* LCPI10_0(%rip) */
	QUAD $0xfffffea30d6ffac5 // vmovdqu      $-349(%rip), %xmm1  /* LCPI10_1(%rip) */
	QUAD $0xfffffeab156ffac5 // vmovdqu      $-341(%rip), %xmm2  /* LCPI10_2(%rip) */
	QUAD $0xfffffeb31d6ffac5 // vmovdqu      $-333(%rip), %xmm3  /* LCPI10_3(%rip) */
...
LBB10_40:
	...
	CMPL    CX, $125
	JA      LBB10_43
	LONG    $0x55158d48; WORD $0x0002; BYTE $0x00 // leaq         $597(%rip), %rdx  /* LJTI10_0(%rip) */
...
LBB10_42:
	...
	LEAQ -40(BP), SI
	MOVQ R14, DX
	LONG $0x0007e9e8; BYTE $0x00 // callq        _vnumber
	MOVQ -40(BP), AX
	JMP  LBB10_81
...
LBB10_44:
	...
	MOVQ  R15, SI
	MOVQ  R12, DX
	LONG  $0x00049ae8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB10_63
	MOVQ  AX, -40(BP)
	MOVQ  R12, 16(R14)
...
// .set L10_0_set_42, LBB10_42-LJTI10_0
...
LJTI10_0:
	LONG $0xffffffe9 // .long L10_0_set_79
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	...
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffddd // .long L10_0_set_44
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	...
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffe28 // .long L10_0_set_46
	LONG $0xfffffdb4 // .long L10_0_set_42
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdb4 // .long L10_0_set_42
	LONG $0xfffffdb4 // .long L10_0_set_42
	...
	LONG $0xfffffdb4 // .long L10_0_set_42
	LONG $0xfffffdb4 // .long L10_0_set_42
	LONG $0xfffffe41 // .long L10_0_set_47
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	...
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffe5a // .long L10_0_set_48
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffed8 // .long L10_0_set_56
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	...
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffefb // .long L10_0_set_58
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	...
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffe66 // .long L10_0_set_49
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffe94 // .long L10_0_set_52
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xffffff30 // .long L10_0_set_62
	LONG $0xfffffdd1 // .long L10_0_set_43
	LONG $0xfffffec2 // .long L10_0_set_55
...
_advance_string:
	...
	MOVQ $-1, -48(BP)
	XORL R11, R11
	QUAD $0xffffffa8056ffac5       // vmovdqu      $-88(%rip), %xmm0  /* LCPI12_0(%rip) */
	QUAD $0xffffffb00d6ffac5       // vmovdqu      $-80(%rip), %xmm1  /* LCPI12_1(%rip) */
...
LBB12_13:
	...
	QUAD  $0xfffffe53156ffac5     // vmovdqu      $-429(%rip), %xmm2  /* LCPI12_0(%rip) */
	QUAD  $0xfffffe5b1d6ffac5     // vmovdqu      $-421(%rip), %xmm3  /* LCPI12_1(%rip) */
...
LBB13_63:
	...
	JL    LBB13_72
	LEAL  -22(BX), AX
	LONG  $0x340d8d48; WORD $0x014f; BYTE $0x00 // leaq         $85812(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB13_69:
	...
	JB   LBB13_76
	NEGL BX
	LONG $0xfc058d48; WORD $0x014e; BYTE $0x00 // leaq         $85756(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB13_73:
	...
	JA   LBB13_76
	MOVL AX, AX
	LONG $0x8f0d8d48; WORD $0x014e; BYTE $0x00 // leaq         $85647(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc8               // vmovsd       %xmm0, $-56(%rbp)
	JMP  LBB13_82
...
LBB13_76:
	...
	MOVL  BX, SI
	MOVL  -48(BP), DX
	LONG  $0xffeaf8e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB13_80
...
LBB13_80:
	...
	MOVL 8(CX), SI
	SUBL AX, SI
	LONG $0xffef35e8; BYTE $0xff // callq        _atof_native_decimal
	JMP  LBB13_82
...
_fsm_exec:
	...
	MOVQ  $-1, R13
	MOVQ  $4294977024, R14
	QUAD  $0xffffff781d6ffac5 // vmovdqu      $-136(%rip), %xmm3  /* LCPI17_0(%rip) */
	QUAD  $0xffffff80256ffac5 // vmovdqu      $-128(%rip), %xmm4  /* LCPI17_1(%rip) */
	QUAD  $0xffffff882d6ffac5 // vmovdqu      $-120(%rip), %xmm5  /* LCPI17_2(%rip) */
	QUAD  $0xffffff90356ffac5 // vmovdqu      $-112(%rip), %xmm6  /* LCPI17_3(%rip) */
	MOVQ  R12, R8
	MOVQ  DI, -64(BP)
	JMP   LBB17_7
...
LBB17_48:
	...
	JA      LBB17_53
	LEAQ    -1(SI), R11
	LONG    $0x481d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1096(%rip), %rbx  /* LJTI17_0(%rip) */
...
LBB17_58:
	...
	MOVQ  R12, DX
	LEAQ  -72(BP), CX
	LONG  $0xfff2b0e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, CX
	TESTQ AX, AX
	JS    LBB17_93
...
LBB17_59:
	...
	TESTQ R12, R12
	MOVQ  -64(BP), R9
	QUAD  $0xfffffca71d6ffac5 // vmovdqu      $-857(%rip), %xmm3  /* LCPI17_0(%rip) */
	QUAD  $0xfffffcaf256ffac5 // vmovdqu      $-849(%rip), %xmm4  /* LCPI17_1(%rip) */
	QUAD  $0xfffffcb72d6ffac5 // vmovdqu      $-841(%rip), %xmm5  /* LCPI17_2(%rip) */
	QUAD  $0xfffffcbf356ffac5 // vmovdqu      $-833(%rip), %xmm6  /* LCPI17_3(%rip) */
	JG    LBB17_5
	JMP   LBB17_97
...
LBB17_64:
	MOVQ    $-1, AX
	LONG    $0x4b158d48; WORD $0x0003; BYTE $0x00 // leaq         $843(%rip), %rdx  /* LJTI17_1(%rip) */
	MOVLQSX 0(DX)(CX*4), CX
	ADDQ    DX, CX
	JMP     CX
...
LBB17_67:
	...
	QUAD  $0xfffffc4f356ffac5     // vmovdqu      $-945(%rip), %xmm6  /* LCPI17_3(%rip) */
	QUAD  $0xfffffc372d6ffac5     // vmovdqu      $-969(%rip), %xmm5  /* LCPI17_2(%rip) */
	QUAD  $0xfffffc1f256ffac5     // vmovdqu      $-993(%rip), %xmm4  /* LCPI17_1(%rip) */
	QUAD  $0xfffffc071d6ffac5     // vmovdqu      $-1017(%rip), %xmm3  /* LCPI17_0(%rip) */
	MOVQ  -64(BP), R9
	LEAQ  -1(AX), DX
	MOVQ  $-2, CX
	SUBQ  AX, CX
...
LBB17_70:
	...
	MOVQ    R12, DX
	LEAQ    -72(BP), CX
	LONG    $0xfff162e8; BYTE $0xff // callq        _advance_string
	MOVQ    AX, CX
	TESTQ   AX, AX
	JS      LBB17_93
	MOVQ    -48(BP), AX
	...
	TESTQ   R12, R12
	MOVQ    -64(BP), R9
	QUAD    $0xfffffb5c1d6ffac5     // vmovdqu      $-1188(%rip), %xmm3  /* LCPI17_0(%rip) */
	QUAD    $0xfffffb64256ffac5     // vmovdqu      $-1180(%rip), %xmm4  /* LCPI17_1(%rip) */
	QUAD    $0xfffffb6c2d6ffac5     // vmovdqu      $-1172(%rip), %xmm5  /* LCPI17_2(%rip) */
	QUAD    $0xfffffb74356ffac5     // vmovdqu      $-1164(%rip), %xmm6  /* LCPI17_3(%rip) */
	JLE     LBB17_97
	MOVLQSX 0(R9), AX
	CMPQ    AX, $65535
	JG      LBB17_101
...
// .set L17_0_set_54, LBB17_54-LJTI17_0
...
LJTI17_0:
	LONG $0xfffffbc1 // .long L17_0_set_50
	LONG $0xfffffbef // .long L17_0_set_54
	LONG $0xfffffc1c // .long L17_0_set_56
	LONG $0xfffffc8c // .long L17_0_set_60
	LONG $0xfffffca2 // .long L17_0_set_62
	LONG $0xfffffd4b // .long L17_0_set_65

	// .set L17_1_set_97, LBB17_97-LJTI17_1
	// .set L17_1_set_96, LBB17_96-LJTI17_1
	// .set L17_1_set_58, LBB17_58-LJTI17_1
	// .set L17_1_set_74, LBB17_74-LJTI17_1
	// .set L17_1_set_67, LBB17_67-LJTI17_1
	// .set L17_1_set_76, LBB17_76-LJTI17_1
...
LJTI17_1:
	LONG $0xffffff39 // .long L17_1_set_97
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	...
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xfffffc15 // .long L17_1_set_58
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	...
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xfffffde0 // .long L17_1_set_74
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xfffffcbe // .long L17_1_set_67
	LONG $0xfffffcbe // .long L17_1_set_67
	LONG $0xfffffcbe // .long L17_1_set_67
	LONG $0xfffffcbe // .long L17_1_set_67
	LONG $0xfffffcbe // .long L17_1_set_67
	...
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xfffffe07 // .long L17_1_set_76
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	...
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xfffffe2a // .long L17_1_set_78
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	...
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xfffffe56 // .long L17_1_set_81
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xfffffe7b // .long L17_1_set_86
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xffffff32 // .long L17_1_set_96
	LONG $0xfffffebc // .long L17_1_set_90
...
_skip_string:
	...
	LEAQ  -32(BP), CX
	MOVQ  BX, DX
	LONG  $0xffec7de8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB20_2
	DECQ  BX
	MOVQ  AX, CX
...
LBB22_4:
	...
	CMPQ SI, $16
	JB   LBB22_51
	QUAD $0xffffff47056f7ac5 // vmovdqu      $-185(%rip), %xmm8  /* LCPI22_0(%rip) */
	QUAD $0xffffff4f0d6f7ac5 // vmovdqu      $-177(%rip), %xmm9  /* LCPI22_1(%rip) */
	QUAD $0xffffff57156f7ac5 // vmovdqu      $-169(%rip), %xmm10  /* LCPI22_2(%rip) */
	QUAD $0xffffff5f1d6f7ac5 // vmovdqu      $-161(%rip), %xmm11  /* LCPI22_3(%rip) */
	QUAD $0xffffff67256ffac5 // vmovdqu      $-153(%rip), %xmm4  /* LCPI22_4(%rip) */
	QUAD $0xffffff6f2d6ffac5 // vmovdqu      $-145(%rip), %xmm5  /* LCPI22_5(%rip) */
	QUAD $0xffffff77356ffac5 // vmovdqu      $-137(%rip), %xmm6  /* LCPI22_6(%rip) */
	MOVL $4294967295, R11
	MOVQ $-1, R8
	MOVQ $-1, R9
	MOVQ DI, DX
...
LBB22_22:
	LONG $0xfd358d48; WORD $0x0000; BYTE $0x00 // leaq         $253(%rip), %rsi  /* LJTI22_0(%rip) */
...
// .set L22_0_set_34, LBB22_34-LJTI22_0
// .set L22_0_set_29, LBB22_29-LJTI22_0
// .set L22_0_set_23, LBB22_23-LJTI22_0
// .set L22_0_set_27, LBB22_27-LJTI22_0
LJTI22_0:
	LONG $0xffffff1e // .long L22_0_set_25
	LONG $0xffffff7a // .long L22_0_set_34
	LONG $0xffffff1e // .long L22_0_set_25
	LONG $0xffffff4e // .long L22_0_set_29
	LONG $0xffffff7a // .long L22_0_set_34
	LONG $0xffffff03 // .long L22_0_set_23
	LONG $0xffffff03 // .long L22_0_set_23
	LONG $0xffffff03 // .long L22_0_set_23
	LONG $0xffffff03 // .long L22_0_set_23
	LONG $0xffffff03 // .long L22_0_set_23
	...
	LONG $0xffffff7a // .long L22_0_set_34
	LONG $0xffffff7a // .long L22_0_set_34
	LONG $0xffffff36 // .long L22_0_set_27
	LONG $0xffffff7a // .long L22_0_set_34
	LONG $0xffffff7a // .long L22_0_set_34
	LONG $0xffffff7a // .long L22_0_set_34
	LONG $0xffffff7a // .long L22_0_set_34
...
TEXT ·__f64toa(SB), NOSPLIT, $0 - 24
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+542(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
TEXT ·__i64toa(SB), NOSPLIT, $0 - 24
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+3551(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
TEXT ·__quote(SB), NOSPLIT, $0 - 48
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+4864(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
TEXT ·__skip_array(SB), NOSPLIT, $0 - 32
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+16717(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__skip_object(SB), NOSPLIT, $0 - 32
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+16752(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__skip_one(SB), NOSPLIT, $0 - 32
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+14395(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__u64toa(SB), NOSPLIT, $0 - 24
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+3644(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
TEXT ·__unquote(SB), NOSPLIT, $0 - 48
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+5885(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
TEXT ·__value(SB), NOSPLIT, $0 - 48
	...
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+10074(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
TEXT ·__vnumber(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+12633(SB), AX // _vnumber
	JMP  AX
...
TEXT ·__vsigned(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+13845(SB), AX // _vsigned
	JMP  AX
...
TEXT ·__vstring(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+11680(SB), AX // _vstring
	JMP  AX
...
TEXT ·__vunsigned(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+14122(SB), AX // _vunsigned
	JMP  AX
