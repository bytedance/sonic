...
LBB2_8:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0xbc0d8d48; WORD $0x0083; BYTE $0x00 // leaq         $33724(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R15, R13
	ORQ     $2, R13
	MOVQ    0(AX)(CX*1), R11
	MOVQ    8(AX)(CX*1), R14
...
LBB2_23:
	...
	MOVLQSX AX, DI
	SHLQ    $4, DI
	LONG    $0xe10d8d4c; WORD $0x0097; BYTE $0x00 // leaq         $38881(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R15, BX
	ORQ     $2, BX
	MOVQ    0(DI)(R9*1), R11
	MOVQ    R11, AX
...
LBB2_70:
	...
	MOVQ R15, SI
	MOVL BX, DX
	LONG $0x004d32e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL BX, $2
...
LBB2_77:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R12
	LONG    $0xe7058d48; WORD $0x00a6; BYTE $0x00 // leaq         $42727(%rip), %rax  /* _Digits(%rip) */
...
LBB2_81:
	...
	MOVQ  R13, SI
	MOVL  BX, DX
	LONG  $0x004ca4e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R15, R15
	JS    LBB2_83
	JE    LBB2_124
	MOVL  BX, BX
...
LBB2_78:
	...
	JL      LBB2_80
	MOVLQSX R12, AX
	LONG    $0x320d8d48; WORD $0x00a6; BYTE $0x00 // leaq         $42546(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_86:
	...
	MOVQ R13, SI
	MOVL BX, DX
	LONG $0x004b67e8; BYTE $0x00 // callq        _print_mantissa
	MOVL $2, AX
	JMP  LBB2_111
...
LBB2_104:
	...
	MOVL BX, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0048a4e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_i64toa:
	...
	CMPL    SI, $1000
	JB      LBB3_4
	LONG    $0x1e058d48; WORD $0x00a2; BYTE $0x00 // leaq         $41502(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(DX)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, AX
	JMP     LBB3_5
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x3e058d48; WORD $0x00a1; BYTE $0x00 // leaq         $41278(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(DX)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, AX
	JMP     LBB4_4
...
LBB4_7:
	MOVWLZX CX, CX
	ORQ     $1, CX
	LONG    $0xf2158d48; WORD $0x00a0; BYTE $0x00 // leaq         $41202(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(CX)(DX*1), CX
	MOVL    AX, DX
	ADDL    $1, AX
	MOVB    CX, 0(DI)(DX*1)
...
_u32toa_medium:
	...
	CMPL    SI, $10000000
	JB      LBB5_2
	LONG    $0x49058d48; WORD $0x00a0; BYTE $0x00 // leaq         $41033(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, AX
	JMP     LBB5_3
...
LBB5_3:
	MOVL R10, DX
	ORQ  $1, DX
	LONG $0x24358d48; WORD $0x00a0; BYTE $0x00 // leaq         $40996(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(DX)(SI*1), DX
	MOVL AX, SI
	ADDL $1, AX
	MOVB DX, 0(DI)(SI*1)
...
LBB5_5:
	LONG $0x12158d48; WORD $0x00a0; BYTE $0x00 // leaq         $40978(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(CX)(DX*1), DX
	MOVL AX, SI
	ADDL $1, AX
	MOVB DX, 0(DI)(SI*1)
...
LBB5_6:
	MOVL    CX, CX
	ORQ     $1, CX
	LONG    $0xfa158d48; WORD $0x009f; BYTE $0x00 // leaq         $40954(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(CX)(DX*1), CX
	MOVL    AX, SI
	MOVB    CX, 0(DI)(SI*1)
	MOVB    0(R8)(DX*1), CX
...
_u64toa_large_sse2:
	...
	QUAD $0xffffff562d6ffac5                   // vmovdqu      $-170(%rip), %xmm5  /* LCPI6_3(%rip) */
	...
	SUBL CX, AX
	SHLQ $4, CX
	LONG $0x43158d48; WORD $0x009f; BYTE $0x00 // leaq         $40771(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB7_2:
	...
	JA      LBB7_4
	MOVL    DX, AX
	LONG    $0xe40d8d48; WORD $0x009d; BYTE $0x00 // leaq         $40420(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVL    $2, CX
	JMP     LBB7_7
...
LBB7_4:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x9b0d8d48; WORD $0x009d; BYTE $0x00 // leaq         $40347(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 1(DI)
	MOVL    $3, CX
	JMP     LBB7_7
...
LBB7_6:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x7d0d8d48; WORD $0x009d; BYTE $0x00 // leaq         $40317(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVWLZX DX, AX
	MOVB    0(CX)(AX*2), DX
...
LBB7_7:
	...
	LONG $0xc070fbc5; BYTE $0x50   // vpshuflw     $80, %xmm0, %xmm0
	LONG $0xc070f9c5; BYTE $0x50   // vpshufd      $80, %xmm0, %xmm0
	QUAD $0xfffffec61512fbc5       // vmovddup     $-314(%rip), %xmm2  /* LCPI7_1(%rip) */
	LONG $0xc2e4f9c5               // vpmulhuw     %xmm2, %xmm0, %xmm0
	QUAD $0xfffffec22512fbc5       // vmovddup     $-318(%rip), %xmm4  /* LCPI7_2(%rip) */
	LONG $0xc4e4f9c5               // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffe8e2d6ffac5       // vmovdqu      $-370(%rip), %xmm5  /* LCPI7_3(%rip) */
	LONG $0xf5d5f9c5               // vpmullw      %xmm5, %xmm0, %xmm6
	LONG $0xf673c9c5; BYTE $0x10   // vpsllq       $16, %xmm6, %xmm6
	LONG $0xc6f9f9c5               // vpsubw       %xmm6, %xmm0, %xmm0
	LONG $0xe100c269; WORD $0x05f5 // imull        $100000000, %edx, %eax
	...
	LONG $0xcaf9f1c5               // vpsubw       %xmm2, %xmm1, %xmm1
	LONG $0xc167f9c5               // vpackuswb    %xmm1, %xmm0, %xmm0
	QUAD $0xfffffe4005fcf9c5       // vpaddb       $-448(%rip), %xmm0, %xmm0  /* LCPI7_4(%rip) */
	MOVL CX, AX
...
_quote:
	...
	SUBQ  $32, SP
	TESTB $1, R8
	LONG  $0x8d058d48; WORD $0x009d; BYTE $0x00 // leaq         $40333(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0x86158d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44422(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	...
	MOVQ  CX, -56(BP)
	MOVQ  0(CX), R11
	QUAD  $0xffffff8b056ffac5                   // vmovdqu      $-117(%rip), %xmm0  /* LCPI8_0(%rip) */
	QUAD  $0xffffff930d6ffac5                   // vmovdqu      $-109(%rip), %xmm1  /* LCPI8_1(%rip) */
	QUAD  $0xffffff9b156ffac5                   // vmovdqu      $-101(%rip), %xmm2  /* LCPI8_2(%rip) */
	MOVQ  DI, CX
	MOVQ  DX, -48(BP)
	MOVQ  DX, R8
...
LBB8_9:
	TESTB R14, R14
	JE    LBB8_13
	LONG  $0x6f7ac1c4; BYTE $0x1f // vmovdqu      (%r15), %xmm3
	LONG  $0xe074e1c5             // vpcmpeqb     %xmm0, %xmm3, %xmm4
	LONG  $0xe974e1c5             // vpcmpeqb     %xmm1, %xmm3, %xmm5
	LONG  $0xe4ebd1c5             // vpor         %xmm4, %xmm5, %xmm4
	LONG  $0xeadae1c5             // vpminub      %xmm2, %xmm3, %xmm5
...
LBB8_16:
	...
	MOVQ    DI, DX
	SHLQ    $4, DX
	LONG    $0x170d8d48; WORD $0x009c; BYTE $0x00 // leaq         $39959(%rip), %rcx  /* __SingleQuoteTab(%rip) */
	CMPQ    0(DX)(CX*1), $0
	JNE     LBB8_23
	LEAQ    0(R9)(BX*1), R14
	MOVB    DI, 0(R13)(R10*1)
...
_unquote:
	...
	MOVL  R8, R10
	ANDL  $1, R10
	LONG  $0x34258d4c; WORD $0x00b9; BYTE $0x00 // leaq         $47412(%rip), %r12  /* __UnquoteTab(%rip) */
	QUAD  $0xffffffbc0d6ffac5                   // vmovdqu      $-68(%rip), %xmm1  /* LCPI9_0(%rip) */
	MOVQ  DI, R15
	MOVQ  SI, R13
	MOVQ  DX, R14
	MOVQ  R8, -64(BP)
...
LBB9_90:
	...
	JNE     LBB9_93
	LEAQ    2(R15), DI
	LONG    $0x000585e8; BYTE $0x00 // callq        _unhex16_is
	TESTB   AX, AX
	JE      LBB9_99
	MOVL    2(R15), AX
	BSWAPL  AX
	...
	MOVQ    -88(BP), DX
	MOVQ    -72(BP), SI
	QUAD    $0xfffffd2c0d6ffac5     // vmovdqu      $-724(%rip), %xmm1  /* LCPI9_0(%rip) */
	JA      LBB9_109
	MOVW    $-16401, 0(R14)
	MOVB    $-67, 2(R14)
	ADDQ    $3, R14
...
LBB9_55:
	MOVQ  -64(BP), R8
	LONG  $0x70258d4c; WORD $0x00b5; BYTE $0x00 // leaq         $46448(%rip), %r12  /* __UnquoteTab(%rip) */
	TESTQ R13, R13
	JNE   LBB9_4
	JMP   LBB9_37
...
LBB9_85:
	...
	MOVQ  -72(BP), SI
	MOVQ  -64(BP), R8
	LONG  $0x01258d4c; WORD $0x00b5; BYTE $0x00 // leaq         $46337(%rip), %r12  /* __UnquoteTab(%rip) */
	QUAD  $0xfffffb890d6ffac5                   // vmovdqu      $-1143(%rip), %xmm1  /* LCPI9_0(%rip) */
	TESTQ R13, R13
	JNE   LBB9_4
	JMP   LBB9_37
...
LBB9_77:
	...
	JNE     LBB9_75
	LEAQ    2(BX), DI
	LONG    $0x0002f1e8; BYTE $0x00 // callq        _unhex16_is
	TESTB   AX, AX
	JE      LBB9_81
	MOVL    2(BX), AX
	BSWAPL  AX
...
_html_escape:
	...
	MOVQ  -56(BP), AX
	MOVQ  0(AX), R9
	QUAD  $0xffffff89056ffac5                   // vmovdqu      $-119(%rip), %xmm0  /* LCPI11_0(%rip) */
	QUAD  $0xffffff910d6ffac5                   // vmovdqu      $-111(%rip), %xmm1  /* LCPI11_1(%rip) */
	QUAD  $0xffffff99156ffac5                   // vmovdqu      $-103(%rip), %xmm2  /* LCPI11_2(%rip) */
	QUAD  $0xffffffa11d6ffac5                   // vmovdqu      $-95(%rip), %xmm3  /* LCPI11_3(%rip) */
	LONG  $0x751d8d4c; WORD $0x00b1; BYTE $0x00 // leaq         $45429(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ  DI, R12
	MOVQ  -48(BP), R14
...
LBB11_20:
	SUBQ CX, R15
	ADDQ CX, BX
	LONG $0x1b1d8d4c; WORD $0x00b0; BYTE $0x00 // leaq         $45083(%rip), %r11  /* __HtmlQuoteTab(%rip) */
...
LBB11_45:
	SUBQ  R12, R15
	SUBQ  AX, R15
	LONG  $0xb81d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $44984(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	TESTQ R15, R15
	JNS   LBB11_49
	JMP   LBB11_48
...
LBB12_5:
	...
	LEAL  348(SI), CX
	SHLQ  $4, CX
	LONG  $0x69258d4c; WORD $0x0035; BYTE $0x00 // leaq         $13673(%rip), %r12  /* _POW10_M128_TAB(%rip) */
	MOVQ  DI, AX
	MULQ  8(CX)(R12*1)
	MOVQ  AX, R15
	MOVQ  DX, R11
...
LBB13_6:
	...
	JLE   LBB13_17
	XORL  R12, R12
	LONG  $0x1e358d4c; WORD $0x005f; BYTE $0x00 // leaq         $24350(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB13_11
...
LBB13_15:
	...
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x0031d2e8; BYTE $0x00 // callq        _right_shift
	LEAL 60(R14), SI
	CMPL R14, $-120
	JB   LBB13_15
	MOVQ R13, R14
...
LBB13_17:
	LONG $0xa8358d4c; WORD $0x005e; BYTE $0x00 // leaq         $24232(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB13_19
...
LBB13_25:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002ffde8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB13_30:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x00313ce8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JB   LBB13_30
	ADDL $60, R12
...
LBB13_37:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x0030e7e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB13_38:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002f30e8; BYTE $0x00 // callq        _left_shift
...
LBB13_47:
	...
	JB   LBB13_58
	MOVL DX, R8
	QUAD $0xfffffd51056ffac5               // vmovdqu      $-687(%rip), %xmm0  /* LCPI13_0(%rip) */
	LONG $0x22f9c3c4; WORD $0x00c4         // vpinsrq      $0, %r12, %xmm0, %xmm0
	ANDL $-16, R8
	QUAD $0xfffd3d0d0c7de3c4; WORD $0xf0ff // vblendps     $240, $-707(%rip), %ymm0, %ymm1  /* LCPI13_0(%rip) */
	LEAL -16(R8), CX
	MOVL CX, DI
	SHRL $4, DI
	ADDL $1, DI
	...
	CMPL CX, $48
	JAE  LBB13_51
	QUAD $0xfffffd3f156ffec5               // vmovdqu      $-705(%rip), %ymm2  /* LCPI13_1(%rip) */
...
LBB13_51:
	ANDL $-4, DI
	QUAD $0xfffffd27156ffec5 // vmovdqu      $-729(%rip), %ymm2  /* LCPI13_1(%rip) */
	QUAD $0xfffffd3f256ffac5 // vmovdqu      $-705(%rip), %xmm4  /* LCPI13_2(%rip) */
	LONG $0xda6ffdc5         // vmovdqa      %ymm2, %ymm3
	LONG $0xc26ffdc5         // vmovdqa      %ymm2, %ymm0
...
LBB13_53:
	TESTL SI, SI
	JE    LBB13_56
	QUAD  $0xfffffc4e256ffac5 // vmovdqu      $-946(%rip), %xmm4  /* LCPI13_3(%rip) */
...
LBB14_40:
	LEAQ -32(BP), DI
	LEAQ -40(BP), SI
	LONG $0xfff7b6e8; BYTE $0xff // callq        _decimal_to_f64
...
_value:
	...
	MOVQ    SI, -72(BP)
	LEAQ    -48(BP), DX
	LONG    $0x000560e8; BYTE $0x00               // callq        _advance_ns
	MOVBLSX AX, AX
	CMPL    AX, $125
	JA      LBB15_11
	LONG    $0x150d8d48; WORD $0x0003; BYTE $0x00 // leaq         $789(%rip), %rcx  /* LJTI15_0(%rip) */
...
LBB15_2:
	...
	LEAQ  -48(BP), SI
	MOVQ  -56(BP), DX
	LONG  $0x000aefe8; BYTE $0x00 // callq        _vnumber
	MOVQ  -48(BP), R12
	JMP   LBB15_51
...
LBB15_7:
	MOVQ  R12, DI
	MOVQ  BX, SI
	LONG  $0x00217fe8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB15_47
	ADDQ  AX, R12
	SUBQ  R15, R12
...
LBB15_12:
	...
	LEAQ  -64(BP), DX
	MOVQ  R15, SI
	LONG  $0x0006dde8; BYTE $0x00 // callq        _advance_string
	MOVQ  AX, R12
	TESTQ AX, AX
	JS    LBB15_32
	MOVQ  R12, -48(BP)
...
LJTI15_0:
	LONG $0xfffffd88 // .long L15_0_set_10
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	...
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffdac // .long L15_0_set_12
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	...
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffdff // .long L15_0_set_14
	LONG $0xfffffcf4 // .long L15_0_set_2
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffcf4 // .long L15_0_set_2
	LONG $0xfffffcf4 // .long L15_0_set_2
	...
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffe33 // .long L15_0_set_16
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffe43 // .long L15_0_set_17
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	...
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffe5d // .long L15_0_set_18
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	...
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffe8c // .long L15_0_set_21
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	...
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xfffffefc // .long L15_0_set_29
	LONG $0xfffffd98 // .long L15_0_set_11
	LONG $0xffffff0c // .long L15_0_set_30
...
LBB16_27:
	...
	MOVQ DI, CX
	SUBQ R9, CX
	QUAD $0xfffffea7056ffac5 // vmovdqu      $-345(%rip), %xmm0  /* LCPI16_0(%rip) */
	QUAD $0xfffffeaf0d6ffac5 // vmovdqu      $-337(%rip), %xmm1  /* LCPI16_1(%rip) */
	QUAD $0xfffffeb7156ffac5 // vmovdqu      $-329(%rip), %xmm2  /* LCPI16_2(%rip) */
	QUAD $0xfffffebf1d6ffac5 // vmovdqu      $-321(%rip), %xmm3  /* LCPI16_3(%rip) */
...
_advance_string:
	...
	MOVQ $-1, -48(BP)
	XORL R14, R14
	QUAD $0xffffff98056ffac5 // vmovdqu      $-104(%rip), %xmm0  /* LCPI18_0(%rip) */
	QUAD $0xffffffa00d6ffac5 // vmovdqu      $-96(%rip), %xmm1  /* LCPI18_1(%rip) */
...
LBB18_13:
	...
	QUAD  $0xfffffe4d156ffac5     // vmovdqu      $-435(%rip), %xmm2  /* LCPI18_0(%rip) */
	QUAD  $0xfffffe551d6ffac5     // vmovdqu      $-427(%rip), %xmm3  /* LCPI18_1(%rip) */
...
LBB19_62:
	...
	JB    LBB19_73
	LEAL  -22(BX), AX
	LONG  $0x920d8d48; WORD $0x00bd; BYTE $0x00 // leaq         $48530(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB19_70:
	...
	JB   LBB19_78
	NEGL BX
	LONG $0x4d058d48; WORD $0x00bd; BYTE $0x00 // leaq         $48461(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB19_74:
	...
	JA   LBB19_78
	MOVL AX, AX
	LONG $0xe10d8d48; WORD $0x00bc; BYTE $0x00 // leaq         $48353(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
...
LBB19_78:
	...
	MOVQ  BX, -80(BP)
	MOVL  DX, BX
	LONG  $0xffe656e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB19_83
	MOVQ  -80(BP), SI
	CMPL  -60(BP), $0
	...
	LEAQ  -72(BP), CX
	MOVQ  R12, DI
	LONG  $0xffe636e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB19_83
...
LBB19_83:
	...
	MOVQ -88(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffee5be8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc8 // vmovsd       %xmm0, $-56(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB19_87
...
LBB23_4:
	...
	MOVQ    -56(BP), BX
	MOVQ    BX, DX
	LONG    $0xfff1f7e8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R12), DX
	LEAQ    -1(DX), CX
	CMPQ    R14, $-1
	JNE     LBB23_6
...
LBB23_17:
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff3aee8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB23_56
	MOVQ  R13, 0(BX)
...
LBB23_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000d25e8; BYTE $0x00 // callq        _do_skip_number
	LEAQ  -1(AX), CX
	MOVQ  $-2, DX
	SUBQ  AX, DX
	TESTQ AX, AX
...
LBB23_33:
	...
	MOVQ  R13, DI
	MOVQ  BX, SI
	LONG  $0x000564e8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB23_37
	JMP   LBB23_61
...
LBB23_35:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff244e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB23_56
	MOVQ  R13, 0(BX)
...
LBB23_40:
	...
	MOVQ  -48(BP), DI
	MOVQ  -56(BP), SI
	LONG  $0x0004f4e8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB23_39
	JMP   LBB23_61
...
LBB23_42:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000bfbe8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB23_63
	ADDQ  R13, AX
	MOVQ  AX, 0(BX)
...
LJTI23_0:
	...
	// .set L23_1_set_65, LBB23_65-LJTI23_1
	// .set L23_1_set_64, LBB23_64-LJTI23_1
...
LJTI23_1:
	...
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xfffffda1 // .long L23_1_set_40
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	...
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xfffffdc6 // .long L23_1_set_42
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	...
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xfffffe00 // .long L23_1_set_44
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	...
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xfffffe25 // .long L23_1_set_46
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	...
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xfffffe68 // .long L23_1_set_49
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xfffffe9a // .long L23_1_set_51
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xffffff34 // .long L23_1_set_64
	LONG $0xfffffec8 // .long L23_1_set_53
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffed4fe8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB26_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	MOVQ $-1, -48(BP)
	XORL R13, R13
	QUAD $0xffffff78056ffac5 // vmovdqu      $-136(%rip), %xmm0  /* LCPI27_0(%rip) */
	QUAD $0xffffff800d6ffac5 // vmovdqu      $-128(%rip), %xmm1  /* LCPI27_1(%rip) */
	QUAD $0xffffff88156ffac5 // vmovdqu      $-120(%rip), %xmm2  /* LCPI27_2(%rip) */

LBB27_3:
	MOVQ  -56(BP), AX
	LONG  $0x1c6ffac5; BYTE $0x10   // vmovdqu      (%rax,%rdx), %xmm3
	LONG  $0x646ffac5; WORD $0x1010 // vmovdqu      $16(%rax,%rdx), %xmm4
	LONG  $0x6c6ffac5; WORD $0x2010 // vmovdqu      $32(%rax,%rdx), %xmm5
	LONG  $0x746ffac5; WORD $0x3010 // vmovdqu      $48(%rax,%rdx), %xmm6
	...
	LONG  $0xf4d779c5               // vpmovmskb    %xmm4, %r14d
	SHLQ  $48, R12
	SHLQ  $32, R15
	ORQ   R12, R15
	SHLQ  $16, R11
...
LBB27_16:
	...
	ADDQ  R12, SI
	MOVQ  -72(BP), DI
	LONG  $0x00030ce8; BYTE $0x00 // callq        _utf8_validate
	ADDQ  AX, BX
	TESTQ AX, AX
	LONG  $0xdc480f49             // cmovsq       %r12, %rbx
	MOVQ  $-2, R12
	LONG  $0xe6480f4d             // cmovsq       %r14, %r12
	JMP   LBB27_20
...
LBB27_24:
	...
	QUAD  $0xfffffd52156ffac5     // vmovdqu      $-686(%rip), %xmm2  /* LCPI27_0(%rip) */
	LONG  $0xda74f9c5             // vpcmpeqb     %xmm2, %xmm0, %xmm3
	LONG  $0xc3d779c5             // vpmovmskb    %xmm3, %r8d
	LONG  $0xd274f1c5             // vpcmpeqb     %xmm2, %xmm1, %xmm2
	LONG  $0xf2d7f9c5             // vpmovmskb    %xmm2, %esi
	QUAD  $0xfffffd4a156ffac5     // vmovdqu      $-694(%rip), %xmm2  /* LCPI27_1(%rip) */
	LONG  $0xda74f9c5             // vpcmpeqb     %xmm2, %xmm0, %xmm3
	LONG  $0xdbd779c5             // vpmovmskb    %xmm3, %r11d
	LONG  $0xd274f1c5             // vpcmpeqb     %xmm2, %xmm1, %xmm2
	LONG  $0xdad7f9c5             // vpmovmskb    %xmm2, %ebx
	QUAD  $0xfffffd42156ffac5     // vmovdqu      $-702(%rip), %xmm2  /* LCPI27_2(%rip) */
...
LBB27_56:
	...
	LONG  $0xcb450f4c // cmovneq      %rbx, %r9
	ADDQ  $1, DX
	ADDQ  $-1, CX
	MOVQ  AX, BX
	TESTQ CX, CX
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB28_26
	LONG  $0xcc058d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44236(%rip), %r8  /* _first(%rip) */
	LONG  $0xc50d8d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44485(%rip), %r9  /* _ranges(%rip) */
	LONG  $0x23158d4c; WORD $0x0001; BYTE $0x00 // leaq         $291(%rip), %r10  /* LJTI28_0(%rip) */
	MOVQ  DI, R14
...
LBB28_6:
	LONG  $0x6f7ac1c4; WORD $0x0e04 // vmovdqu      (%r14,%rcx), %xmm0
...
LJTI28_0:
	LONG $0xffffffcc // .long L28_0_set_25
	LONG $0xfffffff3 // .long L28_0_set_24
	LONG $0xffffffaf // .long L28_0_set_21
	LONG $0xffffffa8 // .long L28_0_set_20
	LONG $0xffffffa1 // .long L28_0_set_19
...
LBB30_6:
	...
	MOVQ $-1, R10
	XORL AX, AX
	QUAD $0xffffff29056f7ac5 // vmovdqu      $-215(%rip), %xmm8  /* LCPI30_0(%rip) */
	QUAD $0xffffff310d6f7ac5 // vmovdqu      $-207(%rip), %xmm9  /* LCPI30_1(%rip) */
	QUAD $0xffffff39156f7ac5 // vmovdqu      $-199(%rip), %xmm10  /* LCPI30_2(%rip) */
	QUAD $0xffffff411d6f7ac5 // vmovdqu      $-191(%rip), %xmm11  /* LCPI30_3(%rip) */
	QUAD $0xffffff49256ffac5 // vmovdqu      $-183(%rip), %xmm4  /* LCPI30_4(%rip) */
	QUAD $0xffffff512d6ffac5 // vmovdqu      $-175(%rip), %xmm5  /* LCPI30_5(%rip) */
	QUAD $0xffffff59356ffac5 // vmovdqu      $-167(%rip), %xmm6  /* LCPI30_6(%rip) */
	MOVQ $-1, R9
	MOVQ $-1, R8
	MOVQ SI, R14
...
LBB30_28:
	...
	SUBQ DI, SI
	XORL AX, AX
	LONG $0x3b3d8d4c; WORD $0x0001; BYTE $0x00 // leaq         $315(%rip), %r15  /* LJTI30_0(%rip) */
	JMP  LBB30_29
...
// .set L30_0_set_37, LBB30_37-LJTI30_0
// .set L30_0_set_40, LBB30_40-LJTI30_0
// .set L30_0_set_35, LBB30_35-LJTI30_0
// .set L30_0_set_32, LBB30_32-LJTI30_0
LJTI30_0:
	LONG $0xffffff00 // .long L30_0_set_37
	LONG $0xffffff40 // .long L30_0_set_40
	LONG $0xffffff00 // .long L30_0_set_37
	LONG $0xffffff10 // .long L30_0_set_35
	LONG $0xffffff40 // .long L30_0_set_40
	LONG $0xffffff40 // .long L30_0_set_40
	LONG $0xffffff40 // .long L30_0_set_40
	LONG $0xffffff40 // .long L30_0_set_40
	...
	LONG $0xffffff40 // .long L30_0_set_40
	LONG $0xffffff40 // .long L30_0_set_40
	LONG $0xfffffecc // .long L30_0_set_32
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffc79e8; BYTE $0xff // callq        _do_skip_number
	LEAQ  -1(AX), DX
	MOVQ  $-2, CX
	MOVQ  $-2, SI
	SUBQ  AX, SI
...
LBB32_3:
	MOVQ  BX, DI
	LONG  $0xfffc02e8; BYTE $0xff // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB32_7
	ADDQ  AX, BX
...
_f64toa:
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·__native_entry__+586(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+8514(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_i64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3662(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+5220(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18899(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+21884(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18936(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+17051(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3895(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+6317(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+22001(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+12172(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15088(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16458(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+14076(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16745(SB), AX // _vunsigned
	JMP  AX
