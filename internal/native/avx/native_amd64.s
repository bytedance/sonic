...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0xef0d8d48; WORD $0x0081; BYTE $0x00 // leaq         $33263(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0x190d8d4c; WORD $0x0096; BYTE $0x00 // leaq         $38425(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R9*1), R15
	MOVQ    R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x004b56e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0xf8058d48; WORD $0x00a4; BYTE $0x00 // leaq         $42232(%rip), %rax  /* _Digits(%rip) */
...
LBB2_69:
	...
	JL      LBB2_84
	MOVLQSX R14, AX
	LONG    $0x8d0d8d48; WORD $0x00a4; BYTE $0x00 // leaq         $42125(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x004a52e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_77
	LEAL  0(BX)(R13*1), AX
	CMPL  R13, R15
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0046ede8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0xf80d8d48; WORD $0x009f; BYTE $0x00 // leaq         $40952(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0xd7358d48; WORD $0x009f; BYTE $0x00 // leaq         $40919(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0xc5158d48; WORD $0x009f; BYTE $0x00 // leaq         $40901(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0xac158d48; WORD $0x009f; BYTE $0x00 // leaq         $40876(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0x14058d48; WORD $0x009f; BYTE $0x00 // leaq         $40724(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0xef358d48; WORD $0x009e; BYTE $0x00 // leaq         $40687(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0xdd058d48; WORD $0x009e; BYTE $0x00 // leaq         $40669(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0xc2358d48; WORD $0x009e; BYTE $0x00 // leaq         $40642(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x3a158d48; WORD $0x009e; BYTE $0x00 // leaq         $40506(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0x1d0d8d48; WORD $0x009d; BYTE $0x00 // leaq         $40221(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0xcc0d8d48; WORD $0x009c; BYTE $0x00 // leaq         $40140(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0xa9058d4c; WORD $0x009c; BYTE $0x00 // leaq         $40105(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
LBB4_25:
	...
	LONG $0xc070fbc5; BYTE $0x50   // vpshuflw     $80, %xmm0, %xmm0
	LONG $0xc070f9c5; BYTE $0x50   // vpshufd      $80, %xmm0, %xmm0
	QUAD $0xfffffbde1512fbc5       // vmovddup     $-1058(%rip), %xmm2  /* LCPI4_1(%rip) */
	LONG $0xc2e4f9c5               // vpmulhuw     %xmm2, %xmm0, %xmm0
	QUAD $0xfffffbda2512fbc5       // vmovddup     $-1062(%rip), %xmm4  /* LCPI4_2(%rip) */
	LONG $0xc4e4f9c5               // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffba62d6ffac5       // vmovdqu      $-1114(%rip), %xmm5  /* LCPI4_3(%rip) */
	LONG $0xf5d5f9c5               // vpmullw      %xmm5, %xmm0, %xmm6
	LONG $0xf673c9c5; BYTE $0x10   // vpsllq       $16, %xmm6, %xmm6
	LONG $0xc6f9f9c5               // vpsubw       %xmm6, %xmm0, %xmm0
	LONG $0xe100c269; WORD $0x05f5 // imull        $100000000, %edx, %eax
	...
	LONG $0xcaf9f1c5               // vpsubw       %xmm2, %xmm1, %xmm1
	LONG $0xc167f9c5               // vpackuswb    %xmm1, %xmm0, %xmm0
	QUAD $0xfffffb5805fcf9c5       // vpaddb       $-1192(%rip), %xmm0, %xmm0  /* LCPI4_4(%rip) */
	MOVL CX, AX
...
_quote:
	...
	SUBQ  $32, SP
	TESTB $1, R8
	LONG  $0xae058d48; WORD $0x009c; BYTE $0x00 // leaq         $40110(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0xa7158d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44199(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG  $0xd0440f4c                           // cmoveq       %rax, %r10
	MOVQ  DX, R8
	MOVQ  DI, AX
	TESTQ SI, SI
	...
	MOVQ  CX, -56(BP)
	MOVQ  0(CX), R11
	QUAD  $0xffffff8b056ffac5                   // vmovdqu      $-117(%rip), %xmm0  /* LCPI5_0(%rip) */
	QUAD  $0xffffff930d6ffac5                   // vmovdqu      $-109(%rip), %xmm1  /* LCPI5_1(%rip) */
	QUAD  $0xffffff9b156ffac5                   // vmovdqu      $-101(%rip), %xmm2  /* LCPI5_2(%rip) */
...
LBB5_16:
	MOVBLZX 0(R15)(R10*1), DI
	MOVQ    DI, DX
	SHLQ    $4, DX
	LONG    $0x431d8d48; WORD $0x009b; BYTE $0x00 // leaq         $39747(%rip), %rbx  /* __SingleQuoteTab(%rip) */
	CMPQ    0(DX)(BX*1), $0
	JNE     LBB5_26
	LEAQ    0(R9)(CX*1), R14
	MOVB    DI, 0(R13)(R10*1)
...
_unquote:
	...
	MOVL  R8, R10
	ANDL  $1, R10
	LONG  $0x8e0d8d48; WORD $0x00b8; BYTE $0x00 // leaq         $47246(%rip), %rcx  /* __UnquoteTab(%rip) */
	QUAD  $0xffffffbc056ffac5                   // vmovdqu      $-68(%rip), %xmm0  /* LCPI6_0(%rip) */
	MOVQ  DI, R9
	MOVQ  SI, R13
	MOVQ  DX, AX
...
LBB6_7:
	LONG  $0x6f7a81c4; WORD $0x210c // vmovdqu      (%r9,%r12), %xmm1
	LONG  $0x7f7aa1c4; WORD $0x200c // vmovdqu      %xmm1, (%rax,%r12)
...
LBB7_2:
	MOVBLZX 1(DI), AX
	LONG    $0xe30d8d48; WORD $0x00af; BYTE $0x00 // leaq         $45027(%rip), %rcx  /* __UnquoteTab(%rip) */
	MOVB    0(AX)(CX*1), CX
	CMPB    CX, $-1
	JE      LBB7_5
	MOVL    $2, AX
...
_html_escape:
	...
	LONG  $0x281d8d4c; WORD $0x00af; BYTE $0x00 // leaq         $44840(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ  DI, R12
	MOVQ  -48(BP), R14
...
LBB8_20:
	SUBQ DX, R15
	ADDQ DX, BX
	LONG $0xc91d8d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44489(%rip), %r11  /* __HtmlQuoteTab(%rip) */
...
LBB8_45:
	SUBQ  R12, R15
	SUBQ  AX, R15
	LONG  $0x671d8d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44391(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	TESTQ R15, R15
	JNS   LBB8_49
	JMP   LBB8_48
...
LBB9_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x2a3d8d4c; WORD $0x0033; BYTE $0x00 // leaq         $13098(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB10_5:
	...
	JLE   LBB10_12
	XORL  R12, R12
	LONG  $0x56358d4c; WORD $0x005d; BYTE $0x00 // leaq         $23894(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB10_8
...
LBB10_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x003043e8; BYTE $0x00 // callq        _right_shift
...
LBB10_12:
	LONG $0x18358d4c; WORD $0x005d; BYTE $0x00 // leaq         $23832(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB10_14
...
LBB10_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002e76e8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB10_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x002fa5e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB10_25
	ADDL $60, R12
...
LBB10_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x002f5ee8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB10_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002db4e8; BYTE $0x00 // callq        _left_shift
...
LBB11_40:
	LEAQ -32(BP), DI
	LEAQ -40(BP), SI
	LONG $0xfffb60e8; BYTE $0xff // callq        _decimal_to_f64
...
_value:
	...
	MOVQ    SI, -56(BP)
	LEAQ    -40(BP), DX
	LONG    $0x0004b6e8; BYTE $0x00               // callq        _advance_ns
	MOVBLSX AX, AX
	CMPL    AX, $125
	JA      LBB12_4
...
LBB12_2:
	...
	LEAQ -40(BP), SI
	MOVQ R14, DX
	LONG $0x000a84e8; BYTE $0x00 // callq        _vnumber
	MOVQ -40(BP), BX
	JMP  LBB12_18
...
LBB12_5:
	...
	LEAQ  -48(BP), DX
	MOVQ  R15, SI
	LONG  $0x0006ade8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB12_25
	MOVQ  AX, -40(BP)
	MOVQ  R15, 16(R14)
...
_advance_string:
	...
	MOVQ $-1, DX
	XORL R14, R14
	QUAD $0xffffff95056ffac5 // vmovdqu      $-107(%rip), %xmm0  /* LCPI15_0(%rip) */
	QUAD $0xffffff9d0d6ffac5 // vmovdqu      $-99(%rip), %xmm1  /* LCPI15_1(%rip) */
...
LBB15_13:
	...
	QUAD $0xfffffe40156ffac5     // vmovdqu      $-448(%rip), %xmm2  /* LCPI15_0(%rip) */
	QUAD $0xfffffe481d6ffac5     // vmovdqu      $-440(%rip), %xmm3  /* LCPI15_1(%rip) */
...
LBB16_61:
	...
	JL    LBB16_72
	LEAL  -22(SI), AX
	LONG  $0xad0d8d48; WORD $0x00bf; BYTE $0x00 // leaq         $49069(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB16_69:
	...
	JB   LBB16_76
	NEGL SI
	LONG $0x64058d48; WORD $0x00bf; BYTE $0x00 // leaq         $48996(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB16_73:
	...
	JA   LBB16_76
	MOVL AX, AX
	LONG $0xf00d8d48; WORD $0x00be; BYTE $0x00 // leaq         $48880(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB16_80
...
LBB16_76:
	...
	MOVL  R10, BX
	MOVQ  SI, -88(BP)
	LONG  $0xffeac4e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
	MOVQ  -88(BP), SI
	CMPL  -44(BP), $0
	...
	LEAQ  -80(BP), CX
	MOVQ  R12, DI
	LONG  $0xffeaa4e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB16_81
...
LBB16_81:
	...
	MOVQ -104(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffeea1e8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB16_84
...
LBB20_2:
	MOVQ  R13, DI
	MOVQ  BX, SI
	LONG  $0x00077ce8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JS    LBB20_35
...
LBB20_7:
	...
	CMPL    SI, $5
	JA      LBB20_12
	LONG    $0x603d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1120(%rip), %rdi  /* LJTI20_0(%rip) */
...
LBB20_18:
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff36fe8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_63
	MOVQ  R13, 0(BX)
...
LBB20_25:
	MOVQ    $-1, R13
	LONG    $0x8b0d8d48; WORD $0x0003; BYTE $0x00 // leaq         $907(%rip), %rcx  /* LJTI20_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB20_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x001002e8; BYTE $0x00 // callq        _skip_number
	LEAQ  -1(AX), CX
	MOVQ  $-2, DX
	SUBQ  AX, DX
	TESTQ AX, AX
...
LBB20_33:
	...
	MOVQ  R13, DI
	MOVQ  BX, SI
	LONG  $0x00057ae8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB20_38
	JMP   LBB20_35
...
LBB20_36:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff23ae8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB20_63
	MOVQ  R13, 0(BX)
...
LBB20_40:
	...
	MOVQ  -48(BP), DI
	MOVQ  -56(BP), SI
	LONG  $0x00050ae8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB20_3
	JMP   LBB20_35
...
LBB20_42:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000ed4e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JLE   LBB20_64
	ADDQ  R13, AX
	MOVQ  AX, 0(BX)
...
LJTI20_0:
	LONG $0xfffffba9 // .long L20_0_set_9
	LONG $0xfffffbd8 // .long L20_0_set_13
	LONG $0xfffffc05 // .long L20_0_set_15
	LONG $0xfffffc4e // .long L20_0_set_21
	LONG $0xfffffc63 // .long L20_0_set_23
	LONG $0xfffffceb // .long L20_0_set_26

	// .set L20_1_set_66, LBB20_66-LJTI20_1
	// .set L20_1_set_65, LBB20_65-LJTI20_1
	...
	// .set L20_1_set_55, LBB20_55-LJTI20_1
	// .set L20_1_set_59, LBB20_59-LJTI20_1
LJTI20_1:
	LONG $0xffffff3b // .long L20_1_set_66
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	...
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xfffffd8b // .long L20_1_set_40
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	...
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xfffffdb0 // .long L20_1_set_42
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xfffffc7e // .long L20_1_set_28
	LONG $0xfffffc7e // .long L20_1_set_28
	LONG $0xfffffc7e // .long L20_1_set_28
	LONG $0xfffffc7e // .long L20_1_set_28
	LONG $0xfffffc7e // .long L20_1_set_28
	...
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xfffffdea // .long L20_1_set_45
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	...
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xfffffe0f // .long L20_1_set_47
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	...
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xfffffe52 // .long L20_1_set_50
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xfffffe80 // .long L20_1_set_55
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xffffff34 // .long L20_1_set_65
	LONG $0xfffffebf // .long L20_1_set_59
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffed2fe8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB23_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	MOVQ $-1, R8
	XORL R15, R15
	QUAD $0xffffff67056f7ac5 // vmovdqu      $-153(%rip), %xmm8  /* LCPI24_0(%rip) */
	QUAD $0xffffff6f1d6ffac5 // vmovdqu      $-145(%rip), %xmm3  /* LCPI24_1(%rip) */
	QUAD $0xffffff77256ffac5 // vmovdqu      $-137(%rip), %xmm4  /* LCPI24_2(%rip) */
...
LBB24_3:
	...
	LONG  $0xc274b9c5               // vpcmpeqb     %xmm2, %xmm8, %xmm0
	LONG  $0xe0d779c5               // vpmovmskb    %xmm0, %r12d
	LONG  $0xc174b9c5               // vpcmpeqb     %xmm1, %xmm8, %xmm0
...
LBB24_6:
	LONG  $0xc164d9c5 // vpcmpgtb     %xmm1, %xmm4, %xmm0
	LONG  $0xcd64f1c5 // vpcmpgtb     %xmm5, %xmm1, %xmm1
	LONG  $0xc1dbf9c5 // vpand        %xmm1, %xmm0, %xmm0
	LONG  $0xc0d7f9c5 // vpmovmskb    %xmm0, %eax
	SHLQ  $16, AX
	LONG  $0xc264d9c5 // vpcmpgtb     %xmm2, %xmm4, %xmm0
	LONG  $0xcd64e9c5 // vpcmpgtb     %xmm5, %xmm2, %xmm1
	LONG  $0xc1dbf9c5 // vpand        %xmm1, %xmm0, %xmm0
	LONG  $0xc8d7f9c5 // vpmovmskb    %xmm0, %ecx
	LONG  $0xc764d9c5 // vpcmpgtb     %xmm7, %xmm4, %xmm0
	LONG  $0xcd64c1c5 // vpcmpgtb     %xmm5, %xmm7, %xmm1
	LONG  $0xc1dbf9c5 // vpand        %xmm1, %xmm0, %xmm0
	LONG  $0xd0d7f9c5 // vpmovmskb    %xmm0, %edx
	SHLQ  $32, DX
	ORQ   AX, CX
	ORQ   DX, CX
	LONG  $0xc664d9c5 // vpcmpgtb     %xmm6, %xmm4, %xmm0
	LONG  $0xcd64c9c5 // vpcmpgtb     %xmm5, %xmm6, %xmm1
	LONG  $0xc1dbf9c5 // vpand        %xmm1, %xmm0, %xmm0
	LONG  $0xc0d7f9c5 // vpmovmskb    %xmm0, %eax
	SHLQ  $48, AX
	ORQ   CX, AX
...
LBB24_14:
	...
	MOVQ  R10, -88(BP)
	MOVQ  DI, -80(BP)
	QUAD  $0xffffff70b57ff9c5     // vmovdqa      %xmm6, $-144(%rbp)
	LONG  $0x7d7ff9c5; BYTE $0x80 // vmovdqa      %xmm7, $-128(%rbp)
	QUAD  $0xffffff50957ff9c5     // vmovdqa      %xmm2, $-176(%rbp)
	QUAD  $0xffffff608d7ff9c5     // vmovdqa      %xmm1, $-160(%rbp)
...
LBB24_16:
	...
	SUBQ  AX, SI
	LEAQ  -64(BP), DX
	LONG  $0xffd76de8; BYTE $0xff // callq        _valid_escaped
	TESTL AX, AX
	JS    LBB24_19
	MOVQ  -104(BP), CX
	ADDL  AX, CX
	...
	CMPL  CX, $63
	MOVL  $0, AX
	LONG  $0xd84f0f48             // cmovgq       %rax, %rbx
	TESTQ BX, BX
	MOVQ  -88(BP), R10
	MOVQ  -80(BP), DI
	QUAD  $0xfffffd36056f7ac5     // vmovdqu      $-714(%rip), %xmm8  /* LCPI24_0(%rip) */
	QUAD  $0xfffffd3e1d6ffac5     // vmovdqu      $-706(%rip), %xmm3  /* LCPI24_1(%rip) */
	QUAD  $0xfffffd46256ffac5     // vmovdqu      $-698(%rip), %xmm4  /* LCPI24_2(%rip) */
	LONG  $0xed76d1c5             // vpcmpeqd     %xmm5, %xmm5, %xmm5
	QUAD  $0xffffff70b56ff9c5     // vmovdqa      $-144(%rbp), %xmm6
	LONG  $0x7d6ff9c5; BYTE $0x80 // vmovdqa      $-128(%rbp), %xmm7
	QUAD  $0xffffff50956ff9c5     // vmovdqa      $-176(%rbp), %xmm2
	QUAD  $0xffffff608d6ff9c5     // vmovdqa      $-160(%rbp), %xmm1
	JNE   LBB24_16
	JMP   LBB24_6
...
LBB24_19:
	...
	MOVQ -88(BP), R10
	MOVQ -80(BP), DI
	QUAD $0xfffffcca056f7ac5     // vmovdqu      $-822(%rip), %xmm8  /* LCPI24_0(%rip) */
	QUAD $0xfffffcd21d6ffac5     // vmovdqu      $-814(%rip), %xmm3  /* LCPI24_1(%rip) */
	QUAD $0xfffffcda256ffac5     // vmovdqu      $-806(%rip), %xmm4  /* LCPI24_2(%rip) */
	LONG $0xed76d1c5             // vpcmpeqd     %xmm5, %xmm5, %xmm5
	QUAD $0xffffff70b56ff9c5     // vmovdqa      $-144(%rbp), %xmm6
	LONG $0x7d6ff9c5; BYTE $0x80 // vmovdqa      $-128(%rbp), %xmm7
	QUAD $0xffffff50956ff9c5     // vmovdqa      $-176(%rbp), %xmm2
...
LBB24_31:
	...
	LONG  $0x6f7ac1c4; WORD $0x105e // vmovdqu      $16(%r14), %xmm3
	QUAD  $0xfffffbf8056ffac5       // vmovdqu      $-1032(%rip), %xmm0  /* LCPI24_0(%rip) */
	LONG  $0xc874d9c5               // vpcmpeqb     %xmm0, %xmm4, %xmm1
	LONG  $0xc9d7f9c5               // vpmovmskb    %xmm1, %ecx
	LONG  $0xc074e1c5               // vpcmpeqb     %xmm0, %xmm3, %xmm0
	LONG  $0xe0d779c5               // vpmovmskb    %xmm0, %r12d
	QUAD  $0xfffffbf0056ffac5       // vmovdqu      $-1040(%rip), %xmm0  /* LCPI24_1(%rip) */
	LONG  $0xc874d9c5               // vpcmpeqb     %xmm0, %xmm4, %xmm1
...
LBB24_35:
	QUAD  $0xfffffbbe056ffac5 // vmovdqu      $-1090(%rip), %xmm0  /* LCPI24_2(%rip) */
	LONG  $0xc976f1c5         // vpcmpeqd     %xmm1, %xmm1, %xmm1
	LONG  $0xd364f9c5         // vpcmpgtb     %xmm3, %xmm0, %xmm2
	LONG  $0xd964e1c5         // vpcmpgtb     %xmm1, %xmm3, %xmm3
	LONG  $0xd3dbe9c5         // vpand        %xmm3, %xmm2, %xmm2
	LONG  $0xc464f9c5         // vpcmpgtb     %xmm4, %xmm0, %xmm0
	LONG  $0xc964d9c5         // vpcmpgtb     %xmm1, %xmm4, %xmm1
	LONG  $0xc1dbf9c5         // vpand        %xmm1, %xmm0, %xmm0
...
LBB24_26:
	...
	ADDQ  BX, DI
	MOVQ  R10, R14
	LONG  $0x000309e8; BYTE $0x00 // callq        _utf8_validate
	MOVQ  R14, R10
	ADDQ  AX, BX
	TESTQ AX, AX
	LONG  $0xdf480f49             // cmovsq       %r15, %rbx
	MOVQ  $-2, R15
	LONG  $0xfc480f4d             // cmovsq       %r12, %r15
	JMP   LBB24_74
...
LBB24_53:
	...
	MOVQ  R13, SI
	MOVQ  BX, DX
	LONG  $0xffd481e8; BYTE $0xff // callq        _valid_escaped
	TESTQ AX, AX
	JS    LBB24_77
	ADDQ  AX, R14
	SUBQ  AX, R13
...
LBB24_57:
	LONG  $0x5d7ff9c5; BYTE $0x80 // vmovdqa      %xmm3, $-128(%rbp)
	QUAD  $0xffffff70a57ff9c5     // vmovdqa      %xmm4, $-144(%rbp)
	MOVQ  DI, -80(BP)
	MOVQ  R10, -88(BP)
	MOVL  R15, BX
	NOTL  BX
...
LBB24_59:
	...
	LEAQ  -64(BP), DX
	MOVQ  R15, DI
	LONG  $0xffd377e8; BYTE $0xff // callq        _valid_escaped
	TESTQ AX, AX
	JS    LBB24_78
	ADDQ  AX, R14
	ADDQ  $-1, R14
...
LBB24_65:
	...
	SUBQ  AX, SI
	LEAQ  -64(BP), DX
	LONG  $0xffd2fae8; BYTE $0xff // callq        _valid_escaped
	TESTL AX, AX
	JS    LBB24_76
	MOVQ  -104(BP), CX
	ADDL  AX, CX
...
LBB24_68:
	MOVQ -88(BP), R10
	MOVQ -80(BP), DI
	QUAD $0xffffff70a56ff9c5     // vmovdqa      $-144(%rbp), %xmm4
	LONG $0x5d6ff9c5; BYTE $0x80 // vmovdqa      $-128(%rbp), %xmm3
	JMP  LBB24_35
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB25_28
	LONG  $0x740d8d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44148(%rip), %r9  /* _first(%rip) */
	LONG  $0x6d058d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44397(%rip), %r8  /* _ranges(%rip) */
	LONG  $0x30158d4c; WORD $0x0001; BYTE $0x00 // leaq         $304(%rip), %r10  /* LJTI25_0(%rip) */
	MOVQ  DI, R14
...
LBB25_6:
	LONG  $0x6f7ac1c4; WORD $0x1604 // vmovdqu      (%r14,%rdx), %xmm0
	LONG  $0xc8d7f9c5               // vpmovmskb    %xmm0, %ecx
	TESTW CX, CX
	JNE   LBB25_7
	ADDQ  $16, DX
...
// .set L25_0_set_21, LBB25_21-LJTI25_0
// .set L25_0_set_19, LBB25_19-LJTI25_0
LJTI25_0:
	LONG $0xffffffcc // .long L25_0_set_27
	LONG $0xfffffff3 // .long L25_0_set_26
	LONG $0xffffffaf // .long L25_0_set_23
	LONG $0xffffffa2 // .long L25_0_set_21
	LONG $0xffffff95 // .long L25_0_set_19
...
_skip_negative:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0x000099e8; BYTE $0x00 // callq        _skip_number
	TESTQ AX, AX
	JLE   LBB26_1
	ADDQ  BX, AX
	MOVQ  AX, 0(R14)
...
LBB27_6:
	...
	MOVQ $-1, R10
	XORL AX, AX
	QUAD $0xffffff27056f7ac5 // vmovdqu      $-217(%rip), %xmm8  /* LCPI27_0(%rip) */
	QUAD $0xffffff2f0d6f7ac5 // vmovdqu      $-209(%rip), %xmm9  /* LCPI27_1(%rip) */
	QUAD $0xffffff37156f7ac5 // vmovdqu      $-201(%rip), %xmm10  /* LCPI27_2(%rip) */
	QUAD $0xffffff3f1d6f7ac5 // vmovdqu      $-193(%rip), %xmm11  /* LCPI27_3(%rip) */
	QUAD $0xffffff47256ffac5 // vmovdqu      $-185(%rip), %xmm4  /* LCPI27_4(%rip) */
	QUAD $0xffffff4f2d6ffac5 // vmovdqu      $-177(%rip), %xmm5  /* LCPI27_5(%rip) */
	QUAD $0xffffff57356ffac5 // vmovdqu      $-169(%rip), %xmm6  /* LCPI27_6(%rip) */
	MOVL $4294967295, R11
	MOVQ $-1, R9
	MOVQ $-1, R8
	MOVQ SI, R15
...
LBB27_28:
	...
	SUBQ DI, R14
	XORL AX, AX
	LONG $0x531d8d4c; WORD $0x0001; BYTE $0x00 // leaq         $339(%rip), %r11  /* LJTI27_0(%rip) */
	JMP  LBB27_29
...
LBB27_55:
	...
	TESTQ AX, AX
	NOTQ  R9
	LONG  $0xc9480f4c // cmovsq       %rcx, %r9
	CMPQ  R8, DX
	LONG  $0xc9450f4c // cmovneq      %rcx, %r9
	MOVQ  R9, AX
	JMP   LBB27_56
...
LJTI27_0:
	LONG $0xfffffee8 // .long L27_0_set_37
	LONG $0xffffff2b // .long L27_0_set_40
	LONG $0xfffffee8 // .long L27_0_set_37
	LONG $0xfffffef8 // .long L27_0_set_35
	LONG $0xffffff2b // .long L27_0_set_40
	LONG $0xffffff2b // .long L27_0_set_40
	LONG $0xffffff2b // .long L27_0_set_40
	LONG $0xffffff2b // .long L27_0_set_40
	...
	LONG $0xffffff2b // .long L27_0_set_40
	LONG $0xffffff2b // .long L27_0_set_40
	LONG $0xfffffeb4 // .long L27_0_set_32
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffc55e8; BYTE $0xff // callq        _skip_number
	LEAQ  -1(AX), DX
	MOVQ  $-2, CX
	MOVQ  $-2, SI
	SUBQ  AX, SI
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+8630(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_i64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3653(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+4970(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+17820(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+17857(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+16004(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3748(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+6010(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21548(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+11233(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+14018(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15448(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+12965(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15728(SB), AX // _vunsigned
	JMP  AX
