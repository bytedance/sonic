...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0xae0d8d48; WORD $0x007d; BYTE $0x00 // leaq         $32174(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0xd80d8d4c; WORD $0x0091; BYTE $0x00 // leaq         $37336(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R9*1), R15
	MOVQ    R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x004715e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0xb7058d48; WORD $0x00a0; BYTE $0x00 // leaq         $41143(%rip), %rax  /* _Digits(%rip) */
...
LBB2_69:
	...
	JL      LBB2_84
	MOVLQSX R14, AX
	LONG    $0x4c0d8d48; WORD $0x00a0; BYTE $0x00 // leaq         $41036(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x004611e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_77
	LEAL  0(BX)(R13*1), AX
	CMPL  R13, R15
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0042ace8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0xb70d8d48; WORD $0x009b; BYTE $0x00 // leaq         $39863(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x96358d48; WORD $0x009b; BYTE $0x00 // leaq         $39830(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x84158d48; WORD $0x009b; BYTE $0x00 // leaq         $39812(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x6b158d48; WORD $0x009b; BYTE $0x00 // leaq         $39787(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0xd3058d48; WORD $0x009a; BYTE $0x00 // leaq         $39635(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0xae358d48; WORD $0x009a; BYTE $0x00 // leaq         $39598(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0x9c058d48; WORD $0x009a; BYTE $0x00 // leaq         $39580(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x81358d48; WORD $0x009a; BYTE $0x00 // leaq         $39553(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0xf9158d48; WORD $0x0099; BYTE $0x00 // leaq         $39417(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0xdc0d8d48; WORD $0x0098; BYTE $0x00 // leaq         $39132(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x8b0d8d48; WORD $0x0098; BYTE $0x00 // leaq         $39051(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x68058d4c; WORD $0x0098; BYTE $0x00 // leaq         $39016(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
_quote:
	...
	SUBQ  $32, SP
	TESTB $1, R8
	LONG  $0x6d058d48; WORD $0x0098; BYTE $0x00 // leaq         $39021(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0x66158d4c; WORD $0x00a8; BYTE $0x00 // leaq         $43110(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	LONG  $0xd0440f4c                           // cmoveq       %rax, %r10
	MOVQ  DX, R8
	MOVQ  DI, AX
	TESTQ SI, SI
...
LBB5_16:
	...
	MOVQ    DI, DX
	SHLQ    $4, DX
	LONG    $0x021d8d48; WORD $0x0097; BYTE $0x00 // leaq         $38658(%rip), %rbx  /* __SingleQuoteTab(%rip) */
	CMPQ    0(DX)(BX*1), $0
	JNE     LBB5_26
	LEAQ    0(R9)(CX*1), R14
	MOVB    DI, 0(R13)(R10*1)
...
_unquote:
	...
	MOVL  R8, R10
	ANDL  $1, R10
	LONG  $0x4d0d8d48; WORD $0x00b4; BYTE $0x00 // leaq         $46157(%rip), %rcx  /* __UnquoteTab(%rip) */
...
_html_escape:
	...
	LONG  $0x2d1d8d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44077(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ  DI, R12
	MOVQ  -48(BP), R14
...
LBB7_20:
	SUBQ DX, R15
	ADDQ DX, BX
	LONG $0xce1d8d4c; WORD $0x00aa; BYTE $0x00 // leaq         $43726(%rip), %r11  /* __HtmlQuoteTab(%rip) */
...
LBB7_45:
	SUBQ  R12, R15
	SUBQ  AX, R15
	LONG  $0x6c1d8d4c; WORD $0x00aa; BYTE $0x00 // leaq         $43628(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	TESTQ R15, R15
	JNS   LBB7_49
	JMP   LBB7_48
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x2f3d8d4c; WORD $0x0030; BYTE $0x00 // leaq         $12335(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0x5b358d4c; WORD $0x005a; BYTE $0x00 // leaq         $23131(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002d48e8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0x1d358d4c; WORD $0x005a; BYTE $0x00 // leaq         $23069(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002b7be8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x002caae8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x002c63e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002ab9e8; BYTE $0x00 // callq        _left_shift
...
LBB15_61:
	...
	JL    LBB15_72
	LEAL  -22(SI), AX
	LONG  $0xb80d8d48; WORD $0x00bc; BYTE $0x00 // leaq         $48312(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB15_69:
	...
	JB   LBB15_76
	NEGL SI
	LONG $0x6f058d48; WORD $0x00bc; BYTE $0x00 // leaq         $48239(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB15_73:
	...
	JA   LBB15_76
	MOVL AX, AX
	LONG $0xfb0d8d48; WORD $0x00bb; BYTE $0x00 // leaq         $48123(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB15_80
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20459(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
