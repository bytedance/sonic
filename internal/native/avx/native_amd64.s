...
LBB2_5:
	...
	MOVQ    R12, AX
	SHLQ    $4, AX
	LONG    $0xca0d8d48; WORD $0x0080; BYTE $0x00 // leaq         $32970(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(AX)(CX*1), R10
	MOVQ    8(AX)(CX*1), R9
...
LBB2_12:
	...
	MOVLQSX AX, SI
	SHLQ    $4, SI
	LONG    $0xf40d8d4c; WORD $0x0094; BYTE $0x00 // leaq         $38132(%rip), %r9  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R8, DI
	ORQ     $2, DI
	MOVQ    0(SI)(R9*1), R15
	MOVQ    R15, AX
...
LBB2_60:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x004a25e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R13), AX
	MOVB AX, 0(R13)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_65:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0xd3058d48; WORD $0x00a3; BYTE $0x00 // leaq         $41939(%rip), %rax  /* _Digits(%rip) */
...
LBB2_69:
	...
	JL      LBB2_84
	MOVLQSX R14, AX
	LONG    $0x680d8d48; WORD $0x00a3; BYTE $0x00 // leaq         $41832(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_73:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x004921e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R13, R13
	JE    LBB2_77
	LEAL  0(BX)(R13*1), AX
	CMPL  R13, R15
...
LBB2_110:
	...
	MOVL R15, DX
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0x0045bce8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0xd30d8d48; WORD $0x009e; BYTE $0x00 // leaq         $40659(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0xb2358d48; WORD $0x009e; BYTE $0x00 // leaq         $40626(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0xa0158d48; WORD $0x009e; BYTE $0x00 // leaq         $40608(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x87158d48; WORD $0x009e; BYTE $0x00 // leaq         $40583(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0xef058d48; WORD $0x009d; BYTE $0x00 // leaq         $40431(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0xca358d48; WORD $0x009d; BYTE $0x00 // leaq         $40394(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0xb8058d48; WORD $0x009d; BYTE $0x00 // leaq         $40376(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x9d358d48; WORD $0x009d; BYTE $0x00 // leaq         $40349(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x15158d48; WORD $0x009d; BYTE $0x00 // leaq         $40213(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA   LBB4_22
	MOVL DX, AX
	LONG $0xf80d8d48; WORD $0x009b; BYTE $0x00 // leaq         $39928(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0xa70d8d48; WORD $0x009b; BYTE $0x00 // leaq         $39847(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x84058d4c; WORD $0x009b; BYTE $0x00 // leaq         $39812(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
_quote:
	...
	TESTB $1, R8
	MOVQ  SI, AX
	LONG  $0x7d0d8d48; WORD $0x009b; BYTE $0x00 // leaq         $39805(%rip), %rcx  /* __SingleQuoteTab(%rip) */
	LONG  $0x76258d4c; WORD $0x00ab; BYTE $0x00 // leaq         $43894(%rip), %r12  /* __DoubleQuoteTab(%rip) */
...
LBB5_17:
	...
	MOVQ    SI, BX
	SHLQ    $4, BX
	LONG    $0x06158d48; WORD $0x009a; BYTE $0x00 // leaq         $39430(%rip), %rdx  /* __SingleQuoteTab(%rip) */
	CMPQ    0(BX)(DX*1), $0
	JNE     LBB5_27
	LEAQ    0(R11)(CX*1), R8
	MOVB    SI, 0(R15)(R9*1)
...
LBB5_56:
	LONG $0xe40d8d4c; WORD $0x00b7; BYTE $0x00 // leaq         $47076(%rip), %r9  /* __EscTab(%rip) */
	QUAD $0xfffffc07056ffac5                   // vmovdqu      $-1017(%rip), %xmm0  /* LCPI5_0(%rip) */
	QUAD $0xfffffc0f0d6ffac5                   // vmovdqu      $-1009(%rip), %xmm1  /* LCPI5_1(%rip) */
	QUAD $0xfffffc17156ffac5                   // vmovdqu      $-1001(%rip), %xmm2  /* LCPI5_2(%rip) */
	LONG $0xdb76e1c5                           // vpcmpeqd     %xmm3, %xmm3, %xmm3
	MOVQ R15, BX
	MOVQ AX, R10
...
_unquote:
	...
	MOVL  R8, R10
	ANDL  $1, R10
	LONG  $0x570d8d48; WORD $0x00b6; BYTE $0x00 // leaq         $46679(%rip), %rcx  /* __UnquoteTab(%rip) */
...
_html_escape:
	...
	LONG  $0x371d8d4c; WORD $0x00ae; BYTE $0x00 // leaq         $44599(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ  DI, R12
	MOVQ  -48(BP), R14
...
LBB7_20:
	SUBQ DX, R15
	ADDQ DX, BX
	LONG $0xd81d8d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44248(%rip), %r11  /* __HtmlQuoteTab(%rip) */
...
LBB7_45:
	SUBQ  R12, R15
	SUBQ  AX, R15
	LONG  $0x761d8d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44150(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	TESTQ R15, R15
	JNS   LBB7_49
	JMP   LBB7_48
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0x2d3d8d4c; WORD $0x0031; BYTE $0x00 // leaq         $12589(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0x59358d4c; WORD $0x005b; BYTE $0x00 // leaq         $23385(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002e46e8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0x1b358d4c; WORD $0x005b; BYTE $0x00 // leaq         $23323(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002c79e8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x002da8e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x002d61e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002bb7e8; BYTE $0x00 // callq        _left_shift
...
_value:
	...
	MOVQ    SI, -72(BP)
	LEAQ    -48(BP), DX
	LONG    $0x000564e8; BYTE $0x00               // callq        _advance_ns
	MOVBLSX AX, AX
	CMPL    AX, $125
	JA      LBB11_11
...
LBB11_2:
	...
	LEAQ  -48(BP), SI
	MOVQ  -56(BP), DX
	LONG  $0x000b16e8; BYTE $0x00 // callq        _vnumber
	MOVQ  -48(BP), BX
	JMP   LBB11_50
...
LBB11_7:
	MOVQ  R12, DI
	MOVQ  BX, SI
	LONG  $0x001feae8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB11_46
	ADDQ  AX, R12
	MOVQ  R12, BX
...
LBB11_12:
	...
	LEAQ  -64(BP), DX
	MOVQ  R15, SI
	LONG  $0x0006dae8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB11_31
	MOVQ  AX, -48(BP)
	MOVQ  R15, 16(R14)
...
_advance_string:
	...
	MOVQ $-1, DX
	XORL R14, R14
	QUAD $0xffffff95056ffac5 // vmovdqu      $-107(%rip), %xmm0  /* LCPI14_0(%rip) */
	QUAD $0xffffff9d0d6ffac5 // vmovdqu      $-99(%rip), %xmm1  /* LCPI14_1(%rip) */
...
LBB14_13:
	...
	QUAD $0xfffffe40156ffac5     // vmovdqu      $-448(%rip), %xmm2  /* LCPI14_0(%rip) */
	QUAD $0xfffffe481d6ffac5     // vmovdqu      $-440(%rip), %xmm3  /* LCPI14_1(%rip) */
...
LBB15_61:
	...
	JL    LBB15_72
	LEAL  -22(SI), AX
	LONG  $0x120d8d48; WORD $0x00be; BYTE $0x00 // leaq         $48658(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB15_69:
	...
	JB   LBB15_76
	NEGL SI
	LONG $0xc9058d48; WORD $0x00bd; BYTE $0x00 // leaq         $48585(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB15_73:
	...
	JA   LBB15_76
	MOVL AX, AX
	LONG $0x550d8d48; WORD $0x00bd; BYTE $0x00 // leaq         $48469(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB15_80
...
LBB15_76:
	...
	MOVL  R10, BX
	MOVQ  SI, -88(BP)
	LONG  $0xffea1ae8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_81
	MOVQ  -88(BP), SI
	CMPL  -44(BP), $0
	...
	LEAQ  -80(BP), CX
	MOVQ  R12, DI
	LONG  $0xffe9fae8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_81
...
LBB15_81:
	...
	MOVQ -104(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffedf7e8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB15_84
...
LBB19_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000b52e8; BYTE $0x00 // callq        _do_skip_number
	LEAQ  -1(AX), CX
	MOVQ  $-2, DX
	SUBQ  AX, DX
	TESTQ AX, AX
...
LBB19_42:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000a28e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB19_63
	ADDQ  R13, AX
	MOVQ  AX, 0(BX)
...
LJTI19_1:
	LONG $0xffffff3b // .long L19_1_set_65
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	...
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xfffffda1 // .long L19_1_set_40
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	...
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xfffffdc6 // .long L19_1_set_42
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	...
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xfffffe00 // .long L19_1_set_44
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	...
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xfffffe25 // .long L19_1_set_46
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	...
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xfffffe68 // .long L19_1_set_49
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xfffffe9a // .long L19_1_set_51
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xffffff34 // .long L19_1_set_64
	LONG $0xfffffec8 // .long L19_1_set_53
...
_validate_string:
	...
	MOVQ $-1, R10
	XORL R15, R15
	QUAD $0xffffff90056f7ac5 // vmovdqu      $-112(%rip), %xmm8  /* LCPI23_0(%rip) */
	QUAD $0xffffff980d6ffac5 // vmovdqu      $-104(%rip), %xmm1  /* LCPI23_1(%rip) */
	QUAD $0xffffffa0156ffac5 // vmovdqu      $-96(%rip), %xmm2  /* LCPI23_2(%rip) */
	LONG $0xdb76e1c5         // vpcmpeqd     %xmm3, %xmm3, %xmm3
	MOVQ R14, R9

LBB23_4:
	LONG  $0x6f7a81c4; WORD $0x0c3c             // vmovdqu      (%r12,%r9), %xmm7
	LONG  $0x6f7a81c4; WORD $0x0c74; BYTE $0x10 // vmovdqu      $16(%r12,%r9), %xmm6
	LONG  $0x6f7a81c4; WORD $0x0c6c; BYTE $0x20 // vmovdqu      $32(%r12,%r9), %xmm5
	LONG  $0x6f7a81c4; WORD $0x0c64; BYTE $0x30 // vmovdqu      $48(%r12,%r9), %xmm4
...
LBB23_20:
	...
	LONG  $0x6f7ac1c4; WORD $0x1049 // vmovdqu      $16(%r9), %xmm1
	QUAD  $0xfffffd77156ffac5       // vmovdqu      $-649(%rip), %xmm2  /* LCPI23_0(%rip) */
	LONG  $0xda74f9c5               // vpcmpeqb     %xmm2, %xmm0, %xmm3
	LONG  $0xd3d7f9c5               // vpmovmskb    %xmm3, %edx
	LONG  $0xd274f1c5               // vpcmpeqb     %xmm2, %xmm1, %xmm2
	LONG  $0xdad7f9c5               // vpmovmskb    %xmm2, %ebx
	QUAD  $0xfffffd6f156ffac5       // vmovdqu      $-657(%rip), %xmm2  /* LCPI23_1(%rip) */
	LONG  $0xda74f9c5               // vpcmpeqb     %xmm2, %xmm0, %xmm3
	LONG  $0xc3d7f9c5               // vpmovmskb    %xmm3, %eax
	LONG  $0xd274f1c5               // vpcmpeqb     %xmm2, %xmm1, %xmm2
	LONG  $0xfad7f9c5               // vpmovmskb    %xmm2, %edi
	QUAD  $0xfffffd67156ffac5       // vmovdqu      $-665(%rip), %xmm2  /* LCPI23_2(%rip) */
...
LBB23_40:
	...
	ADDQ DX, DI
	CMPQ R10, $-1
	LONG $0xd7440f4c     // cmoveq       %rdi, %r10
	ADDQ DX, R9
	ADDQ $2, R9
	MOVQ R13, DI
	SUBQ DX, DI
...
LBB25_6:
	...
	MOVQ $-1, R10
	XORL AX, AX
	QUAD $0xffffff27056f7ac5 // vmovdqu      $-217(%rip), %xmm8  /* LCPI25_0(%rip) */
	QUAD $0xffffff2f0d6f7ac5 // vmovdqu      $-209(%rip), %xmm9  /* LCPI25_1(%rip) */
	QUAD $0xffffff37156f7ac5 // vmovdqu      $-201(%rip), %xmm10  /* LCPI25_2(%rip) */
	QUAD $0xffffff3f1d6f7ac5 // vmovdqu      $-193(%rip), %xmm11  /* LCPI25_3(%rip) */
	QUAD $0xffffff47256ffac5 // vmovdqu      $-185(%rip), %xmm4  /* LCPI25_4(%rip) */
	QUAD $0xffffff4f2d6ffac5 // vmovdqu      $-177(%rip), %xmm5  /* LCPI25_5(%rip) */
	QUAD $0xffffff57356ffac5 // vmovdqu      $-169(%rip), %xmm6  /* LCPI25_6(%rip) */
	MOVL $4294967295, R11
	MOVQ $-1, R9
	MOVQ $-1, R8
	MOVQ SI, R15
...
LBB25_28:
	...
	SUBQ DI, R14
	XORL AX, AX
	LONG $0x3f1d8d4c; WORD $0x0001; BYTE $0x00 // leaq         $319(%rip), %r11  /* LJTI25_0(%rip) */
	JMP  LBB25_29
...
LJTI25_0:
	LONG $0xfffffefc // .long L25_0_set_37
	LONG $0xffffff39 // .long L25_0_set_40
	LONG $0xfffffefc // .long L25_0_set_37
	LONG $0xffffff0c // .long L25_0_set_35
	LONG $0xffffff39 // .long L25_0_set_40
	LONG $0xffffff39 // .long L25_0_set_40
	LONG $0xffffff39 // .long L25_0_set_40
	LONG $0xffffff39 // .long L25_0_set_40
	...
	LONG $0xffffff39 // .long L25_0_set_40
	LONG $0xffffff39 // .long L25_0_set_40
	LONG $0xfffffec8 // .long L25_0_set_32
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffc6de8; BYTE $0xff // callq        _do_skip_number
	LEAQ  -1(AX), DX
	MOVQ  $-2, CX
	MOVQ  $-2, SI
	SUBQ  AX, SI
...
LBB27_3:
	MOVQ  BX, DI
	LONG  $0xfffbf6e8; BYTE $0xff // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB27_7
	ADDQ  AX, BX
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB30_28
	LONG  $0x340d8d4c; WORD $0x00a8; BYTE $0x00 // leaq         $43060(%rip), %r9  /* _first(%rip) */
	LONG  $0x2d058d4c; WORD $0x00a9; BYTE $0x00 // leaq         $43309(%rip), %r8  /* _ranges(%rip) */
	LONG  $0x30158d4c; WORD $0x0001; BYTE $0x00 // leaq         $304(%rip), %r10  /* LJTI30_0(%rip) */
	MOVQ  DI, R14
...
// .set L30_0_set_21, LBB30_21-LJTI30_0
// .set L30_0_set_19, LBB30_19-LJTI30_0
LJTI30_0:
	LONG $0xffffffcc // .long L30_0_set_27
	LONG $0xfffffff3 // .long L30_0_set_26
	LONG $0xffffffaf // .long L30_0_set_23
	LONG $0xffffffa2 // .long L30_0_set_21
	LONG $0xffffff95 // .long L30_0_set_19
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+8834(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18226(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+20756(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18263(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+16378(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+6540(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+20873(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+11437(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+14392(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15822(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+13345(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16102(SB), AX // _vunsigned
	JMP  AX
