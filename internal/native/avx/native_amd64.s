...
LBB2_8:
	...
	MOVQ    R13, AX
	SHLQ    $4, AX
	LONG    $0x790d8d48; WORD $0x0080; BYTE $0x00 // leaq         $32889(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R10, R12
	ORQ     $2, R12
	MOVQ    0(AX)(CX*1), R11
	MOVQ    8(AX)(CX*1), R14
...
LBB2_22:
	...
	MOVLQSX AX, DI
	SHLQ    $4, DI
	LONG    $0xac1d8d4c; WORD $0x0094; BYTE $0x00 // leaq         $38060(%rip), %r11  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R10, CX
	ORQ     $2, CX
	MOVQ    0(DI)(R11*1), R9
	MOVQ    R9, AX
...
LBB2_67:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x0049ffe8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R12), AX
	MOVB AX, 0(R12)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_74:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0xbc058d48; WORD $0x00a3; BYTE $0x00 // leaq         $41916(%rip), %rax  /* _Digits(%rip) */
...
LBB2_75:
	...
	JL      LBB2_77
	MOVLQSX R14, AX
	LONG    $0x530d8d48; WORD $0x00a3; BYTE $0x00 // leaq         $41811(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_80:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x0048fee8; BYTE $0x00 // callq        _print_mantissa
	TESTL R12, R12
	JE    LBB2_81
	LEAL  0(R12)(BX*1), AX
	CMPL  R12, R15
...
LBB2_85:
	...
	MOVQ R12, SI
	MOVL R15, DX
	LONG $0x004822e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
	MOVL -44(BP), R9
	JMP  LBB2_105
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x3e0d8d48; WORD $0x00a0; BYTE $0x00 // leaq         $41022(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x1d358d48; WORD $0x00a0; BYTE $0x00 // leaq         $40989(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x0b158d48; WORD $0x00a0; BYTE $0x00 // leaq         $40971(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0xf2158d48; WORD $0x009f; BYTE $0x00 // leaq         $40946(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_8:
	...
	CMPL    SI, $10000000
	JB      LBB4_11
	LONG    $0x5a058d48; WORD $0x009f; BYTE $0x00 // leaq         $40794(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_12
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x35358d48; WORD $0x009f; BYTE $0x00 // leaq         $40757(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0x23058d48; WORD $0x009f; BYTE $0x00 // leaq         $40739(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x08358d48; WORD $0x009f; BYTE $0x00 // leaq         $40712(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x80158d48; WORD $0x009e; BYTE $0x00 // leaq         $40576(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	JA      LBB4_22
	MOVL    DX, AX
	LONG    $0x630d8d48; WORD $0x009d; BYTE $0x00 // leaq         $40291(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVL    $2, CX
	JMP     LBB4_25
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x1a0d8d48; WORD $0x009d; BYTE $0x00 // leaq         $40218(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 1(DI)
	MOVL    $3, CX
	JMP     LBB4_25
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0xfc0d8d48; WORD $0x009c; BYTE $0x00 // leaq         $40188(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVWLZX DX, AX
	MOVB    0(CX)(AX*2), DX
...
_quote:
	...
	MOVQ  0(CX), R10
	TESTB $1, R8
	LONG  $0x09058d48; WORD $0x009d; BYTE $0x00 // leaq         $40201(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0x02058d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44290(%rip), %r8  /* __DoubleQuoteTab(%rip) */
	...
	JE    LBB5_71
	MOVQ  CX, -64(BP)
	QUAD  $0xffffff7a056ffac5                   // vmovdqu      $-134(%rip), %xmm0  /* LCPI5_0(%rip) */
	QUAD  $0xffffff820d6ffac5                   // vmovdqu      $-126(%rip), %xmm1  /* LCPI5_1(%rip) */
	QUAD  $0xffffff8a156ffac5                   // vmovdqu      $-118(%rip), %xmm2  /* LCPI5_2(%rip) */
...
LBB5_6:
	MOVQ  -48(BP), R12
	LONG  $0x6f7a81c4; WORD $0x3c24 // vmovdqu      (%r12,%r15), %xmm4
...
LBB5_17:
	...
	MOVQ    SI, BX
	SHLQ    $4, BX
	LONG    $0x97058d48; WORD $0x009b; BYTE $0x00 // leaq         $39831(%rip), %rax  /* __SingleQuoteTab(%rip) */
	CMPQ    0(BX)(AX*1), $0
	JNE     LBB5_27
	LEAQ    0(R11)(CX*1), R9
	MOVB    SI, 0(R15)(DX*1)
...
LBB5_56:
	QUAD $0xfffffc01056ffac5                   // vmovdqu      $-1023(%rip), %xmm0  /* LCPI5_0(%rip) */
	QUAD $0xfffffc090d6ffac5                   // vmovdqu      $-1015(%rip), %xmm1  /* LCPI5_1(%rip) */
	QUAD $0xfffffc11156ffac5                   // vmovdqu      $-1007(%rip), %xmm2  /* LCPI5_2(%rip) */
	LONG $0xdb76e1c5                           // vpcmpeqd     %xmm3, %xmm3, %xmm3
	MOVQ SI, R11
	LONG $0x3b0d8d4c; WORD $0x00b9; BYTE $0x00 // leaq         $47419(%rip), %r9  /* __EscTab(%rip) */
	MOVQ DX, SI
	MOVQ R11, R14
...
LBB6_17:
	ADDQ    R14, AX
	MOVBLZX -1(R11), BX
	LONG    $0x00158d4c; WORD $0x00b8; BYTE $0x00 // leaq         $47104(%rip), %r10  /* __UnquoteTab(%rip) */
	MOVB    0(BX)(R10*1), BX
	CMPB    BX, $-1
	JE      LBB6_20
	TESTB   BX, BX
...
_html_escape:
	...
	LONG  $0xd91d8d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44505(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ  DI, R12
	MOVQ  -48(BP), R14
...
LBB7_20:
	SUBQ CX, R15
	ADDQ CX, BX
	LONG $0x831d8d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44163(%rip), %r11  /* __HtmlQuoteTab(%rip) */
...
LBB7_45:
	SUBQ  R12, R15
	SUBQ  AX, R15
	LONG  $0x201d8d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44064(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	TESTQ R15, R15
	JNS   LBB7_49
	JMP   LBB7_48
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0xd73d8d4c; WORD $0x0030; BYTE $0x00 // leaq         $12503(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0x04358d4c; WORD $0x005b; BYTE $0x00 // leaq         $23300(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002df1e8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0xc6358d4c; WORD $0x005a; BYTE $0x00 // leaq         $23238(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002c15e8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x002d56e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x002d0fe8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002b56e8; BYTE $0x00 // callq        _left_shift
...
LBB11_2:
	...
	LEAQ  -48(BP), SI
	MOVQ  -56(BP), DX
	LONG  $0x000ae9e8; BYTE $0x00 // callq        _vnumber
	MOVQ  -48(BP), R12
	JMP   LBB11_49
...
LBB11_7:
	MOVQ  R12, DI
	MOVQ  BX, SI
	LONG  $0x002109e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB11_45
	ADDQ  AX, R12
	SUBQ  R15, R12
...
LBB11_12:
	...
	LEAQ  -64(BP), DX
	MOVQ  R15, SI
	LONG  $0x0006d1e8; BYTE $0x00 // callq        _advance_string
	MOVQ  AX, R12
	TESTQ AX, AX
	JS    LBB11_33
	MOVQ  R12, -48(BP)
...
_advance_string:
	...
	MOVQ $-1, -48(BP)
	XORL R14, R14
	QUAD $0xffffff98056ffac5 // vmovdqu      $-104(%rip), %xmm0  /* LCPI14_0(%rip) */
	QUAD $0xffffffa00d6ffac5 // vmovdqu      $-96(%rip), %xmm1  /* LCPI14_1(%rip) */
...
LBB14_13:
	...
	QUAD  $0xfffffe4d156ffac5     // vmovdqu      $-435(%rip), %xmm2  /* LCPI14_0(%rip) */
	QUAD  $0xfffffe551d6ffac5     // vmovdqu      $-427(%rip), %xmm3  /* LCPI14_1(%rip) */
...
LBB15_61:
	...
	JL    LBB15_70
	LEAL  -22(SI), AX
	LONG  $0x780d8d48; WORD $0x00bd; BYTE $0x00 // leaq         $48504(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB15_67:
	...
	JB   LBB15_74
	NEGL SI
	LONG $0x59058d48; WORD $0x00bd; BYTE $0x00 // leaq         $48473(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB15_71:
	...
	JA   LBB15_74
	MOVL AX, AX
	LONG $0x2a0d8d48; WORD $0x00bd; BYTE $0x00 // leaq         $48426(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x0459fbc5; BYTE $0xc1               // vmulsd       (%rcx,%rax,8), %xmm0, %xmm0
	LONG $0x4511fbc5; BYTE $0xc0               // vmovsd       %xmm0, $-64(%rbp)
	JMP  LBB15_78
...
LBB15_74:
	...
	MOVQ  R12, DI
	MOVQ  SI, -88(BP)
	LONG  $0xffea47e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_80
	MOVQ  -88(BP), SI
	CMPL  -68(BP), $0
	...
	MOVQ  R12, DI
	MOVL  -44(BP), DX
	LONG  $0xffea26e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB AX, AX
	JE    LBB15_80
...
LBB15_80:
	...
	MOVQ -56(BP), DX
	MOVQ -96(BP), CX
	LONG $0xffee23e8; BYTE $0xff // callq        _atof_native
	LONG $0x4511fbc5; BYTE $0xc0 // vmovsd       %xmm0, $-64(%rbp)
	LONG $0x7ef9e1c4; BYTE $0xc0 // vmovq        %xmm0, %rax
	JMP  LBB15_83
...
LBB19_6:
	...
	MOVQ    -48(BP), R13
	MOVQ    R13, DX
	LONG    $0xfff23ae8; BYTE $0xff // callq        _advance_ns
	MOVLQSX 0(R12), DX
	LEAQ    -1(DX), CX
	CMPQ    R14, $-1
	JNE     LBB19_8
...
LBB19_8:
	...
	CMPL    SI, $5
	JA      LBB19_13
	LONG    $0x773d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1143(%rip), %rdi  /* LJTI19_0(%rip) */
...
LBB19_16:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff3f6e8; BYTE $0xff // callq        _advance_string
	MOVQ  R13, BX
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB19_63
...
LBB19_24:
	MOVQ    $-1, R13
	LONG    $0xa80d8d48; WORD $0x0003; BYTE $0x00 // leaq         $936(%rip), %rcx  /* LJTI19_1(%rip) */
	MOVLQSX 0(CX)(AX*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB19_27:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000d39e8; BYTE $0x00 // callq        _do_skip_number
	LEAQ  -1(AX), CX
	MOVQ  $-2, DX
	SUBQ  AX, DX
	TESTQ AX, AX
...
LBB19_32:
	...
	MOVQ  BX, DI
	MOVQ  R13, SI
	LONG  $0x000597e8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB19_37
	JMP   LBB19_34
...
LBB19_35:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff2bde8; BYTE $0xff // callq        _advance_string
	MOVQ  R13, BX
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB19_63
...
LBB19_39:
	...
	MOVQ  -56(BP), DI
	MOVQ  -48(BP), SI
	LONG  $0x000523e8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB19_4
	JMP   LBB19_34
...
LBB19_41:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000c07e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB19_65
	ADDQ  R13, AX
	MOVQ  AX, 0(BX)
...
LBB19_62:
	...
	MOVQ  R15, SI
	LEAQ  -72(BP), DX
	LONG  $0xfff10ee8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JNS   LBB19_18
...
LJTI19_0:
	LONG $0xfffffb92 // .long L19_0_set_10
	LONG $0xfffffbc1 // .long L19_0_set_14
	LONG $0xfffffbee // .long L19_0_set_16
	LONG $0xfffffc31 // .long L19_0_set_20
	LONG $0xfffffc46 // .long L19_0_set_22
	LONG $0xfffffcce // .long L19_0_set_25
	...
	// .set L19_1_set_27, LBB19_27-LJTI19_1
...
LJTI19_1:
	LONG $0xffffffd6 // .long L19_1_set_71
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	...
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xfffffd72 // .long L19_1_set_39
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	...
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xfffffd97 // .long L19_1_set_41
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xfffffc61 // .long L19_1_set_27
	LONG $0xfffffc61 // .long L19_1_set_27
	LONG $0xfffffc61 // .long L19_1_set_27
	LONG $0xfffffc61 // .long L19_1_set_27
	LONG $0xfffffc61 // .long L19_1_set_27
	...
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xfffffdd1 // .long L19_1_set_44
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	...
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xfffffdf6 // .long L19_1_set_46
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	...
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xfffffe3d // .long L19_1_set_50
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xfffffe73 // .long L19_1_set_55
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xffffffcf // .long L19_1_set_66
	LONG $0xfffffea9 // .long L19_1_set_60
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffed96e8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB22_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	MOVQ $-1, -48(BP)
	XORL R13, R13
	QUAD $0xffffff78056f7ac5 // vmovdqu      $-136(%rip), %xmm8  /* LCPI23_0(%rip) */
	QUAD $0xffffff800d6ffac5 // vmovdqu      $-128(%rip), %xmm1  /* LCPI23_1(%rip) */
	QUAD $0xffffff88156ffac5 // vmovdqu      $-120(%rip), %xmm2  /* LCPI23_2(%rip) */
	LONG $0xdb76e1c5         // vpcmpeqd     %xmm3, %xmm3, %xmm3

LBB23_3:
	MOVQ  -56(BP), AX
	LONG  $0x246ffac5; BYTE $0x10   // vmovdqu      (%rax,%rdx), %xmm4
	LONG  $0x6c6ffac5; WORD $0x1010 // vmovdqu      $16(%rax,%rdx), %xmm5
	LONG  $0x746ffac5; WORD $0x2010 // vmovdqu      $32(%rax,%rdx), %xmm6
	LONG  $0x7c6ffac5; WORD $0x3010 // vmovdqu      $48(%rax,%rdx), %xmm7
...
LBB23_14:
	...
	ADDQ  R12, SI
	MOVQ  -80(BP), DI
	LONG  $0x0002cde8; BYTE $0x00 // callq        _utf8_validate
	ADDQ  AX, BX
	TESTQ AX, AX
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+8843(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18076(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+21027(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18113(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+16229(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+5818(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21144(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+11432(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+14342(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15647(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+13324(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15927(SB), AX // _vunsigned
	JMP  AX
