...
LBB0_20:
    ...
    WORD $0x3dc00222 // ldr    q2, [x17, :lo12:.LCPI0_0]
    WORD $0x3dc00243 // ldr    q3, [x18, :lo12:.LCPI0_1]
    WORD $0x11000531 // add    w17, w9, #1
    WORD $0x2a0803f2 // mov    w18, w8
LBB0_21:
    WORD $0xad4015c4 // ldp    q4, q5, [x14]
    WORD $0x6e248c04 // cmeq    v4.16b, v0.16b, v4.16b
    WORD $0x6e258c25 // cmeq    v5.16b, v1.16b, v5.16b
...
LBB0_23:
    ...
    WORD $0x24028012 // cmpgt    p2.b, p0/z, z0.b, z2.b
