...
TEXT ·__validate_utf8_fast_arm64_entry__(SB), NOSPLIT, $32
	NO_LOCAL_POINTERS
...
_validate_utf8_fast:
	...
	WORD $0x54000629  // b.ls	LBB0_13 $196(%rip)
...
LBB0_4:
	...
	WORD $0x54000a41  // b.ne	LBB0_31 $328(%rip)
	WORD $0x0a010085  // and	w5, w4, w1
	WORD $0x34000a05  // cbz	w5, LBB0_31 $320(%rip)
	...
	WORD $0x1400004b  // b	LBB0_31 $300(%rip)
LBB0_11:
...
LBB0_14:
	...
	WORD $0x54000822  // b.hs	LBB0_30 $260(%rip)
...
LBB0_17:
	WORD $0xeb09015f  // cmp	x10, x9
	WORD $0x540006a2  // b.hs	LBB0_30 $212(%rip)
LBB0_18:
...
LBB0_22:
	...
	WORD $0x9100b3e1  // add	x1, sp, #44
	WORD $0xaa0a03e2  // mov	x2, x10
	WORD $0xb5fffe23  // cbnz	x3, LBB0_21 $-60(%rip)
LBB0_23:
...
LBB0_24:
	...
	WORD $0x35000121  // cbnz	w1, LBB0_29 $36(%rip)
LBB0_26:
	WORD $0x721f0e3f  // tst	w17, #0x1e
	WORD $0x540001a0  // b.eq	LBB0_31 $52(%rip)
	WORD $0x0a0f0011  // and	w17, w0, w15
	WORD $0x6b10023f  // cmp	w17, w16
	WORD $0x54000141  // b.ne	LBB0_31 $40(%rip)
	WORD $0x52800051  // mov	w17, #2
	WORD $0x8b11014a  // add	x10, x10, x17
	WORD $0x17ffffce  // b	LBB0_17 $-200(%rip)
LBB0_29:
	WORD $0x52800071  // mov	w17, #3
	WORD $0x8b11014a  // add	x10, x10, x17
	WORD $0x17ffffcb  // b	LBB0_17 $-212(%rip)
LBB0_30:
...
_validate_utf8_fast:
	MOVD s+0(FP), R0
	CALL ·__validate_utf8_fast_arm64_entry__+24(SB)  // _validate_utf8_fast
	MOVD R0, ret+8(FP)
	RET
