...
//go:nosplit
//go:noescape
//go:linkname Quote github.com/bytedance/sonic/internal/native/sse.__quote
func Quote(s unsafe.Pointer, nb int, dp unsafe.Pointer, dn *int, flags uint64) int

//go:nosplit
//go:noescape
//go:linkname Unquote github.com/bytedance/sonic/internal/native/sse.__unquote
func Unquote(s unsafe.Pointer, nb int, dp unsafe.Pointer, ep *int, flags uint64) int

//go:nosplit
//go:noescape
//go:linkname HTMLEscape github.com/bytedance/sonic/internal/native/sse.__html_escape
func HTMLEscape(s unsafe.Pointer, nb int, dp unsafe.Pointer, dn *int) int

//go:nosplit
//go:noescape
//go:linkname Value github.com/bytedance/sonic/internal/native/sse.__value
func Value(s unsafe.Pointer, n int, p int, v *types.JsonState, flags uint64) int

//go:nosplit
//go:noescape
//go:linkname SkipOne github.com/bytedance/sonic/internal/native/sse.__skip_one
func SkipOne(s *string, p *int, m *types.StateMachine, flags uint64) int

//go:nosplit
//go:noescape
//go:linkname SkipOneFast github.com/bytedance/sonic/internal/native/sse.__skip_one_fast
func SkipOneFast(s *string, p *int) int

//go:nosplit
//go:noescape
//go:linkname GetByPath github.com/bytedance/sonic/internal/native/sse.__get_by_path
func GetByPath(s *string, p *int, path *[]interface{}, m *types.StateMachine) int

//go:nosplit
//go:noescape
//go:linkname ValidateOne github.com/bytedance/sonic/internal/native/sse.__validate_one
func ValidateOne(s *string, p *int, m *types.StateMachine, flags uint64) int

//go:nosplit
//go:noescape
//go:linkname I64toa github.com/bytedance/sonic/internal/native/sse.__i64toa
func I64toa(out *byte, val int64) (ret int)

//go:nosplit
//go:noescape
//go:linkname U64toa github.com/bytedance/sonic/internal/native/sse.__u64toa
func U64toa(out *byte, val uint64) (ret int)

//go:nosplit
//go:noescape
//go:linkname F64toa github.com/bytedance/sonic/internal/native/sse.__f64toa
func F64toa(out *byte, val float64) (ret int)

//go:nosplit
//go:noescape
//go:linkname F32toa github.com/bytedance/sonic/internal/native/sse.__f32toa
func F32toa(out *byte, val float32) (ret int)

//go:nosplit
//go:noescape
//go:linkname ValidateUTF8 github.com/bytedance/sonic/internal/native/sse.__validate_utf8
func ValidateUTF8(s *string, p *int, m *types.StateMachine) (ret int)

//go:nosplit
//go:noescape
//go:linkname ValidateUTF8Fast github.com/bytedance/sonic/internal/native/sse.__validate_utf8_fast
