...
LBB1_7:
	...
	MOVQ DI, SI
	SUBQ R10, SI
	QUAD $0xffffff44056f0ff3 // movdqu       $-188(%rip), %xmm0  /* LCPI1_0(%rip) */
	QUAD $0xffffff4c0d6f0ff3 // movdqu       $-180(%rip), %xmm1  /* LCPI1_1(%rip) */
	QUAD $0xffffff54156f0ff3 // movdqu       $-172(%rip), %xmm2  /* LCPI1_2(%rip) */
	QUAD $0xffffff5c1d6f0ff3 // movdqu       $-164(%rip), %xmm3  /* LCPI1_3(%rip) */
...
LBB2_8:
	...
	MOVQ    R13, AX
	SHLQ    $4, AX
	LONG    $0x2b0d8d48; WORD $0x0081; BYTE $0x00 // leaq         $33067(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
	MOVQ    R10, R12
	ORQ     $2, R12
	MOVQ    0(AX)(CX*1), R11
	MOVQ    8(AX)(CX*1), R14
...
LBB2_22:
	...
	MOVLQSX AX, DI
	SHLQ    $4, DI
	LONG    $0x5e1d8d4c; WORD $0x0095; BYTE $0x00 // leaq         $38238(%rip), %r11  /* _DOUBLE_POW5_SPLIT(%rip) */
	MOVQ    R10, CX
	ORQ     $2, CX
	MOVQ    0(DI)(R11*1), R9
	MOVQ    R9, AX
...
LBB2_67:
	...
	MOVQ BX, SI
	MOVL R15, DX
	LONG $0x004ab1e8; BYTE $0x00 // callq        _print_mantissa
	MOVB 1(R12), AX
	MOVB AX, 0(R12)
	MOVL $1, AX
	CMPL R15, $2
...
LBB2_74:
	...
	LEAL    0(AX)(AX*4), AX
	SUBL    AX, R14
	LONG    $0x6e058d48; WORD $0x00a4; BYTE $0x00 // leaq         $42094(%rip), %rax  /* _Digits(%rip) */
...
LBB2_75:
	...
	JL      LBB2_77
	MOVLQSX R14, AX
	LONG    $0x050d8d48; WORD $0x00a4; BYTE $0x00 // leaq         $41989(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_80:
	...
	ADDQ  -56(BP), SI
	MOVL  R15, DX
	LONG  $0x0049b0e8; BYTE $0x00 // callq        _print_mantissa
	TESTL R12, R12
	JE    LBB2_81
	LEAL  0(R12)(BX*1), AX
	CMPL  R12, R15
...
LBB2_85:
	...
	MOVQ R12, SI
	MOVL R15, DX
	LONG $0x0048d7e8; BYTE $0x00 // callq        _print_mantissa
	ADDL BX, R15
	MOVL R15, BX
	MOVL -44(BP), R9
	JMP  LBB2_105
...
LBB2_97:
	...
	NEGQ SI
	XORL DI, DI
	QUAD $0xfffff6de056f0ff3 // movdqu       $-2338(%rip), %xmm0  /* LCPI2_0(%rip) */

LBB2_98:
	MOVOU X0, -112(CX)(DI*1)
	MOVOU X0, -96(CX)(DI*1)
	MOVOU X0, -80(CX)(DI*1)
	MOVOU X0, -64(CX)(DI*1)
	MOVOU X0, -48(CX)(DI*1)
...
LBB2_99:
	...
	SHLQ  $5, DX
	XORL  SI, SI
	QUAD  $0xfffff687056f0ff3 // movdqu       $-2425(%rip), %xmm0  /* LCPI2_0(%rip) */
...
LBB3_1:
	...
	ADDQ $1, DI
	NEGQ SI
	LONG $0x000055e8; BYTE $0x00 // callq        _u64toa
	ADDL $1, AX
	BYTE $0x5d                   // popq         %rbp
	RET
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB4_3
	LONG    $0x4d0d8d48; WORD $0x00a1; BYTE $0x00 // leaq         $41293(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB4_4
...
LBB4_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0x2c358d48; WORD $0x00a1; BYTE $0x00 // leaq         $41260(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	ADDL    $1, CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB4_6:
	LONG $0x1a158d48; WORD $0x00a1; BYTE $0x00 // leaq         $41242(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	ADDL $1, CX
	MOVB DX, 0(DI)(SI*1)
...
LBB4_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x01158d48; WORD $0x00a1; BYTE $0x00 // leaq         $41217(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	ADDL    $1, CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB4_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0x44358d48; WORD $0x00a0; BYTE $0x00 // leaq         $41028(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_14:
	LONG $0x32058d48; WORD $0x00a0; BYTE $0x00 // leaq         $41010(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	ADDL $1, CX
	MOVB AX, 0(DI)(SI*1)
...
LBB4_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0x17358d48; WORD $0x00a0; BYTE $0x00 // leaq         $40983(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DI)(DX*1)
	MOVB    0(R8)(SI*1), AX
...
LBB4_16:
	...
	QUAD      $0xfffffdb60d6f0ff3                   // movdqu       $-586(%rip), %xmm1  /* LCPI4_0(%rip) */
	MOVO      X0, X2
	PMULULQ   X1, X2
	PSRLQ     $45, X2
	MOVL      $10000, AX
	...
	PSHUFLW   $80, X2, X0
	PSHUFL    $80, X0, X0
	QUAD      $0xfffffd88156f0ff3                   // movdqu       $-632(%rip), %xmm2  /* LCPI4_1(%rip) */
	PMULHUW   X2, X0
	QUAD      $0xfffffd8c256f0ff3                   // movdqu       $-628(%rip), %xmm4  /* LCPI4_2(%rip) */
	PMULHUW   X4, X0
	QUAD      $0xfffffd902d6f0ff3                   // movdqu       $-624(%rip), %xmm5  /* LCPI4_3(%rip) */
	MOVO      X0, X6
	PMULLW    X5, X6
	PSLLQ     $16, X6
	PSUBW     X6, X0
	...
	PSUBW     X5, X1
	PACKUSWB  X1, X0
	QUAD      $0xfffffd460d6f0ff3                   // movdqu       $-698(%rip), %xmm1  /* LCPI4_4(%rip) */
	PADDB     X0, X1
	PXOR      X2, X2
	PCMPEQB   X0, X2
	PMOVMSKB  X2, AX
	...
	SUBL      AX, CX
	SHLQ      $4, AX
	LONG      $0x7f158d48; WORD $0x009f; BYTE $0x00 // leaq         $40831(%rip), %rdx  /* _VecShiftShuffles(%rip) */
	PSHUFB    0(AX)(DX*1), X1
	MOVOU     X1, 0(DI)
	MOVL      CX, AX
	BYTE      $0x5d                                 // popq         %rbp
...
LBB4_20:
	...
	JA      LBB4_22
	MOVL    DX, AX
	LONG    $0x620d8d48; WORD $0x009e; BYTE $0x00 // leaq         $40546(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVL    $2, CX
	JMP     LBB4_25
...
LBB4_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0x190d8d48; WORD $0x009e; BYTE $0x00 // leaq         $40473(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 1(DI)
	MOVL    $3, CX
	JMP     LBB4_25
...
LBB4_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0xfb0d8d48; WORD $0x009d; BYTE $0x00 // leaq         $40443(%rip), %rcx  /* _Digits(%rip) */
	MOVWLZX 0(CX)(AX*2), AX
	MOVW    AX, 0(DI)
	MOVWLZX DX, AX
	MOVB    0(CX)(AX*2), DX
...
LBB4_25:
	...
	SHRQ      $26, DX
	LONG      $0xc26e0f66               // movd         %edx, %xmm0
	QUAD      $0xfffffbdc0d6f0ff3       // movdqu       $-1060(%rip), %xmm1  /* LCPI4_0(%rip) */
	MOVO      X0, X3
	PMULULQ   X1, X3
	PSRLQ     $45, X3
	MOVL      $10000, AX
	...
	PSHUFLW   $80, X3, X0
	PSHUFL    $80, X0, X0
	QUAD      $0xfffffbae256f0ff3       // movdqu       $-1106(%rip), %xmm4  /* LCPI4_1(%rip) */
	PMULHUW   X4, X0
	QUAD      $0xfffffbb22d6f0ff3       // movdqu       $-1102(%rip), %xmm5  /* LCPI4_2(%rip) */
	PMULHUW   X5, X0
	QUAD      $0xfffffbb61d6f0ff3       // movdqu       $-1098(%rip), %xmm3  /* LCPI4_3(%rip) */
	MOVO      X0, X6
	PMULLW    X3, X6
	PSLLQ     $16, X6
	PSUBW     X6, X0
	...
	PSUBW     X3, X1
	PACKUSWB  X1, X0
	QUAD      $0xfffffb6405fc0f66       // paddb        $-1180(%rip), %xmm0  /* LCPI4_4(%rip) */
	MOVL      CX, AX
	MOVOU     X0, 0(DI)(AX*1)
	ORL       $16, CX
	MOVL      CX, AX
...
_quote:
	...
	TESTB   $1, R8
	MOVQ    SI, AX
	LONG    $0xf30d8d48; WORD $0x009d; BYTE $0x00 // leaq         $40435(%rip), %rcx  /* __SingleQuoteTab(%rip) */
	LONG    $0xec258d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44524(%rip), %r12  /* __DoubleQuoteTab(%rip) */
	...
	JE      LBB5_80
	MOVQ    R11, -56(BP)
	QUAD    $0xffffff71056f0ff3                   // movdqu       $-143(%rip), %xmm0  /* LCPI5_0(%rip) */
	QUAD    $0xffffff790d6f0ff3                   // movdqu       $-135(%rip), %xmm1  /* LCPI5_1(%rip) */
	QUAD    $0xffffff81156f0ff3                   // movdqu       $-127(%rip), %xmm2  /* LCPI5_2(%rip) */
	PCMPEQL X3, X3
	MOVQ    DI, CX
	MOVQ    R15, -48(BP)
	MOVQ    R15, R14
...
LBB5_17:
	MOVBLZX 0(R13)(R9*1), CX
	MOVQ    CX, BX
	SHLQ    $4, BX
	LONG    $0x6d358d48; WORD $0x009c; BYTE $0x00 // leaq         $40045(%rip), %rsi  /* __SingleQuoteTab(%rip) */
	CMPQ    0(BX)(SI*1), $0
	JNE     LBB5_27
	LEAQ    0(R11)(DX*1), R8
	MOVB    CX, 0(R15)(R9*1)
...
LBB5_56:
	...
	QUAD    $0xfffffbf3056f0ff3                   // movdqu       $-1037(%rip), %xmm0  /* LCPI5_0(%rip) */
	QUAD    $0xfffffbfb0d6f0ff3                   // movdqu       $-1029(%rip), %xmm1  /* LCPI5_1(%rip) */
	QUAD    $0xfffffc03156f0ff3                   // movdqu       $-1021(%rip), %xmm2  /* LCPI5_2(%rip) */
	PCMPEQL X3, X3
	MOVQ    R15, BX
	MOVQ    AX, SI
...
_unquote:
	...
	MOVL  R8, R9
	ANDL  $1, R9
	QUAD  $0xffffffc7056f0ff3 // movdqu       $-57(%rip), %xmm0  /* LCPI6_0(%rip) */
	MOVQ  DI, R11
	MOVQ  SI, R15
	MOVQ  DX, AX
...
LBB6_17:
	ADDQ    R14, AX
	MOVBLZX -1(R11), BX
	LONG    $0xf4158d4c; WORD $0x00b7; BYTE $0x00 // leaq         $47092(%rip), %r10  /* __UnquoteTab(%rip) */
	MOVB    0(BX)(R10*1), BX
	CMPB    BX, $-1
	JE      LBB6_20
	TESTB   BX, BX
...
_html_escape:
	...
	MOVQ  -56(BP), AX
	MOVQ  0(AX), R9
	QUAD  $0xffffff89056f0ff3                   // movdqu       $-119(%rip), %xmm0  /* LCPI7_0(%rip) */
	QUAD  $0xffffff910d6f0ff3                   // movdqu       $-111(%rip), %xmm1  /* LCPI7_1(%rip) */
	QUAD  $0xffffff99156f0ff3                   // movdqu       $-103(%rip), %xmm2  /* LCPI7_2(%rip) */
	QUAD  $0xffffffa11d6f0ff3                   // movdqu       $-95(%rip), %xmm3  /* LCPI7_3(%rip) */
	LONG  $0xcd1d8d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44493(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	MOVQ  DI, R12
	MOVQ  -48(BP), R14
...
LBB7_20:
	SUBQ BX, R15
	ADDQ BX, CX
	LONG $0x661d8d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44134(%rip), %r11  /* __HtmlQuoteTab(%rip) */
...
LBB7_45:
	SUBQ  R12, R15
	SUBQ  AX, R15
	LONG  $0x031d8d4c; WORD $0x00ac; BYTE $0x00 // leaq         $44035(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	TESTQ R15, R15
	JNS   LBB7_49
	JMP   LBB7_48
...
LBB8_5:
	...
	MOVL AX, CX
	SHLQ $4, CX
	LONG $0xba3d8d4c; WORD $0x0030; BYTE $0x00 // leaq         $12474(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	MOVQ DI, AX
	MULQ 8(CX)(R15*1)
	MOVQ AX, R11
	MOVQ DX, R14
...
LBB9_5:
	...
	JLE   LBB9_12
	XORL  R12, R12
	LONG  $0xe7358d4c; WORD $0x005a; BYTE $0x00 // leaq         $23271(%rip), %r14  /* _POW_TAB(%rip) */
	JMP   LBB9_8
...
LBB9_11:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002dd4e8; BYTE $0x00 // callq        _right_shift
...
LBB9_12:
	LONG $0xa9358d4c; WORD $0x005a; BYTE $0x00 // leaq         $23209(%rip), %r14  /* _POW_TAB(%rip) */
	JMP  LBB9_14
...
LBB9_20:
	MOVQ R15, DI
	MOVL BX, SI
	LONG $0x002bf8e8; BYTE $0x00 // callq        _left_shift
	MOVL 20(R15), AX
...
LBB9_25:
	MOVQ R15, DI
	MOVL $60, SI
	LONG $0x002d39e8; BYTE $0x00 // callq        _right_shift
	ADDL $60, R12
	CMPL R12, $-120
	JL   LBB9_25
	ADDL $60, R12
...
LBB9_31:
	...
	MOVQ R15, DI
	MOVL R12, SI
	LONG $0x002cf2e8; BYTE $0x00 // callq        _right_shift
	MOVL $-1022, R14
...
LBB9_32:
	...
	MOVQ R15, DI
	MOVL $53, SI
	LONG $0x002b39e8; BYTE $0x00 // callq        _left_shift
...
LBB10_40:
	LEAQ  -32(BP), DI
	LEAQ  -40(BP), SI
	LONG  $0xfffb67e8; BYTE $0xff // callq        _decimal_to_f64
	MOVSD -40(BP), X0
	ADDQ  $48, SP
	BYTE  $0x5d                   // popq         %rbp
	RET
...
LBB11_2:
	...
	LEAQ  -48(BP), SI
	MOVQ  -56(BP), DX
	LONG  $0x000b12e8; BYTE $0x00 // callq        _vnumber
	MOVQ  -48(BP), R12
	JMP   LBB11_49
...
LBB11_7:
	MOVQ  R12, DI
	MOVQ  BX, SI
	LONG  $0x0020d3e8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB11_45
	ADDQ  AX, R12
	SUBQ  R15, R12
...
LBB12_27:
	...
	MOVQ DI, CX
	SUBQ R9, CX
	QUAD $0xfffffea7056f0ff3 // movdqu       $-345(%rip), %xmm0  /* LCPI12_0(%rip) */
	QUAD $0xfffffeaf0d6f0ff3 // movdqu       $-337(%rip), %xmm1  /* LCPI12_1(%rip) */
	QUAD $0xfffffeb7156f0ff3 // movdqu       $-329(%rip), %xmm2  /* LCPI12_2(%rip) */
	QUAD $0xfffffebf1d6f0ff3 // movdqu       $-321(%rip), %xmm3  /* LCPI12_3(%rip) */
...
_advance_string:
	...
	MOVQ $-1, -48(BP)
	XORL R14, R14
	QUAD $0xffffff98056f0ff3 // movdqu       $-104(%rip), %xmm0  /* LCPI14_0(%rip) */
	QUAD $0xffffffa00d6f0ff3 // movdqu       $-96(%rip), %xmm1  /* LCPI14_1(%rip) */
...
LBB14_13:
	MOVOU    0(SI), X0
	MOVOU    16(SI), X1
	QUAD     $0xfffffe38156f0ff3 // movdqu       $-456(%rip), %xmm2  /* LCPI14_0(%rip) */
	QUAD     $0xfffffe401d6f0ff3 // movdqu       $-448(%rip), %xmm3  /* LCPI14_1(%rip) */
	MOVO     X0, X4
	PCMPEQB  X2, X4
	PMOVMSKB X4, DI
	PCMPEQB  X1, X2
...
LBB15_69:
	MOVQ     R12, X0
	IMULQ    CX, R12
	QUAD     $0xfffffcd105620f66 // punpckldq    $-815(%rip), %xmm0  /* LCPI15_0(%rip) */
	QUAD     $0xfffffcd9055c0f66 // subpd        $-807(%rip), %xmm0  /* LCPI15_1(%rip) */
	MOVQ     R12, 16(BX)
	MOVAPD   X0, X1
	UNPCKHPD X0, X1
	ADDSD    X0, X1
...
LBB15_61:
	MOVQ     $0, -80(BP)
	MOVQ     R12, X1
	QUAD     $0xfffffc300d620f66                   // punpckldq    $-976(%rip), %xmm1  /* LCPI15_0(%rip) */
	QUAD     $0xfffffc380d5c0f66                   // subpd        $-968(%rip), %xmm1  /* LCPI15_1(%rip) */
	MOVAPD   X1, X0
	UNPCKHPD X1, X0
	ADDSD    X1, X0
	MOVSD    X0, -64(BP)
	...
	JL       LBB15_70
	LEAL     -22(SI), AX
	LONG     $0x300d8d48; WORD $0x00bd; BYTE $0x00 // leaq         $48432(%rip), %rcx  /* _P10_TAB(%rip) */
	MULSD    0(CX)(AX*8), X0
	MOVSD    X0, -64(BP)
	MOVL     $22, AX
	JMP      LBB15_71
...
LBB15_67:
	...
	JB    LBB15_74
	NEGL  SI
	LONG  $0x11058d48; WORD $0x00bd; BYTE $0x00 // leaq         $48401(%rip), %rax  /* _P10_TAB(%rip) */
	DIVSD 0(AX)(SI*8), X0
	MOVSD X0, -64(BP)
	JMP   LBB15_78
...
LBB15_71:
	QUAD    $0xfffffbb3052e0f66                   // ucomisd      $-1101(%rip), %xmm0  /* LCPI15_2(%rip) */
	JA      LBB15_74
	QUAD    $0xfffffbb10d100ff2                   // movsd        $-1103(%rip), %xmm1  /* LCPI15_3(%rip) */
	UCOMISD X0, X1
	JA      LBB15_74
	MOVL    AX, AX
	LONG    $0xe20d8d48; WORD $0x00bc; BYTE $0x00 // leaq         $48354(%rip), %rcx  /* _P10_TAB(%rip) */
	MULSD   0(CX)(AX*8), X0
	MOVSD   X0, -64(BP)
	JMP     LBB15_78
...
LBB15_74:
	...
	MOVQ    R12, DI
	MOVQ    SI, -88(BP)
	LONG    $0xffea1ce8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB   AX, AX
	JE      LBB15_80
	MOVQ    -88(BP), SI
	CMPL    -68(BP), $0
	...
	MOVQ    R12, DI
	MOVL    -44(BP), DX
	LONG    $0xffe9fbe8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTB   AX, AX
	JE      LBB15_80
	MOVSD   -80(BP), X1
	MOVSD   -64(BP), X0
...
LBB15_80:
	...
	MOVQ  -56(BP), DX
	MOVQ  -96(BP), CX
	LONG  $0xffedf8e8; BYTE $0xff // callq        _atof_native
	MOVSD X0, -64(BP)
	MOVQ  X0, AX
	JMP   LBB15_83
...
LBB19_5:
	...
	MOVQ    R8, R15
	MOVQ    R8, DX
	LONG    $0xfff21be8; BYTE $0xff // callq        _advance_ns
	TESTB   AX, AX
	JE      LBB19_65
	MOVLQSX 0(R12), DX
	LEAQ    -1(DX), R9
...
LBB19_8:
	...
	CMPL    DI, $5
	JA      LBB19_13
	LONG    $0x520d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1106(%rip), %rcx  /* LJTI19_0(%rip) */
...
LBB19_19:
	...
	LEAQ  -72(BP), DX
	MOVQ  R8, BX
	LONG  $0xfff3d3e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB19_67
	MOVQ  R13, 0(BX)
...
LBB19_25:
	LONG    $0x800d8d48; WORD $0x0003; BYTE $0x00 // leaq         $896(%rip), %rcx  /* LJTI19_1(%rip) */
	MOVLQSX 0(CX)(SI*4), AX
	ADDQ    CX, AX
	JMP     AX
...
LBB19_28:
	...
	MOVQ  8(AX), SI
	SUBQ  R13, SI
	LONG  $0x000cd8e8; BYTE $0x00 // callq        _do_skip_number
	MOVQ  R15, R8
	LEAQ  -1(AX), CX
	MOVQ  $-2, DX
	SUBQ  AX, DX
...
LBB19_33:
	...
	MOVQ  BX, DI
	MOVQ  R8, SI
	LONG  $0x0004eae8; BYTE $0x00 // callq        _validate_string
	TESTQ AX, AX
	JNS   LBB19_38
	JMP   LBB19_35
...
LBB19_36:
	...
	LEAQ  -72(BP), DX
	MOVQ  R8, -64(BP)
	LONG  $0xfff297e8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, R13
	TESTQ AX, AX
	JS    LBB19_68
	MOVQ  -64(BP), AX
...
LBB19_40:
	...
	MOVQ  -48(BP), DI
	MOVQ  R8, SI
	LONG  $0x00046de8; BYTE $0x00 // callq        _validate_string
	MOVQ  R15, R8
	TESTQ AX, AX
	JNS   LBB19_3
	JMP   LBB19_35
...
LBB19_42:
	...
	SUBQ  R15, SI
	MOVQ  R8, BX
	LONG  $0x000b9ae8; BYTE $0x00 // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB19_70
	ADDQ  R15, AX
	MOVQ  AX, 0(BX)
...
LJTI19_0:
	LONG $0xfffffbb7 // .long L19_0_set_10
	LONG $0xfffffbea // .long L19_0_set_14
	LONG $0xfffffc14 // .long L19_0_set_17
	LONG $0xfffffc59 // .long L19_0_set_21
	LONG $0xfffffc6e // .long L19_0_set_23
	LONG $0xfffffcf5 // .long L19_0_set_26
...
LJTI19_1:
	...
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	...
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xfffffdc8 // .long L19_1_set_42
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xfffffc89 // .long L19_1_set_28
	LONG $0xfffffc89 // .long L19_1_set_28
	LONG $0xfffffc89 // .long L19_1_set_28
	LONG $0xfffffc89 // .long L19_1_set_28
	LONG $0xfffffc89 // .long L19_1_set_28
	...
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xfffffe04 // .long L19_1_set_45
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	...
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xfffffe29 // .long L19_1_set_47
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	...
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xfffffe68 // .long L19_1_set_51
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xfffffe9a // .long L19_1_set_56
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xffffff2c // .long L19_1_set_66
	LONG $0xfffffec8 // .long L19_1_set_61
...
_skip_string:
	...
	LEAQ  -32(BP), DX
	MOVQ  BX, SI
	LONG  $0xffee23e8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB22_2
	ADDQ  $-1, BX
	MOVQ  AX, CX
...
_validate_string:
	...
	MOVQ    $-1, -48(BP)
	XORL    R13, R13
	QUAD    $0xffff77056f0f44f3; BYTE $0xff // movdqu       $-137(%rip), %xmm8  /* LCPI23_0(%rip) */
	QUAD    $0xffffff7f0d6f0ff3             // movdqu       $-129(%rip), %xmm1  /* LCPI23_1(%rip) */
	QUAD    $0xffffff87156f0ff3             // movdqu       $-121(%rip), %xmm2  /* LCPI23_2(%rip) */
	PCMPEQL X3, X3
...
LBB23_14:
	...
	ADDQ  R12, SI
	MOVQ  -80(BP), DI
	LONG  $0x0002dce8; BYTE $0x00 // callq        _utf8_validate
	ADDQ  AX, BX
	TESTQ AX, AX
...
LBB23_22:
	MOVOU    0(DX), X0
	MOVOU    16(DX), X1
	QUAD     $0xfffffcfd156f0ff3 // movdqu       $-771(%rip), %xmm2  /* LCPI23_0(%rip) */
	MOVO     X0, X3
	PCMPEQB  X2, X3
	PMOVMSKB X3, R11
	PCMPEQB  X1, X2
	PMOVMSKB X2, AX
	QUAD     $0xfffffcf0156f0ff3 // movdqu       $-784(%rip), %xmm2  /* LCPI23_1(%rip) */
	MOVO     X0, X3
	PCMPEQB  X2, X3
	PMOVMSKB X3, R8
	PCMPEQB  X1, X2
	PMOVMSKB X2, SI
	QUAD     $0xfffffce3156f0ff3 // movdqu       $-797(%rip), %xmm2  /* LCPI23_2(%rip) */
	MOVO     X2, X3
	PCMPGTB  X0, X3
	PCMPEQL  X4, X4
	PCMPGTB  X4, X0
...
_utf8_validate:
	...
	TESTQ SI, SI
	JLE   LBB24_28
	LONG  $0xfa058d4c; WORD $0x00ad; BYTE $0x00 // leaq         $44538(%rip), %r8  /* _first(%rip) */
	LONG  $0xf30d8d4c; WORD $0x00ae; BYTE $0x00 // leaq         $44787(%rip), %r9  /* _ranges(%rip) */
...
LBB26_6:
	...
	MOVQ $-1, R10
	XORL AX, AX
	QUAD $0xffff28056f0f44f3; BYTE $0xff // movdqu       $-216(%rip), %xmm8  /* LCPI26_0(%rip) */
	QUAD $0xffff2f156f0f44f3; BYTE $0xff // movdqu       $-209(%rip), %xmm10  /* LCPI26_1(%rip) */
	QUAD $0xffff360d6f0f44f3; BYTE $0xff // movdqu       $-202(%rip), %xmm9  /* LCPI26_2(%rip) */
	QUAD $0xffffff3e1d6f0ff3             // movdqu       $-194(%rip), %xmm3  /* LCPI26_3(%rip) */
	QUAD $0xffffff46256f0ff3             // movdqu       $-186(%rip), %xmm4  /* LCPI26_4(%rip) */
	QUAD $0xffffff4e2d6f0ff3             // movdqu       $-178(%rip), %xmm5  /* LCPI26_5(%rip) */
	QUAD $0xffffff56356f0ff3             // movdqu       $-170(%rip), %xmm6  /* LCPI26_6(%rip) */
	MOVQ $-1, R9
	MOVQ $-1, R8
	MOVQ SI, R15
...
LBB26_28:
	...
	SUBQ DI, SI
	XORL AX, AX
	LONG $0x3b358d4c; WORD $0x0001; BYTE $0x00 // leaq         $315(%rip), %r14  /* LJTI26_0(%rip) */
	JMP  LBB26_29
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffc5de8; BYTE $0xff // callq        _do_skip_number
	LEAQ  -1(AX), DX
	MOVQ  $-2, CX
	MOVQ  $-2, SI
	SUBQ  AX, SI
...
LBB28_3:
	MOVQ  BX, DI
	LONG  $0xfffbe6e8; BYTE $0xff // callq        _do_skip_number
	TESTQ AX, AX
	JS    LBB28_7
	ADDQ  AX, BX
...
_f64toa:
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·__native_entry__+525(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+8988(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_i64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3051(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
_lspace:
	...
	MOVQ nb+8(FP), SI
	MOVQ off+16(FP), DX
	CALL ·__native_entry__+210(SB) // _lspace
	MOVQ AX, ret+24(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+4388(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18107(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+21160(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+18144(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
_skip_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+16430(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3162(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+5963(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+21277(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	CALL ·__native_entry__+11592(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+14543(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+15852(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+13496(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+16130(SB), AX // _vunsigned
	JMP  AX
