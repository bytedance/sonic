...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+9808(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+4848(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ m+16(FP), DX
	MOVQ flags+24(FP), CX
	CALL ·__native_entry__+22320(SB) // _skip_array
	MOVQ AX, ret+32(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+23824(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ m+16(FP), DX
	MOVQ flags+24(FP), CX
	CALL ·__native_entry__+22368(SB) // _skip_object
	MOVQ AX, ret+32(FP)
	RET
...
_skip_one:
	...
	MOVQ m+16(FP), DX
	MOVQ flags+24(FP), CX
	CALL ·__native_entry__+20448(SB) // _skip_one
	MOVQ AX, ret+32(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3568(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+6624(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+23968(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	MOVQ v+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+13072(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18192(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+19744(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ v+16(FP), DX
	MOVQ flags+24(FP), CX
	LEAQ ·__native_entry__+15152(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+20096(SB), AX // _vunsigned
	JMP  AX
