...
LBB1_3:
	...
	LONG $0x0111870f; WORD $0x0000 // ja           LBB1_22, $273(%rip)
	LONG $0xd0a30f49               // btq          %rdx, %r8
	LONG $0x0107830f; WORD $0x0000 // jae          LBB1_22, $263(%rip)
...
LBB1_7:
	...
	LONG $0x0087820f; WORD $0x0000                     // jb           LBB1_13, $135(%rip)
	WORD $0x8948; BYTE $0xfe                           // movq         %rdi, %rsi
	WORD $0x294c; BYTE $0xd6                           // subq         %r10, %rsi
	QUAD $0xffffff18056f0f66                           // movdqa       $-232(%rip), %xmm0  /* LCPI1_0(%rip) */
	QUAD $0xffffff200d6f0f66                           // movdqa       $-224(%rip), %xmm1  /* LCPI1_1(%rip) */
	QUAD $0xffffff28156f0f66                           // movdqa       $-216(%rip), %xmm2  /* LCPI1_2(%rip) */
	QUAD $0xffffff301d6f0f66                           // movdqa       $-208(%rip), %xmm3  /* LCPI1_3(%rip) */
	QUAD $0x9090909090909090; QUAD $0x9090909090909090 // .p2align 4, 0x90
...
LBB2_8:
	...
	LONG $0xcd0d8d48; WORD $0x008c; BYTE $0x00 // leaq         $36045(%rip), %rcx  /* _DOUBLE_POW5_INV_SPLIT(%rip) */
...
LBB2_22:
	...
	LONG $0x041d8d4c; WORD $0x00a1; BYTE $0x00 // leaq         $41220(%rip), %r11  /* _DOUBLE_POW5_SPLIT(%rip) */
...
LBB2_67:
	...
	LONG $0x005496e8; BYTE $0x00   // callq        _print_mantissa, $21654(%rip)
...
LBB2_74:
	...
	LONG $0x8e058d48; WORD $0x00af; BYTE $0x00 // leaq         $44942(%rip), %rax  /* _Digits(%rip) */
...
LBB2_75:
	...
	LONG $0x1a0d8d48; WORD $0x00af; BYTE $0x00 // leaq         $44826(%rip), %rcx  /* _Digits(%rip) */
...
LBB2_80:
	...
	WORD $0x8944; BYTE $0xfa                                 // movl         %r15d, %edx
	LONG $0x00537ee8; BYTE $0x00                             // callq        _print_mantissa, $21374(%rip)
...
LBB2_85:
	...
	WORD $0x8944; BYTE $0xfa       // movl         %r15d, %edx
	LONG $0x005270e8; BYTE $0x00   // callq        _print_mantissa, $21104(%rip)
...
LBB2_97:
	...
	WORD $0xff31             // xorl         %edi, %edi
	QUAD $0xfffff5e8056f0f66 // movdqa       $-2584(%rip), %xmm0  /* LCPI2_0(%rip) */
	QUAD $0x9090909090909090 // .p2align 4, 0x90
...
LBB2_99:
	...
	QUAD $0xfffff581056f0f66       // movdqa       $-2687(%rip), %xmm0  /* LCPI2_0(%rip) */
...
_i64toa:
	...
	LONG $0x000082e9; BYTE $0x00   // jmp          _u64toa, $130(%rip)
...
LBB3_1:
	...
	LONG $0x01c78348                       // addq         $1, %rdi
	WORD $0xf748; BYTE $0xde               // negq         %rsi
	LONG $0x00006fe8; BYTE $0x00           // callq        _u64toa, $111(%rip)
...
_u64toa:
	...
	LONG $0xdc0d8d48; WORD $0x00ab; BYTE $0x00 // leaq         $43996(%rip), %rcx  /* _Digits(%rip) */
...
LBB4_4:
	...
	LONG $0xb4358d48; WORD $0x00ab; BYTE $0x00 // leaq         $43956(%rip), %rsi  /* _Digits(%rip) */
...
LBB4_6:
	LONG $0xa2158d48; WORD $0x00ab; BYTE $0x00 // leaq         $43938(%rip), %rdx  /* _Digits(%rip) */
...
LBB4_7:
	...
	LONG $0x89158d48; WORD $0x00ab; BYTE $0x00 // leaq         $43913(%rip), %rdx  /* _Digits(%rip) */
...
LBB4_8:
	...
	LONG $0xe6058d48; WORD $0x00aa; BYTE $0x00 // leaq         $43750(%rip), %rax  /* _Digits(%rip) */
...
LBB4_12:
	...
	LONG $0x01c88348                           // orq          $1, %rax
	LONG $0xba358d48; WORD $0x00aa; BYTE $0x00 // leaq         $43706(%rip), %rsi  /* _Digits(%rip) */
...
LBB4_14:
	LONG $0xa8058d48; WORD $0x00aa; BYTE $0x00 // leaq         $43688(%rip), %rax  /* _Digits(%rip) */
...
LBB4_16:
	...
	QUAD $0xfffffd820d6f0f66                   // movdqa       $-638(%rip), %xmm1  /* LCPI4_0(%rip) */
	...
	QUAD $0xfffffd54156f0f66                   // movdqa       $-684(%rip), %xmm2  /* LCPI4_1(%rip) */
	LONG $0xc2e40f66                           // pmulhuw      %xmm2, %xmm0
	QUAD $0xfffffd58256f0f66                   // movdqa       $-680(%rip), %xmm4  /* LCPI4_2(%rip) */
	LONG $0xc4e40f66                           // pmulhuw      %xmm4, %xmm0
	QUAD $0xfffffd5c2d6f0f66                   // movdqa       $-676(%rip), %xmm5  /* LCPI4_3(%rip) */
	...
	QUAD $0xfffffd120d6f0f66                   // movdqa       $-750(%rip), %xmm1  /* LCPI4_4(%rip) */
	...
	WORD $0xc129                               // subl         %eax, %ecx
	LONG $0x04e0c148                           // shlq         $4, %rax
	LONG $0xf6158d48; WORD $0x00a9; BYTE $0x00 // leaq         $43510(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB4_20:
	...
	LONG $0xc90d8d48; WORD $0x00a8; BYTE $0x00 // leaq         $43209(%rip), %rcx  /* _Digits(%rip) */
	LONG $0x4104b70f                           // movzwl       (%rcx,%rax,2), %eax
...
LBB4_22:
	...
	WORD $0xb70f; BYTE $0xc0                   // movzwl       %ax, %eax
	LONG $0x790d8d48; WORD $0x00a8; BYTE $0x00 // leaq         $43129(%rip), %rcx  /* _Digits(%rip) */
	LONG $0x4104b70f                           // movzwl       (%rcx,%rax,2), %eax
...
LBB4_24:
	...
	WORD $0xb70f; BYTE $0xc0                   // movzwl       %ax, %eax
	LONG $0x580d8d48; WORD $0x00a8; BYTE $0x00 // leaq         $43096(%rip), %rcx  /* _Digits(%rip) */
	LONG $0x4104b70f                           // movzwl       (%rcx,%rax,2), %eax
	WORD $0x8966; BYTE $0x07                   // movw         %ax, (%rdi)
	WORD $0xb70f; BYTE $0xc2                   // movzwl       %dx, %eax
...
LBB4_25:
	...
	LONG $0x1aeac148                                   // shrq         $26, %rdx
	LONG $0xc26e0f66                                   // movd         %edx, %xmm0
	QUAD $0xfffffb960d6f0f66                           // movdqa       $-1130(%rip), %xmm1  /* LCPI4_0(%rip) */
	...
	LONG $0xc0700f66; BYTE $0x50                       // pshufd       $80, %xmm0, %xmm0
	QUAD $0xfffffb68256f0f66                           // movdqa       $-1176(%rip), %xmm4  /* LCPI4_1(%rip) */
	LONG $0xc4e40f66                                   // pmulhuw      %xmm4, %xmm0
	QUAD $0xfffffb6c2d6f0f66                           // movdqa       $-1172(%rip), %xmm5  /* LCPI4_2(%rip) */
	LONG $0xc5e40f66                                   // pmulhuw      %xmm5, %xmm0
	QUAD $0xfffffb701d6f0f66                           // movdqa       $-1168(%rip), %xmm3  /* LCPI4_3(%rip) */
	LONG $0xf06f0f66                                   // movdqa       %xmm0, %xmm6
	...
	LONG $0xc1670f66                                   // packuswb     %xmm1, %xmm0
	QUAD $0xfffffb1e05fc0f66                           // paddb        $-1250(%rip), %xmm0  /* LCPI4_4(%rip) */
	WORD $0xc889                                       // movl         %ecx, %eax
...
_quote:
	...
	WORD $0x8948; BYTE $0xf0                   // movq         %rsi, %rax
	LONG $0x480d8d48; WORD $0x00a8; BYTE $0x00 // leaq         $43080(%rip), %rcx  /* __SingleQuoteTab(%rip) */
	LONG $0x51258d4c; WORD $0x00b8; BYTE $0x00 // leaq         $47185(%rip), %r12  /* __DoubleQuoteTab(%rip) */
	LONG $0xe1440f4c                           // cmoveq       %rcx, %r12
	QUAD $0x00000000f50c8d48                   // leaq         (,%rsi,8), %rcx
	WORD $0x3949; BYTE $0xca                   // cmpq         %rcx, %r10
	LONG $0x041c8d0f; WORD $0x0000             // jge          LBB5_56, $1052(%rip)
	WORD $0x894d; BYTE $0xfe                   // movq         %r15, %r14
	WORD $0x8949; BYTE $0xf9                   // movq         %rdi, %r9
	WORD $0x8548; BYTE $0xc0                   // testq        %rax, %rax
	LONG $0x03fc840f; WORD $0x0000             // je           LBB5_80, $1020(%rip)
	LONG $0xc85d894c                           // movq         %r11, $-56(%rbp)
	QUAD $0xffffff61056f0f66                   // movdqa       $-159(%rip), %xmm0  /* LCPI5_0(%rip) */
	QUAD $0xffffff690d6f0f66                   // movdqa       $-151(%rip), %xmm1  /* LCPI5_1(%rip) */
	QUAD $0xffffff71156f0f66                   // movdqa       $-143(%rip), %xmm2  /* LCPI5_2(%rip) */
...
LBB5_3:
	...
	LONG $0x00938c0f; WORD $0x0000                     // jl           LBB5_10, $147(%rip)
	LONG $0x10fa8349                                   // cmpq         $16, %r10
	LONG $0x00898c0f; WORD $0x0000                     // jl           LBB5_10, $137(%rip)
	WORD $0x3145; BYTE $0xff                           // xorl         %r15d, %r15d
	WORD $0x8948; BYTE $0xc6                           // movq         %rax, %rsi
	WORD $0x894c; BYTE $0xd2                           // movq         %r10, %rdx
	QUAD $0x9090909090909090; QUAD $0x9090909090909090 // .p2align 4, 0x90
...
LBB5_17:
	...
	LONG $0x8c358d48; WORD $0x00a6; BYTE $0x00 // leaq         $42636(%rip), %rsi  /* __SingleQuoteTab(%rip) */
...
LBB5_53:
	...
	LONG $0xfc3d850f; WORD $0xffff // jne          LBB5_3, $-963(%rip)
...
LBB5_56:
	LONG $0x290d8d4c; WORD $0x00c4; BYTE $0x00 // leaq         $50217(%rip), %r9  /* __EscTab(%rip) */
	QUAD $0xfffffb51056f0f66                   // movdqa       $-1199(%rip), %xmm0  /* LCPI5_0(%rip) */
	QUAD $0xfffffb590d6f0f66                   // movdqa       $-1191(%rip), %xmm1  /* LCPI5_1(%rip) */
	QUAD $0xfffffb61156f0f66                   // movdqa       $-1183(%rip), %xmm2  /* LCPI5_2(%rip) */
	LONG $0xdb760f66                           // pcmpeqd      %xmm3, %xmm3
...
_unquote:
	...
	QUAD $0xffffffb7056f0f66       // movdqa       $-73(%rip), %xmm0  /* LCPI6_0(%rip) */
...
LBB6_17:
	...
	LONG $0x44158d4c; WORD $0x00c1; BYTE $0x00 // leaq         $49476(%rip), %r10  /* __UnquoteTab(%rip) */
...
_html_escape:
	...
	QUAD $0xffffff79056f0f66                   // movdqa       $-135(%rip), %xmm0  /* LCPI7_0(%rip) */
	QUAD $0xffffff810d6f0f66                   // movdqa       $-127(%rip), %xmm1  /* LCPI7_1(%rip) */
	QUAD $0xffffff89156f0f66                   // movdqa       $-119(%rip), %xmm2  /* LCPI7_2(%rip) */
	QUAD $0xffffff911d6f0f66                   // movdqa       $-111(%rip), %xmm3  /* LCPI7_3(%rip) */
	LONG $0xaa1d8d4c; WORD $0x00b6; BYTE $0x00 // leaq         $46762(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	WORD $0x8949; BYTE $0xfc                   // movq         %rdi, %r12
...
LBB7_20:
	...
	LONG $0xfc1d8d4c; WORD $0x00b4; BYTE $0x00 // leaq         $46332(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	QUAD $0x9090909090909090; LONG $0x90909090 // .p2align 4, 0x90
...
LBB7_45:
	...
	LONG $0x821d8d4c; WORD $0x00b4; BYTE $0x00 // leaq         $46210(%rip), %r11  /* __HtmlQuoteTab(%rip) */
	WORD $0x854d; BYTE $0xff                   // testq        %r15, %r15
...
LBB8_5:
	...
	WORD $0xc189                               // movl         %eax, %ecx
	LONG $0x04e1c148                           // shlq         $4, %rcx
	LONG $0x313d8d4c; WORD $0x0038; BYTE $0x00 // leaq         $14385(%rip), %r15  /* _POW10_M128_TAB(%rip) */
	WORD $0x8948; BYTE $0xf8                   // movq         %rdi, %rax
...
LBB9_11:
	...
	WORD $0xde89                 // movl         %ebx, %esi
	LONG $0x003495e8; BYTE $0x00 // callq        _right_shift, $13461(%rip)
...
LBB9_12:
	LONG $0xe1358d4c; WORD $0x0061; BYTE $0x00 // leaq         $25057(%rip), %r14  /* _POW_TAB(%rip) */
...
LBB9_20:
	WORD $0x894c; BYTE $0xff     // movq         %r15, %rdi
	WORD $0xde89                 // movl         %ebx, %esi
	LONG $0x003216e8; BYTE $0x00 // callq        _left_shift, $12822(%rip)
	LONG $0x14478b41             // movl         $20(%r15), %eax
...
LBB9_25:
	...
	LONG $0x003393e8; BYTE $0x00   // callq        _right_shift, $13203(%rip)
...
LBB9_31:
	...
	LONG $0x00333fe8; BYTE $0x00   // callq        _right_shift, $13119(%rip)
	LONG $0xfc02be41; WORD $0xffff // movl         $-1022, %r14d
...
LBB9_32:
	...
	LONG $0x003101e8; BYTE $0x00   // callq        _left_shift, $12545(%rip)
...
LBB11_2:
	...
	LONG $0x0013c7e8; BYTE $0x00   // callq        _vnumber, $5063(%rip)
...
LBB11_7:
	...
	WORD $0x8948; BYTE $0xde                   // movq         %rbx, %rsi
	LONG $0x002532e8; BYTE $0x00               // callq        _do_skip_number, $9522(%rip)
	WORD $0x8548; BYTE $0xc0                   // testq        %rax, %rax
...
LBB12_27:
	...
	QUAD $0xfffffe4e056f0f66       // movdqa       $-434(%rip), %xmm0  /* LCPI12_0(%rip) */
	QUAD $0xfffffe560d6f0f66       // movdqa       $-426(%rip), %xmm1  /* LCPI12_1(%rip) */
	QUAD $0xfffffe5e156f0f66       // movdqa       $-418(%rip), %xmm2  /* LCPI12_2(%rip) */
	QUAD $0xfffffe661d6f0f66       // movdqa       $-410(%rip), %xmm3  /* LCPI12_3(%rip) */
	LONG $0x90909090; WORD $0x9090 // .p2align 4, 0x90
...
_advance_string:
	...
	QUAD $0xffffffffc045c748                   // movq         $-1, $-64(%rbp)
	WORD $0x3145; BYTE $0xdb                   // xorl         %r11d, %r11d
	QUAD $0xffffff64056f0f66                   // movdqa       $-156(%rip), %xmm0  /* LCPI14_0(%rip) */
	QUAD $0xffffff6c0d6f0f66                   // movdqa       $-148(%rip), %xmm1  /* LCPI14_1(%rip) */
...
LBB14_12:
	...
	QUAD $0xfffdd6056f0f4466; BYTE $0xff       // movdqa       $-554(%rip), %xmm8  /* LCPI14_0(%rip) */
	QUAD $0xfffffdde0d6f0f66                   // movdqa       $-546(%rip), %xmm1  /* LCPI14_1(%rip) */
	QUAD $0xfffffde6156f0f66                   // movdqa       $-538(%rip), %xmm2  /* LCPI14_2(%rip) */
	LONG $0xdb760f66                           // pcmpeqd      %xmm3, %xmm3
...
LBB14_71:
	...
	QUAD $0xfffff8ad156f0f66       // movdqa       $-1875(%rip), %xmm2  /* LCPI14_0(%rip) */
	QUAD $0xfffff8b51d6f0f66       // movdqa       $-1867(%rip), %xmm3  /* LCPI14_1(%rip) */
	LONG $0xe06f0f66               // movdqa       %xmm0, %xmm4
...
LBB15_69:
	...
	QUAD $0xfffffc2505620f66     // punpckldq    $-987(%rip), %xmm0  /* LCPI15_0(%rip) */
	QUAD $0xfffffc2d055c0f66     // subpd        $-979(%rip), %xmm0  /* LCPI15_1(%rip) */
...
LBB15_61:
	...
	QUAD $0xfffffb720d620f66                   // punpckldq    $-1166(%rip), %xmm1  /* LCPI15_0(%rip) */
	QUAD $0xfffffb7a0d5c0f66                   // subpd        $-1158(%rip), %xmm1  /* LCPI15_1(%rip) */
	...
	LONG $0x020d8d48; WORD $0x00ba; BYTE $0x00 // leaq         $47618(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB15_67:
	...
	WORD $0xdef7                               // negl         %esi
	LONG $0xdc058d48; WORD $0x00b9; BYTE $0x00 // leaq         $47580(%rip), %rax  /* _P10_TAB(%rip) */
...
LBB15_71:
	QUAD $0xfffffaeb052e0f66                   // ucomisd      $-1301(%rip), %xmm0  /* LCPI15_2(%rip) */
	LONG $0x002a870f; WORD $0x0000             // ja           LBB15_74, $42(%rip)
	QUAD $0xfffffae50d100ff2                   // movsd        $-1307(%rip), %xmm1  /* LCPI15_3(%rip) */
	LONG $0xc82e0f66                           // ucomisd      %xmm0, %xmm1
	LONG $0x0018870f; WORD $0x0000             // ja           LBB15_74, $24(%rip)
	WORD $0xc089                               // movl         %eax, %eax
	LONG $0xa20d8d48; WORD $0x00b9; BYTE $0x00 // leaq         $47522(%rip), %rcx  /* _P10_TAB(%rip) */
	LONG $0x04590ff2; BYTE $0xc1               // mulsd        (%rcx,%rax,8), %xmm0
	LONG $0x45110ff2; BYTE $0xc0               // movsd        %xmm0, $-64(%rbp)
...
LBB15_74:
	...
	LONG $0xffdebbe8; BYTE $0xff   // callq        _atof_eisel_lemire64, $-8517(%rip)
	WORD $0xc084                   // testb        %al, %al
	...
	WORD $0x894c; BYTE $0xe7       // movq         %r12, %rdi
	WORD $0x558b; BYTE $0xd4       // movl         $-44(%rbp), %edx
	LONG $0xffde92e8; BYTE $0xff   // callq        _atof_eisel_lemire64, $-8558(%rip)
	WORD $0xc084                   // testb        %al, %al
...
LBB15_80:
	...
	LONG $0xffe3aae8; BYTE $0xff // callq        _atof_native, $-7254(%rip)
	LONG $0x45110ff2; BYTE $0xc0 // movsd        %xmm0, $-64(%rbp)
	LONG $0x7e0f4866; BYTE $0xc0 // movq         %xmm0, %rax
...
LBB19_4:
	...
	WORD $0x894c; BYTE $0xe2       // movq         %r12, %rdx
	LONG $0xffe841e8; BYTE $0xff   // callq        _advance_ns, $-6079(%rip)
	WORD $0xc084                   // testb        %al, %al
...
_skip_string:
	...
	WORD $0x8948; BYTE $0xde       // movq         %rbx, %rsi
	LONG $0xffe420e8; BYTE $0xff   // callq        _advance_string, $-7136(%rip)
	WORD $0x8548; BYTE $0xc0       // testq        %rax, %rax
...
LBB24_6:
	...
	WORD $0xc031                               // xorl         %eax, %eax
	QUAD $0xffff14056f0f4466; BYTE $0xff       // movdqa       $-236(%rip), %xmm8  /* LCPI24_0(%rip) */
	QUAD $0xffff1b156f0f4466; BYTE $0xff       // movdqa       $-229(%rip), %xmm10  /* LCPI24_1(%rip) */
	QUAD $0xffff220d6f0f4466; BYTE $0xff       // movdqa       $-222(%rip), %xmm9  /* LCPI24_2(%rip) */
	QUAD $0xffffff2a1d6f0f66                   // movdqa       $-214(%rip), %xmm3  /* LCPI24_3(%rip) */
	QUAD $0xffffff32256f0f66                   // movdqa       $-206(%rip), %xmm4  /* LCPI24_4(%rip) */
	QUAD $0xffffff3a2d6f0f66                   // movdqa       $-198(%rip), %xmm5  /* LCPI24_5(%rip) */
	QUAD $0xffffff42356f0f66                   // movdqa       $-190(%rip), %xmm6  /* LCPI24_6(%rip) */
	LONG $0xffc1c749; WORD $0xffff; BYTE $0xff // movq         $-1, %r9
...
LBB24_28:
	...
	WORD $0xc031                               // xorl         %eax, %eax
	LONG $0xa8358d4c; WORD $0x0001; BYTE $0x00 // leaq         $424(%rip), %r14  /* LJTI24_0(%rip) */
...
LJTI24_0:
	...
	LONG $0xffffff02 // .long L24_0_set_40
	LONG $0xffffff02 // .long L24_0_set_40
	LONG $0xfffffe66 // .long L24_0_set_32
	LONG $0x90909090 // .p2align 4, 0x90
...
_validate_one:
	...
	WORD $0x8948; BYTE $0xc7                                 // movq         %rax, %rdi
	BYTE $0x5d                                               // popq         %rbp
	LONG $0xfff22ee9; BYTE $0xff                             // jmp          _fsm_exec, $-3538(%rip)
	QUAD $0x9090909090909090; LONG $0x90909090; WORD $0x9090 // .p2align 4, 0x90
...
_f64toa:
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·__native_entry__+688(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
_html_escape:
	...
	MOVQ dp+16(FP), DX
	MOVQ dn+24(FP), CX
	CALL ·__native_entry__+9984(SB) // _html_escape
	MOVQ AX, ret+32(FP)
	RET
...
_lspace:
	...
	MOVQ nb+8(FP), SI
	MOVQ off+16(FP), DX
	CALL ·__native_entry__+272(SB) // _lspace
	MOVQ AX, ret+24(FP)
	RET
...
_quote:
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+4944(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVQ m+16(FP), DX
	MOVQ flags+24(FP), CX
	CALL ·__native_entry__+22592(SB) // _skip_array
	MOVQ AX, ret+32(FP)
	RET
...
_skip_number:
	MOVQ s+0(FP), DI
	MOVQ p+8(FP), SI
	CALL ·__native_entry__+24112(SB) // _skip_number
	MOVQ AX, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVQ m+16(FP), DX
	MOVQ flags+24(FP), CX
	CALL ·__native_entry__+22640(SB) // _skip_object
	MOVQ AX, ret+32(FP)
	RET
...
_skip_one:
	...
	MOVQ m+16(FP), DX
	MOVQ flags+24(FP), CX
	CALL ·__native_entry__+20720(SB) // _skip_one
	MOVQ AX, ret+32(FP)
	RET
...
_u64toa:
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·__native_entry__+3632(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
_unquote:
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+6752(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·__native_entry__+24256(SB) // _validate_one
	MOVQ AX, ret+24(FP)
	RET
...
_value:
	...
	MOVQ v+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·__native_entry__+13280(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+18464(SB), AX // _vnumber
	JMP  AX
...
_vsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+20016(SB), AX // _vsigned
	JMP  AX
...
_vstring:
	...
	MOVQ v+16(FP), DX
	MOVQ flags+24(FP), CX
	LEAQ ·__native_entry__+15392(SB), AX // _vstring
	JMP  AX
...
_vunsigned:
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·__native_entry__+20368(SB), AX // _vunsigned
	JMP  AX
