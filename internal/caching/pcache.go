...
func (self *ProgramCache) Compute(vt *rt.GoType, compute func(*rt.GoType, ... interface{}) (interface{}, error)) (interface{}, error) {
    var err error
    var val interface{}
    ...
    /* compute the value */
    if val, err = compute(vt, rt.F_direct&vt.KindFlags != 0); err != nil {
        return nil, err
    }
