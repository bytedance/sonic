...
func TestIssue829_NullCharacterInVM(t *testing.T) {
	// Test case for issue 829: null character should cause syntax error in VM mode
	var v interface{}
	
	// Test with null character in array
	err := sonic.Unmarshal([]byte("[\u0000]"), &v)
	
	// Should return syntax error, but currently returns nil
	...
	// Both should return syntax errors
